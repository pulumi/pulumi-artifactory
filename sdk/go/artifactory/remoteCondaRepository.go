...
type RemoteCondaRepository struct {
	...
	ContentSynchronisation RemoteCondaRepositoryContentSynchronisationPtrOutput `pulumi:"contentSynchronisation"`
...
// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
func (o RemoteCondaRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolOutput)
}

// The number of seconds the repository stays in assumed offline state after a connection error. At the end of this time, an online check is attempted in order to reset the offline status. A value of 0 means the repository is never assumed offline.
func (o RemoteCondaRepositoryOutput) AssumedOfflinePeriodSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.IntOutput { return v.AssumedOfflinePeriodSecs }).(pulumi.IntOutput)
}
...
// When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
func (o RemoteCondaRepositoryOutput) CdnRedirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.CdnRedirect }).(pulumi.BoolOutput)
}
...
func (o RemoteCondaRepositoryOutput) ContentSynchronisation() RemoteCondaRepositoryContentSynchronisationPtrOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) RemoteCondaRepositoryContentSynchronisationPtrOutput {
		return v.ContentSynchronisation
	}).(RemoteCondaRepositoryContentSynchronisationPtrOutput)
}

// Enable repository to be protected by the Curation service.
func (o RemoteCondaRepositoryOutput) Curated() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.Curated }).(pulumi.BoolOutput)
}
...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too. Introduced since Artifactory 7.41.7.
func (o RemoteCondaRepositoryOutput) DisableProxy() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.DisableProxy }).(pulumi.BoolOutput)
}

// Whether to disable URL normalization. Default is `false`.
func (o RemoteCondaRepositoryOutput) DisableUrlNormalization() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.DisableUrlNormalization }).(pulumi.BoolOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only. Default value is 'false'.
func (o RemoteCondaRepositoryOutput) DownloadDirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.DownloadDirect }).(pulumi.BoolOutput)
}
...
// Enable token (Bearer) based authentication. When set, use an access token as `password` (username may be empty) so Artifactory authenticates to the remote with a Bearer token instead of Basic auth. Default is `false` for most package types; OCI, Helm OCI, and Hugging Face remotes default to `true`.
func (o RemoteCondaRepositoryOutput) EnableTokenAuthentication() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.EnableTokenAuthentication }).(pulumi.BoolOutput)
}
...
// Lists the items of remote folders in simple and list browsing. The remote content is cached according to the value of the 'Retrieval Cache Period'. Default value is 'false'. This field exists in the API but not in the UI.
func (o RemoteCondaRepositoryOutput) ListRemoteFolderItems() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.ListRemoteFolderItems }).(pulumi.BoolOutput)
}

// The local address to be used when creating connections. Useful for specifying the interface to use on systems with multiple network interfaces.
func (o RemoteCondaRepositoryOutput) LocalAddress() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.LocalAddress }).(pulumi.StringOutput)
}

// Metadata Retrieval Cache Timeout (Sec) in the UI.This value refers to the number of seconds to wait for retrieval from the remote before serving locally cached artifact or fail the request.
func (o RemoteCondaRepositoryOutput) MetadataRetrievalTimeoutSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.IntOutput { return v.MetadataRetrievalTimeoutSecs }).(pulumi.IntOutput)
}

// The set of mime types that should override the blockMismatchingMimeTypes setting. Eg: 'application/json,application/xml'. Default value is empty.
func (o RemoteCondaRepositoryOutput) MismatchingMimeTypesOverrideList() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.MismatchingMimeTypesOverrideList }).(pulumi.StringOutput)
}
...
// Internal description.
func (o RemoteCondaRepositoryOutput) Notes() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.Notes }).(pulumi.StringOutput)
}
...
// Enable Pass-through for Curation Audit. When enabled, allows artifacts to pass through the Curation audit process.
func (o RemoteCondaRepositoryOutput) PassThrough() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.PassThrough }).(pulumi.BoolOutput)
}
...
// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
// Write-only equivalent of `password`. The value is used to authenticate against the remote registry but is **never stored in Terraform state or plan**. Requires Terraform 1.11 or later. Conflicts with `password`. Because write-only values are not tracked in state, use `passwordWoVersion` to signal when the secret has changed so it is re-sent to Artifactory.
func (o RemoteCondaRepositoryOutput) PasswordWo() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringPtrOutput { return v.PasswordWo }).(pulumi.StringPtrOutput)
}

// A version identifier for `passwordWo`. Change this value (for example, after rotating the secret) to trigger an update that re-sends the current `passwordWo` value to Artifactory. Only meaningful together with `passwordWo`.
func (o RemoteCondaRepositoryOutput) PasswordWoVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringPtrOutput { return v.PasswordWoVersion }).(pulumi.StringPtrOutput)
}
...
// Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
func (o RemoteCondaRepositoryOutput) ProjectKey() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.ProjectKey }).(pulumi.StringOutput)
}

// When set, if query params are included in the request to Artifactory, they will be passed on to the remote repository.
func (o RemoteCondaRepositoryOutput) PropagateQueryParams() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.PropagateQueryParams }).(pulumi.BoolOutput)
}
...
// Proxy key from Artifactory Proxies settings. Can't be set if `disableProxy = true`.
func (o RemoteCondaRepositoryOutput) Proxy() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.Proxy }).(pulumi.StringOutput)
}

// Custom HTTP query parameters that will be automatically included in all remote resource requests. For example: `param1=val1&param2=val2&param3=val3`
func (o RemoteCondaRepositoryOutput) QueryParams() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.QueryParams }).(pulumi.StringOutput)
}
...
// Sets the layout that the repository should use for storing and identifying modules. A recommended layout that corresponds to the package type defined is suggested, and index packages uploaded and calculate metadata accordingly.
func (o RemoteCondaRepositoryOutput) RepoLayoutRef() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.RepoLayoutRef }).(pulumi.StringOutput)
}
...
// When set to `true`, Artifactory retrieves the SHA256 from the remote server if it is not cached in the remote repo.
func (o RemoteCondaRepositoryOutput) RetrieveSha256FromServer() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.RetrieveSha256FromServer }).(pulumi.BoolOutput)
}
...
func (o RemoteCondaRepositoryOutput) Username() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.StringOutput { return v.Username }).(pulumi.StringOutput)
}

// Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
func (o RemoteCondaRepositoryOutput) XrayIndex() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteCondaRepository) pulumi.BoolOutput { return v.XrayIndex }).(pulumi.BoolOutput)
}
