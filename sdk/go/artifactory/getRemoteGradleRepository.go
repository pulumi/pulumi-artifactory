...
//			_, err := artifactory.GetRemoteGradleRepository(ctx, &artifactory.LookupRemoteGradleRepositoryArgs{
//				Key: "remote-gradle",
//			}, nil)
//			if err != nil {
//				return err
...
func (o LookupRemoteGradleRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteGradleRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteGradleRepositoryResultOutput) MaxUniqueSnapshots() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupRemoteGradleRepositoryResult) *int { return v.MaxUniqueSnapshots }).(pulumi.IntPtrOutput)
}
