...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too.
func (o GetFederatedGitlfsRepositoryResultOutput) DisableProxy() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetFederatedGitlfsRepositoryResult) *bool { return v.DisableProxy }).(pulumi.BoolPtrOutput)
}
...
// Proxy key from Artifactory Proxies settings.
func (o GetFederatedGitlfsRepositoryResultOutput) Proxy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetFederatedGitlfsRepositoryResult) *string { return v.Proxy }).(pulumi.StringPtrOutput)
}
