...
func (o LookupLocalOpkgRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalOpkgRepositoryResult] {
	return pulumix.Output[LookupLocalOpkgRepositoryResult]{
