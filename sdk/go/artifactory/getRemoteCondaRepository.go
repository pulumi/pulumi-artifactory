...
func (o LookupRemoteCondaRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCondaRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteCondaRepositoryResultOutput) Curated() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCondaRepositoryResult) *bool { return v.Curated }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteCondaRepositoryResultOutput) DisableProxy() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCondaRepositoryResult) *bool { return v.DisableProxy }).(pulumi.BoolPtrOutput)
}

func (o LookupRemoteCondaRepositoryResultOutput) DisableUrlNormalization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCondaRepositoryResult) *bool { return v.DisableUrlNormalization }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteCondaRepositoryResultOutput) PassThrough() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCondaRepositoryResult) *bool { return v.PassThrough }).(pulumi.BoolPtrOutput)
}
