...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemoteNugetRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteNugetRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// Enable repository to be protected by the Curation service.
func (o RemoteNugetRepositoryOutput) Curated() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteNugetRepository) pulumi.BoolPtrOutput { return v.Curated }).(pulumi.BoolPtrOutput)
}
