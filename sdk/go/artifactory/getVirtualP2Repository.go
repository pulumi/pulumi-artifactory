...
func (o LookupVirtualP2RepositoryResultOutput) HideUnauthorizedResources() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVirtualP2RepositoryResult) *bool { return v.HideUnauthorizedResources }).(pulumi.BoolPtrOutput)
}
