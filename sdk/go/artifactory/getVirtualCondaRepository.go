...
func (o LookupVirtualCondaRepositoryResultOutput) HideUnauthorizedResources() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVirtualCondaRepositoryResult) *bool { return v.HideUnauthorizedResources }).(pulumi.BoolPtrOutput)
}
