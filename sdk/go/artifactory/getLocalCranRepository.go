...
func (o LookupLocalCranRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalCranRepositoryResult] {
	return pulumix.Output[LookupLocalCranRepositoryResult]{
