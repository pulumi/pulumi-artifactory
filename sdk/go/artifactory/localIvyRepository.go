...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o LocalIvyRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolOutput)
}

// When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
func (o LocalIvyRepositoryOutput) BlackedOut() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.BlackedOut }).(pulumi.BoolOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from AWS
// CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
func (o LocalIvyRepositoryOutput) CdnRedirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.CdnRedirect }).(pulumi.BoolOutput)
}
...
// "server-generated-checksums". Default: "client-checksums"\n For more details, please refer to Checksum Policy -
// https://www.jfrog.com/confluence/display/JFROG/Local+Repositories#LocalRepositories-ChecksumPolicy
func (o LocalIvyRepositoryOutput) ChecksumPolicyType() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.StringOutput { return v.ChecksumPolicyType }).(pulumi.StringOutput)
}

// Public description.
func (o LocalIvyRepositoryOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from the cloud
// storage provider. Available in Enterprise+ and Edge licenses only.
func (o LocalIvyRepositoryOutput) DownloadDirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.DownloadDirect }).(pulumi.BoolOutput)
}
...
// If set, Artifactory allows you to deploy release artifacts into this repository.
func (o LocalIvyRepositoryOutput) HandleReleases() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.HandleReleases }).(pulumi.BoolOutput)
}

// If set, Artifactory allows you to deploy snapshot artifacts into this repository.
func (o LocalIvyRepositoryOutput) HandleSnapshots() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.HandleSnapshots }).(pulumi.BoolOutput)
}
...
// The maximum number of unique snapshots of a single artifact to store. Once the number of snapshots exceeds this setting,
// older versions are removed. A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
func (o LocalIvyRepositoryOutput) MaxUniqueSnapshots() pulumi.IntOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.IntOutput { return v.MaxUniqueSnapshots }).(pulumi.IntOutput)
}

// Internal description.
func (o LocalIvyRepositoryOutput) Notes() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.StringOutput { return v.Notes }).(pulumi.StringOutput)
}

// Setting repositories with priority will cause metadata to be merged only from repositories set with this field
func (o LocalIvyRepositoryOutput) PriorityResolution() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.PriorityResolution }).(pulumi.BoolOutput)
}
...
// Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When
// assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
func (o LocalIvyRepositoryOutput) ProjectKey() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.StringOutput { return v.ProjectKey }).(pulumi.StringOutput)
}
...
// Sets the layout that the repository should use for storing and identifying modules. A recommended layout that
// corresponds to the package type defined is suggested, and index packages uploaded and calculate metadata accordingly.
func (o LocalIvyRepositoryOutput) RepoLayoutRef() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.StringOutput { return v.RepoLayoutRef }).(pulumi.StringOutput)
}

// Specifies the naming convention for Maven SNAPSHOT versions. The options are - `unique`: Version number is based on a
// time-stamp (default), `non-unique`: Version number uses a self-overriding naming pattern of
// artifactId-version-SNAPSHOT.type, `deployer`: Respects the settings in the Maven client that is deploying the artifact.
func (o LocalIvyRepositoryOutput) SnapshotVersionBehavior() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.StringOutput { return v.SnapshotVersionBehavior }).(pulumi.StringOutput)
}
...
// deployment with a `409 Conflict` error. You can disable this behavior by setting the Suppress POM Consistency Checks
// checkbox.
func (o LocalIvyRepositoryOutput) SuppressPomConsistencyChecks() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.SuppressPomConsistencyChecks }).(pulumi.BoolOutput)
}

// Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
// Xray settings.
func (o LocalIvyRepositoryOutput) XrayIndex() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalIvyRepository) pulumi.BoolOutput { return v.XrayIndex }).(pulumi.BoolOutput)
}
