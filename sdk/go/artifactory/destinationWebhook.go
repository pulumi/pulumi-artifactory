...
// Status of webhook. Default to `true`
func (o DestinationWebhookOutput) Enabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *DestinationWebhook) pulumi.BoolOutput { return v.Enabled }).(pulumi.BoolOutput)
}
