...
//			_, err := artifactory.GetRemoteGitlfsRepository(ctx, &artifactory.LookupRemoteGitlfsRepositoryArgs{
//				Key: "remote-gitlfs",
//			}, nil)
//			if err != nil {
//				return err
...
func (o LookupRemoteGitlfsRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteGitlfsRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteGitlfsRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteGitlfsRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
