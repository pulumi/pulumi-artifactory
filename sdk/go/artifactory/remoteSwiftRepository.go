...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemoteSwiftRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteSwiftRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// The remote repo URL.
func (o RemoteSwiftRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteSwiftRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
