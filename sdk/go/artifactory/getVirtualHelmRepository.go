...
//			_, err := artifactory.GetVirtualHelmRepository(ctx, &artifactory.LookupVirtualHelmRepositoryArgs{
//				Key: "virtual-helm",
//			}, nil)
//			if err != nil {
//				return err
...
func (o LookupVirtualHelmRepositoryResultOutput) HideUnauthorizedResources() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVirtualHelmRepositoryResult) *bool { return v.HideUnauthorizedResources }).(pulumi.BoolPtrOutput)
}
