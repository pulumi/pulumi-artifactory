...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemoteGradleRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// Enable repository to be protected by the Curation service.
func (o RemoteGradleRepositoryOutput) Curated() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolPtrOutput { return v.Curated }).(pulumi.BoolPtrOutput)
}
...
// The remote repo URL.
func (o RemoteGradleRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
