...
// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
func (o RemoteGradleRepositoryOutput) AllowAnyHostAuth() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.AllowAnyHostAuth }).(pulumi.BoolOutput)
}

// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
func (o RemoteGradleRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolOutput)
}

// The number of seconds the repository stays in assumed offline state after a connection error. At the end of this time, an online check is attempted in order to reset the offline status. A value of 0 means the repository is never assumed offline.
func (o RemoteGradleRepositoryOutput) AssumedOfflinePeriodSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.AssumedOfflinePeriodSecs }).(pulumi.IntOutput)
}

// (A.K.A 'Ignore Repository' on the UI) When set, the repository or its local cache do not participate in artifact resolution.
func (o RemoteGradleRepositoryOutput) BlackedOut() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.BlackedOut }).(pulumi.BoolOutput)
}

// If set, artifacts will fail to download if a mismatch is detected between requested and received mimetype, according to the list specified in the system properties file under blockedMismatchingMimeTypes. You can override by adding mimetypes to the override list 'mismatching_mime_types_override_list'.
func (o RemoteGradleRepositoryOutput) BlockMismatchingMimeTypes() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.BlockMismatchingMimeTypes }).(pulumi.BoolOutput)
}

// Before caching an artifact, Artifactory first sends a HEAD request to the remote resource. In some remote resources, HEAD requests are disallowed and therefore rejected, even though downloading the artifact is allowed. When checked, Artifactory will bypass the HEAD request and cache the artifact directly using a GET request.
func (o RemoteGradleRepositoryOutput) BypassHeadRequests() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.BypassHeadRequests }).(pulumi.BoolOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
func (o RemoteGradleRepositoryOutput) CdnRedirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.CdnRedirect }).(pulumi.BoolOutput)
}
...
func (o RemoteGradleRepositoryOutput) ContentSynchronisation() RemoteGradleRepositoryContentSynchronisationPtrOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) RemoteGradleRepositoryContentSynchronisationPtrOutput {
		return v.ContentSynchronisation
	}).(RemoteGradleRepositoryContentSynchronisationPtrOutput)
}

// Enable repository to be protected by the Curation service.
func (o RemoteGradleRepositoryOutput) Curated() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.Curated }).(pulumi.BoolOutput)
}

// Public description.
func (o RemoteGradleRepositoryOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}

// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too. Introduced since Artifactory 7.41.7.
func (o RemoteGradleRepositoryOutput) DisableProxy() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.DisableProxy }).(pulumi.BoolOutput)
}

// Whether to disable URL normalization. Default is `false`.
func (o RemoteGradleRepositoryOutput) DisableUrlNormalization() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.DisableUrlNormalization }).(pulumi.BoolOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only. Default value is 'false'.
func (o RemoteGradleRepositoryOutput) DownloadDirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.DownloadDirect }).(pulumi.BoolOutput)
}

// Enables cookie management if the remote repository uses cookies to manage client state.
func (o RemoteGradleRepositoryOutput) EnableCookieManagement() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.EnableCookieManagement }).(pulumi.BoolOutput)
}

// Enable token (Bearer) based authentication. When set, use an access token as `password` (username may be empty) so Artifactory authenticates to the remote with a Bearer token instead of Basic auth. Default is `false` for most package types; OCI, Helm OCI, and Hugging Face remotes default to `true`.
func (o RemoteGradleRepositoryOutput) EnableTokenAuthentication() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.EnableTokenAuthentication }).(pulumi.BoolOutput)
}

// Comma-separated list of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/**/z/*`. This is a single string of comma-separated values, not a list of strings. By default no artifacts are excluded.
func (o RemoteGradleRepositoryOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.ExcludesPattern }).(pulumi.StringOutput)
}

// When set, if a POM is requested, Artifactory attempts to fetch the corresponding jar in the background. This will accelerate first access time to the jar when it is subsequently requested.
func (o RemoteGradleRepositoryOutput) FetchJarsEagerly() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.FetchJarsEagerly }).(pulumi.BoolOutput)
}

// When set, if a binaries jar is requested, Artifactory attempts to fetch the corresponding source jar in the background. This will accelerate first access time to the source jar when it is subsequently requested.
func (o RemoteGradleRepositoryOutput) FetchSourcesEagerly() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.FetchSourcesEagerly }).(pulumi.BoolOutput)
}

// If set, Artifactory allows you to deploy release artifacts into this repository.
func (o RemoteGradleRepositoryOutput) HandleReleases() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.HandleReleases }).(pulumi.BoolOutput)
}

// If set, Artifactory allows you to deploy snapshot artifacts into this repository.
func (o RemoteGradleRepositoryOutput) HandleSnapshots() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.HandleSnapshots }).(pulumi.BoolOutput)
}

// When set, Artifactory will return an error to the client that causes the build to fail if there is a failure to communicate with this repository.
func (o RemoteGradleRepositoryOutput) HardFail() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.HardFail }).(pulumi.BoolOutput)
}

// Comma-separated list of artifact patterns to include when evaluating artifact requests in the form of `x/y/**/z/*`. This is a single string of comma-separated values, not a list of strings. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`**/*`).
func (o RemoteGradleRepositoryOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.IncludesPattern }).(pulumi.StringOutput)
}
...
// Lists the items of remote folders in simple and list browsing. The remote content is cached according to the value of the 'Retrieval Cache Period'. Default value is 'false'. This field exists in the API but not in the UI.
func (o RemoteGradleRepositoryOutput) ListRemoteFolderItems() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.ListRemoteFolderItems }).(pulumi.BoolOutput)
}

// The local address to be used when creating connections. Useful for specifying the interface to use on systems with multiple network interfaces.
func (o RemoteGradleRepositoryOutput) LocalAddress() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.LocalAddress }).(pulumi.StringOutput)
}

// The maximum number of unique snapshots of a single artifact to store. Once the number of snapshots exceeds this setting, older versions are removed. A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
func (o RemoteGradleRepositoryOutput) MaxUniqueSnapshots() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.MaxUniqueSnapshots }).(pulumi.IntOutput)
}

// Metadata Retrieval Cache Timeout (Sec) in the UI.This value refers to the number of seconds to wait for retrieval from the remote before serving locally cached artifact or fail the request.
func (o RemoteGradleRepositoryOutput) MetadataRetrievalTimeoutSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.MetadataRetrievalTimeoutSecs }).(pulumi.IntOutput)
}

// The set of mime types that should override the blockMismatchingMimeTypes setting. Eg: 'application/json,application/xml'. Default value is empty.
func (o RemoteGradleRepositoryOutput) MismatchingMimeTypesOverrideList() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.MismatchingMimeTypesOverrideList }).(pulumi.StringOutput)
}

// Missed Retrieval Cache Period (Sec) in the UI. The number of seconds to cache artifact retrieval misses (artifact not found). A value of 0 indicates no caching.
func (o RemoteGradleRepositoryOutput) MissedCachePeriodSeconds() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.MissedCachePeriodSeconds }).(pulumi.IntOutput)
}

// Internal description.
func (o RemoteGradleRepositoryOutput) Notes() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.Notes }).(pulumi.StringOutput)
}

// If set, Artifactory does not try to fetch remote artifacts. Only locally-cached artifacts are retrieved.
func (o RemoteGradleRepositoryOutput) Offline() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.Offline }).(pulumi.BoolOutput)
}

// Enable Pass-through for Curation Audit. When enabled, allows artifacts to pass through the Curation audit process.
func (o RemoteGradleRepositoryOutput) PassThrough() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.PassThrough }).(pulumi.BoolOutput)
}
...
// Setting repositories with priority will cause metadata to be merged only from repositories set with this field
func (o RemoteGradleRepositoryOutput) PriorityResolution() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.PriorityResolution }).(pulumi.BoolOutput)
}
...
// Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
func (o RemoteGradleRepositoryOutput) ProjectKey() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.ProjectKey }).(pulumi.StringOutput)
}
...
// Proxy key from Artifactory Proxies settings. Can't be set if `disableProxy = true`.
func (o RemoteGradleRepositoryOutput) Proxy() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.Proxy }).(pulumi.StringOutput)
}

// Custom HTTP query parameters that will be automatically included in all remote resource requests. For example: `param1=val1&param2=val2&param3=val3`
func (o RemoteGradleRepositoryOutput) QueryParams() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.QueryParams }).(pulumi.StringOutput)
}

// Reject the caching of jar files that are found to be invalid. For example, pseudo jars retrieved behind a "captive portal".
func (o RemoteGradleRepositoryOutput) RejectInvalidJars() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.RejectInvalidJars }).(pulumi.BoolOutput)
}

// Checking the Checksum effectively verifies the integrity of a deployed resource. The Checksum Policy determines how the system behaves when a client checksum for a remote resource is missing or conflicts with the locally calculated checksum. Available policies are `generate-if-absent`, `fail`, `ignore-and-generate`, and `pass-thru`.
func (o RemoteGradleRepositoryOutput) RemoteRepoChecksumPolicyType() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.RemoteRepoChecksumPolicyType }).(pulumi.StringOutput)
}

// Repository layout key for the remote layout mapping. Repository can be created without this attribute (or set to an empty string). Once it's set, it can't be removed by passing an empty string or removing the attribute, that will be ignored by the Artifactory API. UI shows an error message, if the user tries to remove the value.
func (o RemoteGradleRepositoryOutput) RemoteRepoLayoutRef() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.RemoteRepoLayoutRef }).(pulumi.StringOutput)
}

// Sets the layout that the repository should use for storing and identifying modules. A recommended layout that corresponds to the package type defined is suggested, and index packages uploaded and calculate metadata accordingly.
func (o RemoteGradleRepositoryOutput) RepoLayoutRef() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.RepoLayoutRef }).(pulumi.StringOutput)
}

// Metadata Retrieval Cache Period (Sec) in the UI. This value refers to the number of seconds to cache metadata files before checking for newer versions on remote server. A value of 0 indicates no caching.
func (o RemoteGradleRepositoryOutput) RetrievalCachePeriodSeconds() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.RetrievalCachePeriodSeconds }).(pulumi.IntOutput)
}
...
// Network timeout (in ms) to use when establishing a connection and for unanswered requests. Timing out on a network operation is considered a retrieval failure.
func (o RemoteGradleRepositoryOutput) SocketTimeoutMillis() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.SocketTimeoutMillis }).(pulumi.IntOutput)
}

// When set, the repository should store cached artifacts locally. When not set, artifacts are not stored locally, and direct repository-to-client streaming is used. This can be useful for multi-server setups over a high-speed LAN, with one Artifactory caching certain data on central storage, and streaming it directly to satellite pass-though Artifactory servers.
func (o RemoteGradleRepositoryOutput) StoreArtifactsLocally() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.StoreArtifactsLocally }).(pulumi.BoolOutput)
}

// By default, the system keeps your repositories healthy by refusing POMs with incorrect coordinates (path). If the groupId:artifactId:version information inside the POM does not match the deployed path, Artifactory rejects the deployment with a "409 Conflict" error. You can disable this behavior by setting this attribute to `true`.
func (o RemoteGradleRepositoryOutput) SuppressPomConsistencyChecks() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.SuppressPomConsistencyChecks }).(pulumi.BoolOutput)
}

// When set, remote artifacts are fetched along with their properties.
func (o RemoteGradleRepositoryOutput) SynchronizeProperties() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.SynchronizeProperties }).(pulumi.BoolOutput)
}

// Unused Artifacts Cleanup Period (Hr) in the UI. The number of hours to wait before an artifact is deemed 'unused' and eligible for cleanup from the repository. A value of 0 means automatic cleanup of cached artifacts is disabled.
func (o RemoteGradleRepositoryOutput) UnusedArtifactsCleanupPeriodHours() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.IntOutput { return v.UnusedArtifactsCleanupPeriodHours }).(pulumi.IntOutput)
}
...
func (o RemoteGradleRepositoryOutput) Username() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.StringOutput { return v.Username }).(pulumi.StringOutput)
}

// Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
func (o RemoteGradleRepositoryOutput) XrayIndex() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteGradleRepository) pulumi.BoolOutput { return v.XrayIndex }).(pulumi.BoolOutput)
}
