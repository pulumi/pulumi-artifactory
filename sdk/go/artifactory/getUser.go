...
//			_, err := artifactory.GetUser(ctx, &artifactory.LookupUserArgs{
//				Name: "user1",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupUserOutput(ctx *pulumi.Context, args LookupUserOutputArgs, opts ...pulumi.InvokeOption) LookupUserResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUserResultOutput, error) {
			...
			return ctx.InvokeOutput("artifactory:index/getUser:getUser", args, LookupUserResultOutput{}, options).(LookupUserResultOutput), nil
