...
func (o GetVirtualGoRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetVirtualGoRepositoryResult] {
	return pulumix.Output[GetVirtualGoRepositoryResult]{
