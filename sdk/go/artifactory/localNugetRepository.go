...
// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
func (o LocalNugetRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolOutput)
}

// When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
func (o LocalNugetRepositoryOutput) BlackedOut() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.BlackedOut }).(pulumi.BoolOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
func (o LocalNugetRepositoryOutput) CdnRedirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.CdnRedirect }).(pulumi.BoolOutput)
}

// Public description.
func (o LocalNugetRepositoryOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only.
func (o LocalNugetRepositoryOutput) DownloadDirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.DownloadDirect }).(pulumi.BoolOutput)
}
...
// Force basic authentication credentials in order to use this repository.
// Default is `false`.
func (o LocalNugetRepositoryOutput) ForceNugetAuthentication() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.ForceNugetAuthentication }).(pulumi.BoolOutput)
}
...
// Once the number of snapshots exceeds this setting, older versions are removed
// A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
func (o LocalNugetRepositoryOutput) MaxUniqueSnapshots() pulumi.IntOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.IntOutput { return v.MaxUniqueSnapshots }).(pulumi.IntOutput)
}

// Internal description.
func (o LocalNugetRepositoryOutput) Notes() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.StringOutput { return v.Notes }).(pulumi.StringOutput)
}

// Setting repositories with priority will cause metadata to be merged only from repositories set with this field
func (o LocalNugetRepositoryOutput) PriorityResolution() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.PriorityResolution }).(pulumi.BoolOutput)
}
...
// Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
func (o LocalNugetRepositoryOutput) ProjectKey() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.StringOutput { return v.ProjectKey }).(pulumi.StringOutput)
}
...
// Sets the layout that the repository should use for storing and identifying modules. A recommended layout that corresponds to the package type defined is suggested, and index packages uploaded and calculate metadata accordingly.
func (o LocalNugetRepositoryOutput) RepoLayoutRef() pulumi.StringOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.StringOutput { return v.RepoLayoutRef }).(pulumi.StringOutput)
}

// Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
func (o LocalNugetRepositoryOutput) XrayIndex() pulumi.BoolOutput {
	return o.ApplyT(func(v *LocalNugetRepository) pulumi.BoolOutput { return v.XrayIndex }).(pulumi.BoolOutput)
}
