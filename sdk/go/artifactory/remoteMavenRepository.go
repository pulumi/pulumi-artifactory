...
// Deprecated: This field is not returned in a get payload but is offered on the UI. It's inserted here for inclusive and informational reasons. It does not function
func (o RemoteMavenRepositoryOutput) FailedRetrievalCachePeriodSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteMavenRepository) pulumi.IntOutput { return v.FailedRetrievalCachePeriodSecs }).(pulumi.IntOutput)
}
...
func (o RemoteMavenRepositoryOutput) UnusedArtifactsCleanupPeriodEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteMavenRepository) pulumi.BoolOutput { return v.UnusedArtifactsCleanupPeriodEnabled }).(pulumi.BoolOutput)
}
