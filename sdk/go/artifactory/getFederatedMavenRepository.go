...
//			_, err := artifactory.GetFederatedMavenRepository(ctx, &artifactory.LookupFederatedMavenRepositoryArgs{
...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too.
func (o LookupFederatedMavenRepositoryResultOutput) DisableProxy() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupFederatedMavenRepositoryResult) *bool { return v.DisableProxy }).(pulumi.BoolPtrOutput)
}
...
func (o LookupFederatedMavenRepositoryResultOutput) ExcludesPattern() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedMavenRepositoryResult) *string { return v.ExcludesPattern }).(pulumi.StringPtrOutput)
}
...
func (o LookupFederatedMavenRepositoryResultOutput) IncludesPattern() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedMavenRepositoryResult) *string { return v.IncludesPattern }).(pulumi.StringPtrOutput)
}
...
// Proxy key from Artifactory Proxies settings.
func (o LookupFederatedMavenRepositoryResultOutput) Proxy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedMavenRepositoryResult) *string { return v.Proxy }).(pulumi.StringPtrOutput)
}
