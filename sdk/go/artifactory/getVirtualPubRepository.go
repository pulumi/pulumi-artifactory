...
func (o LookupVirtualPubRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualPubRepositoryResult] {
	return pulumix.Output[LookupVirtualPubRepositoryResult]{
