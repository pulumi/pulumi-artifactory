...
//			_, err := artifactory.GetVirtualGitlfsRepository(ctx, &artifactory.LookupVirtualGitlfsRepositoryArgs{
//				Key: "virtual-gitlfs",
//			}, nil)
//			if err != nil {
//				return err
...
func (o LookupVirtualGitlfsRepositoryResultOutput) HideUnauthorizedResources() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVirtualGitlfsRepositoryResult) *bool { return v.HideUnauthorizedResources }).(pulumi.BoolPtrOutput)
}
