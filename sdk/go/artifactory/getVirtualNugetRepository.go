...
func (o LookupVirtualNugetRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualNugetRepositoryResult] {
	return pulumix.Output[LookupVirtualNugetRepositoryResult]{
