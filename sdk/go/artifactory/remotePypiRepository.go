...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemotePypiRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemotePypiRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// Enable repository to be protected by the Curation service.
func (o RemotePypiRepositoryOutput) Curated() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemotePypiRepository) pulumi.BoolPtrOutput { return v.Curated }).(pulumi.BoolPtrOutput)
}
...
// The remote repo URL.
func (o RemotePypiRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemotePypiRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
