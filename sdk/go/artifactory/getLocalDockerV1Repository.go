...
func (o GetLocalDockerV1RepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetLocalDockerV1RepositoryResult] {
	return pulumix.Output[GetLocalDockerV1RepositoryResult]{
...
func (o GetLocalDockerV1RepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v GetLocalDockerV1RepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o GetLocalDockerV1RepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v GetLocalDockerV1RepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
