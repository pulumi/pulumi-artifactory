...
// When set, if query params are included in the request to Artifactory, they will be passed on to the remote repository.
func (o RemotePuppetRepositoryOutput) PropagateQueryParams() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemotePuppetRepository) pulumi.BoolPtrOutput { return v.PropagateQueryParams }).(pulumi.BoolPtrOutput)
}
