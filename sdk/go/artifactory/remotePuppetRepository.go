...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemotePuppetRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemotePuppetRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// The remote repo URL.
func (o RemotePuppetRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemotePuppetRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
