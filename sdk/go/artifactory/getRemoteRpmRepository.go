...
//			_, err := artifactory.GetRemoteRpmRepository(ctx, &artifactory.LookupRemoteRpmRepositoryArgs{
//				Key: "remote-rpm",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupRemoteRpmRepositoryOutput(ctx *pulumi.Context, args LookupRemoteRpmRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRemoteRpmRepositoryResultOutput {
	...
	return ctx.InvokeOutput("artifactory:index/getRemoteRpmRepository:getRemoteRpmRepository", args, LookupRemoteRpmRepositoryResultOutput{}, options).(LookupRemoteRpmRepositoryResultOutput)
}
...
func (o LookupRemoteRpmRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteRpmRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteRpmRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteRpmRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
