...
//			_, err := artifactory.GetRemoteSbtRepository(ctx, &artifactory.LookupRemoteSbtRepositoryArgs{
//				Key: "remote-sbt",
//			}, nil)
//			if err != nil {
//				return err
...
func (o LookupRemoteSbtRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteSbtRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
