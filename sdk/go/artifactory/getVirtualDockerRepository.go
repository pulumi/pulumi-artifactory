...
func (o LookupVirtualDockerRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualDockerRepositoryResult] {
	return pulumix.Output[LookupVirtualDockerRepositoryResult]{
