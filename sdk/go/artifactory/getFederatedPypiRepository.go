...
//			_, err := artifactory.GetFederatedPypiRepository(ctx, &artifactory.LookupFederatedPypiRepositoryArgs{
...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too.
func (o LookupFederatedPypiRepositoryResultOutput) DisableProxy() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupFederatedPypiRepositoryResult) *bool { return v.DisableProxy }).(pulumi.BoolPtrOutput)
}
...
// Proxy key from Artifactory Proxies settings.
func (o LookupFederatedPypiRepositoryResultOutput) Proxy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedPypiRepositoryResult) *string { return v.Proxy }).(pulumi.StringPtrOutput)
}
