...
func (o LookupFederatedPypiRepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFederatedPypiRepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o LookupFederatedPypiRepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFederatedPypiRepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
