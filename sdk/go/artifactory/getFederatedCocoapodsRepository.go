...
func (o LookupFederatedCocoapodsRepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFederatedCocoapodsRepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o LookupFederatedCocoapodsRepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupFederatedCocoapodsRepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
