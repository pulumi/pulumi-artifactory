...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemoteChefRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteChefRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// Whether to disable URL normalization, default is `false`.
func (o RemoteChefRepositoryOutput) DisableUrlNormalization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteChefRepository) pulumi.BoolPtrOutput { return v.DisableUrlNormalization }).(pulumi.BoolPtrOutput)
}
...
// The remote repo URL.
func (o RemoteChefRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteChefRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
