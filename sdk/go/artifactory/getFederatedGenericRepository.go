...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too.
func (o LookupFederatedGenericRepositoryResultOutput) DisableProxy() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupFederatedGenericRepositoryResult) *bool { return v.DisableProxy }).(pulumi.BoolPtrOutput)
}
...
func (o LookupFederatedGenericRepositoryResultOutput) ExcludesPattern() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedGenericRepositoryResult) *string { return v.ExcludesPattern }).(pulumi.StringPtrOutput)
}
...
func (o LookupFederatedGenericRepositoryResultOutput) IncludesPattern() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedGenericRepositoryResult) *string { return v.IncludesPattern }).(pulumi.StringPtrOutput)
}
...
// Proxy key from Artifactory Proxies settings.
func (o LookupFederatedGenericRepositoryResultOutput) Proxy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupFederatedGenericRepositoryResult) *string { return v.Proxy }).(pulumi.StringPtrOutput)
}
