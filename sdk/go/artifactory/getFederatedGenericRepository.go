...
func (o LookupFederatedGenericRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFederatedGenericRepositoryResult] {
	return pulumix.Output[LookupFederatedGenericRepositoryResult]{
