...
func (o LookupLocalNugetRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalNugetRepositoryResult] {
	return pulumix.Output[LookupLocalNugetRepositoryResult]{
