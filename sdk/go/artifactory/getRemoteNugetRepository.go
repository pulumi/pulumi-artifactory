...
//			_, err := artifactory.GetRemoteNugetRepository(ctx, &artifactory.LookupRemoteNugetRepositoryArgs{
//				Key: "remote-nuget",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupRemoteNugetRepositoryOutput(ctx *pulumi.Context, args LookupRemoteNugetRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRemoteNugetRepositoryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRemoteNugetRepositoryResultOutput, error) {
			args := v.(LookupRemoteNugetRepositoryArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("artifactory:index/getRemoteNugetRepository:getRemoteNugetRepository", args, LookupRemoteNugetRepositoryResultOutput{}, options).(LookupRemoteNugetRepositoryResultOutput), nil
...
func (o LookupRemoteNugetRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNugetRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNugetRepositoryResultOutput) Curated() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNugetRepositoryResult) *bool { return v.Curated }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNugetRepositoryResultOutput) DisableUrlNormalization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNugetRepositoryResult) *bool { return v.DisableUrlNormalization }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNugetRepositoryResultOutput) PassThrough() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNugetRepositoryResult) *bool { return v.PassThrough }).(pulumi.BoolPtrOutput)
}
