...
func (o LookupRemotePypiRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRemotePypiRepositoryResult] {
	return pulumix.Output[LookupRemotePypiRepositoryResult]{
