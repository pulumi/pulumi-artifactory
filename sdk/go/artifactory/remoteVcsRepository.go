...
// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
func (o RemoteVcsRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolOutput)
}

// The number of seconds the repository stays in assumed offline state after a connection error. At the end of this time, an online check is attempted in order to reset the offline status. A value of 0 means the repository is never assumed offline.
func (o RemoteVcsRepositoryOutput) AssumedOfflinePeriodSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.IntOutput { return v.AssumedOfflinePeriodSecs }).(pulumi.IntOutput)
}
...
// When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
func (o RemoteVcsRepositoryOutput) CdnRedirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.CdnRedirect }).(pulumi.BoolOutput)
}
...
func (o RemoteVcsRepositoryOutput) ContentSynchronisation() RemoteVcsRepositoryContentSynchronisationPtrOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) RemoteVcsRepositoryContentSynchronisationPtrOutput {
...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too. Introduced since Artifactory 7.41.7.
func (o RemoteVcsRepositoryOutput) DisableProxy() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.DisableProxy }).(pulumi.BoolOutput)
}

// Whether to disable URL normalization. Default is `false`.
func (o RemoteVcsRepositoryOutput) DisableUrlNormalization() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.DisableUrlNormalization }).(pulumi.BoolOutput)
}

// When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only. Default value is 'false'.
func (o RemoteVcsRepositoryOutput) DownloadDirect() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.DownloadDirect }).(pulumi.BoolOutput)
}
...
// Enable token (Bearer) based authentication. When set, use an access token as `password` (username may be empty) so Artifactory authenticates to the remote with a Bearer token instead of Basic auth. Default is `false` for most package types; OCI, Helm OCI, and Hugging Face remotes default to `true`.
func (o RemoteVcsRepositoryOutput) EnableTokenAuthentication() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.EnableTokenAuthentication }).(pulumi.BoolOutput)
}
...
// Lists the items of remote folders in simple and list browsing. The remote content is cached according to the value of the 'Retrieval Cache Period'. Default value is 'false'. This field exists in the API but not in the UI.
func (o RemoteVcsRepositoryOutput) ListRemoteFolderItems() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.ListRemoteFolderItems }).(pulumi.BoolOutput)
}

// The local address to be used when creating connections. Useful for specifying the interface to use on systems with multiple network interfaces.
func (o RemoteVcsRepositoryOutput) LocalAddress() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.LocalAddress }).(pulumi.StringOutput)
}

// The maximum number of unique snapshots of a single artifact to store.
// Once the number of snapshots exceeds this setting, older versions are removed.
// A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
func (o RemoteVcsRepositoryOutput) MaxUniqueSnapshots() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.IntOutput { return v.MaxUniqueSnapshots }).(pulumi.IntOutput)
}

// Metadata Retrieval Cache Timeout (Sec) in the UI.This value refers to the number of seconds to wait for retrieval from the remote before serving locally cached artifact or fail the request.
func (o RemoteVcsRepositoryOutput) MetadataRetrievalTimeoutSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.IntOutput { return v.MetadataRetrievalTimeoutSecs }).(pulumi.IntOutput)
}

// The set of mime types that should override the blockMismatchingMimeTypes setting. Eg: 'application/json,application/xml'. Default value is empty.
func (o RemoteVcsRepositoryOutput) MismatchingMimeTypesOverrideList() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.MismatchingMimeTypesOverrideList }).(pulumi.StringOutput)
}
...
// Internal description.
func (o RemoteVcsRepositoryOutput) Notes() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.Notes }).(pulumi.StringOutput)
}
...
// **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
// Write-only equivalent of `password`. The value is used to authenticate against the remote registry but is **never stored in Terraform state or plan**. Requires Terraform 1.11 or later. Conflicts with `password`. Because write-only values are not tracked in state, use `passwordWoVersion` to signal when the secret has changed so it is re-sent to Artifactory.
func (o RemoteVcsRepositoryOutput) PasswordWo() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringPtrOutput { return v.PasswordWo }).(pulumi.StringPtrOutput)
}

// A version identifier for `passwordWo`. Change this value (for example, after rotating the secret) to trigger an update that re-sends the current `passwordWo` value to Artifactory. Only meaningful together with `passwordWo`.
func (o RemoteVcsRepositoryOutput) PasswordWoVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringPtrOutput { return v.PasswordWoVersion }).(pulumi.StringPtrOutput)
}
...
// Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
func (o RemoteVcsRepositoryOutput) ProjectKey() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.ProjectKey }).(pulumi.StringOutput)
}
...
// Proxy key from Artifactory Proxies settings. Can't be set if `disableProxy = true`.
func (o RemoteVcsRepositoryOutput) Proxy() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.Proxy }).(pulumi.StringOutput)
}

// Custom HTTP query parameters that will be automatically included in all remote resource requests. For example: `param1=val1&param2=val2&param3=val3`
func (o RemoteVcsRepositoryOutput) QueryParams() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.QueryParams }).(pulumi.StringOutput)
}
...
// Sets the layout that the repository should use for storing and identifying modules. A recommended layout that corresponds to the package type defined is suggested, and index packages uploaded and calculate metadata accordingly.
func (o RemoteVcsRepositoryOutput) RepoLayoutRef() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.RepoLayoutRef }).(pulumi.StringOutput)
}
...
func (o RemoteVcsRepositoryOutput) Username() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.Username }).(pulumi.StringOutput)
}
...
// Artifactory supports proxying the following Git providers out-of-the-box: GitHub (GITHUB), GitHub Enterprise (GITHUBENTERPRISE), BitBucket Cloud (BITBUCKET), BitBucket Server (STASH), GitLab (GITLAB), or a remote Artifactory instance. Use CUSTOM for a custom URL. Allowed values are: `GITHUB`, `GITHUBENTERPRISE`, `BITBUCKET`, `OLDSTASH`, `STASH`, `ARTIFACTORY`, `GITLAB`, `CUSTOM`. Default value is `GITHUB`.
func (o RemoteVcsRepositoryOutput) VcsGitProvider() pulumi.StringOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.StringOutput { return v.VcsGitProvider }).(pulumi.StringOutput)
}

// Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
func (o RemoteVcsRepositoryOutput) XrayIndex() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteVcsRepository) pulumi.BoolOutput { return v.XrayIndex }).(pulumi.BoolOutput)
}
