...
func (o LookupLocalRpmRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalRpmRepositoryResult] {
	return pulumix.Output[LookupLocalRpmRepositoryResult]{
