...
func (o GetLocalAlpineRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetLocalAlpineRepositoryResult] {
	return pulumix.Output[GetLocalAlpineRepositoryResult]{
