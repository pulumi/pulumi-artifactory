...
func (o LookupLocalHelmRepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalHelmRepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o LookupLocalHelmRepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalHelmRepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
