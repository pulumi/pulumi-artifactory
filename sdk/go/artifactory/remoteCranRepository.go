...
// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
// security (e.g., cross-site scripting attacks).
func (o RemoteCranRepositoryOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteCranRepository) pulumi.BoolPtrOutput { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
// When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set
// for the Artifactory instance, it will be ignored, too. Introduced since Artifactory 7.41.7.
func (o RemoteCranRepositoryOutput) DisableProxy() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteCranRepository) pulumi.BoolPtrOutput { return v.DisableProxy }).(pulumi.BoolPtrOutput)
}

// Whether to disable URL normalization, default is `false`.
func (o RemoteCranRepositoryOutput) DisableUrlNormalization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteCranRepository) pulumi.BoolPtrOutput { return v.DisableUrlNormalization }).(pulumi.BoolPtrOutput)
}
...
// The remote repo URL.
func (o RemoteCranRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteCranRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
