...
func (o LookupLocalCocoapodsRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalCocoapodsRepositoryResult] {
	return pulumix.Output[LookupLocalCocoapodsRepositoryResult]{
