...
// The remote repo URL.
func (o RemoteNpmRepositoryOutput) Url() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteNpmRepository) pulumi.StringPtrOutput { return v.Url }).(pulumi.StringPtrOutput)
}
