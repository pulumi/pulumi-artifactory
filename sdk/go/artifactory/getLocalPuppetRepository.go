...
func (o LookupLocalPuppetRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalPuppetRepositoryResult] {
	return pulumix.Output[LookupLocalPuppetRepositoryResult]{
...
func (o LookupLocalPuppetRepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalPuppetRepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o LookupLocalPuppetRepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalPuppetRepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
