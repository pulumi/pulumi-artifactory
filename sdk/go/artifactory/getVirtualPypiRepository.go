...
func (o LookupVirtualPypiRepositoryResultOutput) HideUnauthorizedResources() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupVirtualPypiRepositoryResult) *bool { return v.HideUnauthorizedResources }).(pulumi.BoolPtrOutput)
}
