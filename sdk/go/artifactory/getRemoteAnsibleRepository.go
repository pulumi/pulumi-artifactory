...
//			_, err := artifactory.GetRemoteAnsibleRepository(ctx, &artifactory.LookupRemoteAnsibleRepositoryArgs{
//				Key: "remote-ansible",
//			}, nil)
//			if err != nil {
//				return err
...
func (o LookupRemoteAnsibleRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteAnsibleRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
