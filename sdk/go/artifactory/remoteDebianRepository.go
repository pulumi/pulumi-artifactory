...
// Client TLS certificate name.
func (o RemoteDebianRepositoryOutput) ClientTlsCertificate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteDebianRepository) pulumi.StringPtrOutput { return v.ClientTlsCertificate }).(pulumi.StringPtrOutput)
}
