...
func (o LookupRemoteNpmRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRemoteNpmRepositoryResult] {
	return pulumix.Output[LookupRemoteNpmRepositoryResult]{
