...
//			_, err := artifactory.GetRemoteNpmRepository(ctx, &artifactory.LookupRemoteNpmRepositoryArgs{
//				Key: "remote-npm",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupRemoteNpmRepositoryOutput(ctx *pulumi.Context, args LookupRemoteNpmRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRemoteNpmRepositoryResultOutput {
	...
	return ctx.InvokeOutput("artifactory:index/getRemoteNpmRepository:getRemoteNpmRepository", args, LookupRemoteNpmRepositoryResultOutput{}, options).(LookupRemoteNpmRepositoryResultOutput)
}
...
func (o LookupRemoteNpmRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNpmRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNpmRepositoryResultOutput) Curated() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNpmRepositoryResult) *bool { return v.Curated }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNpmRepositoryResultOutput) DisableUrlNormalization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNpmRepositoryResult) *bool { return v.DisableUrlNormalization }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNpmRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNpmRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteNpmRepositoryResultOutput) PassThrough() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteNpmRepositoryResult) *bool { return v.PassThrough }).(pulumi.BoolPtrOutput)
}
