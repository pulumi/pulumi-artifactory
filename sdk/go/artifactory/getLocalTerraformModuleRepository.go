...
func (o LookupLocalTerraformModuleRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalTerraformModuleRepositoryResult] {
	return pulumix.Output[LookupLocalTerraformModuleRepositoryResult]{
...
func (o LookupLocalTerraformModuleRepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalTerraformModuleRepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o LookupLocalTerraformModuleRepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalTerraformModuleRepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
