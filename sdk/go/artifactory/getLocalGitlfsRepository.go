...
func (o GetLocalGitlfsRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetLocalGitlfsRepositoryResult] {
	return pulumix.Output[GetLocalGitlfsRepositoryResult]{
