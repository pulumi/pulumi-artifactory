...
func (o LookupLocalGenericRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupLocalGenericRepositoryResult] {
	return pulumix.Output[LookupLocalGenericRepositoryResult]{
...
func (o LookupLocalGenericRepositoryResultOutput) ExcludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalGenericRepositoryResult) string { return v.ExcludesPattern }).(pulumi.StringOutput)
}
...
func (o LookupLocalGenericRepositoryResultOutput) IncludesPattern() pulumi.StringOutput {
	return o.ApplyT(func(v LookupLocalGenericRepositoryResult) string { return v.IncludesPattern }).(pulumi.StringOutput)
}
