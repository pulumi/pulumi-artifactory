...
// Client TLS certificate name.
func (o RemoteOpkgRepositoryOutput) ClientTlsCertificate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *RemoteOpkgRepository) pulumi.StringPtrOutput { return v.ClientTlsCertificate }).(pulumi.StringPtrOutput)
}
