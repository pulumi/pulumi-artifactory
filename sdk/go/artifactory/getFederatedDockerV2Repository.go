...
func (o LookupFederatedDockerV2RepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFederatedDockerV2RepositoryResult] {
	return pulumix.Output[LookupFederatedDockerV2RepositoryResult]{
