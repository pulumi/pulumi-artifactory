...
func LookupRemoteCocoapodsRepositoryOutput(ctx *pulumi.Context, args LookupRemoteCocoapodsRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRemoteCocoapodsRepositoryResultOutput {
	...
	return ctx.InvokeOutput("artifactory:index/getRemoteCocoapodsRepository:getRemoteCocoapodsRepository", args, LookupRemoteCocoapodsRepositoryResultOutput{}, options).(LookupRemoteCocoapodsRepositoryResultOutput)
}
...
func (o LookupRemoteCocoapodsRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCocoapodsRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteCocoapodsRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteCocoapodsRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
