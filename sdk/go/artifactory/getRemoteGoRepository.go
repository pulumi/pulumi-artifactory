...
func LookupRemoteGoRepositoryOutput(ctx *pulumi.Context, args LookupRemoteGoRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRemoteGoRepositoryResultOutput {
	...
	return ctx.InvokeOutput("artifactory:index/getRemoteGoRepository:getRemoteGoRepository", args, LookupRemoteGoRepositoryResultOutput{}, options).(LookupRemoteGoRepositoryResultOutput)
}
...
func (o LookupRemoteGoRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteGoRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteGoRepositoryResultOutput) DisableUrlNormalization() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteGoRepositoryResult) *bool { return v.DisableUrlNormalization }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemoteGoRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemoteGoRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
