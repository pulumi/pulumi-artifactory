...
func (o LookupRemoteGoRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupRemoteGoRepositoryResult] {
	return pulumix.Output[LookupRemoteGoRepositoryResult]{
