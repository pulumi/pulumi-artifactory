...
func (o LookupFederatedPuppetRepositoryResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupFederatedPuppetRepositoryResult] {
	return pulumix.Output[LookupFederatedPuppetRepositoryResult]{
