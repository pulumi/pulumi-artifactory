...
// Deprecated: This field is not returned in a get payload but is offered on the UI. It's inserted here for inclusive and informational reasons. It does not function
func (o RemoteConanRepositoryOutput) FailedRetrievalCachePeriodSecs() pulumi.IntOutput {
	return o.ApplyT(func(v *RemoteConanRepository) pulumi.IntOutput { return v.FailedRetrievalCachePeriodSecs }).(pulumi.IntOutput)
}
...
// When set, if query params are included in the request to Artifactory, they will be passed on to the remote repository.
func (o RemoteConanRepositoryOutput) PropagateQueryParams() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *RemoteConanRepository) pulumi.BoolPtrOutput { return v.PropagateQueryParams }).(pulumi.BoolPtrOutput)
}
...
func (o RemoteConanRepositoryOutput) UnusedArtifactsCleanupPeriodEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *RemoteConanRepository) pulumi.BoolOutput { return v.UnusedArtifactsCleanupPeriodEnabled }).(pulumi.BoolOutput)
}
