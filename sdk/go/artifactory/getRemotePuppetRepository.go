...
func LookupRemotePuppetRepositoryOutput(ctx *pulumi.Context, args LookupRemotePuppetRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRemotePuppetRepositoryResultOutput {
	...
	return ctx.InvokeOutput("artifactory:index/getRemotePuppetRepository:getRemotePuppetRepository", args, LookupRemotePuppetRepositoryResultOutput{}, options).(LookupRemotePuppetRepositoryResultOutput)
}
...
func (o LookupRemotePuppetRepositoryResultOutput) ArchiveBrowsingEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemotePuppetRepositoryResult) *bool { return v.ArchiveBrowsingEnabled }).(pulumi.BoolPtrOutput)
}
...
func (o LookupRemotePuppetRepositoryResultOutput) EnableTokenAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRemotePuppetRepositoryResult) *bool { return v.EnableTokenAuthentication }).(pulumi.BoolPtrOutput)
}
