...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_gems_repo = new Artifactory.Index.FederatedGemsRepository("terraform-federated-test-gems-repo", new()
    ///     {
    ...
    public partial class FederatedGemsRepository : global::Pulumi.CustomResource
    {
        ...
        public FederatedGemsRepository(string name, FederatedGemsRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedGemsRepository:FederatedGemsRepository", name, args ?? new FederatedGemsRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedGemsRepository(string name, Input<string> id, FederatedGemsRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedGemsRepository:FederatedGemsRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FederatedGemsRepository Get(string name, Input<string> id, FederatedGemsRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class FederatedGemsRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedGemsRepositoryMemberArgs>());
            set => _members = value;
        }
    ...
    public sealed class FederatedGemsRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedGemsRepositoryMemberGetArgs>());
            set => _members = value;
        }
