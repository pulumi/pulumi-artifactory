...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualCranRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualCranRepository(string name, VirtualCranRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualCranRepository:VirtualCranRepository", name, args ?? new VirtualCranRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualCranRepository(string name, Input<string> id, VirtualCranRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualCranRepository:VirtualCranRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualCranRepository Get(string name, Input<string> id, VirtualCranRepositoryState? state = null, CustomResourceOptions? options = null)
        {
