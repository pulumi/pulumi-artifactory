...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_local_test_terraform_provider_repo = new Artifactory.Index.LocalTerraformProviderRepository("terraform-local-test-terraform-provider-repo", new()
    ///     {
