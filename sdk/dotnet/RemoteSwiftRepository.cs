...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_swift = new Artifactory.Index.RemoteSwiftRepository("my-remote-swift", new()
    ///     {
    ///         Key = "my-remote-swift",
    ///         Url = "https://swift.org/",
    ///     });
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/remoteSwiftRepository:RemoteSwiftRepository")]
    public partial class RemoteSwiftRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.RemoteSwiftRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteSwiftRepository(string name, RemoteSwiftRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteSwiftRepository:RemoteSwiftRepository", name, args ?? new RemoteSwiftRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteSwiftRepository(string name, Input<string> id, RemoteSwiftRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteSwiftRepository:RemoteSwiftRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteSwiftRepository Get(string name, Input<string> id, RemoteSwiftRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new RemoteSwiftRepository(name, id, state, options);
        }
    }

    public sealed class RemoteSwiftRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        public Input<Inputs.RemoteSwiftRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteSwiftRepositoryArgs()
        {
        }
        public static new RemoteSwiftRepositoryArgs Empty => new RemoteSwiftRepositoryArgs();
    }

    public sealed class RemoteSwiftRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteSwiftRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteSwiftRepositoryState()
        {
        }
        public static new RemoteSwiftRepositoryState Empty => new RemoteSwiftRepositoryState();
    }
}
