...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_local_test_bower_repo = new Artifactory.Index.LocalBowerRepository("terraform-local-test-bower-repo", new()
    ///     {
    ...
    public partial class LocalBowerRepository : global::Pulumi.CustomResource
    {
        ...
        public LocalBowerRepository(string name, LocalBowerRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/localBowerRepository:LocalBowerRepository", name, args ?? new LocalBowerRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalBowerRepository(string name, Input<string> id, LocalBowerRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/localBowerRepository:LocalBowerRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocalBowerRepository Get(string name, Input<string> id, LocalBowerRepositoryState? state = null, CustomResourceOptions? options = null)
        {
