...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_bower = new Artifactory.Index.RemoteBowerRepository("my-remote-bower", new()
    ///     {
    ///         Key = "my-remote-bower",
    ...
    public partial class RemoteBowerRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemoteBowerRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteBowerRepository(string name, RemoteBowerRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteBowerRepository:RemoteBowerRepository", name, args ?? new RemoteBowerRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteBowerRepository(string name, Input<string> id, RemoteBowerRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteBowerRepository:RemoteBowerRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteBowerRepository Get(string name, Input<string> id, RemoteBowerRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new RemoteBowerRepository(name, id, state, options);
        }
    }

    public sealed class RemoteBowerRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        public Input<Inputs.RemoteBowerRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteBowerRepositoryArgs()
        {
        }
        public static new RemoteBowerRepositoryArgs Empty => new RemoteBowerRepositoryArgs();
    }

    public sealed class RemoteBowerRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteBowerRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteBowerRepositoryState()
        {
        }
        public static new RemoteBowerRepositoryState Empty => new RemoteBowerRepositoryState();
    }
}
