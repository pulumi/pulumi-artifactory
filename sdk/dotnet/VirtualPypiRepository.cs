...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualPypiRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualPypiRepository(string name, VirtualPypiRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualPypiRepository:VirtualPypiRepository", name, args ?? new VirtualPypiRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualPypiRepository(string name, Input<string> id, VirtualPypiRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualPypiRepository:VirtualPypiRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualPypiRepository Get(string name, Input<string> id, VirtualPypiRepositoryState? state = null, CustomResourceOptions? options = null)
        {
