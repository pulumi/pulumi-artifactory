...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualDebianRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualDebianRepository(string name, VirtualDebianRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualDebianRepository:VirtualDebianRepository", name, args ?? new VirtualDebianRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualDebianRepository(string name, Input<string> id, VirtualDebianRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualDebianRepository:VirtualDebianRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualDebianRepository Get(string name, Input<string> id, VirtualDebianRepositoryState? state = null, CustomResourceOptions? options = null)
        {
