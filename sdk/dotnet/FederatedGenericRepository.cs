...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_generic_repo = new Artifactory.Index.FederatedGenericRepository.FederatedGenericRepository("terraform-federated-test-generic-repo", new()
    ///     {
    ...
    public partial class FederatedGenericRepository : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("members")]
        public Output<ImmutableArray<Outputs.FederatedGenericRepositoryMember>> Members { get; private set; } = null!;
        ...
        public FederatedGenericRepository(string name, FederatedGenericRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedGenericRepository:FederatedGenericRepository", name, args ?? new FederatedGenericRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedGenericRepository(string name, Input<string> id, FederatedGenericRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedGenericRepository:FederatedGenericRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FederatedGenericRepository Get(string name, Input<string> id, FederatedGenericRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class FederatedGenericRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.FederatedGenericRepositoryMemberArgs>? _members;
        ...
        /// to set up Federated repositories correctly.
        /// </summary>
        public InputList<Inputs.FederatedGenericRepositoryMemberArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedGenericRepositoryMemberArgs>());
            set => _members = value;
        }
    ...
    public sealed class FederatedGenericRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("members")]
        private InputList<Inputs.FederatedGenericRepositoryMemberGetArgs>? _members;
        ...
        /// to set up Federated repositories correctly.
        /// </summary>
        public InputList<Inputs.FederatedGenericRepositoryMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedGenericRepositoryMemberGetArgs>());
            set => _members = value;
        }
