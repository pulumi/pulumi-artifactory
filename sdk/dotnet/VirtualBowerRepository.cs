...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualBowerRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualBowerRepository(string name, VirtualBowerRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualBowerRepository:VirtualBowerRepository", name, args ?? new VirtualBowerRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualBowerRepository(string name, Input<string> id, VirtualBowerRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualBowerRepository:VirtualBowerRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualBowerRepository Get(string name, Input<string> id, VirtualBowerRepositoryState? state = null, CustomResourceOptions? options = null)
        {
