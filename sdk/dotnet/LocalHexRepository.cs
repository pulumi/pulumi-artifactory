...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/localHexRepository:LocalHexRepository")]
    public partial class LocalHexRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LocalHexRepository(string name, LocalHexRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/localHexRepository:LocalHexRepository", name, args ?? new LocalHexRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalHexRepository(string name, Input<string> id, LocalHexRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/localHexRepository:LocalHexRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocalHexRepository Get(string name, Input<string> id, LocalHexRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new LocalHexRepository(name, id, state, options);
        }
    }

    public sealed class LocalHexRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
        /// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
        ...
        public LocalHexRepositoryArgs()
        {
        }
        public static new LocalHexRepositoryArgs Empty => new LocalHexRepositoryArgs();
    }

    public sealed class LocalHexRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
        /// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
        ...
        public LocalHexRepositoryState()
        {
        }
        public static new LocalHexRepositoryState Empty => new LocalHexRepositoryState();
    }
}
