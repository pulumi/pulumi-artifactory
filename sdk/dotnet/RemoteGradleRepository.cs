...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var gradle_remote = new Artifactory.Index.RemoteGradleRepository.RemoteGradleRepository("gradle-remote", new()
    ///     {
    ...
    public partial class RemoteGradleRepository : global::Pulumi.CustomResource
    {
        ...
        public RemoteGradleRepository(string name, RemoteGradleRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteGradleRepository:RemoteGradleRepository", name, args ?? new RemoteGradleRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteGradleRepository(string name, Input<string> id, RemoteGradleRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteGradleRepository:RemoteGradleRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteGradleRepository Get(string name, Input<string> id, RemoteGradleRepositoryState? state = null, CustomResourceOptions? options = null)
        {
