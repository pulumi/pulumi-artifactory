...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_conan_repo = new Artifactory.Index.FederatedConanRepository.FederatedConanRepository("terraform-federated-test-conan-repo", new()
    ///     {
    ...
    public partial class FederatedConanRepository : global::Pulumi.CustomResource
    {
        ...
        public FederatedConanRepository(string name, FederatedConanRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedConanRepository:FederatedConanRepository", name, args ?? new FederatedConanRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedConanRepository(string name, Input<string> id, FederatedConanRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedConanRepository:FederatedConanRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FederatedConanRepository Get(string name, Input<string> id, FederatedConanRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class FederatedConanRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedConanRepositoryMemberArgs>());
            set => _members = value;
        }
    ...
    public sealed class FederatedConanRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedConanRepositoryMemberGetArgs>());
            set => _members = value;
        }
