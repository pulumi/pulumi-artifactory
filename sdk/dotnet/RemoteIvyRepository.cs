...
namespace Pulumi.Artifactory
{
    ...
    public partial class RemoteIvyRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemoteIvyRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteIvyRepository(string name, RemoteIvyRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteIvyRepository:RemoteIvyRepository", name, args ?? new RemoteIvyRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteIvyRepository(string name, Input<string> id, RemoteIvyRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteIvyRepository:RemoteIvyRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteIvyRepository Get(string name, Input<string> id, RemoteIvyRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RemoteIvyRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RemoteIvyRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
    ...
    public sealed class RemoteIvyRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteIvyRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
