...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_cargo_repo = new Artifactory.Index.FederatedCargoRepository.FederatedCargoRepository("terraform-federated-test-cargo-repo", new()
    ///     {
    ...
    public partial class FederatedCargoRepository : global::Pulumi.CustomResource
    {
        ...
        public FederatedCargoRepository(string name, FederatedCargoRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedCargoRepository:FederatedCargoRepository", name, args ?? new FederatedCargoRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedCargoRepository(string name, Input<string> id, FederatedCargoRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedCargoRepository:FederatedCargoRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FederatedCargoRepository Get(string name, Input<string> id, FederatedCargoRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class FederatedCargoRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.FederatedCargoRepositoryMemberArgs>? _members;
        ...
        /// to set up Federated repositories correctly.
        /// </summary>
        public InputList<Inputs.FederatedCargoRepositoryMemberArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedCargoRepositoryMemberArgs>());
            set => _members = value;
        }
    ...
    public sealed class FederatedCargoRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("members")]
        private InputList<Inputs.FederatedCargoRepositoryMemberGetArgs>? _members;
        ...
        /// to set up Federated repositories correctly.
        /// </summary>
        public InputList<Inputs.FederatedCargoRepositoryMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedCargoRepositoryMemberGetArgs>());
            set => _members = value;
        }
