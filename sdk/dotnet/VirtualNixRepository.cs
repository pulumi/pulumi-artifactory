...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/virtualNixRepository:VirtualNixRepository")]
    public partial class VirtualNixRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VirtualNixRepository(string name, VirtualNixRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualNixRepository:VirtualNixRepository", name, args ?? new VirtualNixRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualNixRepository(string name, Input<string> id, VirtualNixRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualNixRepository:VirtualNixRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualNixRepository Get(string name, Input<string> id, VirtualNixRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualNixRepository(name, id, state, options);
        }
    }

    public sealed class VirtualNixRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
        /// </summary>
        ...
        public VirtualNixRepositoryArgs()
        {
        }
        public static new VirtualNixRepositoryArgs Empty => new VirtualNixRepositoryArgs();
    }

    public sealed class VirtualNixRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
        /// </summary>
        ...
        public VirtualNixRepositoryState()
        {
        }
        public static new VirtualNixRepositoryState Empty => new VirtualNixRepositoryState();
    }
}
