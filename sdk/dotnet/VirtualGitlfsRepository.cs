...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var foo_gitlfs = new Artifactory.Index.VirtualGitlfsRepository.VirtualGitlfsRepository("foo-gitlfs", new()
    ///     {
    ...
    public partial class VirtualGitlfsRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualGitlfsRepository(string name, VirtualGitlfsRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualGitlfsRepository:VirtualGitlfsRepository", name, args ?? new VirtualGitlfsRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualGitlfsRepository(string name, Input<string> id, VirtualGitlfsRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualGitlfsRepository:VirtualGitlfsRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualGitlfsRepository Get(string name, Input<string> id, VirtualGitlfsRepositoryState? state = null, CustomResourceOptions? options = null)
        {
