...
namespace Pulumi.Artifactory
{
    ...
    public partial class RemoteSbtRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.RemoteSbtRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteSbtRepository(string name, RemoteSbtRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteSbtRepository:RemoteSbtRepository", name, args ?? new RemoteSbtRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteSbtRepository(string name, Input<string> id, RemoteSbtRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteSbtRepository:RemoteSbtRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteSbtRepository Get(string name, Input<string> id, RemoteSbtRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new RemoteSbtRepository(name, id, state, options);
        }
    }

    public sealed class RemoteSbtRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        public Input<Inputs.RemoteSbtRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteSbtRepositoryArgs()
        {
        }
        public static new RemoteSbtRepositoryArgs Empty => new RemoteSbtRepositoryArgs();
    }

    public sealed class RemoteSbtRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteSbtRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteSbtRepositoryState()
        {
        }
        public static new RemoteSbtRepositoryState Empty => new RemoteSbtRepositoryState();
    }
}
