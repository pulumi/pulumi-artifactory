...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_maven_repo = new Artifactory.Index.FederatedMavenRepository.FederatedMavenRepository("terraform-federated-test-maven-repo", new()
    ///     {
    ...
    public partial class FederatedMavenRepository : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("members")]
        public Output<ImmutableArray<Outputs.FederatedMavenRepositoryMember>> Members { get; private set; } = null!;
        ...
        public FederatedMavenRepository(string name, FederatedMavenRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedMavenRepository:FederatedMavenRepository", name, args ?? new FederatedMavenRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private FederatedMavenRepository(string name, Input<string> id, FederatedMavenRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/federatedMavenRepository:FederatedMavenRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static FederatedMavenRepository Get(string name, Input<string> id, FederatedMavenRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new FederatedMavenRepository(name, id, state, options);
        }
    }
    ...
    public sealed class FederatedMavenRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.FederatedMavenRepositoryMemberArgs>? _members;
        ...
        /// to set up Federated repositories correctly.
        /// </summary>
        public InputList<Inputs.FederatedMavenRepositoryMemberArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedMavenRepositoryMemberArgs>());
            set => _members = value;
        }
    ...
    public sealed class FederatedMavenRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("members")]
        private InputList<Inputs.FederatedMavenRepositoryMemberGetArgs>? _members;
        ...
        /// to set up Federated repositories correctly.
        /// </summary>
        public InputList<Inputs.FederatedMavenRepositoryMemberGetArgs> Members
        {
            get => _members ?? (_members = new InputList<Inputs.FederatedMavenRepositoryMemberGetArgs>());
            set => _members = value;
        }
