...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/virtualP2Repository:VirtualP2Repository")]
    public partial class VirtualP2Repository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public VirtualP2Repository(string name, VirtualP2RepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualP2Repository:VirtualP2Repository", name, args ?? new VirtualP2RepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualP2Repository(string name, Input<string> id, VirtualP2RepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualP2Repository:VirtualP2Repository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualP2Repository Get(string name, Input<string> id, VirtualP2RepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualP2Repository(name, id, state, options);
        }
    }

    public sealed class VirtualP2RepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
        /// </summary>
        ...
        public VirtualP2RepositoryArgs()
        {
        }
        public static new VirtualP2RepositoryArgs Empty => new VirtualP2RepositoryArgs();
    }

    public sealed class VirtualP2RepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
        /// </summary>
        ...
        public VirtualP2RepositoryState()
        {
        }
        public static new VirtualP2RepositoryState Empty => new VirtualP2RepositoryState();
    }
}
