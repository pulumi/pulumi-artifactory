...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_local_test_cocoapods_repo = new Artifactory.Index.LocalCocoapodsRepository("terraform-local-test-cocoapods-repo", new()
    ///     {
    ...
    public partial class LocalCocoapodsRepository : global::Pulumi.CustomResource
    {
        ...
        public LocalCocoapodsRepository(string name, LocalCocoapodsRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/localCocoapodsRepository:LocalCocoapodsRepository", name, args ?? new LocalCocoapodsRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalCocoapodsRepository(string name, Input<string> id, LocalCocoapodsRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/localCocoapodsRepository:LocalCocoapodsRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocalCocoapodsRepository Get(string name, Input<string> id, LocalCocoapodsRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new LocalCocoapodsRepository(name, id, state, options);
        }
    }

    public sealed class LocalCocoapodsRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
        /// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
        ...
        public LocalCocoapodsRepositoryArgs()
        {
        }
        public static new LocalCocoapodsRepositoryArgs Empty => new LocalCocoapodsRepositoryArgs();
    }

    public sealed class LocalCocoapodsRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory.
        /// This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
        ...
        public LocalCocoapodsRepositoryState()
        {
        }
        public static new LocalCocoapodsRepositoryState Empty => new LocalCocoapodsRepositoryState();
    }
}
