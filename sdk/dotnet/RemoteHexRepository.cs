...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/remoteHexRepository:RemoteHexRepository")]
    public partial class RemoteHexRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.RemoteHexRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteHexRepository(string name, RemoteHexRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteHexRepository:RemoteHexRepository", name, args ?? new RemoteHexRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteHexRepository(string name, Input<string> id, RemoteHexRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteHexRepository:RemoteHexRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteHexRepository Get(string name, Input<string> id, RemoteHexRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new RemoteHexRepository(name, id, state, options);
        }
    }

    public sealed class RemoteHexRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        public Input<Inputs.RemoteHexRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteHexRepositoryArgs()
        {
        }
        public static new RemoteHexRepositoryArgs Empty => new RemoteHexRepositoryArgs();
    }

    public sealed class RemoteHexRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
        /// </summary>
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteHexRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
        ...
        public RemoteHexRepositoryState()
        {
        }
        public static new RemoteHexRepositoryState Empty => new RemoteHexRepositoryState();
    }
}
