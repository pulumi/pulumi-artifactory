...
namespace Pulumi.Artifactory.Inputs
{
    ...
    public sealed class XrayPolicyRuleGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Required) Nested block describing the actions to be applied by the policy. Described below.
        /// </summary>
        [Input("actions")]
        public Input<Inputs.XrayPolicyRuleActionsGetArgs>? Actions { get; set; }

        /// <summary>
        /// (Required) Nested block describing the criteria for the policy. Described below.
        /// </summary>
        [Input("criteria", required: true)]
        public Input<Inputs.XrayPolicyRuleCriteriaGetArgs> Criteria { get; set; } = null!;
