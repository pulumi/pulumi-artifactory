...
namespace Pulumi.Artifactory
{
    ...
    public partial class RemoteMavenRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemoteMavenRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteMavenRepository(string name, RemoteMavenRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteMavenRepository:RemoteMavenRepository", name, args ?? new RemoteMavenRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteMavenRepository(string name, Input<string> id, RemoteMavenRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteMavenRepository:RemoteMavenRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteMavenRepository Get(string name, Input<string> id, RemoteMavenRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RemoteMavenRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RemoteMavenRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
    ...
    public sealed class RemoteMavenRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteMavenRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
