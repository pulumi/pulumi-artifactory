...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_local_test_puppet_repo = new Artifactory.Index.LocalPuppetRepository.LocalPuppetRepository("terraform-local-test-puppet-repo", new()
    ///     {
    ...
    public partial class LocalPuppetRepository : global::Pulumi.CustomResource
    {
        ...
        public LocalPuppetRepository(string name, LocalPuppetRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/localPuppetRepository:LocalPuppetRepository", name, args ?? new LocalPuppetRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalPuppetRepository(string name, Input<string> id, LocalPuppetRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/localPuppetRepository:LocalPuppetRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocalPuppetRepository Get(string name, Input<string> id, LocalPuppetRepositoryState? state = null, CustomResourceOptions? options = null)
        {
