...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_docker = new Artifactory.Index.RemoteDockerRepository.RemoteDockerRepository("my-remote-docker", new()
    ///     {
    ...
    public partial class RemoteDockerRepository : global::Pulumi.CustomResource
    {
        ...
        public RemoteDockerRepository(string name, RemoteDockerRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteDockerRepository:RemoteDockerRepository", name, args ?? new RemoteDockerRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteDockerRepository(string name, Input<string> id, RemoteDockerRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteDockerRepository:RemoteDockerRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteDockerRepository Get(string name, Input<string> id, RemoteDockerRepositoryState? state = null, CustomResourceOptions? options = null)
        {
