...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_alpine = new Artifactory.Index.RemoteAlpineRepository("my-remote-alpine", new()
    ///     {
    ...
    public partial class RemoteAlpineRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemoteAlpineRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteAlpineRepository(string name, RemoteAlpineRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, args ?? new RemoteAlpineRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteAlpineRepository(string name, Input<string> id, RemoteAlpineRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteAlpineRepository Get(string name, Input<string> id, RemoteAlpineRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RemoteAlpineRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RemoteAlpineRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
    ...
    public sealed class RemoteAlpineRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteAlpineRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
