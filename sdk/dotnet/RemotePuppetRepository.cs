...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_puppet = new Artifactory.Index.RemotePuppetRepository("my-remote-puppet", new()
    ///     {
    ...
    public partial class RemotePuppetRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemotePuppetRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemotePuppetRepository(string name, RemotePuppetRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remotePuppetRepository:RemotePuppetRepository", name, args ?? new RemotePuppetRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemotePuppetRepository(string name, Input<string> id, RemotePuppetRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remotePuppetRepository:RemotePuppetRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemotePuppetRepository Get(string name, Input<string> id, RemotePuppetRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RemotePuppetRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RemotePuppetRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
    ...
    public sealed class RemotePuppetRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemotePuppetRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
