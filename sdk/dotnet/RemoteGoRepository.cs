...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_go = new Artifactory.Index.RemoteGoRepository.RemoteGoRepository("my-remote-go", new()
    ///     {
    ///         Key = "my-remote-go",
    ...
    public partial class RemoteGoRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemoteGoRepositoryContentSynchronisation> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteGoRepository(string name, RemoteGoRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteGoRepository:RemoteGoRepository", name, args ?? new RemoteGoRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteGoRepository(string name, Input<string> id, RemoteGoRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteGoRepository:RemoteGoRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteGoRepository Get(string name, Input<string> id, RemoteGoRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RemoteGoRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RemoteGoRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
    ...
    public sealed class RemoteGoRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteGoRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
