...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_terraformProvider_repo = new Artifactory.Index.FederatedTerraformProviderRepository("terraform-federated-test-terraform_provider-repo", new()
    ///     {
