...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/localAnsibleRepository:LocalAnsibleRepository")]
    public partial class LocalAnsibleRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LocalAnsibleRepository(string name, LocalAnsibleRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/localAnsibleRepository:LocalAnsibleRepository", name, args ?? new LocalAnsibleRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalAnsibleRepository(string name, Input<string> id, LocalAnsibleRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/localAnsibleRepository:LocalAnsibleRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocalAnsibleRepository Get(string name, Input<string> id, LocalAnsibleRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new LocalAnsibleRepository(name, id, state, options);
        }
    }

    public sealed class LocalAnsibleRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
        /// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
        ...
        public LocalAnsibleRepositoryArgs()
        {
        }
        public static new LocalAnsibleRepositoryArgs Empty => new LocalAnsibleRepositoryArgs();
    }

    public sealed class LocalAnsibleRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
        /// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
        ...
        public LocalAnsibleRepositoryState()
        {
        }
        public static new LocalAnsibleRepositoryState Empty => new LocalAnsibleRepositoryState();
    }
}
