...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/virtualAnsibleRepository:VirtualAnsibleRepository")]
    public partial class VirtualAnsibleRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("hideUnauthorizedResources")]
        public Output<bool?> HideUnauthorizedResources { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a VirtualAnsibleRepository resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public VirtualAnsibleRepository(string name, VirtualAnsibleRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualAnsibleRepository:VirtualAnsibleRepository", name, args ?? new VirtualAnsibleRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualAnsibleRepository(string name, Input<string> id, VirtualAnsibleRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualAnsibleRepository:VirtualAnsibleRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualAnsibleRepository Get(string name, Input<string> id, VirtualAnsibleRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualAnsibleRepository(name, id, state, options);
        }
    }

    public sealed class VirtualAnsibleRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
        /// </summary>
        ...
        public VirtualAnsibleRepositoryArgs()
        {
        }
        public static new VirtualAnsibleRepositoryArgs Empty => new VirtualAnsibleRepositoryArgs();
    }

    public sealed class VirtualAnsibleRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
        /// </summary>
        ...
        public VirtualAnsibleRepositoryState()
        {
        }
        public static new VirtualAnsibleRepositoryState Empty => new VirtualAnsibleRepositoryState();
    }
}
