...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualChefRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualChefRepository(string name, VirtualChefRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualChefRepository:VirtualChefRepository", name, args ?? new VirtualChefRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualChefRepository(string name, Input<string> id, VirtualChefRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualChefRepository:VirtualChefRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualChefRepository Get(string name, Input<string> id, VirtualChefRepositoryState? state = null, CustomResourceOptions? options = null)
        {
