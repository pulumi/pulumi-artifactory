...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_conda_repo = new Artifactory.Index.FederatedCondaRepository.FederatedCondaRepository("terraform-federated-test-conda-repo", new()
    ///     {
