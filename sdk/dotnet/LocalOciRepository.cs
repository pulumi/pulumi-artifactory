...
namespace Pulumi.Artifactory
{
    ...
    /// ```
    /// </summary>
    [ArtifactoryResourceType("artifactory:index/localOciRepository:LocalOciRepository")]
    public partial class LocalOciRepository : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public LocalOciRepository(string name, LocalOciRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/localOciRepository:LocalOciRepository", name, args ?? new LocalOciRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LocalOciRepository(string name, Input<string> id, LocalOciRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/localOciRepository:LocalOciRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LocalOciRepository Get(string name, Input<string> id, LocalOciRepositoryState? state = null, CustomResourceOptions? options = null)
        {
            return new LocalOciRepository(name, id, state, options);
        }
    }

    public sealed class LocalOciRepositoryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
        /// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
        ...
        public LocalOciRepositoryArgs()
        {
        }
        public static new LocalOciRepositoryArgs Empty => new LocalOciRepositoryArgs();
    }

    public sealed class LocalOciRepositoryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
        /// therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
        ...
        public LocalOciRepositoryState()
        {
        }
        public static new LocalOciRepositoryState Empty => new LocalOciRepositoryState();
    }
}
