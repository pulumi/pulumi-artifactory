...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualSbtRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualSbtRepository(string name, VirtualSbtRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualSbtRepository:VirtualSbtRepository", name, args ?? new VirtualSbtRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualSbtRepository(string name, Input<string> id, VirtualSbtRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualSbtRepository:VirtualSbtRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualSbtRepository Get(string name, Input<string> id, VirtualSbtRepositoryState? state = null, CustomResourceOptions? options = null)
        {
