...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualSwiftRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualSwiftRepository(string name, VirtualSwiftRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualSwiftRepository:VirtualSwiftRepository", name, args ?? new VirtualSwiftRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualSwiftRepository(string name, Input<string> id, VirtualSwiftRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualSwiftRepository:VirtualSwiftRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualSwiftRepository Get(string name, Input<string> id, VirtualSwiftRepositoryState? state = null, CustomResourceOptions? options = null)
        {
