...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var terraform_federated_test_alpine_repo = new Artifactory.Index.FederatedAlpineRepository.FederatedAlpineRepository("terraform-federated-test-alpine-repo", new()
    ///     {
