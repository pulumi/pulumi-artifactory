...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_nuget = new Artifactory.Index.RemoteNugetRepository("my-remote-nuget", new()
    ///     {
    ///         Key = "my-remote-nuget",
    ...
    public partial class RemoteNugetRepository : global::Pulumi.CustomResource
    {
        ...
        public Output<Outputs.RemoteNugetRepositoryContentSynchronisation?> ContentSynchronisation { get; private set; } = null!;
        ...
        public RemoteNugetRepository(string name, RemoteNugetRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteNugetRepository:RemoteNugetRepository", name, args ?? new RemoteNugetRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteNugetRepository(string name, Input<string> id, RemoteNugetRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteNugetRepository:RemoteNugetRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteNugetRepository Get(string name, Input<string> id, RemoteNugetRepositoryState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class RemoteNugetRepositoryArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.RemoteNugetRepositoryContentSynchronisationArgs>? ContentSynchronisation { get; set; }
    ...
    public sealed class RemoteNugetRepositoryState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("contentSynchronisation")]
        public Input<Inputs.RemoteNugetRepositoryContentSynchronisationGetArgs>? ContentSynchronisation { get; set; }
