...
namespace Pulumi.Artifactory
{
    ...
    /// {
    ///     var my_remote_debian = new Artifactory.Index.RemoteDebianRepository("my-remote-debian", new()
    ///     {
    ...
    public partial class RemoteDebianRepository : global::Pulumi.CustomResource
    {
        ...
        public RemoteDebianRepository(string name, RemoteDebianRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteDebianRepository:RemoteDebianRepository", name, args ?? new RemoteDebianRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RemoteDebianRepository(string name, Input<string> id, RemoteDebianRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/remoteDebianRepository:RemoteDebianRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static RemoteDebianRepository Get(string name, Input<string> id, RemoteDebianRepositoryState? state = null, CustomResourceOptions? options = null)
        {
