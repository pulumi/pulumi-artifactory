...
namespace Pulumi.Artifactory
{
    ...
    public partial class VirtualComposerRepository : global::Pulumi.CustomResource
    {
        ...
        public VirtualComposerRepository(string name, VirtualComposerRepositoryArgs args, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualComposerRepository:VirtualComposerRepository", name, args ?? new VirtualComposerRepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualComposerRepository(string name, Input<string> id, VirtualComposerRepositoryState? state = null, CustomResourceOptions? options = null)
            : base("artifactory:index/virtualComposerRepository:VirtualComposerRepository", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualComposerRepository Get(string name, Input<string> id, VirtualComposerRepositoryState? state = null, CustomResourceOptions? options = null)
        {
