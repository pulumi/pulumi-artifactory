...
__all__ = [
    ...
    'AwaitableGetLocalGemsRepositoryResult',
    'get_local_gems_repository',
    'get_local_gems_repository_output',
]

@pulumi.output_type
class GetLocalGemsRepositoryResult:
    """
...
class AwaitableGetLocalGemsRepositoryResult(GetLocalGemsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalGemsRepositoryResult(
...
def get_local_gems_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalGemsRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalGemsRepository:getLocalGemsRepository', __args__, opts=opts, typ=GetLocalGemsRepositoryResult).value

    return AwaitableGetLocalGemsRepositoryResult(
...
def get_local_gems_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalGemsRepositoryResult]:
    """
    Retrieves a local gems repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalGemsRepository:getLocalGemsRepository', __args__, opts=opts, typ=GetLocalGemsRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalGemsRepositoryResult(
