...
class ProxyArgs:
    def __init__(__self__, *,
                 ...
                 nt_domain: Optional[pulumi.Input[builtins.str]] = None,
                 nt_host: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 platform_default: Optional[pulumi.Input[builtins.bool]] = None,
                 redirect_to_hosts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] host: The name of the proxy host.
        :param pulumi.Input[builtins.str] key: The unique ID of the proxy.
        :param pulumi.Input[builtins.int] port: The proxy port number.
        :param pulumi.Input[builtins.str] nt_domain: The proxy domain/realm name.
        :param pulumi.Input[builtins.str] nt_host: The computer name of the machine (the machine connecting to the NTLM proxy).
        :param pulumi.Input[builtins.str] password: The proxy password when authentication credentials are required.
        :param pulumi.Input[builtins.bool] platform_default: When set, this proxy will be the default proxy for new remote repositories and for internal HTTP requests issued by Artifactory. Will also be used as proxy for all other services in the platform (for example: Xray, Distribution, etc).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] redirect_to_hosts: An optional list of host names to which this proxy may redirect requests. The credentials defined for the proxy are reused by requests redirected to all of these hosts.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: An optional list of services names to which this proxy be the default of. The options are `jfrt`, `jfmc`, `jfxr`, `jfds`.
        :param pulumi.Input[builtins.str] username: The proxy username when authentication credentials are required.
        """
    ...
    def nt_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @nt_domain.setter
    def nt_domain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nt_domain", value)

    @property
    @pulumi.getter(name="ntHost")
    def nt_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @nt_host.setter
    def nt_host(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def platform_default(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def platform_default(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "platform_default", value)

    @property
    @pulumi.getter(name="redirectToHosts")
    def redirect_to_hosts(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def redirect_to_hosts(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Proxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redirect_to_hosts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Proxy':
        """
    ...
    @property
    @pulumi.getter(name="ntDomain")
    def nt_domain(self) -> pulumi.Output[builtins.str]:
        """
        The proxy domain/realm name.
        """
        return pulumi.get(self, "nt_domain")
    ...
    @property
    @pulumi.getter(name="ntHost")
    def nt_host(self) -> pulumi.Output[builtins.str]:
        """
        The computer name of the machine (the machine connecting to the NTLM proxy).
        """
        return pulumi.get(self, "nt_host")
    ...
    @property
    @pulumi.getter(name="platformDefault")
    def platform_default(self) -> pulumi.Output[builtins.bool]:
        """
        When set, this proxy will be the default proxy for new remote repositories and for internal HTTP requests issued by Artifactory. Will also be used as proxy for all other services in the platform (for example: Xray, Distribution, etc).
        """
        return pulumi.get(self, "platform_default")
    ...
    @property
    @pulumi.getter(name="redirectToHosts")
    def redirect_to_hosts(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An optional list of host names to which this proxy may redirect requests. The credentials defined for the proxy are reused by requests redirected to all of these hosts.
        """
        return pulumi.get(self, "redirect_to_hosts")
