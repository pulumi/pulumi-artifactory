...
class RemoteDockerRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        RemoteDockerRepositoryArgs._configure(
            ...
            enable_token_authentication=enable_token_authentication,
            excludes_pattern=excludes_pattern,
            external_dependencies_enabled=external_dependencies_enabled,
            external_dependencies_patterns=external_dependencies_patterns,
            hard_fail=hard_fail,
    ...
    def _configure(
        ...
        if enable_token_authentication is None and 'enableTokenAuthentication' in kwargs:
        ...
        if enable_token_authentication is not None:
            _setter("enable_token_authentication", enable_token_authentication)
        if excludes_pattern is not None:
            _setter("excludes_pattern", excludes_pattern)
        if external_dependencies_enabled is not None:
            _setter("external_dependencies_enabled", external_dependencies_enabled)
        if external_dependencies_patterns is not None:
            _setter("external_dependencies_patterns", external_dependencies_patterns)
...
class _RemoteDockerRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _RemoteDockerRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            allow_any_host_auth=allow_any_host_auth,
            assumed_offline_period_secs=assumed_offline_period_secs,
            blacked_out=blacked_out,
...
class RemoteDockerRepository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RemoteDockerRepositoryArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if content_synchronisation is not None and not isinstance(content_synchronisation, RemoteDockerRepositoryContentSynchronisationArgs):
                content_synchronisation = content_synchronisation or {}
                def _setter(key, value):
                    content_synchronisation[key] = value
                RemoteDockerRepositoryContentSynchronisationArgs._configure(_setter, **content_synchronisation)
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'RemoteDockerRepository':
        """
