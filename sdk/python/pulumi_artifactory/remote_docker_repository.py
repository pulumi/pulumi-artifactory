...
class RemoteDockerRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] block_pushing_schema1: When set, Artifactory will block the pulling of Docker images with manifest v2
...
class RemoteDockerRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'RemoteDockerRepository':
        """
