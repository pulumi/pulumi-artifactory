...
__all__ = [
    'GetFederatedTerraformProviderRepositoryResult',
    'AwaitableGetFederatedTerraformProviderRepositoryResult',
    'get_federated_terraform_provider_repository',
    'get_federated_terraform_provider_repository_output',
]

@pulumi.output_type
class GetFederatedTerraformProviderRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedTerraformProviderRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedTerraformProviderRepositoryResult(GetFederatedTerraformProviderRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedTerraformProviderRepositoryResult(
...
def get_federated_terraform_provider_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                                ...
                                                members: Optional[Sequence[Union['GetFederatedTerraformProviderRepositoryMemberArgs', 'GetFederatedTerraformProviderRepositoryMemberArgsDict', 'outputs.GetFederatedTerraformProviderRepositoryMemberResult']]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedTerraformProviderRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedTerraformProviderRepositoryMemberArgs', 'GetFederatedTerraformProviderRepositoryMemberArgsDict', 'outputs.GetFederatedTerraformProviderRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedTerraformProviderRepository:getFederatedTerraformProviderRepository', __args__, opts=opts, typ=GetFederatedTerraformProviderRepositoryResult).value

    return AwaitableGetFederatedTerraformProviderRepositoryResult(
...
def get_federated_terraform_provider_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                                       ...
                                                       members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedTerraformProviderRepositoryMemberArgs', 'GetFederatedTerraformProviderRepositoryMemberArgsDict', 'outputs.GetFederatedTerraformProviderRepositoryMemberResult']]]]] = None,
                                                       ...
                                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedTerraformProviderRepositoryResult]:
    """
    Retrieves a federated terraform provider repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedTerraformProviderRepository:getFederatedTerraformProviderRepository', __args__, opts=opts, typ=GetFederatedTerraformProviderRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedTerraformProviderRepositoryResult(
