...
class FederatedDockerV2RepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        FederatedDockerV2RepositoryArgs._configure(
    ...
    def _configure(
        ...
        if block_pushing_schema1 is None and 'blockPushingSchema1' in kwargs:
        ...
        if max_unique_tags is None and 'maxUniqueTags' in kwargs:
        ...
        if tag_retention is None and 'tagRetention' in kwargs:
        ...
        if block_pushing_schema1 is not None:
            _setter("block_pushing_schema1", block_pushing_schema1)
        ...
        if max_unique_tags is not None:
            _setter("max_unique_tags", max_unique_tags)
        ...
        if tag_retention is not None:
            _setter("tag_retention", tag_retention)
...
class _FederatedDockerV2RepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _FederatedDockerV2RepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class FederatedDockerV2Repository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 key: Optional[pulumi.Input[str]] = None,
                 max_unique_tags: Optional[pulumi.Input[int]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FederatedDockerV2RepositoryMemberArgs']]]]] = None,
                 notes: Optional[pulumi.Input[str]] = None,
                 priority_resolution: Optional[pulumi.Input[bool]] = None,
                 project_environments: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 project_key: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[int] max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository. Once the number tags for an
               image exceeds this setting, older tags are removed. A value of 0 (default) indicates there is no limit. This only
               applies to manifest v2
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FederatedDockerV2RepositoryMemberArgs']]]] members: The list of Federated members and must contain this repository URL (configured base URL
               `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
               Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
        :param pulumi.Input[str] notes: Internal description.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            FederatedDockerV2RepositoryArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: Optional[pulumi.Input[str]] = None,
            tag_retention: Optional[pulumi.Input[int]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'FederatedDockerV2Repository':
        """
