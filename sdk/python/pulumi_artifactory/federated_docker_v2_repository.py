...
class FederatedDockerV2RepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository. Once the number tags for an
        ...
        :param pulumi.Input[_builtins.int] tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up number. This only applies to
               manifest V2
