...
class FederatedDockerV2RepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] block_pushing_schema1: When set, Artifactory will block the pushing of Docker images with manifest v2 schema 1 to this repository.
        ...
        :param pulumi.Input[_builtins.int] tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up number. This only applies to manifest V2
...
class _FederatedDockerV2RepositoryState:
    def __init__(__self__, *,
                 ...
                 max_unique_tags: pulumi.Input[Optional[_builtins.int]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedDockerV2RepositoryMemberArgs']]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] api_version: The Docker API version to use. This cannot be set
        :param pulumi.Input[_builtins.bool] archive_browsing_enabled: When set, you may view content such as HTML or Javadoc files directly from Artifactory.
               This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
        :param pulumi.Input[_builtins.bool] blacked_out: When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
        :param pulumi.Input[_builtins.bool] block_pushing_schema1: When set, Artifactory will block the pushing of Docker images with manifest v2 schema 1 to this repository.
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FederatedDockerV2RepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedDockerV2RepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
class FederatedDockerV2Repository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 max_unique_tags: pulumi.Input[Optional[_builtins.int]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FederatedDockerV2RepositoryMemberArgs', 'FederatedDockerV2RepositoryMemberArgsDict', 'outputs.FederatedDockerV2RepositoryMember']]]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
                 priority_resolution: pulumi.Input[Optional[_builtins.bool]] = None,
                 project_environments: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_key: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository.
               Once the number tags for an image exceeds this setting, older tags are removed. A value of 0 (default) indicates there is no limit.
               This only applies to manifest v2
        :param pulumi.Input[Sequence[pulumi.Input[Union['FederatedDockerV2RepositoryMemberArgs', 'FederatedDockerV2RepositoryMemberArgsDict', 'outputs.FederatedDockerV2RepositoryMember']]]] members: The list of Federated members and must contain this repository URL (configured base URL
               `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
               Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
        :param pulumi.Input[_builtins.str] notes: Internal description.
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: pulumi.Input[Optional[_builtins.str]] = None,
            tag_retention: pulumi.Input[Optional[_builtins.int]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FederatedDockerV2Repository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="maxUniqueTags")
    def max_unique_tags(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The maximum number of unique tags of a single Docker image to store in this repository.
        Once the number tags for an image exceeds this setting, older tags are removed. A value of 0 (default) indicates there is no limit.
        This only applies to manifest v2
    ...
    @_builtins.property
    @pulumi.getter(name="tagRetention")
    def tag_retention(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        If greater than 1, overwritten tags will be saved by their digest, up to the set up number. This only applies to manifest V2
        """
        return pulumi.get(self, "tag_retention")
