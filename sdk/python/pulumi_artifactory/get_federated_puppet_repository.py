...
__all__ = [
    'GetFederatedPuppetRepositoryResult',
    'AwaitableGetFederatedPuppetRepositoryResult',
    'get_federated_puppet_repository',
    'get_federated_puppet_repository_output',
]

@pulumi.output_type
class GetFederatedPuppetRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedPuppetRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedPuppetRepositoryResult(GetFederatedPuppetRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedPuppetRepositoryResult(
...
def get_federated_puppet_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                    ...
                                    members: Optional[Sequence[Union['GetFederatedPuppetRepositoryMemberArgs', 'GetFederatedPuppetRepositoryMemberArgsDict', 'outputs.GetFederatedPuppetRepositoryMemberResult']]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedPuppetRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedPuppetRepositoryMemberArgs', 'GetFederatedPuppetRepositoryMemberArgsDict', 'outputs.GetFederatedPuppetRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedPuppetRepository:getFederatedPuppetRepository', __args__, opts=opts, typ=GetFederatedPuppetRepositoryResult).value

    return AwaitableGetFederatedPuppetRepositoryResult(
...
def get_federated_puppet_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                           ...
                                           members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedPuppetRepositoryMemberArgs', 'GetFederatedPuppetRepositoryMemberArgsDict', 'outputs.GetFederatedPuppetRepositoryMemberResult']]]]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedPuppetRepositoryResult]:
    """
    Retrieves a federated Puppet repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedPuppetRepository:getFederatedPuppetRepository', __args__, opts=opts, typ=GetFederatedPuppetRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedPuppetRepositoryResult(
