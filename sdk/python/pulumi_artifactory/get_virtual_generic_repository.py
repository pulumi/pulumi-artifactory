...
def get_virtual_generic_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
...
def get_virtual_generic_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualGenericRepositoryResult]:
    """
    Retrieves a virtual Generic repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualGenericRepository:getVirtualGenericRepository', __args__, opts=opts, typ=GetVirtualGenericRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualGenericRepositoryResult(
