...
class _CertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content: PEM-encoded client certificate and private key. Cannot be set with `file` attribute simultaneously.
        :param pulumi.Input[_builtins.str] file: Path to the PEM file. Cannot be set with `content` attribute simultaneously.
        :param pulumi.Input[_builtins.str] fingerprint: SHA256 fingerprint of the certificate.
        :param pulumi.Input[_builtins.str] issued_by: Name of the certificate authority that issued the certificate.
        :param pulumi.Input[_builtins.str] issued_on: The time & date when the certificate is valid from.
        :param pulumi.Input[_builtins.str] issued_to: Name of whom the certificate has been issued to.
        :param pulumi.Input[_builtins.str] valid_until: The time & date when the certificate expires.
        """
