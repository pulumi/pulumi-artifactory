...
__all__ = [
    ...
    'AwaitableGetRemoteVcsRepositoryResult',
    'get_remote_vcs_repository',
    'get_remote_vcs_repository_output',
]

@pulumi.output_type
class GetRemoteVcsRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteVcsRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteVcsRepositoryResult(GetRemoteVcsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteVcsRepositoryResult(
...
def get_remote_vcs_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemoteVcsRepositoryContentSynchronisationArgs', 'GetRemoteVcsRepositoryContentSynchronisationArgsDict']] = None,
    ...
    :param builtins.int max_unique_snapshots: (Optional) The maximum number of unique snapshots of a single artifact to store. Once the number of snapshots exceeds this setting, older versions are removed. A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
    ...
    :param builtins.str vcs_git_provider: (Optional) Artifactory supports proxying the following Git providers out-of-the-box: GitHub, Bitbucket, Stash, a remote Artifactory instance or a custom Git repository. Allowed values are: `GITHUB`, `BITBUCKET`, `OLDSTASH`, `STASH`, `ARTIFACTORY`, `CUSTOM`. Default value is `GITHUB`
    """
    __args__ = dict()
...
def get_remote_vcs_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteVcsRepositoryContentSynchronisationArgs', 'GetRemoteVcsRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteVcsRepositoryResult]:
    """
    Retrieves a remote VCS repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteVcsRepository:getRemoteVcsRepository', __args__, opts=opts, typ=GetRemoteVcsRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteVcsRepositoryResult(
