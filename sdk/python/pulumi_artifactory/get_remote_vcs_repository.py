...
def get_remote_vcs_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
...
def get_remote_vcs_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
