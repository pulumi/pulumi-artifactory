...
__all__ = [
    'GetVirtualPuppetRepositoryResult',
    'AwaitableGetVirtualPuppetRepositoryResult',
    'get_virtual_puppet_repository',
    'get_virtual_puppet_repository_output',
]

@pulumi.output_type
class GetVirtualPuppetRepositoryResult:
    """
...
class AwaitableGetVirtualPuppetRepositoryResult(GetVirtualPuppetRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualPuppetRepositoryResult(
...
def get_virtual_puppet_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualPuppetRepository:getVirtualPuppetRepository', __args__, opts=opts, typ=GetVirtualPuppetRepositoryResult).value

    return AwaitableGetVirtualPuppetRepositoryResult(
...
def get_virtual_puppet_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualPuppetRepositoryResult]:
    """
    Retrieves a virtual Puppet repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualPuppetRepository:getVirtualPuppetRepository', __args__, opts=opts, typ=GetVirtualPuppetRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualPuppetRepositoryResult(
