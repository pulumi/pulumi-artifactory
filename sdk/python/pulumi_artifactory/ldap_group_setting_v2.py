...
class LdapGroupSettingV2Args:
    def __init__(__self__, *,
                 description_attribute: pulumi.Input[builtins.str],
                 filter: pulumi.Input[builtins.str],
                 group_member_attribute: pulumi.Input[builtins.str],
                 group_name_attribute: pulumi.Input[builtins.str],
                 strategy: pulumi.Input[builtins.str],
                 enabled_ldap: Optional[pulumi.Input[builtins.str]] = None,
                 force_attribute_search: Optional[pulumi.Input[builtins.bool]] = None,
                 group_base_dn: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sub_tree: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a LdapGroupSettingV2 resource.
        :param pulumi.Input[builtins.str] description_attribute: An attribute on the group entry which denoting the group description. Used when importing groups.
        :param pulumi.Input[builtins.str] filter: The LDAP filter used to search for group entries. Used for importing groups.
        :param pulumi.Input[builtins.str] group_member_attribute: A multi-value attribute on the group entry containing user DNs or IDs of the group members (e.g., uniqueMember, member).
        :param pulumi.Input[builtins.str] group_name_attribute: Attribute on the group entry denoting the group name. Used when importing groups.
        :param pulumi.Input[builtins.str] strategy: The JFrog Platform Deployment (JPD) supports three ways of mapping groups to LDAP schemas: STATIC: Group objects are aware of their members, however, the users are not aware of the groups they belong to. Each group object such as groupOfNames or groupOfUniqueNames holds its respective member attributes, typically member or uniqueMember, which is a user DN. DYNAMIC: User objects are aware of what groups they belong to, but the group objects are not aware of their members. Each user object contains a custom attribute, such as group, that holds the group DNs or group names of which the user is a member. HIERARCHICAL: The user's DN is indicative of the groups the user belongs to by using group names as part of user DN hierarchy. Each user DN contains a list of ou's or custom attributes that make up the group association. For example, `uid=user1,ou=developers,ou=uk,dc=jfrog,dc=org` indicates that `user1` belongs to two groups: `uk` and `developers`. Valid values are: `STATIC`, `DYNAMIC`, `HIERARCHICAL`, case sensitive, all caps.
        :param pulumi.Input[builtins.str] enabled_ldap: The LDAP setting key you want to use for group retrieval.
        :param pulumi.Input[builtins.bool] force_attribute_search: This attribute is used in very specific cases of LDAP group settings. Don't switch it to `false`, unless instructed by the JFrog support team. Default value is `false`.
        :param pulumi.Input[builtins.str] group_base_dn: A search base for group entry DNs, relative to the DN on the LDAP server’s URL (and not relative to the LDAP Setting’s “Search Base”). Used when importing groups.
        :param pulumi.Input[builtins.str] name: Ldap group setting name.
        :param pulumi.Input[builtins.bool] sub_tree: When set, enables deep search through the sub-tree of the LDAP URL + Search Base. `true` by default. `sub_tree` can be set to true only with `STATIC` or `DYNAMIC` strategy.
        """
    ...
    def description_attribute(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def description_attribute(self, value: pulumi.Input[builtins.str]):
    ...
    def group_member_attribute(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def group_member_attribute(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "group_member_attribute", value)

    @property
    @pulumi.getter(name="groupNameAttribute")
    def group_name_attribute(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def group_name_attribute(self, value: pulumi.Input[builtins.str]):
    ...
    def enabled_ldap(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @enabled_ldap.setter
    def enabled_ldap(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enabled_ldap", value)

    @property
    @pulumi.getter(name="forceAttributeSearch")
    def force_attribute_search(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_attribute_search(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "force_attribute_search", value)

    @property
    @pulumi.getter(name="groupBaseDn")
    def group_base_dn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def group_base_dn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sub_tree(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @sub_tree.setter
    def sub_tree(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _LdapGroupSettingV2State:
    def __init__(__self__, *,
                 description_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 enabled_ldap: Optional[pulumi.Input[builtins.str]] = None,
                 filter: Optional[pulumi.Input[builtins.str]] = None,
                 force_attribute_search: Optional[pulumi.Input[builtins.bool]] = None,
                 group_base_dn: Optional[pulumi.Input[builtins.str]] = None,
                 group_member_attribute: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="descriptionAttribute")
    def description_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An attribute on the group entry which denoting the group description. Used when importing groups.
        """
        return pulumi.get(self, "description_attribute")
    ...
    @description_attribute.setter
    def description_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "description_attribute", value)
    ...
    @property
    @pulumi.getter(name="groupMemberAttribute")
    def group_member_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A multi-value attribute on the group entry containing user DNs or IDs of the group members (e.g., uniqueMember, member).
        """
        return pulumi.get(self, "group_member_attribute")
    ...
    @group_member_attribute.setter
    def group_member_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_member_attribute", value)
...
class LdapGroupSettingV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            strategy: Optional[pulumi.Input[builtins.str]] = None,
            sub_tree: Optional[pulumi.Input[builtins.bool]] = None) -> 'LdapGroupSettingV2':
        """
    ...
    @property
    @pulumi.getter(name="descriptionAttribute")
    def description_attribute(self) -> pulumi.Output[builtins.str]:
        """
        An attribute on the group entry which denoting the group description. Used when importing groups.
        """
        return pulumi.get(self, "description_attribute")
    ...
    @property
    @pulumi.getter(name="enabledLdap")
    def enabled_ldap(self) -> pulumi.Output[builtins.str]:
        """
        The LDAP setting key you want to use for group retrieval.
        """
        return pulumi.get(self, "enabled_ldap")
    ...
    @property
    @pulumi.getter(name="forceAttributeSearch")
    def force_attribute_search(self) -> pulumi.Output[builtins.bool]:
        """
        This attribute is used in very specific cases of LDAP group settings. Don't switch it to `false`, unless instructed by the JFrog support team. Default value is `false`.
        """
        return pulumi.get(self, "force_attribute_search")
    ...
    @property
    @pulumi.getter(name="groupBaseDn")
    def group_base_dn(self) -> pulumi.Output[builtins.str]:
        """
        A search base for group entry DNs, relative to the DN on the LDAP server’s URL (and not relative to the LDAP Setting’s “Search Base”). Used when importing groups.
        """
        return pulumi.get(self, "group_base_dn")
    ...
    @property
    @pulumi.getter(name="groupMemberAttribute")
    def group_member_attribute(self) -> pulumi.Output[builtins.str]:
        """
        A multi-value attribute on the group entry containing user DNs or IDs of the group members (e.g., uniqueMember, member).
        """
        return pulumi.get(self, "group_member_attribute")
    ...
    @property
    @pulumi.getter(name="subTree")
    def sub_tree(self) -> pulumi.Output[builtins.bool]:
        """
        When set, enables deep search through the sub-tree of the LDAP URL + Search Base. `true` by default. `sub_tree` can be set to true only with `STATIC` or `DYNAMIC` strategy.
        """
        return pulumi.get(self, "sub_tree")
