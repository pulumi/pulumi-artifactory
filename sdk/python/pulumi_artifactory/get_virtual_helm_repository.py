...
__all__ = [
    ...
    'AwaitableGetVirtualHelmRepositoryResult',
    'get_virtual_helm_repository',
    'get_virtual_helm_repository_output',
]

@pulumi.output_type
class GetVirtualHelmRepositoryResult:
    """
    A collection of values returned by getVirtualHelmRepository.
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, default_deployment_repo=None, description=None, excludes_pattern=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None, retrieval_cache_period_seconds=None, use_namespaces=None):
        ...
        if use_namespaces and not isinstance(use_namespaces, bool):
            raise TypeError("Expected argument 'use_namespaces' to be a bool")
    ...
    def use_namespaces(self) -> Optional[_builtins.bool]:
        """
...
class AwaitableGetVirtualHelmRepositoryResult(GetVirtualHelmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualHelmRepositoryResult(
...
def get_virtual_helm_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                ...
                                use_namespaces: Optional[_builtins.bool] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualHelmRepositoryResult:
    """
    ...
    :param _builtins.bool use_namespaces: (Optional) From Artifactory 7.24.1 (SaaS Version), you can explicitly state a specific aggregated local or remote repository to fetch from a virtual by assigning namespaces to local and remote repositories. See the documentation [here](https://www.jfrog.com/confluence/display/JFROG/Kubernetes+Helm+Chart+Repositories#KubernetesHelmChartRepositories-NamespaceSupportforHelmVirtualRepositories). Default is `false`.
    """
    __args__ = dict()
...
def get_virtual_helm_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       use_namespaces: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetVirtualHelmRepositoryResult(
        ...
        use_namespaces=pulumi.get(__response__, 'use_namespaces')))
