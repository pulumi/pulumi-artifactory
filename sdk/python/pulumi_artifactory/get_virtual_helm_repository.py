...
class GetVirtualHelmRepositoryResult:
    ...
    def use_namespaces(self) -> Optional[builtins.bool]:
        """
...
def get_virtual_helm_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
                                ...
                                use_namespaces: Optional[builtins.bool] = None,
    ...
    :param builtins.bool use_namespaces: (Optional) From Artifactory 7.24.1 (SaaS Version), you can explicitly state a specific aggregated local or remote repository to fetch from a virtual by assigning namespaces to local and remote repositories. See the documentation [here](https://www.jfrog.com/confluence/display/JFROG/Kubernetes+Helm+Chart+Repositories#KubernetesHelmChartRepositories-NamespaceSupportforHelmVirtualRepositories). Default is `false`.
    """
    __args__ = dict()
...
def get_virtual_helm_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       ...
                                       use_namespaces: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
