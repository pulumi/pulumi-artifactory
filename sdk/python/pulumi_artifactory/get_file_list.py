...
class GetFileListResult:
    ...
    def deep_listing(self) -> Optional[builtins.bool]:
        """
        Get deep listing
        """
    ...
    def include_root_path(self) -> Optional[builtins.bool]:
        """
        Include root path
        """
    ...
    def list_folders(self) -> Optional[builtins.bool]:
        """
        Include folders
        """
    ...
    def metadata_timestamps(self) -> Optional[builtins.bool]:
        """
    ...
    def repository_key(self) -> builtins.str:
        """
        Repository key
        """
...
def get_file_list(deep_listing: Optional[builtins.bool] = None,
                  depth: Optional[builtins.int] = None,
                  folder_path: Optional[builtins.str] = None,
                  include_root_path: Optional[builtins.bool] = None,
                  list_folders: Optional[builtins.bool] = None,
                  metadata_timestamps: Optional[builtins.bool] = None,
    ...
    :param builtins.bool deep_listing: Get deep listing
    :param builtins.int depth: Depth of the deep listing
    :param builtins.str folder_path: Path of the folder
    :param builtins.bool include_root_path: Include root path
    :param builtins.bool list_folders: Include folders
    :param builtins.bool metadata_timestamps: Include metadata timestamps
    :param builtins.str repository_key: Repository key
    """
    __args__ = dict()
...
def get_file_list_output(deep_listing: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         depth: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                         folder_path: Optional[pulumi.Input[builtins.str]] = None,
                         include_root_path: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         list_folders: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         metadata_timestamps: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                         repository_key: Optional[pulumi.Input[builtins.str]] = None,
