...
__all__ = [
    ...
    'AwaitableGetLocalPypiRepositoryResult',
    'get_local_pypi_repository',
    'get_local_pypi_repository_output',
]

@pulumi.output_type
class GetLocalPypiRepositoryResult:
    """
...
class AwaitableGetLocalPypiRepositoryResult(GetLocalPypiRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalPypiRepositoryResult(
...
def get_local_pypi_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalPypiRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalPypiRepository:getLocalPypiRepository', __args__, opts=opts, typ=GetLocalPypiRepositoryResult).value

    return AwaitableGetLocalPypiRepositoryResult(
...
def get_local_pypi_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalPypiRepositoryResult]:
    """
    Retrieves a local pypi repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalPypiRepository:getLocalPypiRepository', __args__, opts=opts, typ=GetLocalPypiRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalPypiRepositoryResult(
