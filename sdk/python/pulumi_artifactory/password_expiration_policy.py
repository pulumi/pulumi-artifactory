...
class PasswordExpirationPolicyArgs:
    def __init__(__self__, *,
                 ...
                 notify_by_email: pulumi.Input[builtins.bool],
                 password_max_age: pulumi.Input[builtins.int],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PasswordExpirationPolicy resource.
        :param pulumi.Input[builtins.bool] enabled: Enable Password Expiration Policy. This only applies to internal user passwords.
        :param pulumi.Input[builtins.bool] notify_by_email: Send mail notification before password expiration. Users will receive an email notification X days before password will expire. Mail server must be enabled and configured correctly.
        :param pulumi.Input[builtins.int] password_max_age: Password expires every N days. The time interval in which users will be obligated to change their password.
    ...
    def notify_by_email(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def notify_by_email(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "notify_by_email", value)

    @property
    @pulumi.getter(name="passwordMaxAge")
    def password_max_age(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def password_max_age(self, value: pulumi.Input[builtins.int]):
...
class _PasswordExpirationPolicyState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notify_by_email: Optional[pulumi.Input[builtins.bool]] = None,
                 password_max_age: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="notifyByEmail")
    def notify_by_email(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Send mail notification before password expiration. Users will receive an email notification X days before password will expire. Mail server must be enabled and configured correctly.
        """
        return pulumi.get(self, "notify_by_email")
    ...
    @notify_by_email.setter
    def notify_by_email(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_by_email", value)

    @property
    @pulumi.getter(name="passwordMaxAge")
    def password_max_age(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Password expires every N days. The time interval in which users will be obligated to change their password.
        """
        return pulumi.get(self, "password_max_age")
    ...
    @password_max_age.setter
    def password_max_age(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "password_max_age", value)
...
class PasswordExpirationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            notify_by_email: Optional[pulumi.Input[builtins.bool]] = None,
            password_max_age: Optional[pulumi.Input[builtins.int]] = None) -> 'PasswordExpirationPolicy':
        """
    ...
    @property
    @pulumi.getter(name="notifyByEmail")
    def notify_by_email(self) -> pulumi.Output[builtins.bool]:
        """
        Send mail notification before password expiration. Users will receive an email notification X days before password will expire. Mail server must be enabled and configured correctly.
        """
        return pulumi.get(self, "notify_by_email")
    ...
    @property
    @pulumi.getter(name="passwordMaxAge")
    def password_max_age(self) -> pulumi.Output[builtins.int]:
        """
        Password expires every N days. The time interval in which users will be obligated to change their password.
        """
        return pulumi.get(self, "password_max_age")
