...
class LocalRepositorySingleReplicationArgs:
    def __init__(__self__, *,
                 cron_exp: pulumi.Input[builtins.str],
                 repo_key: pulumi.Input[builtins.str],
                 url: pulumi.Input[builtins.str],
                 username: pulumi.Input[builtins.str],
                 check_binary_existence_in_filestore: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_proxy: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_event_replication: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 exclude_path_prefix_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 include_path_prefix_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 proxy: Optional[pulumi.Input[builtins.str]] = None,
                 socket_timeout_millis: Optional[pulumi.Input[builtins.int]] = None,
                 sync_deletes: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_properties: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_statistics: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a LocalRepositorySingleReplication resource.
        :param pulumi.Input[builtins.str] cron_exp: A valid CRON expression that you can use to control replication frequency. Eg: `0 0 12 * * ? *`, `0 0 2 ? * MON-SAT *`. Note: use 6 or 7 parts format - Seconds, Minutes Hours, Day Of Month, Month, Day Of Week, Year (optional). Specifying both a day-of-week AND a day-of-month parameter is not supported. One of them should be replaced by `?`. Incorrect: `* 5,7,9 14/2 * * WED,SAT *`, correct: `* 5,7,9 14/2 ? * WED,SAT *`. See details in [Cron Trigger Tutorial](https://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html).
        :param pulumi.Input[builtins.str] repo_key: Repository name.
        :param pulumi.Input[builtins.str] url: The URL of the target local repository on a remote Artifactory server. Use the format `https://<artifactory_url>/artifactory/<repository_name>`.
        :param pulumi.Input[builtins.str] username: Username on the remote Artifactory instance.
        :param pulumi.Input[builtins.bool] check_binary_existence_in_filestore: Enabling the `check_binary_existence_in_filestore` flag requires an Enterprise Plus license. When true, enables distributed checksum storage. For more information, see [Optimizing Repository Replication with Checksum-Based Storage](https://www.jfrog.com/confluence/display/JFROG/Repository+Replication#RepositoryReplication-OptimizingRepositoryReplicationUsingStorageLevelSynchronizationOptions).
        :param pulumi.Input[builtins.bool] disable_proxy: When set to `true`, the `proxy` attribute will be ignored (from version 7.41.7). The default value is `false`.
        :param pulumi.Input[builtins.bool] enable_event_replication: When set, each event will trigger replication of the artifacts changed in this event. This can be any type of event on artifact, e.g. add, deleted or property change. Default value is `false`.
        :param pulumi.Input[builtins.bool] enabled: When set, enables replication of this repository to the target specified in `url` attribute. Default value is `true`.
        :param pulumi.Input[builtins.str] exclude_path_prefix_pattern: List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/**/z/*`. By default, no artifacts are excluded.
        :param pulumi.Input[builtins.str] include_path_prefix_pattern: List of artifact patterns to include when evaluating artifact requests in the form of `x/y/**/z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included `(**/*)`.
        :param pulumi.Input[builtins.str] password: Use either the HTTP authentication password or [identity token](https://www.jfrog.com/confluence/display/JFROG/User+Profile#UserProfile-IdentityTokenidentitytoken).
        :param pulumi.Input[builtins.str] proxy: Proxy key from Artifactory Proxies settings. The proxy configuration will be used when communicating with the remote instance.
        :param pulumi.Input[builtins.int] socket_timeout_millis: The network timeout in milliseconds to use for remote operations. Default value is `15000`.
        :param pulumi.Input[builtins.bool] sync_deletes: When set, items that were deleted locally should also be deleted remotely (also applies to properties metadata). Note that enabling this option, will delete artifacts on the target that do not exist in the source repository. Default value is `false`.
        :param pulumi.Input[builtins.bool] sync_properties: When set, the task also synchronizes the properties of replicated artifacts. Default value is `true`.
        :param pulumi.Input[builtins.bool] sync_statistics: When set, the task also synchronizes artifact download statistics. Set to avoid inadvertent cleanup at the target instance when setting up replication for disaster recovery. Default value is `false`
        """
    ...
    def cron_exp(self) -> pulumi.Input[builtins.str]:
        """
        A valid CRON expression that you can use to control replication frequency. Eg: `0 0 12 * * ? *`, `0 0 2 ? * MON-SAT *`. Note: use 6 or 7 parts format - Seconds, Minutes Hours, Day Of Month, Month, Day Of Week, Year (optional). Specifying both a day-of-week AND a day-of-month parameter is not supported. One of them should be replaced by `?`. Incorrect: `* 5,7,9 14/2 * * WED,SAT *`, correct: `* 5,7,9 14/2 ? * WED,SAT *`. See details in [Cron Trigger Tutorial](https://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html).
        """
    ...
    @cron_exp.setter
    def cron_exp(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cron_exp", value)

    @property
    @pulumi.getter(name="repoKey")
    def repo_key(self) -> pulumi.Input[builtins.str]:
        """
        Repository name.
        """
    ...
    @repo_key.setter
    def repo_key(self, value: pulumi.Input[builtins.str]):
    ...
    def check_binary_existence_in_filestore(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def check_binary_existence_in_filestore(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_event_replication(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_event_replication(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def exclude_path_prefix_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exclude_path_prefix_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exclude_path_prefix_pattern", value)

    @property
    @pulumi.getter(name="includePathPrefixPattern")
    def include_path_prefix_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def include_path_prefix_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sync_deletes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @sync_deletes.setter
    def sync_deletes(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sync_deletes", value)

    @property
    @pulumi.getter(name="syncProperties")
    def sync_properties(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sync_properties(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sync_properties", value)

    @property
    @pulumi.getter(name="syncStatistics")
    def sync_statistics(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sync_statistics(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _LocalRepositorySingleReplicationState:
    def __init__(__self__, *,
                 check_binary_existence_in_filestore: Optional[pulumi.Input[builtins.bool]] = None,
                 cron_exp: Optional[pulumi.Input[builtins.str]] = None,
                 disable_proxy: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_event_replication: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 exclude_path_prefix_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 proxy: Optional[pulumi.Input[builtins.str]] = None,
                 replication_key: Optional[pulumi.Input[builtins.str]] = None,
                 repo_key: Optional[pulumi.Input[builtins.str]] = None,
                 socket_timeout_millis: Optional[pulumi.Input[builtins.int]] = None,
                 sync_deletes: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_properties: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_statistics: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] password: Use either the HTTP authentication password or [identity token](https://www.jfrog.com/confluence/display/JFROG/User+Profile#UserProfile-IdentityTokenidentitytoken).
        :param pulumi.Input[builtins.str] proxy: Proxy key from Artifactory Proxies settings. The proxy configuration will be used when communicating with the remote instance.
        :param pulumi.Input[builtins.str] replication_key: Replication ID, the value is unknown until the resource is created. Can't be set or updated.
        :param pulumi.Input[builtins.str] repo_key: Repository name.
        :param pulumi.Input[builtins.int] socket_timeout_millis: The network timeout in milliseconds to use for remote operations. Default value is `15000`.
        :param pulumi.Input[builtins.bool] sync_deletes: When set, items that were deleted locally should also be deleted remotely (also applies to properties metadata). Note that enabling this option, will delete artifacts on the target that do not exist in the source repository. Default value is `false`.
        :param pulumi.Input[builtins.bool] sync_properties: When set, the task also synchronizes the properties of replicated artifacts. Default value is `true`.
    ...
    @property
    @pulumi.getter(name="cronExp")
    def cron_exp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A valid CRON expression that you can use to control replication frequency. Eg: `0 0 12 * * ? *`, `0 0 2 ? * MON-SAT *`. Note: use 6 or 7 parts format - Seconds, Minutes Hours, Day Of Month, Month, Day Of Week, Year (optional). Specifying both a day-of-week AND a day-of-month parameter is not supported. One of them should be replaced by `?`. Incorrect: `* 5,7,9 14/2 * * WED,SAT *`, correct: `* 5,7,9 14/2 ? * WED,SAT *`. See details in [Cron Trigger Tutorial](https://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html).
        """
        return pulumi.get(self, "cron_exp")
    ...
    @cron_exp.setter
    def cron_exp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cron_exp", value)
    ...
    def replication_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replication_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_key", value)

    @property
    @pulumi.getter(name="repoKey")
    def repo_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Repository name.
        """
        return pulumi.get(self, "repo_key")
    ...
    @repo_key.setter
    def repo_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "repo_key", value)
...
class LocalRepositorySingleReplication(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["replication_key"] = None
    ...
    def get(resource_name: str,
            ...
            sync_statistics: Optional[pulumi.Input[builtins.bool]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'LocalRepositorySingleReplication':
        """
    ...
    @property
    @pulumi.getter(name="checkBinaryExistenceInFilestore")
    def check_binary_existence_in_filestore(self) -> pulumi.Output[builtins.bool]:
        """
        Enabling the `check_binary_existence_in_filestore` flag requires an Enterprise Plus license. When true, enables distributed checksum storage. For more information, see [Optimizing Repository Replication with Checksum-Based Storage](https://www.jfrog.com/confluence/display/JFROG/Repository+Replication#RepositoryReplication-OptimizingRepositoryReplicationUsingStorageLevelSynchronizationOptions).
        """
        return pulumi.get(self, "check_binary_existence_in_filestore")
    ...
    @property
    @pulumi.getter(name="cronExp")
    def cron_exp(self) -> pulumi.Output[builtins.str]:
        """
        A valid CRON expression that you can use to control replication frequency. Eg: `0 0 12 * * ? *`, `0 0 2 ? * MON-SAT *`. Note: use 6 or 7 parts format - Seconds, Minutes Hours, Day Of Month, Month, Day Of Week, Year (optional). Specifying both a day-of-week AND a day-of-month parameter is not supported. One of them should be replaced by `?`. Incorrect: `* 5,7,9 14/2 * * WED,SAT *`, correct: `* 5,7,9 14/2 ? * WED,SAT *`. See details in [Cron Trigger Tutorial](https://www.quartz-scheduler.org/documentation/quartz-2.3.0/tutorials/crontrigger.html).
        """
        return pulumi.get(self, "cron_exp")
    ...
    @property
    @pulumi.getter(name="enableEventReplication")
    def enable_event_replication(self) -> pulumi.Output[builtins.bool]:
        """
        When set, each event will trigger replication of the artifacts changed in this event. This can be any type of event on artifact, e.g. add, deleted or property change. Default value is `false`.
        """
        return pulumi.get(self, "enable_event_replication")
    ...
    @property
    @pulumi.getter(name="excludePathPrefixPattern")
    def exclude_path_prefix_pattern(self) -> pulumi.Output[builtins.str]:
        """
        List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/**/z/*`. By default, no artifacts are excluded.
        """
        return pulumi.get(self, "exclude_path_prefix_pattern")
    ...
    @property
    @pulumi.getter(name="includePathPrefixPattern")
    def include_path_prefix_pattern(self) -> pulumi.Output[builtins.str]:
        """
        List of artifact patterns to include when evaluating artifact requests in the form of `x/y/**/z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included `(**/*)`.
        """
        return pulumi.get(self, "include_path_prefix_pattern")
    ...
    @property
    @pulumi.getter(name="replicationKey")
    def replication_key(self) -> pulumi.Output[builtins.str]:
        """
        Replication ID, the value is unknown until the resource is created. Can't be set or updated.
        """
        return pulumi.get(self, "replication_key")
    ...
    @property
    @pulumi.getter(name="repoKey")
    def repo_key(self) -> pulumi.Output[builtins.str]:
        """
        Repository name.
        """
        return pulumi.get(self, "repo_key")
    ...
    @property
    @pulumi.getter(name="syncDeletes")
    def sync_deletes(self) -> pulumi.Output[builtins.bool]:
        """
        When set, items that were deleted locally should also be deleted remotely (also applies to properties metadata). Note that enabling this option, will delete artifacts on the target that do not exist in the source repository. Default value is `false`.
        """
        return pulumi.get(self, "sync_deletes")
    ...
    @property
    @pulumi.getter(name="syncProperties")
    def sync_properties(self) -> pulumi.Output[builtins.bool]:
        """
        When set, the task also synchronizes the properties of replicated artifacts. Default value is `true`.
        """
        return pulumi.get(self, "sync_properties")
    ...
    @property
    @pulumi.getter(name="syncStatistics")
    def sync_statistics(self) -> pulumi.Output[builtins.bool]:
        """
        When set, the task also synchronizes artifact download statistics. Set to avoid inadvertent cleanup at the target instance when setting up replication for disaster recovery. Default value is `false`
        """
        return pulumi.get(self, "sync_statistics")
