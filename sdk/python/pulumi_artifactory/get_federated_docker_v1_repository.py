...
class GetFederatedDockerV1RepositoryResult:
    ...
    def max_unique_tags(self) -> _builtins.int:
    ...
    def tag_retention(self) -> _builtins.int:
...
def get_federated_docker_v1_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
...
def get_federated_docker_v1_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
