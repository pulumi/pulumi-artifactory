...
class VirtualHelmociRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 resolve_oci_tags_by_timestamp: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] resolve_oci_tags_by_timestamp: When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
        """
    ...
    def resolve_oci_tags_by_timestamp(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def resolve_oci_tags_by_timestamp(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class VirtualHelmociRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: Optional[pulumi.Input[_builtins.str]] = None,
            repositories: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            resolve_oci_tags_by_timestamp: Optional[pulumi.Input[_builtins.bool]] = None) -> 'VirtualHelmociRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="resolveOciTagsByTimestamp")
    def resolve_oci_tags_by_timestamp(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
        """
        return pulumi.get(self, "resolve_oci_tags_by_timestamp")
