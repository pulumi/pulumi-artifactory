...
class VirtualHelmociRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] resolve_oci_tags_by_timestamp: When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
        """
    ...
    def resolve_oci_tags_by_timestamp(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def resolve_oci_tags_by_timestamp(self, value: Optional[pulumi.Input[bool]]):
...
class VirtualHelmociRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: Optional[pulumi.Input[str]] = None,
            repositories: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            resolve_oci_tags_by_timestamp: Optional[pulumi.Input[bool]] = None) -> 'VirtualHelmociRepository':
        """
    ...
    @property
    @pulumi.getter(name="resolveOciTagsByTimestamp")
    def resolve_oci_tags_by_timestamp(self) -> pulumi.Output[Optional[bool]]:
        """
        When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
        """
        return pulumi.get(self, "resolve_oci_tags_by_timestamp")
