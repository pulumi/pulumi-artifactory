...
class ManagedUserArgs:
    def __init__(__self__, *,
                 ...
                 disable_ui_access: Optional[pulumi.Input[builtins.bool]] = None,
                 groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 internal_password_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password_policy: Optional[pulumi.Input['ManagedUserPasswordPolicyArgs']] = None,
                 profile_updatable: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ManagedUser resource.
        :param pulumi.Input[builtins.str] email: Email for user.
        :param pulumi.Input[builtins.str] password: Password for the user.
        :param pulumi.Input[builtins.bool] admin: (Optional, Default: false) When enabled, this user is an administrator with all the ensuing privileges.
        :param pulumi.Input[builtins.bool] disable_ui_access: (Optional, Default: true) When enabled, this user can only access the system through the REST API. This option cannot be set if the user has Admin privileges.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: List of groups this user is a part of. **Notes:** If this attribute is not specified then user's group membership is set to empty. User will not be part of default "readers" group automatically.
        :param pulumi.Input[builtins.bool] internal_password_disabled: (Optional, Default: false) When enabled, disables the fallback mechanism for using an internal password when external authentication (such as LDAP) is enabled.
        :param pulumi.Input[builtins.str] name: Username for user. May contain lowercase letters, numbers and symbols: '.-_@' for self-hosted. For SaaS, '+' is also allowed.
        :param pulumi.Input['ManagedUserPasswordPolicyArgs'] password_policy: Password policy to match JFrog Access to provide pre-apply validation. Default values: `uppercase=1`, `lowercase=1`, `special_char=0`, `digit=1`, `length=8`. Also see [Supported Access Configurations](https://jfrog.com/help/r/jfrog-installation-setup-documentation/supported-access-configurations) for more details
        :param pulumi.Input[builtins.bool] profile_updatable: (Optional, Default: true) When enabled, this user can update their profile details (except for the password. Only an administrator can update the password). There may be cases in which you want to leave this unset to prevent users from updating their profile. For example, a departmental user with a single password shared between all department members.
        """
    ...
    def disable_ui_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disable_ui_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def internal_password_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def internal_password_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def password_policy(self) -> Optional[pulumi.Input['ManagedUserPasswordPolicyArgs']]:
        """
    ...
    def password_policy(self, value: Optional[pulumi.Input['ManagedUserPasswordPolicyArgs']]):
        pulumi.set(self, "password_policy", value)

    @property
    @pulumi.getter(name="profileUpdatable")
    def profile_updatable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def profile_updatable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ManagedUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 password_policy: Optional[pulumi.Input[Union['ManagedUserPasswordPolicyArgs', 'ManagedUserPasswordPolicyArgsDict']]] = None,
                 profile_updatable: Optional[pulumi.Input[builtins.bool]] = None,
                 __props__=None):
        """
        ## Example Usage
        ...
        :param pulumi.Input[builtins.str] name: Username for user. May contain lowercase letters, numbers and symbols: '.-_@' for self-hosted. For SaaS, '+' is also allowed.
        :param pulumi.Input[builtins.str] password: Password for the user.
        :param pulumi.Input[Union['ManagedUserPasswordPolicyArgs', 'ManagedUserPasswordPolicyArgsDict']] password_policy: Password policy to match JFrog Access to provide pre-apply validation. Default values: `uppercase=1`, `lowercase=1`, `special_char=0`, `digit=1`, `length=8`. Also see [Supported Access Configurations](https://jfrog.com/help/r/jfrog-installation-setup-documentation/supported-access-configurations) for more details
        :param pulumi.Input[builtins.bool] profile_updatable: (Optional, Default: true) When enabled, this user can update their profile details (except for the password. Only an administrator can update the password). There may be cases in which you want to leave this unset to prevent users from updating their profile. For example, a departmental user with a single password shared between all department members.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            password_policy: Optional[pulumi.Input[Union['ManagedUserPasswordPolicyArgs', 'ManagedUserPasswordPolicyArgsDict']]] = None,
            profile_updatable: Optional[pulumi.Input[builtins.bool]] = None) -> 'ManagedUser':
        """
    ...
    @property
    @pulumi.getter(name="disableUiAccess")
    def disable_ui_access(self) -> pulumi.Output[builtins.bool]:
        """
        (Optional, Default: true) When enabled, this user can only access the system through the REST API. This option cannot be set if the user has Admin privileges.
        """
        return pulumi.get(self, "disable_ui_access")
    ...
    @property
    @pulumi.getter(name="internalPasswordDisabled")
    def internal_password_disabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Optional, Default: false) When enabled, disables the fallback mechanism for using an internal password when external authentication (such as LDAP) is enabled.
        """
        return pulumi.get(self, "internal_password_disabled")
    ...
    @property
    @pulumi.getter(name="passwordPolicy")
    def password_policy(self) -> pulumi.Output[Optional['outputs.ManagedUserPasswordPolicy']]:
        """
        Password policy to match JFrog Access to provide pre-apply validation. Default values: `uppercase=1`, `lowercase=1`, `special_char=0`, `digit=1`, `length=8`. Also see [Supported Access Configurations](https://jfrog.com/help/r/jfrog-installation-setup-documentation/supported-access-configurations) for more details
        """
        return pulumi.get(self, "password_policy")
    ...
    @property
    @pulumi.getter(name="profileUpdatable")
    def profile_updatable(self) -> pulumi.Output[builtins.bool]:
        """
        (Optional, Default: true) When enabled, this user can update their profile details (except for the password. Only an administrator can update the password). There may be cases in which you want to leave this unset to prevent users from updating their profile. For example, a departmental user with a single password shared between all department members.
        """
        return pulumi.get(self, "profile_updatable")
