...
class ManagedUserArgs:
    def __init__(__self__, *,
                 ...
                 password_policy: pulumi.Input[Optional['ManagedUserPasswordPolicyArgs']] = None,
    ...
    def password_policy(self) -> pulumi.Input[Optional['ManagedUserPasswordPolicyArgs']]:
        """
    ...
    def password_policy(self, value: pulumi.Input[Optional['ManagedUserPasswordPolicyArgs']]):
...
class ManagedUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 password: pulumi.Input[Optional[_builtins.str]] = None,
                 password_policy: pulumi.Input[Optional[Union['ManagedUserPasswordPolicyArgs', 'ManagedUserPasswordPolicyArgsDict', 'outputs.ManagedUserPasswordPolicy']]] = None,
                 profile_updatable: pulumi.Input[Optional[_builtins.bool]] = None,
                 __props__=None):
        """
        ...
        Unlike `UnmanagedUser` and `User`, the `password` attribute is required and cannot be empty. Consider using a separate provider to generate and manage passwords.
        ...
        ->Due to Terraform limitation with interpolated value, we can only validate interpolated value prior to making API requests. This means `terraform validate` or `pulumi preview` will not return error if `password` does not meet `password_policy` criteria.
        ...
        :param pulumi.Input[_builtins.str] name: Username for user. May contain lowercase letters, numbers and symbols: '.-_@' for self-hosted. For SaaS, '+' is also allowed.
        :param pulumi.Input[_builtins.str] password: Password for the user.
        :param pulumi.Input[Union['ManagedUserPasswordPolicyArgs', 'ManagedUserPasswordPolicyArgsDict', 'outputs.ManagedUserPasswordPolicy']] password_policy: Password policy to match JFrog Access to provide pre-apply validation. Default values: `uppercase=1`, `lowercase=1`, `special_char=0`, `digit=1`, `length=8`. Also see [Supported Access Configurations](https://jfrog.com/help/r/jfrog-installation-setup-documentation/supported-access-configurations) for more details
        :param pulumi.Input[_builtins.bool] profile_updatable: (Optional, Default: true) When enabled, this user can update their profile details (except for the password. Only an administrator can update the password). There may be cases in which you want to leave this unset to prevent users from updating their profile. For example, a departmental user with a single password shared between all department members.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            password: pulumi.Input[Optional[_builtins.str]] = None,
            password_policy: pulumi.Input[Optional[Union['ManagedUserPasswordPolicyArgs', 'ManagedUserPasswordPolicyArgsDict', 'outputs.ManagedUserPasswordPolicy']]] = None,
            profile_updatable: pulumi.Input[Optional[_builtins.bool]] = None) -> 'ManagedUser':
        """
