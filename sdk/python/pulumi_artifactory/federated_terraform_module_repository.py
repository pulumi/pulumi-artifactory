...
class FederatedTerraformModuleRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FederatedTerraformModuleRepositoryMemberArgs']]] members: The list of Federated members. If a Federated member receives a request that does not include the repository URL, it
...
class FederatedTerraformModuleRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FederatedTerraformModuleRepository resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] key: A mandatory identifier for the repository that must be unique. Must be 3 - 10 lowercase alphanumeric and hyphen
               characters. It cannot begin with a number or contain spaces or special characters.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FederatedTerraformModuleRepositoryMemberArgs']]]] members: The list of Federated members. If a Federated member receives a request that does not include the repository URL, it
               will automatically be added with the combination of the configured base URL and `key` field value. Note that each of the
               federated members will need to have a base URL set. Please follow the
               [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
