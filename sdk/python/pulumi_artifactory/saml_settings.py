...
class SamlSettingsArgs:
    def __init__(__self__, *,
                 ...
                 no_auto_user_creation: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_groups: Optional[pulumi.Input[builtins.bool]] = None,
                 use_encrypted_assertion: Optional[pulumi.Input[builtins.bool]] = None,
                 verify_audience_restriction: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SamlSettings resource.
        :param pulumi.Input[builtins.str] login_url: Service provider login url configured on the IdP.
        :param pulumi.Input[builtins.str] logout_url: Service provider logout url, or where to redirect after user logs out.
        :param pulumi.Input[builtins.str] service_provider_name: The SAML service provider name. This should be a URI that is also known as the entityID, providerID, or entity identity.
        :param pulumi.Input[builtins.bool] allow_user_to_access_profile: Allow persisted users to access their profile.  Default value is `true`.
        :param pulumi.Input[builtins.bool] auto_redirect: Auto redirect to login through the IdP when clicking on Artifactory's login link.  Default value is `false`.
        :param pulumi.Input[builtins.str] certificate: SAML certificate that contains the public key for the IdP service provider.  Used by Artifactory to verify sign-in requests. Default value is ``.
        :param pulumi.Input[builtins.str] email_attribute: Name of the attribute in the SAML response from the IdP that contains the user's email. Default value is ``.
        :param pulumi.Input[builtins.bool] enable: Enable SAML SSO.  Default value is `true`.
        :param pulumi.Input[builtins.str] group_attribute: Name of the attribute in the SAML response from the IdP that contains the user's group memberships. Default value is ``.
        :param pulumi.Input[builtins.bool] no_auto_user_creation: When automatic user creation is off, authenticated users are not automatically created inside Artifactory. Instead, for every request from an SSO user, the user is temporarily associated with default groups (if such groups are defined), and the permissions for these groups apply. Without auto-user creation, you must manually create the user inside Artifactory to manage user permissions not attached to their default groups. Default value is `false`.
        :param pulumi.Input[builtins.bool] sync_groups: Associate user with Artifactory groups based on the `group_attribute` provided in the SAML response from the identity provider.  Default value is `false`.
        :param pulumi.Input[builtins.bool] use_encrypted_assertion: When set, an X.509 public certificate will be created by Artifactory. Download this certificate and upload it to your IDP and choose your own encryption algorithm. This process will let you encrypt the assertion section in your SAML response. Default value is `false`.
        :param pulumi.Input[builtins.bool] verify_audience_restriction: Enable "audience", or who the SAML assertion is intended for.  Ensures that the correct service provider intended for Artifactory is used on the IdP.  Default value is `true`.
        """
    ...
    def logout_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @logout_url.setter
    def logout_url(self, value: pulumi.Input[builtins.str]):
    ...
    def auto_redirect(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_redirect(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def no_auto_user_creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When automatic user creation is off, authenticated users are not automatically created inside Artifactory. Instead, for every request from an SSO user, the user is temporarily associated with default groups (if such groups are defined), and the permissions for these groups apply. Without auto-user creation, you must manually create the user inside Artifactory to manage user permissions not attached to their default groups. Default value is `false`.
        """
    ...
    def no_auto_user_creation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_encrypted_assertion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_encrypted_assertion(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_encrypted_assertion", value)

    @property
    @pulumi.getter(name="verifyAudienceRestriction")
    def verify_audience_restriction(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def verify_audience_restriction(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SamlSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sync_groups: Optional[pulumi.Input[builtins.bool]] = None,
            use_encrypted_assertion: Optional[pulumi.Input[builtins.bool]] = None,
            verify_audience_restriction: Optional[pulumi.Input[builtins.bool]] = None) -> 'SamlSettings':
        """
    ...
    @property
    @pulumi.getter(name="autoRedirect")
    def auto_redirect(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Auto redirect to login through the IdP when clicking on Artifactory's login link.  Default value is `false`.
        """
        return pulumi.get(self, "auto_redirect")
    ...
    @property
    @pulumi.getter(name="groupAttribute")
    def group_attribute(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the attribute in the SAML response from the IdP that contains the user's group memberships. Default value is ``.
        """
        return pulumi.get(self, "group_attribute")
    ...
    @property
    @pulumi.getter(name="noAutoUserCreation")
    def no_auto_user_creation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When automatic user creation is off, authenticated users are not automatically created inside Artifactory. Instead, for every request from an SSO user, the user is temporarily associated with default groups (if such groups are defined), and the permissions for these groups apply. Without auto-user creation, you must manually create the user inside Artifactory to manage user permissions not attached to their default groups. Default value is `false`.
        """
        return pulumi.get(self, "no_auto_user_creation")
    ...
    @property
    @pulumi.getter(name="useEncryptedAssertion")
    def use_encrypted_assertion(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set, an X.509 public certificate will be created by Artifactory. Download this certificate and upload it to your IDP and choose your own encryption algorithm. This process will let you encrypt the assertion section in your SAML response. Default value is `false`.
        """
        return pulumi.get(self, "use_encrypted_assertion")
    ...
    @property
    @pulumi.getter(name="verifyAudienceRestriction")
    def verify_audience_restriction(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable "audience", or who the SAML assertion is intended for.  Ensures that the correct service provider intended for Artifactory is used on the IdP.  Default value is `true`.
        """
        return pulumi.get(self, "verify_audience_restriction")
