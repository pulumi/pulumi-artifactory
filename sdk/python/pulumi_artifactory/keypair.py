...
class KeypairArgs:
    def __init__(__self__, *,
                 ...
                 pair_name: pulumi.Input[builtins.str],
                 pair_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] alias: Will be used as a filename when retrieving the public key via REST API.
        :param pulumi.Input[builtins.str] pair_name: A unique identifier for the Key Pair record.
        :param pulumi.Input[builtins.str] pair_type: Key Pair type. Supported types - GPG and RSA.
        :param pulumi.Input[builtins.str] private_key: Private key. PEM format will be validated. Must not include extranous spaces or tabs.
        :param pulumi.Input[builtins.str] public_key: Public key. PEM format will be validated. Must not include extranous spaces or tabs.
        ...
        :param pulumi.Input[builtins.str] passphrase: Passphrase will be used to decrypt the private key. Validated server side.
        """
    ...
    def pair_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @pair_name.setter
    def pair_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pair_name", value)

    @property
    @pulumi.getter(name="pairType")
    def pair_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @pair_type.setter
    def pair_type(self, value: pulumi.Input[builtins.str]):
...
class _KeypairState:
    def __init__(__self__, *,
                 ...
                 pair_type: Optional[pulumi.Input[builtins.str]] = None,
                 passphrase: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="pairType")
    def pair_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Key Pair type. Supported types - GPG and RSA.
        """
        return pulumi.get(self, "pair_type")
    ...
    @pair_type.setter
    def pair_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pair_type", value)
...
class Keypair(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="pairType")
    def pair_type(self) -> pulumi.Output[builtins.str]:
        """
        Key Pair type. Supported types - GPG and RSA.
        """
        return pulumi.get(self, "pair_type")
