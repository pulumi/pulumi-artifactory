...
__all__ = [
    ...
    'AwaitableGetRemoteHelmociRepositoryResult',
    'get_remote_helmoci_repository',
    'get_remote_helmoci_repository_output',
]

@pulumi.output_type
class GetRemoteHelmociRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteHelmociRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteHelmociRepositoryResult(GetRemoteHelmociRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteHelmociRepositoryResult(
...
def get_remote_helmoci_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                                  ...
                                  content_synchronisation: Optional[Union['GetRemoteHelmociRepositoryContentSynchronisationArgs', 'GetRemoteHelmociRepositoryContentSynchronisationArgsDict']] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteHelmociRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteHelmociRepository:getRemoteHelmociRepository', __args__, opts=opts, typ=GetRemoteHelmociRepositoryResult).value

    return AwaitableGetRemoteHelmociRepositoryResult(
...
def get_remote_helmoci_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         ...
                                         content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteHelmociRepositoryContentSynchronisationArgs', 'GetRemoteHelmociRepositoryContentSynchronisationArgsDict']]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteHelmociRepositoryResult]:
    """
    Retrieves a remote Helm OCI repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteHelmociRepository:getRemoteHelmociRepository', __args__, opts=opts, typ=GetRemoteHelmociRepositoryResult)
