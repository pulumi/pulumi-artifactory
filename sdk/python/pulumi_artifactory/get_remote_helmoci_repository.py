...
def get_remote_helmoci_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
...
def get_remote_helmoci_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
