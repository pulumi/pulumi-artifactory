...
class VirtualRpmRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        primary_keypair = artifactory.index.keypair.Keypair("primary-keypair",
        ...
        secondary_keypair = artifactory.index.keypair.Keypair("secondary-keypair",
            pair_name=secondary-keypair,
            pair_type=GPG,
            alias=foo-alias-2,
            private_key=(lambda path: open(path).read())(samples/gpg.priv),
            public_key=(lambda path: open(path).read())(samples/gpg.pub))
        foo_rpm_virtual = artifactory.index.virtual_rpm_repository.VirtualRpmRepository("foo-rpm-virtual",
            key=foo-rpm-virtual,
