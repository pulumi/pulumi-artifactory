...
class ReleaseBundleV2PromotionArgs:
    def __init__(__self__, *,
                 ...
                 keypair_name: pulumi.Input[builtins.str],
                 version: pulumi.Input[builtins.str],
                 excluded_repository_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_repository_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] environment: Target environment
        :param pulumi.Input[builtins.str] keypair_name: Key-pair name to use for signature creation
        :param pulumi.Input[builtins.str] version: Version to promote
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_repository_keys: Defines specific repositories to exclude from the promotion.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_repository_keys: Defines specific repositories to include in the promotion. If this property is left undefined, all repositories (except those specifically excluded) are included in the promotion. Important: If one or more repositories are specifically included, all other repositories are excluded (regardless of what is defined in `excluded_repository_keys`).
        :param pulumi.Input[builtins.str] name: Name of Release Bundle
        :param pulumi.Input[builtins.str] project_key: Project key the Release Bundle belongs to
        """
    ...
    def keypair_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @keypair_name.setter
    def keypair_name(self, value: pulumi.Input[builtins.str]):
    ...
    def excluded_repository_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def excluded_repository_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_repository_keys", value)

    @property
    @pulumi.getter(name="includedRepositoryKeys")
    def included_repository_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Defines specific repositories to include in the promotion. If this property is left undefined, all repositories (except those specifically excluded) are included in the promotion. Important: If one or more repositories are specifically included, all other repositories are excluded (regardless of what is defined in `excluded_repository_keys`).
        """
    ...
    def included_repository_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ReleaseBundleV2PromotionState:
    def __init__(__self__, *,
                 ...
                 created_millis: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] created: Timestamp when the new version was created (ISO 8601 standard).
        :param pulumi.Input[builtins.int] created_millis: Timestamp when the new version was created (in milliseconds).
        :param pulumi.Input[builtins.str] environment: Target environment
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_repository_keys: Defines specific repositories to exclude from the promotion.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_repository_keys: Defines specific repositories to include in the promotion. If this property is left undefined, all repositories (except those specifically excluded) are included in the promotion. Important: If one or more repositories are specifically included, all other repositories are excluded (regardless of what is defined in `excluded_repository_keys`).
        :param pulumi.Input[builtins.str] keypair_name: Key-pair name to use for signature creation
    ...
    def created_millis(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def created_millis(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ReleaseBundleV2Promotion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            project_key: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'ReleaseBundleV2Promotion':
        """
    ...
    @property
    @pulumi.getter(name="createdMillis")
    def created_millis(self) -> pulumi.Output[builtins.int]:
        """
        Timestamp when the new version was created (in milliseconds).
        """
        return pulumi.get(self, "created_millis")
    ...
    @property
    @pulumi.getter(name="excludedRepositoryKeys")
    def excluded_repository_keys(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Defines specific repositories to exclude from the promotion.
        """
        return pulumi.get(self, "excluded_repository_keys")
    ...
    @property
    @pulumi.getter(name="includedRepositoryKeys")
    def included_repository_keys(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Defines specific repositories to include in the promotion. If this property is left undefined, all repositories (except those specifically excluded) are included in the promotion. Important: If one or more repositories are specifically included, all other repositories are excluded (regardless of what is defined in `excluded_repository_keys`).
        """
        return pulumi.get(self, "included_repository_keys")
    ...
    @property
    @pulumi.getter(name="keypairName")
    def keypair_name(self) -> pulumi.Output[builtins.str]:
        """
        Key-pair name to use for signature creation
        """
        return pulumi.get(self, "keypair_name")
