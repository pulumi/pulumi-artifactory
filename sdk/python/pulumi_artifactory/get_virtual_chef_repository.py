...
__all__ = [
    'GetVirtualChefRepositoryResult',
    'AwaitableGetVirtualChefRepositoryResult',
    'get_virtual_chef_repository',
    'get_virtual_chef_repository_output',
]

@pulumi.output_type
class GetVirtualChefRepositoryResult:
    """
...
class AwaitableGetVirtualChefRepositoryResult(GetVirtualChefRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualChefRepositoryResult(
...
def get_virtual_chef_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualChefRepository:getVirtualChefRepository', __args__, opts=opts, typ=GetVirtualChefRepositoryResult).value

    return AwaitableGetVirtualChefRepositoryResult(
...
def get_virtual_chef_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
