...
__all__ = [
    'GetFederatedSwiftRepositoryResult',
    'AwaitableGetFederatedSwiftRepositoryResult',
    'get_federated_swift_repository',
    'get_federated_swift_repository_output',
]

@pulumi.output_type
class GetFederatedSwiftRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedSwiftRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedSwiftRepositoryResult(GetFederatedSwiftRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedSwiftRepositoryResult(
...
def get_federated_swift_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                   ...
                                   members: Optional[Sequence[Union['GetFederatedSwiftRepositoryMemberArgs', 'GetFederatedSwiftRepositoryMemberArgsDict', 'outputs.GetFederatedSwiftRepositoryMemberResult']]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedSwiftRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedSwiftRepositoryMemberArgs', 'GetFederatedSwiftRepositoryMemberArgsDict', 'outputs.GetFederatedSwiftRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedSwiftRepository:getFederatedSwiftRepository', __args__, opts=opts, typ=GetFederatedSwiftRepositoryResult).value

    return AwaitableGetFederatedSwiftRepositoryResult(
...
def get_federated_swift_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                          ...
                                          members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedSwiftRepositoryMemberArgs', 'GetFederatedSwiftRepositoryMemberArgsDict', 'outputs.GetFederatedSwiftRepositoryMemberResult']]]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedSwiftRepositoryResult]:
    """
    Retrieves a federated Swift repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedSwiftRepository:getFederatedSwiftRepository', __args__, opts=opts, typ=GetFederatedSwiftRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedSwiftRepositoryResult(
