...
class PropertySetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Property set name.
        ...
        :param pulumi.Input[builtins.bool] visible: Defines if the list visible and assignable to the repository or artifact. Default value is `true`.
        """
        if name is not None:
...
class PropertySet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            properties: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PropertySetPropertyArgs', 'PropertySetPropertyArgsDict']]]]] = None,
            visible: Optional[pulumi.Input[builtins.bool]] = None) -> 'PropertySet':
        """
