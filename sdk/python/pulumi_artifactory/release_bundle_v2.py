...
class ReleaseBundleV2Args:
    def __init__(__self__, *,
                 ...
                 skip_docker_manifest_resolution: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] source_type: Source type. Valid values: `aql`, `artifacts`, `builds`, `release_bundles`
        ...
        :param pulumi.Input[builtins.bool] skip_docker_manifest_resolution: Determines whether to skip the resolution of the Docker manifest, which adds the image layers to the Release Bundle. The default value is `false` (the manifest is resolved and image layers are included).
        """
    ...
    def skip_docker_manifest_resolution(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_docker_manifest_resolution(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ReleaseBundleV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_by: The user who created the Release Bundle.
        :param pulumi.Input[builtins.str] keypair_name: Key-pair name to use for signature creation
        :param pulumi.Input[builtins.str] name: Name of Release Bundle
        :param pulumi.Input[builtins.str] project_key: Project key the Release Bundle belongs to
        :param pulumi.Input[builtins.str] service_id: The unique identifier of the Artifactory instance where the Release Bundle was created.
        :param pulumi.Input[builtins.bool] skip_docker_manifest_resolution: Determines whether to skip the resolution of the Docker manifest, which adds the image layers to the Release Bundle. The default value is `false` (the manifest is resolved and image layers are included).
        :param pulumi.Input['ReleaseBundleV2SourceArgs'] source: Defines specific repositories to include in the promotion. If this property is left undefined, all repositories (except those specifically excluded) are included in the promotion. Important: If one or more repositories are specifically included, all other repositories are excluded (regardless of what is defined in `excluded_repository_keys`).
        :param pulumi.Input[builtins.str] source_type: Source type. Valid values: `aql`, `artifacts`, `builds`, `release_bundles`
        :param pulumi.Input[builtins.str] version: Version to promote
...
class ReleaseBundleV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[Union['ReleaseBundleV2SourceArgs', 'ReleaseBundleV2SourceArgsDict']]] = None,
            source_type: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'ReleaseBundleV2':
        """
    ...
    @property
    @pulumi.getter(name="skipDockerManifestResolution")
    def skip_docker_manifest_resolution(self) -> pulumi.Output[builtins.bool]:
        """
        Determines whether to skip the resolution of the Docker manifest, which adds the image layers to the Release Bundle. The default value is `false` (the manifest is resolved and image layers are included).
        """
        return pulumi.get(self, "skip_docker_manifest_resolution")
