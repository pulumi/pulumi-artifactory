...
__all__ = [
    'GetLocalConanRepositoryResult',
    'AwaitableGetLocalConanRepositoryResult',
    'get_local_conan_repository',
    'get_local_conan_repository_output',
]

@pulumi.output_type
class GetLocalConanRepositoryResult:
    """
...
class AwaitableGetLocalConanRepositoryResult(GetLocalConanRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalConanRepositoryResult(
...
def get_local_conan_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool force_conan_authentication: Force basic authentication credentials in order to use this repository.
           Default is `false`.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalConanRepository:getLocalConanRepository', __args__, opts=opts, typ=GetLocalConanRepositoryResult).value

    return AwaitableGetLocalConanRepositoryResult(
...
def get_local_conan_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalConanRepositoryResult]:
    """
    Retrieves a local conan repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalConanRepository:getLocalConanRepository', __args__, opts=opts, typ=GetLocalConanRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalConanRepositoryResult(
