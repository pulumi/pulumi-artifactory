...
class AwaitableGetRemoteBazelRepositoryResult(GetRemoteBazelRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteBazelRepositoryResult(
...
def get_remote_bazel_repository(key: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteBazelRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteBazelRepository:getRemoteBazelRepository', __args__, opts=opts, typ=GetRemoteBazelRepositoryResult).value

    return AwaitableGetRemoteBazelRepositoryResult(
...
def get_remote_bazel_repository_output(key: pulumi.Input[Optional[_builtins.str]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteBazelRepositoryResult]:
    """
    Retrieves configuration for a remote Bazel Modules repository. See [Bazel Modules Repositories](https://docs.jfrog.com/artifactory/docs/bazel-modules-repositories).
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteBazelRepository:getRemoteBazelRepository', __args__, opts=opts, typ=GetRemoteBazelRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteBazelRepositoryResult(
