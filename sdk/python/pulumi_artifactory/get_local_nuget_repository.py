...
__all__ = [
    'GetLocalNugetRepositoryResult',
    'AwaitableGetLocalNugetRepositoryResult',
    'get_local_nuget_repository',
    'get_local_nuget_repository_output',
]

@pulumi.output_type
class GetLocalNugetRepositoryResult:
    """
    A collection of values returned by getLocalNugetRepository.
    """
    def __init__(__self__, archive_browsing_enabled=None, blacked_out=None, cdn_redirect=None, description=None, download_direct=None, excludes_pattern=None, force_nuget_authentication=None, id=None, includes_pattern=None, key=None, max_unique_snapshots=None, notes=None, package_type=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, repo_layout_ref=None, xray_index=None):
...
class AwaitableGetLocalNugetRepositoryResult(GetLocalNugetRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalNugetRepositoryResult(
...
def get_local_nuget_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool force_nuget_authentication: Force basic authentication credentials in order to use this repository.
           Default is `false`.
    :param _builtins.str key: the identity key of the repo.
    :param _builtins.int max_unique_snapshots: The maximum number of unique snapshots of a single artifact to store Once the
           number of snapshots exceeds this setting, older versions are removed A value of 0 (default) indicates there is no
           limit, and unique snapshots are not cleaned up.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalNugetRepository:getLocalNugetRepository', __args__, opts=opts, typ=GetLocalNugetRepositoryResult).value

    return AwaitableGetLocalNugetRepositoryResult(
...
def get_local_nuget_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalNugetRepositoryResult]:
    """
    Retrieves a local Nuget repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalNugetRepository:getLocalNugetRepository', __args__, opts=opts, typ=GetLocalNugetRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalNugetRepositoryResult(
