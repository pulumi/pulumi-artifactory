...
def get_local_nuget_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.bool force_nuget_authentication: Force basic authentication credentials in order to use this repository.
           Default is `false`.
    :param builtins.str key: the identity key of the repo.
    :param builtins.int max_unique_snapshots: The maximum number of unique snapshots of a single artifact to store Once the
           number of snapshots exceeds this setting, older versions are removed A value of 0 (default) indicates there is no
           limit, and unique snapshots are not cleaned up.
    """
    __args__ = dict()
...
def get_local_nuget_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
