...
class FederatedAlpineRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 index_compression_formats: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] primary_keypair_ref: Used to sign index files in Alpine Linux repositories. See: https://www.jfrog.com/confluence/display/JFROG/Alpine+Linux+Repositories#AlpineLinuxRepositories-SigningAlpineLinuxIndex
    ...
    def index_compression_formats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        return pulumi.get(self, "index_compression_formats")

    @index_compression_formats.setter
    def index_compression_formats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class FederatedAlpineRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            proxy: Optional[pulumi.Input[_builtins.str]] = None,
            repo_layout_ref: Optional[pulumi.Input[_builtins.str]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'FederatedAlpineRepository':
        """
