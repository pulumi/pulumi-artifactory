...
def get_repositories(package_type: Optional[builtins.str] = None,
    ...
    :param builtins.str project_key: Filter for repositories assigned to a specific project.
    :param builtins.str repository_type: Filter for repositories of a specific type. Allowed values are: local, remote, virtual, federated, distribution
    """
    __args__ = dict()
...
def get_repositories_output(package_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            project_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            repository_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
