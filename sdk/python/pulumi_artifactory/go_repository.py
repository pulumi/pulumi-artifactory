...
class GoRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] external_dependencies_enabled: Shorthand for "Enable 'go-import' Meta Tags" on the UI. This must be set to true in order to use the allow list. 
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_dependencies_patterns: 'go-import' Allow List on the UI.
...
@pulumi.type_token("artifactory:index/goRepository:GoRepository")
class GoRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_key: Optional[pulumi.Input[builtins.str]] = None,
            repo_layout_ref: Optional[pulumi.Input[builtins.str]] = None,
            repositories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'GoRepository':
        """
