...
__all__ = [
    ...
    'AwaitableGetFederatedCocoapodsRepositoryResult',
    'get_federated_cocoapods_repository',
    'get_federated_cocoapods_repository_output',
]

@pulumi.output_type
class GetFederatedCocoapodsRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedCocoapodsRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedCocoapodsRepositoryResult(GetFederatedCocoapodsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedCocoapodsRepositoryResult(
...
def get_federated_cocoapods_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                       ...
                                       members: Optional[Sequence[Union['GetFederatedCocoapodsRepositoryMemberArgs', 'GetFederatedCocoapodsRepositoryMemberArgsDict', 'outputs.GetFederatedCocoapodsRepositoryMemberResult']]] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedCocoapodsRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedCocoapodsRepositoryMemberArgs', 'GetFederatedCocoapodsRepositoryMemberArgsDict', 'outputs.GetFederatedCocoapodsRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedCocoapodsRepository:getFederatedCocoapodsRepository', __args__, opts=opts, typ=GetFederatedCocoapodsRepositoryResult).value

    return AwaitableGetFederatedCocoapodsRepositoryResult(
...
def get_federated_cocoapods_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                              ...
                                              members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedCocoapodsRepositoryMemberArgs', 'GetFederatedCocoapodsRepositoryMemberArgsDict', 'outputs.GetFederatedCocoapodsRepositoryMemberResult']]]]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedCocoapodsRepositoryResult]:
    """
    Retrieves a federated Cocoapods repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedCocoapodsRepository:getFederatedCocoapodsRepository', __args__, opts=opts, typ=GetFederatedCocoapodsRepositoryResult)
