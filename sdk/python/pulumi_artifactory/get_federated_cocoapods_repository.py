...
def get_federated_cocoapods_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                       ...
                                       members: Optional[Sequence[Union['GetFederatedCocoapodsRepositoryMemberArgs', 'GetFederatedCocoapodsRepositoryMemberArgsDict']]] = None,
    ...
    :param Sequence[Union['GetFederatedCocoapodsRepositoryMemberArgs', 'GetFederatedCocoapodsRepositoryMemberArgsDict']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
...
def get_federated_cocoapods_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                              ...
                                              members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedCocoapodsRepositoryMemberArgs', 'GetFederatedCocoapodsRepositoryMemberArgsDict']]]]] = None,
