...
def get_federated_cocoapods_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
...
def get_federated_cocoapods_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
