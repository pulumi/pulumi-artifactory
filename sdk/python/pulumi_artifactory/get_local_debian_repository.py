...
def get_local_debian_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] index_compression_formats: The options are Bzip2 (.bz2 extension) (default), LZMA (.lzma extension)
           and XZ (.xz extension).
    :param _builtins.str key: the identity key of the repo.
    :param _builtins.str primary_keypair_ref: The primary RSA key to be used to sign packages.
    :param _builtins.str secondary_keypair_ref: The secondary RSA key to be used to sign packages.
    :param _builtins.bool trivial_layout: When set, the repository will use the deprecated trivial layout.
    """
    __args__ = dict()
...
def get_local_debian_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
