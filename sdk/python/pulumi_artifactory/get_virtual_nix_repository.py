...
__all__ = [
    'GetVirtualNixRepositoryResult',
    'AwaitableGetVirtualNixRepositoryResult',
    'get_virtual_nix_repository',
    'get_virtual_nix_repository_output',
]

@pulumi.output_type
class GetVirtualNixRepositoryResult:
    """
...
class AwaitableGetVirtualNixRepositoryResult(GetVirtualNixRepositoryResult):
...
def get_virtual_nix_repository(key: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualNixRepositoryResult:
    """
    ...
    example = artifactory.get_virtual_nix_repository(key="my-nix-virtual")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualNixRepository:getVirtualNixRepository', __args__, opts=opts, typ=GetVirtualNixRepositoryResult).value
...
def get_virtual_nix_repository_output(key: pulumi.Input[Optional[_builtins.str]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualNixRepositoryResult]:
    """
    Retrieves configuration for a virtual Nix repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualNixRepository:getVirtualNixRepository', __args__, opts=opts, typ=GetVirtualNixRepositoryResult)
