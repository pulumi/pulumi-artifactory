...
class GetUserResult:
    ...
    def disable_ui_access(self) -> Optional[_builtins.bool]:
        """
    ...
    def internal_password_disabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def profile_updatable(self) -> Optional[_builtins.bool]:
        """
...
def get_user(admin: Optional[_builtins.bool] = None,
             disable_ui_access: Optional[_builtins.bool] = None,
             email: Optional[_builtins.str] = None,
             groups: Optional[Sequence[_builtins.str]] = None,
             internal_password_disabled: Optional[_builtins.bool] = None,
             name: Optional[_builtins.str] = None,
             profile_updatable: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool admin: When enabled, this user is an administrator with all the ensuing privileges. Default value is `false`.
    :param _builtins.bool disable_ui_access: When set, this user can only access Artifactory through the REST API. This option cannot be set if the user has Admin privileges. Default value is `true`.
    :param _builtins.str email: Email for user.
    :param Sequence[_builtins.str] groups: List of groups this user is a part of.
    :param _builtins.bool internal_password_disabled: When set, disables the fallback of using an internal password when external authentication (such as LDAP) is enabled.
    :param _builtins.str name: Name of the user.
    :param _builtins.bool profile_updatable: When set, this user can update his profile details (except for the password. Only an administrator can update the password). Default value is `true`.
    """
    __args__ = dict()
