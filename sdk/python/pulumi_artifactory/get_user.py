...
class GetUserResult:
    ...
    def disable_ui_access(self) -> Optional[builtins.bool]:
        """
    ...
    def internal_password_disabled(self) -> Optional[builtins.bool]:
        """
    ...
    def profile_updatable(self) -> Optional[builtins.bool]:
        """
...
def get_user(admin: Optional[builtins.bool] = None,
             disable_ui_access: Optional[builtins.bool] = None,
             email: Optional[builtins.str] = None,
             groups: Optional[Sequence[builtins.str]] = None,
             internal_password_disabled: Optional[builtins.bool] = None,
             name: Optional[builtins.str] = None,
             profile_updatable: Optional[builtins.bool] = None,
    ...
    :param builtins.bool admin: When enabled, this user is an administrator with all the ensuing privileges. Default value is `false`.
    :param builtins.bool disable_ui_access: When set, this user can only access Artifactory through the REST API. This option cannot be set if the user has Admin privileges. Default value is `true`.
    :param builtins.str email: Email for user.
    :param Sequence[builtins.str] groups: List of groups this user is a part of.
    :param builtins.bool internal_password_disabled: When set, disables the fallback of using an internal password when external authentication (such as LDAP) is enabled.
    :param builtins.str name: Name of the user.
    :param builtins.bool profile_updatable: When set, this user can update his profile details (except for the password. Only an administrator can update the password). Default value is `true`.
    """
    __args__ = dict()
...
def get_user_output(admin: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    disable_ui_access: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    email: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    groups: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                    internal_password_disabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                    name: Optional[pulumi.Input[builtins.str]] = None,
                    profile_updatable: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
