...
class GetFederatedGradleRepositoryResult:
    ...
    def checksum_policy_type(self) -> Optional[builtins.str]:
        return pulumi.get(self, "checksum_policy_type")

    @property
    @pulumi.getter(name="cleanupOnDelete")
    def cleanup_on_delete(self) -> Optional[builtins.bool]:
    ...
    def snapshot_version_behavior(self) -> Optional[builtins.str]:
...
def get_federated_gradle_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
                                    blacked_out: Optional[builtins.bool] = None,
                                    cdn_redirect: Optional[builtins.bool] = None,
                                    checksum_policy_type: Optional[builtins.str] = None,
                                    cleanup_on_delete: Optional[builtins.bool] = None,
                                    ...
                                    snapshot_version_behavior: Optional[builtins.str] = None,
    ...
    :param builtins.bool disable_proxy: When set to `true`, the proxy is disabled, and not returned in the API response body. If there is a default proxy set for the Artifactory instance, it will be ignored, too.
    ...
    :param Sequence[Union['GetFederatedGradleRepositoryMemberArgs', 'GetFederatedGradleRepositoryMemberArgsDict']] members: The list of Federated members and must contain this repository URL (configured base URL
           ...
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    :param builtins.str proxy: Proxy key from Artifactory Proxies settings.
    """
    __args__ = dict()
...
def get_federated_gradle_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                           ...
                                           checksum_policy_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           cleanup_on_delete: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                           ...
                                           snapshot_version_behavior: Optional[pulumi.Input[Optional[builtins.str]]] = None,
