...
__all__ = [
    'GetFederatedGradleRepositoryResult',
    'AwaitableGetFederatedGradleRepositoryResult',
    'get_federated_gradle_repository',
    'get_federated_gradle_repository_output',
]

@pulumi.output_type
class GetFederatedGradleRepositoryResult:
    """
    ...
    def checksum_policy_type(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "checksum_policy_type")

    @_builtins.property
    @pulumi.getter(name="cleanupOnDelete")
    def cleanup_on_delete(self) -> Optional[_builtins.bool]:
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedGradleRepositoryMemberResult']]:
        """
    ...
    def snapshot_version_behavior(self) -> Optional[_builtins.str]:
...
class AwaitableGetFederatedGradleRepositoryResult(GetFederatedGradleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedGradleRepositoryResult(
...
def get_federated_gradle_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                    blacked_out: Optional[_builtins.bool] = None,
                                    cdn_redirect: Optional[_builtins.bool] = None,
                                    checksum_policy_type: Optional[_builtins.str] = None,
                                    cleanup_on_delete: Optional[_builtins.bool] = None,
                                    ...
                                    members: Optional[Sequence[Union['GetFederatedGradleRepositoryMemberArgs', 'GetFederatedGradleRepositoryMemberArgsDict', 'outputs.GetFederatedGradleRepositoryMemberResult']]] = None,
                                    ...
                                    snapshot_version_behavior: Optional[_builtins.str] = None,
                                    suppress_pom_consistency_checks: Optional[_builtins.bool] = None,
                                    xray_index: Optional[_builtins.bool] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedGradleRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedGradleRepositoryMemberArgs', 'GetFederatedGradleRepositoryMemberArgsDict', 'outputs.GetFederatedGradleRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    :param _builtins.str proxy: Proxy key from Artifactory Proxies settings.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedGradleRepository:getFederatedGradleRepository', __args__, opts=opts, typ=GetFederatedGradleRepositoryResult).value

    return AwaitableGetFederatedGradleRepositoryResult(
...
def get_federated_gradle_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                           ...
                                           checksum_policy_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           cleanup_on_delete: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                           ...
                                           members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedGradleRepositoryMemberArgs', 'GetFederatedGradleRepositoryMemberArgsDict', 'outputs.GetFederatedGradleRepositoryMemberResult']]]]] = None,
                                           ...
                                           snapshot_version_behavior: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedGradleRepositoryResult]:
    """
    Retrieves a federated Gradle repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedGradleRepository:getFederatedGradleRepository', __args__, opts=opts, typ=GetFederatedGradleRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedGradleRepositoryResult(
