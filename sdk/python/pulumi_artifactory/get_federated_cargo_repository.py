...
def get_federated_cargo_repository(anonymous_access: Optional[builtins.bool] = None,
...
def get_federated_cargo_repository_output(anonymous_access: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
