...
__all__ = [
    'GetFederatedHuggingfacemlRepositoryResult',
    'AwaitableGetFederatedHuggingfacemlRepositoryResult',
    'get_federated_huggingfaceml_repository',
    'get_federated_huggingfaceml_repository_output',
]

@pulumi.output_type
class GetFederatedHuggingfacemlRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedHuggingfacemlRepositoryMemberResult']]:
...
class AwaitableGetFederatedHuggingfacemlRepositoryResult(GetFederatedHuggingfacemlRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedHuggingfacemlRepositoryResult(
...
def get_federated_huggingfaceml_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                           ...
                                           members: Optional[Sequence[Union['GetFederatedHuggingfacemlRepositoryMemberArgs', 'GetFederatedHuggingfacemlRepositoryMemberArgsDict']]] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedHuggingfacemlRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedHuggingfacemlRepository:getFederatedHuggingfacemlRepository', __args__, opts=opts, typ=GetFederatedHuggingfacemlRepositoryResult).value

    return AwaitableGetFederatedHuggingfacemlRepositoryResult(
...
def get_federated_huggingfaceml_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                                  ...
                                                  members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedHuggingfacemlRepositoryMemberArgs', 'GetFederatedHuggingfacemlRepositoryMemberArgsDict']]]]] = None,
                                                  ...
                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedHuggingfacemlRepositoryResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedHuggingfacemlRepository:getFederatedHuggingfacemlRepository', __args__, opts=opts, typ=GetFederatedHuggingfacemlRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedHuggingfacemlRepositoryResult(
