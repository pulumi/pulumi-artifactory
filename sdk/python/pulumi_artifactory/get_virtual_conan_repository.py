...
class GetVirtualConanRepositoryResult:
    ...
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, default_deployment_repo=None, description=None, excludes_pattern=None, force_conan_authentication=None, hide_unauthorized_resources=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None, retrieval_cache_period_seconds=None):
...
def get_virtual_conan_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
...
def get_virtual_conan_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualConanRepositoryResult]:
    """
    Retrieves a virtual Conan repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualConanRepository:getVirtualConanRepository', __args__, opts=opts, typ=GetVirtualConanRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualConanRepositoryResult(
