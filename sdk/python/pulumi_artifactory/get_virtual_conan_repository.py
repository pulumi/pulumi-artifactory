...
def get_virtual_conan_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
    ...
    :param builtins.bool force_conan_authentication: Force basic authentication credentials in order to use this repository.
           Default is `false`.
...
def get_virtual_conan_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
