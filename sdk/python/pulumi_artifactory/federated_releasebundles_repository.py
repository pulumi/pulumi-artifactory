...
class _FederatedReleasebundlesRepositoryState:
    def __init__(__self__, *,
                 ...
                 members: Optional[pulumi.Input[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]] = None,
                 notes: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
class FederatedReleasebundlesRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 includes_pattern: Optional[pulumi.Input[_builtins.str]] = None,
                 key: Optional[pulumi.Input[_builtins.str]] = None,
                 members: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FederatedReleasebundlesRepositoryMemberArgs', 'FederatedReleasebundlesRepositoryMemberArgsDict']]]]] = None,
                 notes: Optional[pulumi.Input[_builtins.str]] = None,
                 priority_resolution: Optional[pulumi.Input[_builtins.bool]] = None,
                 project_environments: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_key: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        **Recommended Solution**: To avoid this manual step (especially with hundred of projects), use this resource to create the federated `releasebundles` repository before creating any release bundles in the project.
        ...
        :param pulumi.Input[_builtins.str] includes_pattern: List of comma-separated artifact patterns to include when evaluating artifact requests in the form of `x/y/**/z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`**/*`).
        :param pulumi.Input[_builtins.str] key: the identity key of the repo. Repository name for this package type myst chave following format: `<project_name>-release-bundles-v2`. Project myst exist before the repository was created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FederatedReleasebundlesRepositoryMemberArgs', 'FederatedReleasebundlesRepositoryMemberArgsDict']]]] members: The list of Federated members and must contain this repository URL (configured base URL
               `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
               Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
        :param pulumi.Input[_builtins.str] notes: Internal description.
    ...
    def get(resource_name: str,
            ...
            proxy: Optional[pulumi.Input[_builtins.str]] = None,
            repo_layout_ref: Optional[pulumi.Input[_builtins.str]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'FederatedReleasebundlesRepository':
        """
