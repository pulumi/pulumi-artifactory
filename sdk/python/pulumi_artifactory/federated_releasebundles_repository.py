...
__all__ = ['FederatedReleasebundlesRepositoryArgs', 'FederatedReleasebundlesRepository']

@pulumi.input_type
class FederatedReleasebundlesRepositoryArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[_builtins.str],
                 members: pulumi.Input[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]],
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]:
        """
    ...
    @members.setter
    def members(self, value: pulumi.Input[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]):
...
@pulumi.input_type
class _FederatedReleasebundlesRepositoryState:
    def __init__(__self__, *,
                 archive_browsing_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 blacked_out: pulumi.Input[Optional[_builtins.bool]] = None,
                 cdn_redirect: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 members: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedReleasebundlesRepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
@pulumi.type_token("artifactory:index/federatedReleasebundlesRepository:FederatedReleasebundlesRepository")
class FederatedReleasebundlesRepository(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 includes_pattern: pulumi.Input[Optional[_builtins.str]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FederatedReleasebundlesRepositoryMemberArgs', 'FederatedReleasebundlesRepositoryMemberArgsDict', 'outputs.FederatedReleasebundlesRepositoryMember']]]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
                 priority_resolution: pulumi.Input[Optional[_builtins.bool]] = None,
                 project_environments: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_key: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        **Recommended Solution**: To avoid this manual step (especially with hundred of projects), use this resource to create the federated `releasebundles` repository before creating any release bundles in the project.
        ...
        :param pulumi.Input[_builtins.str] includes_pattern: Comma-separated list of artifact patterns to include when evaluating artifact requests in the form of `x/y/**/z/*`. This is a single string of comma-separated values, not a list of strings. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`**/*`).
        :param pulumi.Input[_builtins.str] key: the identity key of the repo. Repository name for this package type myst chave following format: `<project_name>-release-bundles-v2`. Project myst exist before the repository was created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FederatedReleasebundlesRepositoryMemberArgs', 'FederatedReleasebundlesRepositoryMemberArgsDict', 'outputs.FederatedReleasebundlesRepositoryMember']]]] members: The list of Federated members and must contain this repository URL (configured base URL
               `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
               Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
        :param pulumi.Input[_builtins.str] notes: Internal description.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: FederatedReleasebundlesRepositoryArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a federated Release Bundles repository. This resource should be used only when you require release bundle federation and are using Artifactory Projects.
        It is not possible to create repository with this package type in the UI.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FederatedReleasebundlesRepositoryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FederatedReleasebundlesRepositoryArgs.__new__(FederatedReleasebundlesRepositoryArgs)
        ...
        super(FederatedReleasebundlesRepository, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            proxy: pulumi.Input[Optional[_builtins.str]] = None,
            repo_layout_ref: pulumi.Input[Optional[_builtins.str]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FederatedReleasebundlesRepository':
        """
        Get an existing FederatedReleasebundlesRepository resource's state with the given name, id, and optional extra
        ...
        __props__ = _FederatedReleasebundlesRepositoryState.__new__(_FederatedReleasebundlesRepositoryState)
        ...
        __props__.__dict__["repo_layout_ref"] = repo_layout_ref
        __props__.__dict__["xray_index"] = xray_index
        return FederatedReleasebundlesRepository(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Output[Sequence['outputs.FederatedReleasebundlesRepositoryMember']]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
