...
def get_local_helmoci_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.int max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository. Once the number tags for an image exceeds this setting, older tags are removed. A value of 0 (default) indicates there is no limit.
    :param builtins.int tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up number.
    """
    __args__ = dict()
...
def get_local_helmoci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
