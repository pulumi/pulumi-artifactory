...
__all__ = [
    ...
    'AwaitableGetLocalHelmociRepositoryResult',
    'get_local_helmoci_repository',
    'get_local_helmoci_repository_output',
]

@pulumi.output_type
class GetLocalHelmociRepositoryResult:
    """
...
class AwaitableGetLocalHelmociRepositoryResult(GetLocalHelmociRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalHelmociRepositoryResult(
...
def get_local_helmoci_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalHelmociRepositoryResult:
    """
    ...
    :param _builtins.int max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository. Once the number tags for an image exceeds this setting, older tags are removed. A value of 0 (default) indicates there is no limit.
    :param _builtins.int tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up number.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalHelmociRepository:getLocalHelmociRepository', __args__, opts=opts, typ=GetLocalHelmociRepositoryResult).value

    return AwaitableGetLocalHelmociRepositoryResult(
...
def get_local_helmoci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalHelmociRepositoryResult]:
    """
    Retrieves a local Helm OCI repository resource
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalHelmociRepository:getLocalHelmociRepository', __args__, opts=opts, typ=GetLocalHelmociRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalHelmociRepositoryResult(
