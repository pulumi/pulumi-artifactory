...
__all__ = [
    ...
    'AwaitableGetVirtualGitlfsRepositoryResult',
    'get_virtual_gitlfs_repository',
    'get_virtual_gitlfs_repository_output',
]

@pulumi.output_type
class GetVirtualGitlfsRepositoryResult:
    """
...
class AwaitableGetVirtualGitlfsRepositoryResult(GetVirtualGitlfsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualGitlfsRepositoryResult(
...
def get_virtual_gitlfs_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualGitlfsRepository:getVirtualGitlfsRepository', __args__, opts=opts, typ=GetVirtualGitlfsRepositoryResult).value

    return AwaitableGetVirtualGitlfsRepositoryResult(
...
def get_virtual_gitlfs_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualGitlfsRepositoryResult]:
    """
    Retrieves a virtual Git LFS repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualGitlfsRepository:getVirtualGitlfsRepository', __args__, opts=opts, typ=GetVirtualGitlfsRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualGitlfsRepositoryResult(
