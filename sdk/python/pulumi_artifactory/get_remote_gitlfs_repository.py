...
def get_remote_gitlfs_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                 ...
                                 content_synchronisation: Optional[Union['GetRemoteGitlfsRepositoryContentSynchronisationArgs', 'GetRemoteGitlfsRepositoryContentSynchronisationArgsDict']] = None,
...
def get_remote_gitlfs_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteGitlfsRepositoryContentSynchronisationArgs', 'GetRemoteGitlfsRepositoryContentSynchronisationArgsDict']]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteGitlfsRepositoryResult]:
    """
    Retrieves a remote GitLfs repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteGitlfsRepository:getRemoteGitlfsRepository', __args__, opts=opts, typ=GetRemoteGitlfsRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteGitlfsRepositoryResult(
