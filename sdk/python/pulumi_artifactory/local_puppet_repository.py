...
class LocalPuppetRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        LocalPuppetRepositoryArgs._configure(
...
class _LocalPuppetRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _LocalPuppetRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            archive_browsing_enabled=archive_browsing_enabled,
            blacked_out=blacked_out,
            cdn_redirect=cdn_redirect,
...
class LocalPuppetRepository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            LocalPuppetRepositoryArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            property_sets: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            repo_layout_ref: Optional[pulumi.Input[str]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'LocalPuppetRepository':
        """
