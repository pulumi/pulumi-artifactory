...
__all__ = ['RemoteJetbrainspluginsRepositoryArgs', 'RemoteJetbrainspluginsRepository']

@pulumi.input_type
class RemoteJetbrainspluginsRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 content_synchronisation: pulumi.Input[Optional['RemoteJetbrainspluginsRepositoryContentSynchronisationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] url: The remote repo URL. Use `https://plugins.jetbrains.com` for the JetBrains Marketplace.
        ...
        :param pulumi.Input[_builtins.str] notes: `repo_layout_ref` defaults to `simple-default`.
    ...
    def content_synchronisation(self) -> pulumi.Input[Optional['RemoteJetbrainspluginsRepositoryContentSynchronisationArgs']]:
        return pulumi.get(self, "content_synchronisation")

    @content_synchronisation.setter
    def content_synchronisation(self, value: pulumi.Input[Optional['RemoteJetbrainspluginsRepositoryContentSynchronisationArgs']]):
...
@pulumi.input_type
class _RemoteJetbrainspluginsRepositoryState:
    def __init__(__self__, *,
                 allow_any_host_auth: pulumi.Input[Optional[_builtins.bool]] = None,
                 archive_browsing_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 assumed_offline_period_secs: pulumi.Input[Optional[_builtins.int]] = None,
...
@pulumi.type_token("artifactory:index/remoteJetbrainspluginsRepository:RemoteJetbrainspluginsRepository")
class RemoteJetbrainspluginsRepository(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 cdn_redirect: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_tls_certificate: pulumi.Input[Optional[_builtins.str]] = None,
                 content_synchronisation: pulumi.Input[Optional[Union['RemoteJetbrainspluginsRepositoryContentSynchronisationArgs', 'RemoteJetbrainspluginsRepositoryContentSynchronisationArgsDict', 'outputs.RemoteJetbrainspluginsRepositoryContentSynchronisation']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 disable_proxy: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_url_normalization: pulumi.Input[Optional[_builtins.bool]] = None,
                 download_direct: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        my_remote_jetbrainsplugins = artifactory.RemoteJetbrainspluginsRepository("my-remote-jetbrainsplugins",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RemoteJetbrainspluginsRepositoryArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a remote JetBrains Plugins repository, which proxies and caches IDE plugins from the
        JetBrains Marketplace (`https://plugins.jetbrains.com`).
        ...
        :param str resource_name: The name of the resource.
        :param RemoteJetbrainspluginsRepositoryArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RemoteJetbrainspluginsRepositoryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RemoteJetbrainspluginsRepositoryArgs.__new__(RemoteJetbrainspluginsRepositoryArgs)
        ...
        super(RemoteJetbrainspluginsRepository, __self__).__init__(
            'artifactory:index/remoteJetbrainspluginsRepository:RemoteJetbrainspluginsRepository',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            url: pulumi.Input[Optional[_builtins.str]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'RemoteJetbrainspluginsRepository':
        """
        Get an existing RemoteJetbrainspluginsRepository resource's state with the given name, id, and optional extra
        ...
        __props__ = _RemoteJetbrainspluginsRepositoryState.__new__(_RemoteJetbrainspluginsRepositoryState)
        ...
        __props__.__dict__["username"] = username
        __props__.__dict__["xray_index"] = xray_index
        return RemoteJetbrainspluginsRepository(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output[Optional['outputs.RemoteJetbrainspluginsRepositoryContentSynchronisation']]:
        return pulumi.get(self, "content_synchronisation")
