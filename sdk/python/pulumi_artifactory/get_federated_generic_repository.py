...
__all__ = [
    ...
    'AwaitableGetFederatedGenericRepositoryResult',
    'get_federated_generic_repository',
    'get_federated_generic_repository_output',
]

@pulumi.output_type
class GetFederatedGenericRepositoryResult:
    """
...
class AwaitableGetFederatedGenericRepositoryResult(GetFederatedGenericRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedGenericRepositoryResult(
...
def get_federated_generic_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                     ...
                                     members: Optional[Sequence[Union['GetFederatedGenericRepositoryMemberArgs', 'GetFederatedGenericRepositoryMemberArgsDict', 'outputs.GetFederatedGenericRepositoryMemberResult']]] = None,
    ...
    :param Sequence[Union['GetFederatedGenericRepositoryMemberArgs', 'GetFederatedGenericRepositoryMemberArgsDict', 'outputs.GetFederatedGenericRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedGenericRepository:getFederatedGenericRepository', __args__, opts=opts, typ=GetFederatedGenericRepositoryResult).value

    return AwaitableGetFederatedGenericRepositoryResult(
...
def get_federated_generic_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                            ...
                                            members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedGenericRepositoryMemberArgs', 'GetFederatedGenericRepositoryMemberArgsDict', 'outputs.GetFederatedGenericRepositoryMemberResult']]]]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedGenericRepositoryResult]:
    """
    Retrieves a federated Generic repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedGenericRepository:getFederatedGenericRepository', __args__, opts=opts, typ=GetFederatedGenericRepositoryResult)
