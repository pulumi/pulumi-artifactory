...
__all__ = [
    ...
    'AwaitableGetVirtualSbtRepositoryResult',
    'get_virtual_sbt_repository',
    'get_virtual_sbt_repository_output',
]

@pulumi.output_type
class GetVirtualSbtRepositoryResult:
    """
...
class AwaitableGetVirtualSbtRepositoryResult(GetVirtualSbtRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualSbtRepositoryResult(
...
def get_virtual_sbt_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str key_pair: (Optional) The keypair used to sign artifacts.
    :param _builtins.str pom_repository_references_cleanup_policy: (Optional)
           - (1: discard_active_reference) Discard Active References - Removes repository elements that are declared directly under project or under a profile in the same POM that is activeByDefault.
           - (2: discard_any_reference) Discard Any References - Removes all repository elements regardless of whether they are included in an active profile or not.
           - (3: nothing) Nothing - Does not remove any repository elements declared in the POM.
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualSbtRepository:getVirtualSbtRepository', __args__, opts=opts, typ=GetVirtualSbtRepositoryResult).value

    return AwaitableGetVirtualSbtRepositoryResult(
...
def get_virtual_sbt_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualSbtRepositoryResult]:
    """
    Retrieves a virtual SBT repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualSbtRepository:getVirtualSbtRepository', __args__, opts=opts, typ=GetVirtualSbtRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualSbtRepositoryResult(
