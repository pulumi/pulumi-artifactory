...
__all__ = [
    ...
    'AwaitableGetFederatedOpkgRepositoryResult',
    'get_federated_opkg_repository',
    'get_federated_opkg_repository_output',
]

@pulumi.output_type
class GetFederatedOpkgRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedOpkgRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedOpkgRepositoryResult(GetFederatedOpkgRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedOpkgRepositoryResult(
...
def get_federated_opkg_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  members: Optional[Sequence[Union['GetFederatedOpkgRepositoryMemberArgs', 'GetFederatedOpkgRepositoryMemberArgsDict', 'outputs.GetFederatedOpkgRepositoryMemberResult']]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedOpkgRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedOpkgRepositoryMemberArgs', 'GetFederatedOpkgRepositoryMemberArgsDict', 'outputs.GetFederatedOpkgRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedOpkgRepository:getFederatedOpkgRepository', __args__, opts=opts, typ=GetFederatedOpkgRepositoryResult).value

    return AwaitableGetFederatedOpkgRepositoryResult(
...
def get_federated_opkg_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedOpkgRepositoryMemberArgs', 'GetFederatedOpkgRepositoryMemberArgsDict', 'outputs.GetFederatedOpkgRepositoryMemberResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedOpkgRepositoryResult]:
    """
    Retrieves a federated Opkg repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedOpkgRepository:getFederatedOpkgRepository', __args__, opts=opts, typ=GetFederatedOpkgRepositoryResult)
