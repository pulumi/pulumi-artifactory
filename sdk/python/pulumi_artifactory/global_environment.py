...
class GlobalEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name must start with a letter and contain letters, digits and `-` character. The maximum length is 32 characters
        """
        if name is not None:
...
class GlobalEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'GlobalEnvironment':
        """
