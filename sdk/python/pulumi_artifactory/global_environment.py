...
__all__ = ['GlobalEnvironmentArgs', 'GlobalEnvironment']

@pulumi.input_type
class GlobalEnvironmentArgs:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a GlobalEnvironment resource.
        :param pulumi.Input[str] name: Name must start with a letter and contain letters, digits and `-` character. The maximum length is 32 characters
        """
        GlobalEnvironmentArgs._configure(
...
class _GlobalEnvironmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name must start with a letter and contain letters, digits and `-` character. The maximum length is 32 characters
        """
        _GlobalEnvironmentState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            name=name,
        )
    @staticmethod
...
class GlobalEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GlobalEnvironmentArgs, pulumi.ResourceOptions, *args, **kwargs)
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            GlobalEnvironmentArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GlobalEnvironmentArgs.__new__(GlobalEnvironmentArgs)

            __props__.__dict__["name"] = name
        super(GlobalEnvironment, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'GlobalEnvironment':
        """
        ...
        __props__ = _GlobalEnvironmentState.__new__(_GlobalEnvironmentState)

        __props__.__dict__["name"] = name
        return GlobalEnvironment(resource_name, opts=opts, __props__=__props__)
