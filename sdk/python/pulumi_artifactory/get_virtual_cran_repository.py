...
__all__ = [
    'GetVirtualCranRepositoryResult',
    'AwaitableGetVirtualCranRepositoryResult',
    'get_virtual_cran_repository',
    'get_virtual_cran_repository_output',
]

@pulumi.output_type
class GetVirtualCranRepositoryResult:
    """
...
class AwaitableGetVirtualCranRepositoryResult(GetVirtualCranRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualCranRepositoryResult(
...
def get_virtual_cran_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualCranRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualCranRepository:getVirtualCranRepository', __args__, opts=opts, typ=GetVirtualCranRepositoryResult).value

    return AwaitableGetVirtualCranRepositoryResult(
...
def get_virtual_cran_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualCranRepositoryResult]:
    """
    Retrieves a virtual Cran repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualCranRepository:getVirtualCranRepository', __args__, opts=opts, typ=GetVirtualCranRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualCranRepositoryResult(
