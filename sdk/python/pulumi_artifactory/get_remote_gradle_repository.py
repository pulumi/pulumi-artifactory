...
__all__ = [
    ...
    'AwaitableGetRemoteGradleRepositoryResult',
    'get_remote_gradle_repository',
    'get_remote_gradle_repository_output',
]

@pulumi.output_type
class GetRemoteGradleRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteGradleRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteGradleRepositoryResult(GetRemoteGradleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteGradleRepositoryResult(
...
def get_remote_gradle_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                 ...
                                 content_synchronisation: Optional[Union['GetRemoteGradleRepositoryContentSynchronisationArgs', 'GetRemoteGradleRepositoryContentSynchronisationArgsDict']] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteGradleRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteGradleRepository:getRemoteGradleRepository', __args__, opts=opts, typ=GetRemoteGradleRepositoryResult).value

    return AwaitableGetRemoteGradleRepositoryResult(
...
def get_remote_gradle_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteGradleRepositoryContentSynchronisationArgs', 'GetRemoteGradleRepositoryContentSynchronisationArgsDict']]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteGradleRepositoryResult]:
    """
    Retrieves a remote Gradle repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteGradleRepository:getRemoteGradleRepository', __args__, opts=opts, typ=GetRemoteGradleRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteGradleRepositoryResult(
