...
__all__ = [
    ...
    'AwaitableGetFederatedIvyRepositoryResult',
    'get_federated_ivy_repository',
    'get_federated_ivy_repository_output',
]

@pulumi.output_type
class GetFederatedIvyRepositoryResult:
    """
...
class AwaitableGetFederatedIvyRepositoryResult(GetFederatedIvyRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedIvyRepositoryResult(
...
def get_federated_ivy_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 ...
                                 members: Optional[Sequence[Union['GetFederatedIvyRepositoryMemberArgs', 'GetFederatedIvyRepositoryMemberArgsDict', 'outputs.GetFederatedIvyRepositoryMemberResult']]] = None,
    ...
    :param Sequence[Union['GetFederatedIvyRepositoryMemberArgs', 'GetFederatedIvyRepositoryMemberArgsDict', 'outputs.GetFederatedIvyRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedIvyRepository:getFederatedIvyRepository', __args__, opts=opts, typ=GetFederatedIvyRepositoryResult).value

    return AwaitableGetFederatedIvyRepositoryResult(
...
def get_federated_ivy_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedIvyRepositoryMemberArgs', 'GetFederatedIvyRepositoryMemberArgsDict', 'outputs.GetFederatedIvyRepositoryMemberResult']]]]] = None,
