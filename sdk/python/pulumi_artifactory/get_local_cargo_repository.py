...
def get_local_cargo_repository(anonymous_access: Optional[builtins.bool] = None,
    ...
    :param builtins.bool anonymous_access: Cargo client does not send credentials when performing download and search for crates.
           Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous
           access option. Default value is `false`.
    :param builtins.bool enable_sparse_index: Enable internal index support based on Cargo sparse index specifications, instead
           of the default git index. Default value is `false`.
...
def get_local_cargo_repository_output(anonymous_access: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
