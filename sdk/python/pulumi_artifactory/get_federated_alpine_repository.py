...
__all__ = [
    'GetFederatedAlpineRepositoryResult',
    'AwaitableGetFederatedAlpineRepositoryResult',
    'get_federated_alpine_repository',
    'get_federated_alpine_repository_output',
]

@pulumi.output_type
class GetFederatedAlpineRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedAlpineRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedAlpineRepositoryResult(GetFederatedAlpineRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedAlpineRepositoryResult(
...
def get_federated_alpine_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                    ...
                                    members: Optional[Sequence[Union['GetFederatedAlpineRepositoryMemberArgs', 'GetFederatedAlpineRepositoryMemberArgsDict', 'outputs.GetFederatedAlpineRepositoryMemberResult']]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedAlpineRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedAlpineRepositoryMemberArgs', 'GetFederatedAlpineRepositoryMemberArgsDict', 'outputs.GetFederatedAlpineRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedAlpineRepository:getFederatedAlpineRepository', __args__, opts=opts, typ=GetFederatedAlpineRepositoryResult).value

    return AwaitableGetFederatedAlpineRepositoryResult(
...
def get_federated_alpine_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                           ...
                                           members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedAlpineRepositoryMemberArgs', 'GetFederatedAlpineRepositoryMemberArgsDict', 'outputs.GetFederatedAlpineRepositoryMemberResult']]]]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedAlpineRepositoryResult]:
    """
    Retrieves a federated Alpine repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedAlpineRepository:getFederatedAlpineRepository', __args__, opts=opts, typ=GetFederatedAlpineRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedAlpineRepositoryResult(
