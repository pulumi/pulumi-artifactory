...
def get_remote_rpm_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemoteRpmRepositoryContentSynchronisationArgs', 'GetRemoteRpmRepositoryContentSynchronisationArgsDict']] = None,
...
def get_remote_rpm_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteRpmRepositoryContentSynchronisationArgs', 'GetRemoteRpmRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteRpmRepositoryResult]:
    """
    Retrieves a remote Rpm repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteRpmRepository:getRemoteRpmRepository', __args__, opts=opts, typ=GetRemoteRpmRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteRpmRepositoryResult(
