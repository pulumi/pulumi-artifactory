...
class ReleaseBundleV2CustomWebhookArgs:
    def __init__(__self__, *,
                 criteria: pulumi.Input['ReleaseBundleV2CustomWebhookCriteriaArgs'],
                 event_types: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 handlers: pulumi.Input[Sequence[pulumi.Input['ReleaseBundleV2CustomWebhookHandlerArgs']]],
    ...
    @_builtins.property
    @pulumi.getter
    def criteria(self) -> pulumi.Input['ReleaseBundleV2CustomWebhookCriteriaArgs']:
        """
    ...
    @criteria.setter
    def criteria(self, value: pulumi.Input['ReleaseBundleV2CustomWebhookCriteriaArgs']):
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Input[Sequence[pulumi.Input['ReleaseBundleV2CustomWebhookHandlerArgs']]]:
        """
    ...
    @handlers.setter
    def handlers(self, value: pulumi.Input[Sequence[pulumi.Input['ReleaseBundleV2CustomWebhookHandlerArgs']]]):
...
class _ReleaseBundleV2CustomWebhookState:
    def __init__(__self__, *,
                 criteria: pulumi.Input[Optional['ReleaseBundleV2CustomWebhookCriteriaArgs']] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input['ReleaseBundleV2CustomWebhookHandlerArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def criteria(self) -> pulumi.Input[Optional['ReleaseBundleV2CustomWebhookCriteriaArgs']]:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @criteria.setter
    def criteria(self, value: pulumi.Input[Optional['ReleaseBundleV2CustomWebhookCriteriaArgs']]):
        pulumi.set(self, "criteria", value)
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReleaseBundleV2CustomWebhookHandlerArgs']]]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
    ...
    @handlers.setter
    def handlers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReleaseBundleV2CustomWebhookHandlerArgs']]]]):
        pulumi.set(self, "handlers", value)
...
class ReleaseBundleV2CustomWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 criteria: pulumi.Input[Optional[Union['ReleaseBundleV2CustomWebhookCriteriaArgs', 'ReleaseBundleV2CustomWebhookCriteriaArgsDict', 'outputs.ReleaseBundleV2CustomWebhookCriteria']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReleaseBundleV2CustomWebhookHandlerArgs', 'ReleaseBundleV2CustomWebhookHandlerArgsDict', 'outputs.ReleaseBundleV2CustomWebhookHandler']]]]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ReleaseBundleV2CustomWebhookCriteriaArgs', 'ReleaseBundleV2CustomWebhookCriteriaArgsDict', 'outputs.ReleaseBundleV2CustomWebhookCriteria']] criteria: Specifies where the webhook will be applied on which repositories.
        :param pulumi.Input[_builtins.str] description: Webhook description. Max length 1000 characters.
        :param pulumi.Input[_builtins.bool] enabled: Status of webhook. Default to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `release_bundle_v2_started`, `release_bundle_v2_failed`, `release_bundle_v2_completed`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReleaseBundleV2CustomWebhookHandlerArgs', 'ReleaseBundleV2CustomWebhookHandlerArgsDict', 'outputs.ReleaseBundleV2CustomWebhookHandler']]]] handlers: At least one is required.
        :param pulumi.Input[_builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReleaseBundleV2CustomWebhookHandlerArgs', 'ReleaseBundleV2CustomWebhookHandlerArgsDict', 'outputs.ReleaseBundleV2CustomWebhookHandler']]]]] = None,
            key: pulumi.Input[Optional[_builtins.str]] = None) -> 'ReleaseBundleV2CustomWebhook':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def criteria(self) -> pulumi.Output['outputs.ReleaseBundleV2CustomWebhookCriteria']:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Output[Sequence['outputs.ReleaseBundleV2CustomWebhookHandler']]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
