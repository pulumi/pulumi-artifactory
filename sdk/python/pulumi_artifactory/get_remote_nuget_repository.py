...
class GetRemoteNugetRepositoryResult:
    ...
    def download_context_path(self) -> Optional[_builtins.str]:
        """
    ...
    def feed_context_path(self) -> Optional[_builtins.str]:
        """
    ...
    def force_nuget_authentication(self) -> Optional[_builtins.bool]:
        """
    ...
    def symbol_server_url(self) -> Optional[_builtins.str]:
        """
    ...
    def v3_feed_url(self) -> Optional[_builtins.str]:
        """
...
def get_remote_nuget_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                ...
                                symbol_server_url: Optional[_builtins.str] = None,
                                ...
                                v3_feed_url: Optional[_builtins.str] = None,
    ...
    :param _builtins.str download_context_path: (Optional) The context path prefix through which NuGet downloads are served. For example, the NuGet Gallery download URL is `https://nuget.org/api/v2/package`, so the repository URL should be configured as `https://nuget.org` and the download context path should be configured as `api/v2/package`. Default value is `api/v2/package`.
    :param _builtins.str feed_context_path: (Optional) When proxying a remote NuGet repository, customize feed resource location using this attribute. Default value is `api/v2`.
    :param _builtins.bool force_nuget_authentication: (Optional) Force basic authentication credentials in order to use this repository. Default value is `false`.
    :param _builtins.str key: the identity key of the repo.
    :param _builtins.str symbol_server_url: (Optional) NuGet symbol server URL. Default value is `https://symbols.nuget.org/download/symbols`.
    :param _builtins.str v3_feed_url: (Optional) The URL to the NuGet v3 feed. Default value is `https://api.nuget.org/v3/index.json`.
    """
    __args__ = dict()
...
def get_remote_nuget_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       download_context_path: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       feed_context_path: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       force_nuget_authentication: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       symbol_server_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       v3_feed_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
