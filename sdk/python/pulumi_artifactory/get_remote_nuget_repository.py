...
__all__ = [
    ...
    'AwaitableGetRemoteNugetRepositoryResult',
    'get_remote_nuget_repository',
    'get_remote_nuget_repository_output',
]

@pulumi.output_type
class GetRemoteNugetRepositoryResult:
    """
    ...
    def __init__(__self__, allow_any_host_auth=None, archive_browsing_enabled=None, assumed_offline_period_secs=None, blacked_out=None, block_mismatching_mime_types=None, bypass_head_requests=None, cdn_redirect=None, client_tls_certificate=None, content_synchronisation=None, curated=None, description=None, disable_proxy=None, disable_url_normalization=None, download_context_path=None, download_direct=None, enable_cookie_management=None, excludes_pattern=None, feed_context_path=None, force_nuget_authentication=None, hard_fail=None, id=None, includes_pattern=None, key=None, list_remote_folder_items=None, local_address=None, metadata_retrieval_timeout_secs=None, mismatching_mime_types_override_list=None, missed_cache_period_seconds=None, notes=None, offline=None, package_type=None, password=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, query_params=None, remote_repo_layout_ref=None, repo_layout_ref=None, retrieval_cache_period_seconds=None, share_configuration=None, socket_timeout_millis=None, store_artifacts_locally=None, symbol_server_url=None, synchronize_properties=None, unused_artifacts_cleanup_period_hours=None, url=None, username=None, v3_feed_url=None, xray_index=None):
        ...
        if feed_context_path and not isinstance(feed_context_path, str):
            raise TypeError("Expected argument 'feed_context_path' to be a str")
        ...
        if symbol_server_url and not isinstance(symbol_server_url, str):
            raise TypeError("Expected argument 'symbol_server_url' to be a str")
        ...
        if v3_feed_url and not isinstance(v3_feed_url, str):
            raise TypeError("Expected argument 'v3_feed_url' to be a str")
    ...
    def download_context_path(self) -> Optional[builtins.str]:
        """
    ...
    def feed_context_path(self) -> Optional[builtins.str]:
        """
    ...
    def force_nuget_authentication(self) -> Optional[builtins.bool]:
        """
    ...
    def symbol_server_url(self) -> Optional[builtins.str]:
        """
    ...
    def v3_feed_url(self) -> Optional[builtins.str]:
        """
...
class AwaitableGetRemoteNugetRepositoryResult(GetRemoteNugetRepositoryResult):
    ...
    def __await__(self):
        ...
        return GetRemoteNugetRepositoryResult(
            ...
            symbol_server_url=self.symbol_server_url,
            ...
            v3_feed_url=self.v3_feed_url,
            xray_index=self.xray_index)


def get_remote_nuget_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                                ...
                                download_context_path: Optional[builtins.str] = None,
                                ...
                                feed_context_path: Optional[builtins.str] = None,
                                force_nuget_authentication: Optional[builtins.bool] = None,
                                ...
                                symbol_server_url: Optional[builtins.str] = None,
                                ...
                                v3_feed_url: Optional[builtins.str] = None,
    ...
    :param builtins.str download_context_path: (Optional) The context path prefix through which NuGet downloads are served. For example, the NuGet Gallery download URL is `https://nuget.org/api/v2/package`, so the repository URL should be configured as `https://nuget.org` and the download context path should be configured as `api/v2/package`. Default value is `api/v2/package`.
    :param builtins.str feed_context_path: (Optional) When proxying a remote NuGet repository, customize feed resource location using this attribute. Default value is `api/v2`.
    :param builtins.bool force_nuget_authentication: (Optional) Force basic authentication credentials in order to use this repository. Default value is `false`.
    :param builtins.str key: the identity key of the repo.
    :param builtins.str symbol_server_url: (Optional) NuGet symbol server URL. Default value is `https://symbols.nuget.org/download/symbols`.
    :param builtins.str v3_feed_url: (Optional) The URL to the NuGet v3 feed. Default value is `https://api.nuget.org/v3/index.json`.
    """
    __args__ = dict()
    ...
    __args__['symbolServerUrl'] = symbol_server_url
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteNugetRepository:getRemoteNugetRepository', __args__, opts=opts, typ=GetRemoteNugetRepositoryResult).value
    ...
    return AwaitableGetRemoteNugetRepositoryResult(
        ...
        symbol_server_url=pulumi.get(__ret__, 'symbol_server_url'),
        ...
        v3_feed_url=pulumi.get(__ret__, 'v3_feed_url'),
        xray_index=pulumi.get(__ret__, 'xray_index'))
def get_remote_nuget_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       ...
                                       download_context_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       feed_context_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       force_nuget_authentication: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       ...
                                       symbol_server_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       v3_feed_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetRemoteNugetRepositoryResult(
        ...
        symbol_server_url=pulumi.get(__response__, 'symbol_server_url'),
        ...
        v3_feed_url=pulumi.get(__response__, 'v3_feed_url'),
