...
__all__ = [
    ...
    'AwaitableGetLocalComposerRepositoryResult',
    'get_local_composer_repository',
    'get_local_composer_repository_output',
]

@pulumi.output_type
class GetLocalComposerRepositoryResult:
    """
...
class AwaitableGetLocalComposerRepositoryResult(GetLocalComposerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalComposerRepositoryResult(
...
def get_local_composer_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalComposerRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalComposerRepository:getLocalComposerRepository', __args__, opts=opts, typ=GetLocalComposerRepositoryResult).value

    return AwaitableGetLocalComposerRepositoryResult(
...
def get_local_composer_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalComposerRepositoryResult]:
    """
    Retrieves a local composer repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalComposerRepository:getLocalComposerRepository', __args__, opts=opts, typ=GetLocalComposerRepositoryResult)
