...
__all__ = [
    'GetLocalNpmRepositoryResult',
    'AwaitableGetLocalNpmRepositoryResult',
    'get_local_npm_repository',
    'get_local_npm_repository_output',
]

@pulumi.output_type
class GetLocalNpmRepositoryResult:
    """
...
class AwaitableGetLocalNpmRepositoryResult(GetLocalNpmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalNpmRepositoryResult(
...
def get_local_npm_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalNpmRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalNpmRepository:getLocalNpmRepository', __args__, opts=opts, typ=GetLocalNpmRepositoryResult).value

    return AwaitableGetLocalNpmRepositoryResult(
...
def get_local_npm_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalNpmRepositoryResult]:
    """
    Retrieves a local npm repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalNpmRepository:getLocalNpmRepository', __args__, opts=opts, typ=GetLocalNpmRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalNpmRepositoryResult(
