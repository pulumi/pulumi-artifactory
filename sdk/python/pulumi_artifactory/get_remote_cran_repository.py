...
__all__ = [
    ...
    'AwaitableGetRemoteCranRepositoryResult',
    'get_remote_cran_repository',
    'get_remote_cran_repository_output',
]

@pulumi.output_type
class GetRemoteCranRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteCranRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteCranRepositoryResult(GetRemoteCranRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteCranRepositoryResult(
...
def get_remote_cran_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                               ...
                               content_synchronisation: Optional[Union['GetRemoteCranRepositoryContentSynchronisationArgs', 'GetRemoteCranRepositoryContentSynchronisationArgsDict']] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteCranRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteCranRepository:getRemoteCranRepository', __args__, opts=opts, typ=GetRemoteCranRepositoryResult).value

    return AwaitableGetRemoteCranRepositoryResult(
...
def get_remote_cran_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteCranRepositoryContentSynchronisationArgs', 'GetRemoteCranRepositoryContentSynchronisationArgsDict']]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteCranRepositoryResult]:
    """
    Retrieves a remote CRAN repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteCranRepository:getRemoteCranRepository', __args__, opts=opts, typ=GetRemoteCranRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteCranRepositoryResult(
