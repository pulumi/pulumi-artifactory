...
__all__ = ['FederatedRpmRepositoryArgs', 'FederatedRpmRepository']

@pulumi.input_type
class FederatedRpmRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 calculate_yum_metadata: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 enable_file_lists_indexing: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 yum_group_file_names: Optional[pulumi.Input[builtins.str]] = None,
                 yum_root_depth: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        :param pulumi.Input[builtins.str] yum_group_file_names: A comma separated list of XML file names containing RPM group component definitions. Artifactory includes the group
               definitions as part of the calculated RPM metadata, as well as automatically generating a gzipped version of the group
               files, if required.
        :param pulumi.Input[builtins.int] yum_root_depth: The depth, relative to the repository's root folder, where RPM metadata is created. This is useful when your repository
    ...
    @members.setter
    def members(self, value: pulumi.Input[Sequence[pulumi.Input['FederatedRpmRepositoryMemberArgs']]]):
    ...
    def calculate_yum_metadata(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "calculate_yum_metadata")

    @calculate_yum_metadata.setter
    def calculate_yum_metadata(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_file_lists_indexing(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "enable_file_lists_indexing")

    @enable_file_lists_indexing.setter
    def enable_file_lists_indexing(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def yum_group_file_names(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def yum_group_file_names(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "yum_group_file_names", value)

    @property
    @pulumi.getter(name="yumRootDepth")
    def yum_root_depth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def yum_root_depth(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FederatedRpmRepository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FederatedRpmRepositoryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FederatedRpmRepositoryArgs.__new__(FederatedRpmRepositoryArgs)
    ...
    def get(resource_name: str,
            ...
            xray_index: Optional[pulumi.Input[builtins.bool]] = None,
            yum_group_file_names: Optional[pulumi.Input[builtins.str]] = None,
            yum_root_depth: Optional[pulumi.Input[builtins.int]] = None) -> 'FederatedRpmRepository':
        """
        ...
        __props__ = _FederatedRpmRepositoryState.__new__(_FederatedRpmRepositoryState)
    ...
    @property
    @pulumi.getter(name="calculateYumMetadata")
    def calculate_yum_metadata(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "calculate_yum_metadata")
    ...
    @property
    @pulumi.getter(name="enableFileListsIndexing")
    def enable_file_lists_indexing(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "enable_file_lists_indexing")
    ...
    @property
    @pulumi.getter(name="yumGroupFileNames")
    def yum_group_file_names(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A comma separated list of XML file names containing RPM group component definitions. Artifactory includes the group
        definitions as part of the calculated RPM metadata, as well as automatically generating a gzipped version of the group
        files, if required.
    ...
    @property
    @pulumi.getter(name="yumRootDepth")
    def yum_root_depth(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The depth, relative to the repository's root folder, where RPM metadata is created. This is useful when your repository
        contains multiple RPM repositories under parallel hierarchies. For example, if your RPMs are stored under
        'fedora/linux/$releasever/$basearch', specify a depth of 4.
