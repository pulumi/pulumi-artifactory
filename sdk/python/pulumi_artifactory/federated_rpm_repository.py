...
class FederatedRpmRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] yum_group_file_names: A comma separated list of XML file names containing RPM group component definitions. Artifactory includes the group definitions as part of the calculated RPM metadata, as well as automatically generating a gzipped version of the group files, if required.
        :param pulumi.Input[_builtins.int] yum_root_depth: The depth, relative to the repository's root folder, where RPM metadata is created. This is useful when your repository contains multiple RPM repositories under parallel hierarchies. For example, if your RPMs are stored under 'fedora/linux/$releasever/$basearch', specify a depth of 4.
        """
...
class FederatedRpmRepository(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="calculateYumMetadata")
    def calculate_yum_metadata(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "calculate_yum_metadata")
    ...
    @_builtins.property
    @pulumi.getter(name="enableFileListsIndexing")
    def enable_file_lists_indexing(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "enable_file_lists_indexing")
    ...
    @_builtins.property
    @pulumi.getter(name="yumGroupFileNames")
    def yum_group_file_names(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A comma separated list of XML file names containing RPM group component definitions. Artifactory includes the group definitions as part of the calculated RPM metadata, as well as automatically generating a gzipped version of the group files, if required.
        """
        return pulumi.get(self, "yum_group_file_names")
    ...
    @_builtins.property
    @pulumi.getter(name="yumRootDepth")
    def yum_root_depth(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The depth, relative to the repository's root folder, where RPM metadata is created. This is useful when your repository contains multiple RPM repositories under parallel hierarchies. For example, if your RPMs are stored under 'fedora/linux/$releasever/$basearch', specify a depth of 4.
        """
        return pulumi.get(self, "yum_root_depth")
