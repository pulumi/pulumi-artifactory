...
__all__ = [
    ...
    'AwaitableGetLocalAnsibleRepositoryResult',
    'get_local_ansible_repository',
    'get_local_ansible_repository_output',
]

@pulumi.output_type
class GetLocalAnsibleRepositoryResult:
    """
    A collection of values returned by getLocalAnsibleRepository.
    """
    def __init__(__self__, archive_browsing_enabled=None, blacked_out=None, cdn_redirect=None, description=None, download_direct=None, excludes_pattern=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, primary_keypair_ref=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, repo_layout_ref=None, xray_index=None):
...
class AwaitableGetLocalAnsibleRepositoryResult(GetLocalAnsibleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalAnsibleRepositoryResult(
...
def get_local_ansible_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalAnsibleRepositoryResult:
    """
    ...
    :param _builtins.str primary_keypair_ref: The RSA key to be used to sign Ansible indices.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalAnsibleRepository:getLocalAnsibleRepository', __args__, opts=opts, typ=GetLocalAnsibleRepositoryResult).value

    return AwaitableGetLocalAnsibleRepositoryResult(
...
def get_local_ansible_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalAnsibleRepositoryResult]:
    """
    Retrieves a local Ansible repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalAnsibleRepository:getLocalAnsibleRepository', __args__, opts=opts, typ=GetLocalAnsibleRepositoryResult)
