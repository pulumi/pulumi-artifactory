...
def get_local_ansible_repository(archive_browsing_enabled: Optional[bool] = None,
    ...
    :param str primary_keypair_ref: The RSA key to be used to sign Ansible indices.
    """
    __args__ = dict()
...
def get_local_ansible_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[bool]]] = None,
