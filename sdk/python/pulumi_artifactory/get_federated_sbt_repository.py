...
__all__ = [
    'GetFederatedSbtRepositoryResult',
    'AwaitableGetFederatedSbtRepositoryResult',
    'get_federated_sbt_repository',
    'get_federated_sbt_repository_output',
]

@pulumi.output_type
class GetFederatedSbtRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedSbtRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedSbtRepositoryResult(GetFederatedSbtRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedSbtRepositoryResult(
...
def get_federated_sbt_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 ...
                                 members: Optional[Sequence[Union['GetFederatedSbtRepositoryMemberArgs', 'GetFederatedSbtRepositoryMemberArgsDict', 'outputs.GetFederatedSbtRepositoryMemberResult']]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedSbtRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedSbtRepositoryMemberArgs', 'GetFederatedSbtRepositoryMemberArgsDict', 'outputs.GetFederatedSbtRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedSbtRepository:getFederatedSbtRepository', __args__, opts=opts, typ=GetFederatedSbtRepositoryResult).value

    return AwaitableGetFederatedSbtRepositoryResult(
...
def get_federated_sbt_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedSbtRepositoryMemberArgs', 'GetFederatedSbtRepositoryMemberArgsDict', 'outputs.GetFederatedSbtRepositoryMemberResult']]]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedSbtRepositoryResult]:
    """
    Retrieves a federated SBT repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedSbtRepository:getFederatedSbtRepository', __args__, opts=opts, typ=GetFederatedSbtRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedSbtRepositoryResult(
