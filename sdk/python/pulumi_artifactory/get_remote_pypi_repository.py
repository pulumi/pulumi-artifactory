...
class GetRemotePypiRepositoryResult:
    ...
    def __init__(__self__, allow_any_host_auth=None, archive_browsing_enabled=None, assumed_offline_period_secs=None, blacked_out=None, block_mismatching_mime_types=None, bypass_head_requests=None, cdn_redirect=None, client_tls_certificate=None, content_synchronisation=None, curated=None, description=None, disable_proxy=None, disable_url_normalization=None, download_direct=None, enable_cookie_management=None, excludes_pattern=None, hard_fail=None, id=None, includes_pattern=None, key=None, list_remote_folder_items=None, local_address=None, metadata_retrieval_timeout_secs=None, mismatching_mime_types_override_list=None, missed_cache_period_seconds=None, notes=None, offline=None, package_type=None, pass_through=None, password=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, pypi_registry_url=None, pypi_repository_suffix=None, query_params=None, remote_repo_layout_ref=None, repo_layout_ref=None, retrieval_cache_period_seconds=None, share_configuration=None, socket_timeout_millis=None, store_artifacts_locally=None, synchronize_properties=None, unused_artifacts_cleanup_period_hours=None, url=None, username=None, xray_index=None):
        ...
        if pypi_registry_url and not isinstance(pypi_registry_url, str):
            raise TypeError("Expected argument 'pypi_registry_url' to be a str")
        pulumi.set(__self__, "pypi_registry_url", pypi_registry_url)
        if pypi_repository_suffix and not isinstance(pypi_repository_suffix, str):
            raise TypeError("Expected argument 'pypi_repository_suffix' to be a str")
    ...
    def content_synchronisation(self) -> 'outputs.GetRemotePypiRepositoryContentSynchronisationResult':
    ...
    def pypi_registry_url(self) -> Optional[_builtins.str]:
        """
    ...
    def pypi_repository_suffix(self) -> Optional[_builtins.str]:
        """
...
class AwaitableGetRemotePypiRepositoryResult(GetRemotePypiRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemotePypiRepositoryResult(
            ...
            pypi_repository_suffix=self.pypi_repository_suffix,
...
def get_remote_pypi_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                               ...
                               content_synchronisation: Optional[Union['GetRemotePypiRepositoryContentSynchronisationArgs', 'GetRemotePypiRepositoryContentSynchronisationArgsDict']] = None,
                               ...
                               pypi_registry_url: Optional[_builtins.str] = None,
                               pypi_repository_suffix: Optional[_builtins.str] = None,
    ...
    __args__['pypiRegistryUrl'] = pypi_registry_url
    __args__['pypiRepositorySuffix'] = pypi_repository_suffix
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemotePypiRepository:getRemotePypiRepository', __args__, opts=opts, typ=GetRemotePypiRepositoryResult).value

    return AwaitableGetRemotePypiRepositoryResult(
        ...
        pypi_registry_url=pulumi.get(__ret__, 'pypi_registry_url'),
        pypi_repository_suffix=pulumi.get(__ret__, 'pypi_repository_suffix'),
...
def get_remote_pypi_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemotePypiRepositoryContentSynchronisationArgs', 'GetRemotePypiRepositoryContentSynchronisationArgsDict']]]] = None,
                                      ...
                                      pypi_registry_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      pypi_repository_suffix: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemotePypiRepositoryResult]:
    """
    Retrieves a remote Pypi repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemotePypiRepository:getRemotePypiRepository', __args__, opts=opts, typ=GetRemotePypiRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemotePypiRepositoryResult(
        ...
        pypi_registry_url=pulumi.get(__response__, 'pypi_registry_url'),
        pypi_repository_suffix=pulumi.get(__response__, 'pypi_repository_suffix'),
