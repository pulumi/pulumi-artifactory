...
class _UserCustomWebhookState:
    def __init__(__self__, *,
                 ...
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input['UserCustomWebhookHandlerArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['UserCustomWebhookHandlerArgs']]]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
    ...
    @handlers.setter
    def handlers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['UserCustomWebhookHandlerArgs']]]]):
        pulumi.set(self, "handlers", value)
