...
class _DistributionCustomWebhookState:
    def __init__(__self__, *,
                 criteria: pulumi.Input[Optional['DistributionCustomWebhookCriteriaArgs']] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input['DistributionCustomWebhookHandlerArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def criteria(self) -> pulumi.Input[Optional['DistributionCustomWebhookCriteriaArgs']]:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @criteria.setter
    def criteria(self, value: pulumi.Input[Optional['DistributionCustomWebhookCriteriaArgs']]):
        pulumi.set(self, "criteria", value)
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DistributionCustomWebhookHandlerArgs']]]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
    ...
    @handlers.setter
    def handlers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DistributionCustomWebhookHandlerArgs']]]]):
        pulumi.set(self, "handlers", value)
...
@pulumi.type_token("artifactory:index/distributionCustomWebhook:DistributionCustomWebhook")
class DistributionCustomWebhook(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 criteria: pulumi.Input[Optional[Union['DistributionCustomWebhookCriteriaArgs', 'DistributionCustomWebhookCriteriaArgsDict', 'outputs.DistributionCustomWebhookCriteria']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DistributionCustomWebhookHandlerArgs', 'DistributionCustomWebhookHandlerArgsDict', 'outputs.DistributionCustomWebhookHandler']]]]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DistributionCustomWebhookCriteriaArgs', 'DistributionCustomWebhookCriteriaArgsDict', 'outputs.DistributionCustomWebhookCriteria']] criteria: Specifies where the webhook will be applied on which repositories.
        :param pulumi.Input[_builtins.str] description: Webhook description. Max length 1000 characters.
        :param pulumi.Input[_builtins.bool] enabled: Status of webhook. Default to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `distribute_started`, `distribute_completed`, `distribute_aborted`, ` distribute_failed,  `delete_started` ,  `delete_completed` ,  `delete_failed`
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributionCustomWebhookHandlerArgs', 'DistributionCustomWebhookHandlerArgsDict', 'outputs.DistributionCustomWebhookHandler']]]] handlers: At least one is required.
        :param pulumi.Input[_builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DistributionCustomWebhookHandlerArgs', 'DistributionCustomWebhookHandlerArgsDict', 'outputs.DistributionCustomWebhookHandler']]]]] = None,
            key: pulumi.Input[Optional[_builtins.str]] = None) -> 'DistributionCustomWebhook':
        """
