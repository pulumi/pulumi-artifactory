...
class ArchivePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: An ID that is used to identify the archive policy. A minimum of three characters is required and can include letters, numbers, underscore and hyphen.
        ...
        :param pulumi.Input[builtins.str] project_key: This attribute is used only for project-level archive V2 policies, it is not used for global-level policies.
    ...
    def skip_trashcan(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ArchivePolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_key: Optional[pulumi.Input[builtins.str]] = None,
            search_criteria: Optional[pulumi.Input[Union['ArchivePolicySearchCriteriaArgs', 'ArchivePolicySearchCriteriaArgsDict']]] = None,
            skip_trashcan: Optional[pulumi.Input[builtins.bool]] = None) -> 'ArchivePolicy':
        """
