...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: (Optional, Sensitive) Password for the user. When omitted, a random password is generated using the following password policy: 12 characters with 1 digit, 1 symbol, with upper and lower case letters
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[builtins.str]] = None,
            password_policy: Optional[pulumi.Input[Union['UserPasswordPolicyArgs', 'UserPasswordPolicyArgsDict']]] = None,
            profile_updatable: Optional[pulumi.Input[builtins.bool]] = None) -> 'User':
        """
