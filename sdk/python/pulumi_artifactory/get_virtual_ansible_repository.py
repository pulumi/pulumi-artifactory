...
__all__ = [
    ...
    'AwaitableGetVirtualAnsibleRepositoryResult',
    'get_virtual_ansible_repository',
    'get_virtual_ansible_repository_output',
]

@pulumi.output_type
class GetVirtualAnsibleRepositoryResult:
    """
    A collection of values returned by getVirtualAnsibleRepository.
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, default_deployment_repo=None, description=None, excludes_pattern=None, hide_unauthorized_resources=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None, retrieval_cache_period_seconds=None):
...
class AwaitableGetVirtualAnsibleRepositoryResult(GetVirtualAnsibleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualAnsibleRepositoryResult(
...
def get_virtual_ansible_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualAnsibleRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualAnsibleRepository:getVirtualAnsibleRepository', __args__, opts=opts, typ=GetVirtualAnsibleRepositoryResult).value

    return AwaitableGetVirtualAnsibleRepositoryResult(
...
def get_virtual_ansible_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualAnsibleRepositoryResult]:
    """
    Retrieves a virtual Ansible repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualAnsibleRepository:getVirtualAnsibleRepository', __args__, opts=opts, typ=GetVirtualAnsibleRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualAnsibleRepositoryResult(
