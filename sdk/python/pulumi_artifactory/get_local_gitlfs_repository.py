...
__all__ = [
    'GetLocalGitlfsRepositoryResult',
    'AwaitableGetLocalGitlfsRepositoryResult',
    'get_local_gitlfs_repository',
    'get_local_gitlfs_repository_output',
]

@pulumi.output_type
class GetLocalGitlfsRepositoryResult:
    """
...
class AwaitableGetLocalGitlfsRepositoryResult(GetLocalGitlfsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalGitlfsRepositoryResult(
...
def get_local_gitlfs_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalGitlfsRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalGitlfsRepository:getLocalGitlfsRepository', __args__, opts=opts, typ=GetLocalGitlfsRepositoryResult).value

    return AwaitableGetLocalGitlfsRepositoryResult(
...
def get_local_gitlfs_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalGitlfsRepositoryResult]:
    """
    Retrieves a local gitlfs repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalGitlfsRepository:getLocalGitlfsRepository', __args__, opts=opts, typ=GetLocalGitlfsRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalGitlfsRepositoryResult(
