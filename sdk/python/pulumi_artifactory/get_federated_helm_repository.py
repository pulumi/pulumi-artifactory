...
__all__ = [
    'GetFederatedHelmRepositoryResult',
    'AwaitableGetFederatedHelmRepositoryResult',
    'get_federated_helm_repository',
    'get_federated_helm_repository_output',
]

@pulumi.output_type
class GetFederatedHelmRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedHelmRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedHelmRepositoryResult(GetFederatedHelmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedHelmRepositoryResult(
...
def get_federated_helm_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  members: Optional[Sequence[Union['GetFederatedHelmRepositoryMemberArgs', 'GetFederatedHelmRepositoryMemberArgsDict', 'outputs.GetFederatedHelmRepositoryMemberResult']]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedHelmRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedHelmRepositoryMemberArgs', 'GetFederatedHelmRepositoryMemberArgsDict', 'outputs.GetFederatedHelmRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedHelmRepository:getFederatedHelmRepository', __args__, opts=opts, typ=GetFederatedHelmRepositoryResult).value

    return AwaitableGetFederatedHelmRepositoryResult(
...
def get_federated_helm_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedHelmRepositoryMemberArgs', 'GetFederatedHelmRepositoryMemberArgsDict', 'outputs.GetFederatedHelmRepositoryMemberResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedHelmRepositoryResult]:
    """
    Retrieves a federated Helm repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedHelmRepository:getFederatedHelmRepository', __args__, opts=opts, typ=GetFederatedHelmRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedHelmRepositoryResult(
