...
__all__ = [
    ...
    'AwaitableGetVirtualCondaRepositoryResult',
    'get_virtual_conda_repository',
    'get_virtual_conda_repository_output',
]

@pulumi.output_type
class GetVirtualCondaRepositoryResult:
    """
...
class AwaitableGetVirtualCondaRepositoryResult(GetVirtualCondaRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualCondaRepositoryResult(
...
def get_virtual_conda_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualCondaRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualCondaRepository:getVirtualCondaRepository', __args__, opts=opts, typ=GetVirtualCondaRepositoryResult).value

    return AwaitableGetVirtualCondaRepositoryResult(
...
def get_virtual_conda_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualCondaRepositoryResult]:
    """
    Retrieves a virtual Conda repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualCondaRepository:getVirtualCondaRepository', __args__, opts=opts, typ=GetVirtualCondaRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualCondaRepositoryResult(
