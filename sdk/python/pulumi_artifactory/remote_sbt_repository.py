...
class RemoteSbtRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        RemoteSbtRepositoryArgs._configure(
...
class _RemoteSbtRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _RemoteSbtRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            allow_any_host_auth=allow_any_host_auth,
            assumed_offline_period_secs=assumed_offline_period_secs,
            blacked_out=blacked_out,
...
class RemoteSbtRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cdn_redirect: Optional[pulumi.Input[bool]] = None,
                 client_tls_certificate: Optional[pulumi.Input[str]] = None,
                 content_synchronisation: Optional[pulumi.Input[pulumi.InputType['RemoteSbtRepositoryContentSynchronisationArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 disable_proxy: Optional[pulumi.Input[bool]] = None,
                 disable_url_normalization: Optional[pulumi.Input[bool]] = None,
                 download_direct: Optional[pulumi.Input[bool]] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RemoteSbtRepositoryArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if content_synchronisation is not None and not isinstance(content_synchronisation, RemoteSbtRepositoryContentSynchronisationArgs):
                content_synchronisation = content_synchronisation or {}
                def _setter(key, value):
                    content_synchronisation[key] = value
                RemoteSbtRepositoryContentSynchronisationArgs._configure(_setter, **content_synchronisation)
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'RemoteSbtRepository':
        """
    ...
    @property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output['outputs.RemoteSbtRepositoryContentSynchronisation']:
        return pulumi.get(self, "content_synchronisation")
