...
__all__ = [
    'GetRemotePuppetRepositoryResult',
    'AwaitableGetRemotePuppetRepositoryResult',
    'get_remote_puppet_repository',
    'get_remote_puppet_repository_output',
]

@pulumi.output_type
class GetRemotePuppetRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemotePuppetRepositoryContentSynchronisationResult':
...
class AwaitableGetRemotePuppetRepositoryResult(GetRemotePuppetRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemotePuppetRepositoryResult(
...
def get_remote_puppet_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                 ...
                                 content_synchronisation: Optional[Union['GetRemotePuppetRepositoryContentSynchronisationArgs', 'GetRemotePuppetRepositoryContentSynchronisationArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemotePuppetRepository:getRemotePuppetRepository', __args__, opts=opts, typ=GetRemotePuppetRepositoryResult).value

    return AwaitableGetRemotePuppetRepositoryResult(
...
def get_remote_puppet_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemotePuppetRepositoryContentSynchronisationArgs', 'GetRemotePuppetRepositoryContentSynchronisationArgsDict']]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemotePuppetRepositoryResult]:
    """
    Retrieves a remote Peppet repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemotePuppetRepository:getRemotePuppetRepository', __args__, opts=opts, typ=GetRemotePuppetRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemotePuppetRepositoryResult(
