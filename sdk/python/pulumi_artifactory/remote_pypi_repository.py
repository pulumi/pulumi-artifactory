...
class RemotePypiRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 pypi_registry_url: Optional[pulumi.Input[_builtins.str]] = None,
                 pypi_repository_suffix: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] pypi_registry_url: To configure the remote repo to proxy public external PyPI repository, or a PyPI repository hosted on another Artifactory server. See JFrog Pypi documentation [here](https://www.jfrog.com/confluence/display/JFROG/PyPI+Repositories) for the usage details. Default value is `https://pypi.org`.
        :param pulumi.Input[_builtins.str] pypi_repository_suffix: Usually should be left as a default for `simple`, unless the remote is a PyPI server that has custom registry suffix, like +simple in DevPI. Default value is `simple`.
    ...
    def pypi_registry_url(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def pypi_registry_url(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "pypi_registry_url", value)

    @_builtins.property
    @pulumi.getter(name="pypiRepositorySuffix")
    def pypi_repository_suffix(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def pypi_repository_suffix(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class RemotePypiRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'RemotePypiRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="pypiRegistryUrl")
    def pypi_registry_url(self) -> pulumi.Output[_builtins.str]:
        """
        To configure the remote repo to proxy public external PyPI repository, or a PyPI repository hosted on another Artifactory server. See JFrog Pypi documentation [here](https://www.jfrog.com/confluence/display/JFROG/PyPI+Repositories) for the usage details. Default value is `https://pypi.org`.
        """
        return pulumi.get(self, "pypi_registry_url")
    ...
    @_builtins.property
    @pulumi.getter(name="pypiRepositorySuffix")
    def pypi_repository_suffix(self) -> pulumi.Output[_builtins.str]:
        """
        Usually should be left as a default for `simple`, unless the remote is a PyPI server that has custom registry suffix, like +simple in DevPI. Default value is `simple`.
        """
        return pulumi.get(self, "pypi_repository_suffix")
