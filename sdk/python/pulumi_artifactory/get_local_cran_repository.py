...
__all__ = [
    ...
    'AwaitableGetLocalCranRepositoryResult',
    'get_local_cran_repository',
    'get_local_cran_repository_output',
]

@pulumi.output_type
class GetLocalCranRepositoryResult:
    """
...
class AwaitableGetLocalCranRepositoryResult(GetLocalCranRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalCranRepositoryResult(
...
def get_local_cran_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalCranRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalCranRepository:getLocalCranRepository', __args__, opts=opts, typ=GetLocalCranRepositoryResult).value

    return AwaitableGetLocalCranRepositoryResult(
...
def get_local_cran_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalCranRepositoryResult]:
    """
    Retrieves a local cran repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalCranRepository:getLocalCranRepository', __args__, opts=opts, typ=GetLocalCranRepositoryResult)
