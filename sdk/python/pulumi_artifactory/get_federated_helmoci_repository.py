...
__all__ = [
    ...
    'AwaitableGetFederatedHelmociRepositoryResult',
    'get_federated_helmoci_repository',
    'get_federated_helmoci_repository_output',
]

@pulumi.output_type
class GetFederatedHelmociRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedHelmociRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedHelmociRepositoryResult(GetFederatedHelmociRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedHelmociRepositoryResult(
...
def get_federated_helmoci_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                     ...
                                     members: Optional[Sequence[Union['GetFederatedHelmociRepositoryMemberArgs', 'GetFederatedHelmociRepositoryMemberArgsDict']]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedHelmociRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedHelmociRepositoryMemberArgs', 'GetFederatedHelmociRepositoryMemberArgsDict']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedHelmociRepository:getFederatedHelmociRepository', __args__, opts=opts, typ=GetFederatedHelmociRepositoryResult).value

    return AwaitableGetFederatedHelmociRepositoryResult(
...
def get_federated_helmoci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                            ...
                                            max_unique_tags: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                            members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedHelmociRepositoryMemberArgs', 'GetFederatedHelmociRepositoryMemberArgsDict']]]]] = None,
                                            ...
                                            tag_retention: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                            xray_index: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedHelmociRepositoryResult]:
    """
    Retrieves a federated Helm OCI repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedHelmociRepository:getFederatedHelmociRepository', __args__, opts=opts, typ=GetFederatedHelmociRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedHelmociRepositoryResult(
