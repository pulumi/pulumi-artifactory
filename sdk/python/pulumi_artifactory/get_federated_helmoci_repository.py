...
class GetFederatedHelmociRepositoryResult:
    ...
    def max_unique_tags(self) -> Optional[builtins.int]:
    ...
    def tag_retention(self) -> Optional[builtins.int]:
...
def get_federated_helmoci_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
                                     ...
                                     tag_retention: Optional[builtins.int] = None,
...
def get_federated_helmoci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                            ...
                                            tag_retention: Optional[pulumi.Input[Optional[builtins.int]]] = None,
