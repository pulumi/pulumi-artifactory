...
class GetFederatedHelmociRepositoryResult:
    ...
    def max_unique_tags(self) -> Optional[int]:
    ...
    def tag_retention(self) -> Optional[int]:
...
def get_federated_helmoci_repository(archive_browsing_enabled: Optional[bool] = None,
...
def get_federated_helmoci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[bool]]] = None,
