...
__all__ = [
    ...
    'AwaitableGetFederatedChefRepositoryResult',
    'get_federated_chef_repository',
    'get_federated_chef_repository_output',
]

@pulumi.output_type
class GetFederatedChefRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedChefRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedChefRepositoryResult(GetFederatedChefRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedChefRepositoryResult(
...
def get_federated_chef_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  members: Optional[Sequence[Union['GetFederatedChefRepositoryMemberArgs', 'GetFederatedChefRepositoryMemberArgsDict', 'outputs.GetFederatedChefRepositoryMemberResult']]] = None,
    ...
    :param Sequence[Union['GetFederatedChefRepositoryMemberArgs', 'GetFederatedChefRepositoryMemberArgsDict', 'outputs.GetFederatedChefRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedChefRepository:getFederatedChefRepository', __args__, opts=opts, typ=GetFederatedChefRepositoryResult).value

    return AwaitableGetFederatedChefRepositoryResult(
...
def get_federated_chef_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedChefRepositoryMemberArgs', 'GetFederatedChefRepositoryMemberArgsDict', 'outputs.GetFederatedChefRepositoryMemberResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedChefRepositoryResult]:
    """
    Retrieves a federated Chef repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedChefRepository:getFederatedChefRepository', __args__, opts=opts, typ=GetFederatedChefRepositoryResult)
