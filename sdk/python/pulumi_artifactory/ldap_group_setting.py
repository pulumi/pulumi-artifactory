...
class LdapGroupSettingArgs:
    def __init__(__self__, *,
                 ...
                 ldap_setting_key: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ldap_setting_key: The LDAP setting key you want to use for group retrieval. The value for this field corresponds to 'enabledLdap' field of the ldap group setting XML block of system configuration.
        :param pulumi.Input[builtins.str] strategy: The JFrog Platform Deployment (JPD) supports three ways of mapping groups to LDAP schemas:
        ...
        :param pulumi.Input[builtins.bool] sub_tree: When set, enables deep search through the sub-tree of the LDAP URL + Search Base. True by default.
        """
    ...
    def ldap_setting_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ldap_setting_key(self, value: pulumi.Input[builtins.str]):
...
class _LdapGroupSettingState:
    def __init__(__self__, *,
                 ...
                 ldap_setting_key: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ldapSettingKey")
    def ldap_setting_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The LDAP setting key you want to use for group retrieval. The value for this field corresponds to 'enabledLdap' field of the ldap group setting XML block of system configuration.
        """
        return pulumi.get(self, "ldap_setting_key")
    ...
    @ldap_setting_key.setter
    def ldap_setting_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_setting_key", value)
...
@pulumi.type_token("artifactory:index/ldapGroupSetting:LdapGroupSetting")
class LdapGroupSetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            strategy: Optional[pulumi.Input[builtins.str]] = None,
            sub_tree: Optional[pulumi.Input[builtins.bool]] = None) -> 'LdapGroupSetting':
        """
    ...
    @property
    @pulumi.getter(name="groupBaseDn")
    def group_base_dn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A search base for group entry DNs, relative to the DN on the LDAP server’s URL (and not relative to the LDAP Setting’s “Search Base”). Used when importing groups.
        """
        return pulumi.get(self, "group_base_dn")
    ...
    @property
    @pulumi.getter(name="ldapSettingKey")
    def ldap_setting_key(self) -> pulumi.Output[builtins.str]:
        """
        The LDAP setting key you want to use for group retrieval. The value for this field corresponds to 'enabledLdap' field of the ldap group setting XML block of system configuration.
        """
        return pulumi.get(self, "ldap_setting_key")
    ...
    @property
    @pulumi.getter(name="subTree")
    def sub_tree(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set, enables deep search through the sub-tree of the LDAP URL + Search Base. True by default.
        """
        return pulumi.get(self, "sub_tree")
