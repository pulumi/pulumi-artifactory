...
__all__ = [
    'GetLocalHexRepositoryResult',
    'AwaitableGetLocalHexRepositoryResult',
    'get_local_hex_repository',
    'get_local_hex_repository_output',
]

@pulumi.output_type
class GetLocalHexRepositoryResult:
    """
...
class AwaitableGetLocalHexRepositoryResult(GetLocalHexRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalHexRepositoryResult(
...
def get_local_hex_repository(key: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalHexRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalHexRepository:getLocalHexRepository', __args__, opts=opts, typ=GetLocalHexRepositoryResult).value

    return AwaitableGetLocalHexRepositoryResult(
...
def get_local_hex_repository_output(key: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalHexRepository:getLocalHexRepository', __args__, opts=opts, typ=GetLocalHexRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalHexRepositoryResult(
