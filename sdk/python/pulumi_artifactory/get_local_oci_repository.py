...
__all__ = [
    ...
    'AwaitableGetLocalOciRepositoryResult',
    'get_local_oci_repository',
    'get_local_oci_repository_output',
]

@pulumi.output_type
class GetLocalOciRepositoryResult:
    """
...
class AwaitableGetLocalOciRepositoryResult(GetLocalOciRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalOciRepositoryResult(
...
def get_local_oci_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalOciRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalOciRepository:getLocalOciRepository', __args__, opts=opts, typ=GetLocalOciRepositoryResult).value

    return AwaitableGetLocalOciRepositoryResult(
...
def get_local_oci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
