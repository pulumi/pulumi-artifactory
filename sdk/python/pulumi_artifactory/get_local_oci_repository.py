...
@_utilities.lift_output_func(get_local_oci_repository)
def get_local_oci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[bool]]] = None,
