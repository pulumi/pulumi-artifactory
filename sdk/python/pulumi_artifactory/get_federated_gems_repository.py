...
__all__ = [
    'GetFederatedGemsRepositoryResult',
    'AwaitableGetFederatedGemsRepositoryResult',
    'get_federated_gems_repository',
    'get_federated_gems_repository_output',
]

@pulumi.output_type
class GetFederatedGemsRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedGemsRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedGemsRepositoryResult(GetFederatedGemsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedGemsRepositoryResult(
...
def get_federated_gems_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  members: Optional[Sequence[Union['GetFederatedGemsRepositoryMemberArgs', 'GetFederatedGemsRepositoryMemberArgsDict', 'outputs.GetFederatedGemsRepositoryMemberResult']]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedGemsRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedGemsRepositoryMemberArgs', 'GetFederatedGemsRepositoryMemberArgsDict', 'outputs.GetFederatedGemsRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedGemsRepository:getFederatedGemsRepository', __args__, opts=opts, typ=GetFederatedGemsRepositoryResult).value

    return AwaitableGetFederatedGemsRepositoryResult(
...
def get_federated_gems_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedGemsRepositoryMemberArgs', 'GetFederatedGemsRepositoryMemberArgsDict', 'outputs.GetFederatedGemsRepositoryMemberResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedGemsRepositoryResult]:
    """
    Retrieves a federated Gems repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedGemsRepository:getFederatedGemsRepository', __args__, opts=opts, typ=GetFederatedGemsRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedGemsRepositoryResult(
