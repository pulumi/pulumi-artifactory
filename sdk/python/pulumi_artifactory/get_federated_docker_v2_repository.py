...
__all__ = [
    ...
    'AwaitableGetFederatedDockerV2RepositoryResult',
    'get_federated_docker_v2_repository',
    'get_federated_docker_v2_repository_output',
]

@pulumi.output_type
class GetFederatedDockerV2RepositoryResult:
    """
    ...
    def max_unique_tags(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "max_unique_tags")

    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedDockerV2RepositoryMemberResult']]:
        """
    ...
    def tag_retention(self) -> Optional[_builtins.int]:
...
class AwaitableGetFederatedDockerV2RepositoryResult(GetFederatedDockerV2RepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedDockerV2RepositoryResult(
...
def get_federated_docker_v2_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                       ...
                                       members: Optional[Sequence[Union['GetFederatedDockerV2RepositoryMemberArgs', 'GetFederatedDockerV2RepositoryMemberArgsDict', 'outputs.GetFederatedDockerV2RepositoryMemberResult']]] = None,
                                       ...
                                       tag_retention: Optional[_builtins.int] = None,
                                       xray_index: Optional[_builtins.bool] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedDockerV2RepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedDockerV2RepositoryMemberArgs', 'GetFederatedDockerV2RepositoryMemberArgsDict', 'outputs.GetFederatedDockerV2RepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedDockerV2Repository:getFederatedDockerV2Repository', __args__, opts=opts, typ=GetFederatedDockerV2RepositoryResult).value

    return AwaitableGetFederatedDockerV2RepositoryResult(
...
def get_federated_docker_v2_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                              ...
                                              members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedDockerV2RepositoryMemberArgs', 'GetFederatedDockerV2RepositoryMemberArgsDict', 'outputs.GetFederatedDockerV2RepositoryMemberResult']]]]] = None,
                                              ...
                                              tag_retention: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                              xray_index: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedDockerV2RepositoryResult]:
    """
    Retrieves a federated Docker repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedDockerV2Repository:getFederatedDockerV2Repository', __args__, opts=opts, typ=GetFederatedDockerV2RepositoryResult)
