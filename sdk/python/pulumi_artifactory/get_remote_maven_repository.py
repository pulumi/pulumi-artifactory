...
__all__ = [
    'GetRemoteMavenRepositoryResult',
    'AwaitableGetRemoteMavenRepositoryResult',
    'get_remote_maven_repository',
    'get_remote_maven_repository_output',
]

@pulumi.output_type
class GetRemoteMavenRepositoryResult:
    """
    ...
    def __init__(__self__, allow_any_host_auth=None, archive_browsing_enabled=None, assumed_offline_period_secs=None, blacked_out=None, block_mismatching_mime_types=None, bypass_head_requests=None, cdn_redirect=None, client_tls_certificate=None, content_synchronisation=None, curated=None, description=None, disable_proxy=None, disable_url_normalization=None, download_direct=None, enable_cookie_management=None, excludes_pattern=None, fetch_jars_eagerly=None, fetch_sources_eagerly=None, handle_releases=None, handle_snapshots=None, hard_fail=None, id=None, includes_pattern=None, key=None, list_remote_folder_items=None, local_address=None, max_unique_snapshots=None, metadata_retrieval_timeout_secs=None, mismatching_mime_types_override_list=None, missed_cache_period_seconds=None, notes=None, offline=None, package_type=None, password=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, query_params=None, reject_invalid_jars=None, remote_repo_checksum_policy_type=None, remote_repo_layout_ref=None, repo_layout_ref=None, retrieval_cache_period_seconds=None, share_configuration=None, socket_timeout_millis=None, store_artifacts_locally=None, suppress_pom_consistency_checks=None, synchronize_properties=None, unused_artifacts_cleanup_period_hours=None, url=None, username=None, xray_index=None):
        ...
        if fetch_jars_eagerly and not isinstance(fetch_jars_eagerly, bool):
            raise TypeError("Expected argument 'fetch_jars_eagerly' to be a bool")
        pulumi.set(__self__, "fetch_jars_eagerly", fetch_jars_eagerly)
        if fetch_sources_eagerly and not isinstance(fetch_sources_eagerly, bool):
            raise TypeError("Expected argument 'fetch_sources_eagerly' to be a bool")
        ...
        if reject_invalid_jars and not isinstance(reject_invalid_jars, bool):
            raise TypeError("Expected argument 'reject_invalid_jars' to be a bool")
        pulumi.set(__self__, "reject_invalid_jars", reject_invalid_jars)
        if remote_repo_checksum_policy_type and not isinstance(remote_repo_checksum_policy_type, str):
            raise TypeError("Expected argument 'remote_repo_checksum_policy_type' to be a str")
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteMavenRepositoryContentSynchronisationResult':
    ...
    def disable_url_normalization(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "disable_url_normalization")

    @_builtins.property
    @pulumi.getter(name="downloadDirect")
    def download_direct(self) -> Optional[_builtins.bool]:
    ...
    def fetch_jars_eagerly(self) -> Optional[_builtins.bool]:
        """
    ...
    def fetch_sources_eagerly(self) -> Optional[_builtins.bool]:
        """
    ...
    def handle_releases(self) -> Optional[_builtins.bool]:
        """
    ...
    def handle_snapshots(self) -> Optional[_builtins.bool]:
        """
    ...
    def hard_fail(self) -> Optional[_builtins.bool]:
    ...
    def list_remote_folder_items(self) -> Optional[_builtins.bool]:
    ...
    def max_unique_snapshots(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "max_unique_snapshots")

    @_builtins.property
    @pulumi.getter(name="metadataRetrievalTimeoutSecs")
    def metadata_retrieval_timeout_secs(self) -> Optional[_builtins.int]:
        """
    ...
    def mismatching_mime_types_override_list(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "mismatching_mime_types_override_list")

    @_builtins.property
    @pulumi.getter(name="missedCachePeriodSeconds")
    def missed_cache_period_seconds(self) -> Optional[_builtins.int]:
    ...
    def priority_resolution(self) -> Optional[_builtins.bool]:
    ...
    def property_sets(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def reject_invalid_jars(self) -> Optional[_builtins.bool]:
        """
    ...
    def remote_repo_checksum_policy_type(self) -> Optional[_builtins.str]:
        """
    ...
    def remote_repo_layout_ref(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "remote_repo_layout_ref")

    @_builtins.property
    @pulumi.getter(name="repoLayoutRef")
    def repo_layout_ref(self) -> Optional[_builtins.str]:
    ...
    def store_artifacts_locally(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "store_artifacts_locally")

    @_builtins.property
    @pulumi.getter(name="suppressPomConsistencyChecks")
    def suppress_pom_consistency_checks(self) -> Optional[_builtins.bool]:
        """
    ...
    def synchronize_properties(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "synchronize_properties")

    @_builtins.property
    @pulumi.getter(name="unusedArtifactsCleanupPeriodHours")
    def unused_artifacts_cleanup_period_hours(self) -> Optional[_builtins.int]:
    ...
    def xray_index(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "xray_index")


class AwaitableGetRemoteMavenRepositoryResult(GetRemoteMavenRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteMavenRepositoryResult(
            ...
            reject_invalid_jars=self.reject_invalid_jars,
            remote_repo_checksum_policy_type=self.remote_repo_checksum_policy_type,
...
def get_remote_maven_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                archive_browsing_enabled: Optional[_builtins.bool] = None,
                                assumed_offline_period_secs: Optional[_builtins.int] = None,
                                blacked_out: Optional[_builtins.bool] = None,
                                block_mismatching_mime_types: Optional[_builtins.bool] = None,
                                bypass_head_requests: Optional[_builtins.bool] = None,
                                cdn_redirect: Optional[_builtins.bool] = None,
                                client_tls_certificate: Optional[_builtins.str] = None,
                                content_synchronisation: Optional[Union['GetRemoteMavenRepositoryContentSynchronisationArgs', 'GetRemoteMavenRepositoryContentSynchronisationArgsDict']] = None,
                                ...
                                handle_releases: Optional[_builtins.bool] = None,
                                handle_snapshots: Optional[_builtins.bool] = None,
                                hard_fail: Optional[_builtins.bool] = None,
                                includes_pattern: Optional[_builtins.str] = None,
                                key: Optional[_builtins.str] = None,
                                list_remote_folder_items: Optional[_builtins.bool] = None,
                                local_address: Optional[_builtins.str] = None,
                                max_unique_snapshots: Optional[_builtins.int] = None,
                                metadata_retrieval_timeout_secs: Optional[_builtins.int] = None,
                                mismatching_mime_types_override_list: Optional[_builtins.str] = None,
                                ...
                                property_sets: Optional[Sequence[_builtins.str]] = None,
                                proxy: Optional[_builtins.str] = None,
                                query_params: Optional[_builtins.str] = None,
                                reject_invalid_jars: Optional[_builtins.bool] = None,
                                remote_repo_checksum_policy_type: Optional[_builtins.str] = None,
                                remote_repo_layout_ref: Optional[_builtins.str] = None,
                                repo_layout_ref: Optional[_builtins.str] = None,
                                retrieval_cache_period_seconds: Optional[_builtins.int] = None,
                                share_configuration: Optional[_builtins.bool] = None,
                                socket_timeout_millis: Optional[_builtins.int] = None,
                                store_artifacts_locally: Optional[_builtins.bool] = None,
                                suppress_pom_consistency_checks: Optional[_builtins.bool] = None,
                                synchronize_properties: Optional[_builtins.bool] = None,
                                unused_artifacts_cleanup_period_hours: Optional[_builtins.int] = None,
                                url: Optional[_builtins.str] = None,
                                username: Optional[_builtins.str] = None,
                                xray_index: Optional[_builtins.bool] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteMavenRepositoryResult:
    """
    ...
    :param _builtins.bool fetch_jars_eagerly: (Optional, Default: `false`) When set, if a POM is requested, Artifactory attempts to fetch the corresponding jar in the background. This will accelerate first access time to the jar when it is subsequently requested.
    :param _builtins.bool fetch_sources_eagerly: (Optional, Default: `false`) When set, if a binaries jar is requested, Artifactory attempts to fetch the corresponding source jar in the background. This will accelerate first access time to the source jar when it is subsequently requested.
    :param _builtins.bool handle_releases: (Optional, Default: `true`) If set, Artifactory allows you to deploy release artifacts into this repository.
    :param _builtins.bool handle_snapshots: (Optional, Default: `true`) If set, Artifactory allows you to deploy snapshot artifacts into this repository.
    :param _builtins.str key: the identity key of the repo.
    :param _builtins.int metadata_retrieval_timeout_secs: (Optional, Default: 60) This value refers to the number of seconds to wait for retrieval from the remote before serving locally cached artifact or fail the request. Can not set to 0 or negative.
    :param _builtins.bool reject_invalid_jars: (Optional, Default: `false`) Reject the caching of jar files that are found to be invalid. For example, pseudo jars retrieved behind a "captive portal".
    :param _builtins.str remote_repo_checksum_policy_type: (Optional, Default: `generate-if-absent`) Checking the Checksum effectively verifies the integrity of a deployed resource. The Checksum Policy determines how the system behaves when a client checksum for a remote resource is missing or conflicts with the locally calculated checksum. Available policies are `generate-if-absent`, `fail`, `ignore-and-generate`, and `pass-thru`.
    :param _builtins.bool suppress_pom_consistency_checks: (Optional, Default: `true`) By default, the system keeps your repositories healthy by refusing POMs with incorrect coordinates (path). If the groupId:artifactId:version information inside the POM does not match the deployed path, Artifactory rejects the deployment with a "409 Conflict" error. You can disable this behavior by setting this attribute to `true`.
    """
    __args__ = dict()
    ...
    __args__['rejectInvalidJars'] = reject_invalid_jars
    __args__['remoteRepoChecksumPolicyType'] = remote_repo_checksum_policy_type
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteMavenRepository:getRemoteMavenRepository', __args__, opts=opts, typ=GetRemoteMavenRepositoryResult).value

    return AwaitableGetRemoteMavenRepositoryResult(
        ...
        reject_invalid_jars=pulumi.get(__ret__, 'reject_invalid_jars'),
        remote_repo_checksum_policy_type=pulumi.get(__ret__, 'remote_repo_checksum_policy_type'),
...
def get_remote_maven_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       assumed_offline_period_secs: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       blacked_out: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       block_mismatching_mime_types: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       bypass_head_requests: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       cdn_redirect: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       client_tls_certificate: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteMavenRepositoryContentSynchronisationArgs', 'GetRemoteMavenRepositoryContentSynchronisationArgsDict']]]] = None,
                                       curated: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       disable_proxy: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       disable_url_normalization: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       download_direct: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       enable_cookie_management: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       excludes_pattern: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       fetch_jars_eagerly: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       fetch_sources_eagerly: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       handle_releases: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       handle_snapshots: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       hard_fail: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       includes_pattern: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       key: Optional[pulumi.Input[_builtins.str]] = None,
                                       list_remote_folder_items: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       local_address: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       max_unique_snapshots: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       metadata_retrieval_timeout_secs: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       mismatching_mime_types_override_list: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       property_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                       proxy: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       query_params: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       reject_invalid_jars: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       remote_repo_checksum_policy_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       remote_repo_layout_ref: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       repo_layout_ref: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       retrieval_cache_period_seconds: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       share_configuration: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       socket_timeout_millis: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       store_artifacts_locally: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       suppress_pom_consistency_checks: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       synchronize_properties: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       unused_artifacts_cleanup_period_hours: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteMavenRepositoryResult]:
    """
    Retrieves a remote Maven repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteMavenRepository:getRemoteMavenRepository', __args__, opts=opts, typ=GetRemoteMavenRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteMavenRepositoryResult(
        ...
        reject_invalid_jars=pulumi.get(__response__, 'reject_invalid_jars'),
        remote_repo_checksum_policy_type=pulumi.get(__response__, 'remote_repo_checksum_policy_type'),
