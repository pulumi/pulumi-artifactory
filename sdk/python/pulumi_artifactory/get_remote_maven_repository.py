...
class GetRemoteMavenRepositoryResult:
    ...
    def allow_any_host_auth(self) -> Optional[builtins.bool]:
    ...
    def assumed_offline_period_secs(self) -> Optional[builtins.int]:
    ...
    def block_mismatching_mime_types(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "block_mismatching_mime_types")

    @property
    @pulumi.getter(name="bypassHeadRequests")
    def bypass_head_requests(self) -> Optional[builtins.bool]:
    ...
    def client_tls_certificate(self) -> builtins.str:
    ...
    @property
    @pulumi.getter
    def curated(self) -> Optional[builtins.bool]:
    ...
    def disable_url_normalization(self) -> Optional[builtins.bool]:
    ...
    def enable_cookie_management(self) -> Optional[builtins.bool]:
    ...
    def fetch_jars_eagerly(self) -> Optional[builtins.bool]:
        """
    ...
    def fetch_sources_eagerly(self) -> Optional[builtins.bool]:
        """
    ...
    def handle_releases(self) -> Optional[builtins.bool]:
        """
    ...
    def handle_snapshots(self) -> Optional[builtins.bool]:
        """
    ...
    def hard_fail(self) -> Optional[builtins.bool]:
    ...
    def mismatching_mime_types_override_list(self) -> Optional[builtins.str]:
        return pulumi.get(self, "mismatching_mime_types_override_list")

    @property
    @pulumi.getter(name="missedCachePeriodSeconds")
    def missed_cache_period_seconds(self) -> Optional[builtins.int]:
    ...
    def reject_invalid_jars(self) -> Optional[builtins.bool]:
        """
    ...
    def remote_repo_checksum_policy_type(self) -> Optional[builtins.str]:
        """
    ...
    def remote_repo_layout_ref(self) -> Optional[builtins.str]:
    ...
    def retrieval_cache_period_seconds(self) -> Optional[builtins.int]:
        return pulumi.get(self, "retrieval_cache_period_seconds")

    @property
    @pulumi.getter(name="shareConfiguration")
    def share_configuration(self) -> builtins.bool:
    ...
    def store_artifacts_locally(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "store_artifacts_locally")

    @property
    @pulumi.getter(name="suppressPomConsistencyChecks")
    def suppress_pom_consistency_checks(self) -> Optional[builtins.bool]:
        """
    ...
    def synchronize_properties(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "synchronize_properties")

    @property
    @pulumi.getter(name="unusedArtifactsCleanupPeriodHours")
    def unused_artifacts_cleanup_period_hours(self) -> Optional[builtins.int]:
...
def get_remote_maven_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                                archive_browsing_enabled: Optional[builtins.bool] = None,
                                assumed_offline_period_secs: Optional[builtins.int] = None,
                                blacked_out: Optional[builtins.bool] = None,
                                block_mismatching_mime_types: Optional[builtins.bool] = None,
                                bypass_head_requests: Optional[builtins.bool] = None,
                                cdn_redirect: Optional[builtins.bool] = None,
                                client_tls_certificate: Optional[builtins.str] = None,
                                ...
                                curated: Optional[builtins.bool] = None,
                                description: Optional[builtins.str] = None,
                                disable_proxy: Optional[builtins.bool] = None,
                                disable_url_normalization: Optional[builtins.bool] = None,
                                download_direct: Optional[builtins.bool] = None,
                                enable_cookie_management: Optional[builtins.bool] = None,
                                excludes_pattern: Optional[builtins.str] = None,
                                fetch_jars_eagerly: Optional[builtins.bool] = None,
                                fetch_sources_eagerly: Optional[builtins.bool] = None,
                                handle_releases: Optional[builtins.bool] = None,
                                handle_snapshots: Optional[builtins.bool] = None,
                                hard_fail: Optional[builtins.bool] = None,
                                includes_pattern: Optional[builtins.str] = None,
                                key: Optional[builtins.str] = None,
                                list_remote_folder_items: Optional[builtins.bool] = None,
                                local_address: Optional[builtins.str] = None,
                                max_unique_snapshots: Optional[builtins.int] = None,
                                metadata_retrieval_timeout_secs: Optional[builtins.int] = None,
                                mismatching_mime_types_override_list: Optional[builtins.str] = None,
                                missed_cache_period_seconds: Optional[builtins.int] = None,
                                ...
                                reject_invalid_jars: Optional[builtins.bool] = None,
                                remote_repo_checksum_policy_type: Optional[builtins.str] = None,
                                remote_repo_layout_ref: Optional[builtins.str] = None,
                                repo_layout_ref: Optional[builtins.str] = None,
                                retrieval_cache_period_seconds: Optional[builtins.int] = None,
                                share_configuration: Optional[builtins.bool] = None,
                                socket_timeout_millis: Optional[builtins.int] = None,
                                store_artifacts_locally: Optional[builtins.bool] = None,
                                suppress_pom_consistency_checks: Optional[builtins.bool] = None,
                                synchronize_properties: Optional[builtins.bool] = None,
                                unused_artifacts_cleanup_period_hours: Optional[builtins.int] = None,
    ...
    :param builtins.bool fetch_jars_eagerly: (Optional, Default: `false`) When set, if a POM is requested, Artifactory attempts to fetch the corresponding jar in the background. This will accelerate first access time to the jar when it is subsequently requested.
    :param builtins.bool fetch_sources_eagerly: (Optional, Default: `false`) When set, if a binaries jar is requested, Artifactory attempts to fetch the corresponding source jar in the background. This will accelerate first access time to the source jar when it is subsequently requested.
    :param builtins.bool handle_releases: (Optional, Default: `true`) If set, Artifactory allows you to deploy release artifacts into this repository.
    :param builtins.bool handle_snapshots: (Optional, Default: `true`) If set, Artifactory allows you to deploy snapshot artifacts into this repository.
    :param builtins.str key: the identity key of the repo.
    :param builtins.int metadata_retrieval_timeout_secs: (Optional, Default: 60) This value refers to the number of seconds to wait for retrieval from the remote before serving locally cached artifact or fail the request. Can not set to 0 or negative.
    :param builtins.bool reject_invalid_jars: (Optional, Default: `false`) Reject the caching of jar files that are found to be invalid. For example, pseudo jars retrieved behind a "captive portal".
    :param builtins.str remote_repo_checksum_policy_type: (Optional, Default: `generate-if-absent`) Checking the Checksum effectively verifies the integrity of a deployed resource. The Checksum Policy determines how the system behaves when a client checksum for a remote resource is missing or conflicts with the locally calculated checksum. Available policies are `generate-if-absent`, `fail`, `ignore-and-generate`, and `pass-thru`.
    :param builtins.bool suppress_pom_consistency_checks: (Optional, Default: `true`) By default, the system keeps your repositories healthy by refusing POMs with incorrect coordinates (path). If the groupId:artifactId:version information inside the POM does not match the deployed path, Artifactory rejects the deployment with a "409 Conflict" error. You can disable this behavior by setting this attribute to `true`.
    """
    __args__ = dict()
...
def get_remote_maven_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       assumed_offline_period_secs: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                       blacked_out: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       block_mismatching_mime_types: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       bypass_head_requests: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       cdn_redirect: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       client_tls_certificate: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       curated: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       disable_proxy: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       disable_url_normalization: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       download_direct: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       enable_cookie_management: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       excludes_pattern: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       fetch_jars_eagerly: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       fetch_sources_eagerly: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       handle_releases: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       handle_snapshots: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       hard_fail: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       includes_pattern: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       key: Optional[pulumi.Input[builtins.str]] = None,
                                       list_remote_folder_items: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       local_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       max_unique_snapshots: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                       metadata_retrieval_timeout_secs: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                       mismatching_mime_types_override_list: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       missed_cache_period_seconds: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                       notes: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       offline: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       ...
                                       proxy: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       query_params: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       reject_invalid_jars: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       remote_repo_checksum_policy_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       remote_repo_layout_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       repo_layout_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       retrieval_cache_period_seconds: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                       share_configuration: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       socket_timeout_millis: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                       store_artifacts_locally: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       suppress_pom_consistency_checks: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       synchronize_properties: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       unused_artifacts_cleanup_period_hours: Optional[pulumi.Input[Optional[builtins.int]]] = None,
