...
def get_federated_pypi_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  members: Optional[Sequence[Union['GetFederatedPypiRepositoryMemberArgs', 'GetFederatedPypiRepositoryMemberArgsDict', 'outputs.GetFederatedPypiRepositoryMemberResult']]] = None,
    ...
    :param Sequence[Union['GetFederatedPypiRepositoryMemberArgs', 'GetFederatedPypiRepositoryMemberArgsDict', 'outputs.GetFederatedPypiRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
...
def get_federated_pypi_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedPypiRepositoryMemberArgs', 'GetFederatedPypiRepositoryMemberArgsDict', 'outputs.GetFederatedPypiRepositoryMemberResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedPypiRepositoryResult]:
    """
    Retrieves a federated Pypi repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedPypiRepository:getFederatedPypiRepository', __args__, opts=opts, typ=GetFederatedPypiRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedPypiRepositoryResult(
