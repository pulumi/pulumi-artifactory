...
__all__ = [
    'GetFederatedReleasebundlesRepositoryResult',
    'AwaitableGetFederatedReleasebundlesRepositoryResult',
    'get_federated_releasebundles_repository',
    'get_federated_releasebundles_repository_output',
]

@pulumi.output_type
class GetFederatedReleasebundlesRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedReleasebundlesRepositoryMemberResult']]:
...
class AwaitableGetFederatedReleasebundlesRepositoryResult(GetFederatedReleasebundlesRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedReleasebundlesRepositoryResult(
...
def get_federated_releasebundles_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                            ...
                                            members: Optional[Sequence[Union['GetFederatedReleasebundlesRepositoryMemberArgs', 'GetFederatedReleasebundlesRepositoryMemberArgsDict']]] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedReleasebundlesRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedReleasebundlesRepository:getFederatedReleasebundlesRepository', __args__, opts=opts, typ=GetFederatedReleasebundlesRepositoryResult).value

    return AwaitableGetFederatedReleasebundlesRepositoryResult(
...
def get_federated_releasebundles_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                                   ...
                                                   members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedReleasebundlesRepositoryMemberArgs', 'GetFederatedReleasebundlesRepositoryMemberArgsDict']]]]] = None,
                                                   ...
                                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedReleasebundlesRepositoryResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedReleasebundlesRepository:getFederatedReleasebundlesRepository', __args__, opts=opts, typ=GetFederatedReleasebundlesRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedReleasebundlesRepositoryResult(
