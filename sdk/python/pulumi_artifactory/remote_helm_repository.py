...
class RemoteHelmRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        RemoteHelmRepositoryArgs._configure(
            ...
            hard_fail=hard_fail,
            helm_charts_base_url=helm_charts_base_url,
    ...
    def _configure(
        ...
        if helm_charts_base_url is None and 'helmChartsBaseUrl' in kwargs:
            helm_charts_base_url = kwargs['helmChartsBaseUrl']
        ...
        if helm_charts_base_url is not None:
            _setter("helm_charts_base_url", helm_charts_base_url)
...
class _RemoteHelmRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _RemoteHelmRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            allow_any_host_auth=allow_any_host_auth,
            assumed_offline_period_secs=assumed_offline_period_secs,
            blacked_out=blacked_out,
...
class RemoteHelmRepository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RemoteHelmRepositoryArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if content_synchronisation is not None and not isinstance(content_synchronisation, RemoteHelmRepositoryContentSynchronisationArgs):
                content_synchronisation = content_synchronisation or {}
                def _setter(key, value):
                    content_synchronisation[key] = value
                RemoteHelmRepositoryContentSynchronisationArgs._configure(_setter, **content_synchronisation)
