...
class RemoteHelmRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 helm_charts_base_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] external_dependencies_enabled: When set, external dependencies are rewritten. `External Dependency Rewrite` in the UI.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_dependencies_patterns: An allow list of Ant-style path patterns that determine which remote VCS roots Artifactory will
        ...
        :param pulumi.Input[builtins.str] helm_charts_base_url: Base URL for the translation of chart source URLs in the index.yaml of virtual repos. Artifactory will only translate URLs matching the index.yamls hostname or URLs starting with this base url. Support http/https/oci protocol scheme.
    ...
    def helm_charts_base_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def helm_charts_base_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RemoteHelmRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cdn_redirect: Optional[pulumi.Input[builtins.bool]] = None,
                 client_tls_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 content_synchronisation: Optional[pulumi.Input[Union['RemoteHelmRepositoryContentSynchronisationArgs', 'RemoteHelmRepositoryContentSynchronisationArgsDict']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disable_proxy: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_url_normalization: Optional[pulumi.Input[builtins.bool]] = None,
                 download_direct: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            xray_index: Optional[pulumi.Input[builtins.bool]] = None) -> 'RemoteHelmRepository':
        """
    ...
    @property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output[Optional['outputs.RemoteHelmRepositoryContentSynchronisation']]:
        return pulumi.get(self, "content_synchronisation")
    ...
    @property
    @pulumi.getter(name="helmChartsBaseUrl")
    def helm_charts_base_url(self) -> pulumi.Output[builtins.str]:
        """
        Base URL for the translation of chart source URLs in the index.yaml of virtual repos. Artifactory will only translate URLs matching the index.yamls hostname or URLs starting with this base url. Support http/https/oci protocol scheme.
        """
        return pulumi.get(self, "helm_charts_base_url")
