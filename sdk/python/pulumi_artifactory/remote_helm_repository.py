...
class RemoteHelmRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 helm_charts_base_url: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.bool] external_dependencies_enabled: When set, external dependencies are rewritten. `External Dependency Rewrite` in the UI.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] external_dependencies_patterns: An allow list of Ant-style path patterns that determine which remote VCS roots Artifactory will
        ...
        :param pulumi.Input[_builtins.str] helm_charts_base_url: Base URL for the translation of chart source URLs in the index.yaml of virtual repos. Artifactory will only translate URLs matching the index.yamls hostname or URLs starting with this base url. Support http/https/oci protocol scheme.
    ...
    def helm_charts_base_url(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def helm_charts_base_url(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class RemoteHelmRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'RemoteHelmRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="helmChartsBaseUrl")
    def helm_charts_base_url(self) -> pulumi.Output[_builtins.str]:
        """
        Base URL for the translation of chart source URLs in the index.yaml of virtual repos. Artifactory will only translate URLs matching the index.yamls hostname or URLs starting with this base url. Support http/https/oci protocol scheme.
        """
        return pulumi.get(self, "helm_charts_base_url")
