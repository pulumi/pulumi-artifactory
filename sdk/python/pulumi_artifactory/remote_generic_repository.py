...
class RemoteGenericRepositoryArgs:
    ...
    def content_synchronisation(self) -> pulumi.Input[Optional['RemoteGenericRepositoryContentSynchronisationArgs']]:
...
class RemoteGenericRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        When the remote requires an access token, set `enable_token_authentication = true` and put the token in `password` (see common remote arguments):

        ```python
        import pulumi
        import pulumi_artifactory as artifactory

        token_auth = artifactory.RemoteGenericRepository("token-auth",
            key="token-auth-generic",
            url="https://remote.example.com/artifactory/generic-local/",
            password=remote_access_token,
    ...
    def get(resource_name: str,
            ...
            url: pulumi.Input[Optional[_builtins.str]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'RemoteGenericRepository':
        """
