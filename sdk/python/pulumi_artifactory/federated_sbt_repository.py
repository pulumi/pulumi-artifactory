...
class FederatedSbtRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FederatedSbtRepositoryMemberArgs']]] members: The list of Federated members. If a Federated member receives a request that does not include the repository URL, it
...
class FederatedSbtRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FederatedSbtRepository resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[int] max_unique_snapshots: The maximum number of unique snapshots of a single artifact to store. Once the number of snapshots exceeds this setting,
               older versions are removed. A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FederatedSbtRepositoryMemberArgs']]]] members: The list of Federated members. If a Federated member receives a request that does not include the repository URL, it
               will automatically be added with the combination of the configured base URL and `key` field value. Note that each of the
               federated members will need to have a base URL set. Please follow the
               [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
    ...
    def get(resource_name: str,
            ...
            snapshot_version_behavior: Optional[pulumi.Input[str]] = None,
            suppress_pom_consistency_checks: Optional[pulumi.Input[bool]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'FederatedSbtRepository':
        """
