...
__all__ = [
    'GetLocalCocoapodsRepositoryResult',
    'AwaitableGetLocalCocoapodsRepositoryResult',
    'get_local_cocoapods_repository',
    'get_local_cocoapods_repository_output',
]

@pulumi.output_type
class GetLocalCocoapodsRepositoryResult:
    """
...
class AwaitableGetLocalCocoapodsRepositoryResult(GetLocalCocoapodsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalCocoapodsRepositoryResult(
...
def get_local_cocoapods_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalCocoapodsRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalCocoapodsRepository:getLocalCocoapodsRepository', __args__, opts=opts, typ=GetLocalCocoapodsRepositoryResult).value

    return AwaitableGetLocalCocoapodsRepositoryResult(
...
def get_local_cocoapods_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalCocoapodsRepositoryResult]:
    """
    Retrieves a local cocoapods repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalCocoapodsRepository:getLocalCocoapodsRepository', __args__, opts=opts, typ=GetLocalCocoapodsRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalCocoapodsRepositoryResult(
