...
class RemoteCocoapodsRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 pods_specs_repo_url: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] pods_specs_repo_url: (Optional) Proxy remote CocoaPods Specs repositories. Default value is "https://github.com/CocoaPods/Specs".
        ...
        :param pulumi.Input[str] vcs_git_download_url: (Optional) This attribute is used when vcs_git_provider is set to 'CUSTOM'. Provided URL will be used as proxy.
    ...
    def pods_specs_repo_url(self, value: Optional[pulumi.Input[str]]):
...
class RemoteCocoapodsRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bypass_head_requests: Optional[pulumi.Input[bool]] = None,
                 client_tls_certificate: Optional[pulumi.Input[str]] = None,
                 content_synchronisation: Optional[pulumi.Input[pulumi.InputType['RemoteCocoapodsRepositoryContentSynchronisationArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 enable_cookie_management: Optional[pulumi.Input[bool]] = None,
                 excludes_pattern: Optional[pulumi.Input[str]] = None,
                 hard_fail: Optional[pulumi.Input[bool]] = None,
                 ...
                 __props__=None):
        """
        Create a RemoteCocoapodsRepository resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            vcs_git_download_url: Optional[pulumi.Input[str]] = None,
            vcs_git_provider: Optional[pulumi.Input[str]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'RemoteCocoapodsRepository':
        """
    ...
    @property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output['outputs.RemoteCocoapodsRepositoryContentSynchronisation']:
        return pulumi.get(self, "content_synchronisation")
