...
class GetRemoteConanRepositoryResult:
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteConanRepositoryContentSynchronisationResult':
    ...
    def force_conan_authentication(self) -> Optional[_builtins.bool]:
        """
...
class AwaitableGetRemoteConanRepositoryResult(GetRemoteConanRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteConanRepositoryResult(
...
def get_remote_conan_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                ...
                                content_synchronisation: Optional[Union['GetRemoteConanRepositoryContentSynchronisationArgs', 'GetRemoteConanRepositoryContentSynchronisationArgsDict']] = None,
    ...
    :param _builtins.bool force_conan_authentication: (Optional) Force basic authentication credentials in order to use this repository. Default value is `false`.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteConanRepository:getRemoteConanRepository', __args__, opts=opts, typ=GetRemoteConanRepositoryResult).value

    return AwaitableGetRemoteConanRepositoryResult(
...
def get_remote_conan_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteConanRepositoryContentSynchronisationArgs', 'GetRemoteConanRepositoryContentSynchronisationArgsDict']]]] = None,
                                       ...
                                       force_conan_authentication: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteConanRepositoryResult]:
    """
    Retrieves a remote Conan repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteConanRepository:getRemoteConanRepository', __args__, opts=opts, typ=GetRemoteConanRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteConanRepositoryResult(
        ...
        force_conan_authentication=pulumi.get(__response__, 'force_conan_authentication'),
