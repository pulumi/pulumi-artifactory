...
__all__ = [
    'GetLocalGradleRepositoryResult',
    'AwaitableGetLocalGradleRepositoryResult',
    'get_local_gradle_repository',
    'get_local_gradle_repository_output',
]

@pulumi.output_type
class GetLocalGradleRepositoryResult:
    """
...
class AwaitableGetLocalGradleRepositoryResult(GetLocalGradleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalGradleRepositoryResult(
...
def get_local_gradle_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalGradleRepositoryResult:
    """
    ...
    * `suppress_pom_consistency_checks` - By default, Artifactory keeps your repositories healthy by refusing
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalGradleRepository:getLocalGradleRepository', __args__, opts=opts, typ=GetLocalGradleRepositoryResult).value

    return AwaitableGetLocalGradleRepositoryResult(
...
def get_local_gradle_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
