...
__all__ = [
    ...
    'AwaitableGetRemoteP2RepositoryResult',
    'get_remote_p2_repository',
    'get_remote_p2_repository_output',
]

@pulumi.output_type
class GetRemoteP2RepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteP2RepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteP2RepositoryResult(GetRemoteP2RepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteP2RepositoryResult(
...
def get_remote_p2_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                             ...
                             content_synchronisation: Optional[Union['GetRemoteP2RepositoryContentSynchronisationArgs', 'GetRemoteP2RepositoryContentSynchronisationArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteP2Repository:getRemoteP2Repository', __args__, opts=opts, typ=GetRemoteP2RepositoryResult).value

    return AwaitableGetRemoteP2RepositoryResult(
...
def get_remote_p2_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ...
                                    content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteP2RepositoryContentSynchronisationArgs', 'GetRemoteP2RepositoryContentSynchronisationArgsDict']]]] = None,
