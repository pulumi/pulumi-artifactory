...
class GetRemoteCargoRepositoryResult:
    ...
    def __init__(__self__, allow_any_host_auth=None, anonymous_access=None, archive_browsing_enabled=None, assumed_offline_period_secs=None, blacked_out=None, block_mismatching_mime_types=None, bypass_head_requests=None, cdn_redirect=None, client_tls_certificate=None, content_synchronisation=None, description=None, disable_proxy=None, disable_url_normalization=None, download_direct=None, enable_cookie_management=None, enable_sparse_index=None, excludes_pattern=None, git_registry_url=None, hard_fail=None, id=None, includes_pattern=None, key=None, list_remote_folder_items=None, local_address=None, metadata_retrieval_timeout_secs=None, mismatching_mime_types_override_list=None, missed_cache_period_seconds=None, notes=None, offline=None, package_type=None, password=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, query_params=None, remote_repo_layout_ref=None, repo_layout_ref=None, retrieval_cache_period_seconds=None, share_configuration=None, socket_timeout_millis=None, store_artifacts_locally=None, synchronize_properties=None, unused_artifacts_cleanup_period_hours=None, url=None, username=None, xray_index=None):
        ...
        if git_registry_url and not isinstance(git_registry_url, str):
            raise TypeError("Expected argument 'git_registry_url' to be a str")
    ...
    def anonymous_access(self) -> Optional[_builtins.bool]:
        """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteCargoRepositoryContentSynchronisationResult':
    ...
    def enable_sparse_index(self) -> Optional[_builtins.bool]:
        """
    ...
    def git_registry_url(self) -> Optional[_builtins.str]:
        """
...
class AwaitableGetRemoteCargoRepositoryResult(GetRemoteCargoRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteCargoRepositoryResult(
            ...
            git_registry_url=self.git_registry_url,
...
def get_remote_cargo_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                anonymous_access: Optional[_builtins.bool] = None,
                                ...
                                content_synchronisation: Optional[Union['GetRemoteCargoRepositoryContentSynchronisationArgs', 'GetRemoteCargoRepositoryContentSynchronisationArgsDict']] = None,
                                ...
                                enable_sparse_index: Optional[_builtins.bool] = None,
                                excludes_pattern: Optional[_builtins.str] = None,
                                git_registry_url: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool anonymous_access: (Required) Cargo client does not send credentials when performing download and search for crates. Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous access option. Default value is `false`.
    :param _builtins.bool enable_sparse_index: (Optional) Enable internal index support based on Cargo sparse index specifications, instead of the default git index. Default value is `false`.
    :param _builtins.str git_registry_url: (Optional) This is the index url, expected to be a git repository. Default value is `https://github.com/rust-lang/crates.io-index`.
    ...
    __args__['gitRegistryUrl'] = git_registry_url
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteCargoRepository:getRemoteCargoRepository', __args__, opts=opts, typ=GetRemoteCargoRepositoryResult).value

    return AwaitableGetRemoteCargoRepositoryResult(
        allow_any_host_auth=pulumi.get(__ret__, 'allow_any_host_auth'),
        anonymous_access=pulumi.get(__ret__, 'anonymous_access'),
        ...
        git_registry_url=pulumi.get(__ret__, 'git_registry_url'),
...
def get_remote_cargo_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       anonymous_access: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteCargoRepositoryContentSynchronisationArgs', 'GetRemoteCargoRepositoryContentSynchronisationArgsDict']]]] = None,
                                       ...
                                       enable_sparse_index: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       excludes_pattern: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       git_registry_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteCargoRepositoryResult]:
    """
    Retrieves a remote Cargo repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteCargoRepository:getRemoteCargoRepository', __args__, opts=opts, typ=GetRemoteCargoRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteCargoRepositoryResult(
        ...
        git_registry_url=pulumi.get(__response__, 'git_registry_url'),
