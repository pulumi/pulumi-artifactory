...
class GetRemoteCargoRepositoryResult:
    ...
    def anonymous_access(self) -> Optional[builtins.bool]:
        """
    ...
    def enable_sparse_index(self) -> Optional[builtins.bool]:
        """
    ...
    def git_registry_url(self) -> Optional[builtins.str]:
        """
...
def get_remote_cargo_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                                anonymous_access: Optional[builtins.bool] = None,
                                ...
                                enable_sparse_index: Optional[builtins.bool] = None,
                                excludes_pattern: Optional[builtins.str] = None,
                                git_registry_url: Optional[builtins.str] = None,
    ...
    :param builtins.bool anonymous_access: (Required) Cargo client does not send credentials when performing download and search for crates. Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous access option. Default value is `false`.
    :param builtins.bool enable_sparse_index: (Optional) Enable internal index support based on Cargo sparse index specifications, instead of the default git index. Default value is `false`.
    :param builtins.str git_registry_url: (Optional) This is the index url, expected to be a git repository. Default value is `https://github.com/rust-lang/crates.io-index`.
...
def get_remote_cargo_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       anonymous_access: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       ...
                                       enable_sparse_index: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       excludes_pattern: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       git_registry_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
