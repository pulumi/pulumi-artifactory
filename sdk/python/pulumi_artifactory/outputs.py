...
__all__ = [
    ...
    'RemoteAieditorextensionsRepositoryContentSynchronisation',
    'RemoteAieditorextensionsRepositoryCustomHttpHeader',
    'RemoteAlpineRepositoryContentSynchronisation',
    'RemoteAnsibleRepositoryContentSynchronisation',
    'RemoteBazelRepositoryContentSynchronisation',
    ...
    'RemoteGenericRepositoryCustomHttpHeader',
    ...
    'RemoteJetbrainspluginsRepositoryContentSynchronisation',
    'RemoteMavenRepositoryContentSynchronisation',
    'RemoteNixRepositoryContentSynchronisation',
    ...
    'GetRemoteJetbrainspluginsRepositoryContentSynchronisationResult',
...
@pulumi.output_type
class RemoteAieditorextensionsRepositoryContentSynchronisation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RemoteAieditorextensionsRepositoryContentSynchronisation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RemoteAieditorextensionsRepositoryContentSynchronisation.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class RemoteAieditorextensionsRepositoryCustomHttpHeader(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 value: _builtins.str,
                 sensitive: Optional[_builtins.bool] = None):
        """
        :param _builtins.str name: Header name. Artifactory stores header names lower-cased.
        :param _builtins.str value: Header value.
        :param _builtins.bool sensitive: When `true`, Artifactory encrypts the value server-side. Default value is `false`.
...
@pulumi.output_type
class RemoteBazelRepositoryContentSynchronisation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "propertiesEnabled":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RemoteBazelRepositoryContentSynchronisation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RemoteBazelRepositoryContentSynchronisation.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class RemoteGenericRepositoryCustomHttpHeader(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 value: _builtins.str,
                 sensitive: Optional[_builtins.bool] = None):
        ...
        :param _builtins.str value: Header value. Masked in pulumi preview output. Stored in state as configured; never read back from Artifactory.
        :param _builtins.bool sensitive: When `true`, Artifactory encrypts the value server-side.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
        if sensitive is not None:
...
@pulumi.output_type
class RemoteJetbrainspluginsRepositoryContentSynchronisation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "propertiesEnabled":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RemoteJetbrainspluginsRepositoryContentSynchronisation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RemoteJetbrainspluginsRepositoryContentSynchronisation.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class RemoteNixRepositoryContentSynchronisation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "propertiesEnabled":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RemoteNixRepositoryContentSynchronisation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RemoteNixRepositoryContentSynchronisation.__key_warning(key)
        return super().__getitem__(key)
...
@pulumi.output_type
class GetRemoteJetbrainspluginsRepositoryContentSynchronisationResult(dict):
    def __init__(__self__, *,
                 enabled: Optional[_builtins.bool] = None,
                 properties_enabled: Optional[_builtins.bool] = None,
                 source_origin_absence_detection: Optional[_builtins.bool] = None,
