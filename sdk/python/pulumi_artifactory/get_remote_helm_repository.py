...
class GetRemoteHelmRepositoryResult:
    ...
    def __init__(__self__, allow_any_host_auth=None, archive_browsing_enabled=None, assumed_offline_period_secs=None, blacked_out=None, block_mismatching_mime_types=None, bypass_head_requests=None, cdn_redirect=None, client_tls_certificate=None, content_synchronisation=None, description=None, disable_proxy=None, disable_url_normalization=None, download_direct=None, enable_cookie_management=None, excludes_pattern=None, external_dependencies_enabled=None, external_dependencies_patterns=None, hard_fail=None, helm_charts_base_url=None, id=None, includes_pattern=None, key=None, list_remote_folder_items=None, local_address=None, metadata_retrieval_timeout_secs=None, mismatching_mime_types_override_list=None, missed_cache_period_seconds=None, notes=None, offline=None, package_type=None, password=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, query_params=None, remote_repo_layout_ref=None, repo_layout_ref=None, retrieval_cache_period_seconds=None, share_configuration=None, socket_timeout_millis=None, store_artifacts_locally=None, synchronize_properties=None, unused_artifacts_cleanup_period_hours=None, url=None, username=None, xray_index=None):
        ...
        if helm_charts_base_url and not isinstance(helm_charts_base_url, str):
            raise TypeError("Expected argument 'helm_charts_base_url' to be a str")
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteHelmRepositoryContentSynchronisationResult':
    ...
    def external_dependencies_patterns(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def helm_charts_base_url(self) -> Optional[_builtins.str]:
        """
...
class AwaitableGetRemoteHelmRepositoryResult(GetRemoteHelmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteHelmRepositoryResult(
            ...
            helm_charts_base_url=self.helm_charts_base_url,
            id=self.id,
...
def get_remote_helm_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                               ...
                               content_synchronisation: Optional[Union['GetRemoteHelmRepositoryContentSynchronisationArgs', 'GetRemoteHelmRepositoryContentSynchronisationArgsDict']] = None,
                               ...
                               helm_charts_base_url: Optional[_builtins.str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteHelmRepositoryResult:
    """
    ...
    :param _builtins.bool external_dependencies_enabled: (Optional) When set, external dependencies are rewritten. `External Dependency Rewrite` in the UI.
    :param Sequence[_builtins.str] external_dependencies_patterns: (Optional) An allow list of Ant-style path patterns that determine which remote VCS roots Artifactory will follow to download remote modules from, when presented with 'go-import' meta tags in the remote repository response. By default, this is set to `[**]` in the UI, which means that remote modules may be downloaded from any external VCS source. Due to SDKv2 limitations, we can't set the default value for the list. This value `[**]` must be assigned to the attribute manually, if user don't specify any other non-default values. We don't want to make this attribute required, but it must be set to avoid the state drift on update. Note: Artifactory assigns `[**]` on update if HCL doesn't have the attribute set or the list is empty.
    :param _builtins.str helm_charts_base_url: (Optional) No documentation is available. Hopefully you know what this means.
    ...
    __args__['helmChartsBaseUrl'] = helm_charts_base_url
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteHelmRepository:getRemoteHelmRepository', __args__, opts=opts, typ=GetRemoteHelmRepositoryResult).value

    return AwaitableGetRemoteHelmRepositoryResult(
        ...
        helm_charts_base_url=pulumi.get(__ret__, 'helm_charts_base_url'),
...
def get_remote_helm_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteHelmRepositoryContentSynchronisationArgs', 'GetRemoteHelmRepositoryContentSynchronisationArgsDict']]]] = None,
                                      ...
                                      external_dependencies_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      external_dependencies_patterns: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                      hard_fail: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      helm_charts_base_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteHelmRepositoryResult]:
    """
    Retrieves a remote Helm repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteHelmRepository:getRemoteHelmRepository', __args__, opts=opts, typ=GetRemoteHelmRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteHelmRepositoryResult(
        ...
        helm_charts_base_url=pulumi.get(__response__, 'helm_charts_base_url'),
