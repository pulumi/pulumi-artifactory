...
class GetRemoteHelmRepositoryResult:
    ...
    def external_dependencies_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def external_dependencies_patterns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def helm_charts_base_url(self) -> Optional[builtins.str]:
        """
...
def get_remote_helm_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                               ...
                               external_dependencies_enabled: Optional[builtins.bool] = None,
                               external_dependencies_patterns: Optional[Sequence[builtins.str]] = None,
                               hard_fail: Optional[builtins.bool] = None,
                               helm_charts_base_url: Optional[builtins.str] = None,
    ...
    :param builtins.bool external_dependencies_enabled: (Optional) When set, external dependencies are rewritten. `External Dependency Rewrite` in the UI.
    :param Sequence[builtins.str] external_dependencies_patterns: (Optional) An allow list of Ant-style path patterns that determine which remote VCS roots Artifactory will follow to download remote modules from, when presented with 'go-import' meta tags in the remote repository response. By default, this is set to `[**]` in the UI, which means that remote modules may be downloaded from any external VCS source. Due to SDKv2 limitations, we can't set the default value for the list. This value `[**]` must be assigned to the attribute manually, if user don't specify any other non-default values. We don't want to make this attribute required, but it must be set to avoid the state drift on update. Note: Artifactory assigns `[**]` on update if HCL doesn't have the attribute set or the list is empty.
    :param builtins.str helm_charts_base_url: (Optional) No documentation is available. Hopefully you know what this means.
...
def get_remote_helm_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                      ...
                                      external_dependencies_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                      external_dependencies_patterns: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                      hard_fail: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                      helm_charts_base_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
