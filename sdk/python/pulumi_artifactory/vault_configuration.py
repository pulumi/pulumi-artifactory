...
class VaultConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the Vault configuration
        """
...
@pulumi.type_token("artifactory:index/vaultConfiguration:VaultConfiguration")
class VaultConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            config: Optional[pulumi.Input[Union['VaultConfigurationConfigArgs', 'VaultConfigurationConfigArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'VaultConfiguration':
        """
