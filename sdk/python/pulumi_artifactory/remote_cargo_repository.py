...
class RemoteCargoRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 anonymous_access: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 enable_sparse_index: Optional[pulumi.Input[builtins.bool]] = None,
                 excludes_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 git_registry_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_any_host_auth: 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any
               other host.
        :param pulumi.Input[builtins.bool] anonymous_access: Cargo client does not send credentials when performing download and search for crates. Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous access option. Default value is `false`.
        ...
        :param pulumi.Input[builtins.bool] enable_sparse_index: Enable internal index support based on Cargo sparse index specifications, instead of the default git index. Default value is `false`.
        ...
        :param pulumi.Input[builtins.str] git_registry_url: This is the index url, expected to be a git repository. Default value is `https://index.crates.io/`.
        ...
        if enable_sparse_index is not None:
    ...
    def anonymous_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def anonymous_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_sparse_index(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_sparse_index(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_sparse_index", value)
    ...
    def git_registry_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def git_registry_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("artifactory:index/remoteCargoRepository:RemoteCargoRepository")
class RemoteCargoRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cdn_redirect: Optional[pulumi.Input[builtins.bool]] = None,
                 client_tls_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 content_synchronisation: Optional[pulumi.Input[Union['RemoteCargoRepositoryContentSynchronisationArgs', 'RemoteCargoRepositoryContentSynchronisationArgsDict']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disable_proxy: Optional[pulumi.Input[builtins.bool]] = None,
                 disable_url_normalization: Optional[pulumi.Input[builtins.bool]] = None,
                 download_direct: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None,
            xray_index: Optional[pulumi.Input[builtins.bool]] = None) -> 'RemoteCargoRepository':
        """
    ...
    @property
    @pulumi.getter(name="anonymousAccess")
    def anonymous_access(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Cargo client does not send credentials when performing download and search for crates. Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous access option. Default value is `false`.
        """
        return pulumi.get(self, "anonymous_access")
    ...
    @property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output[Optional['outputs.RemoteCargoRepositoryContentSynchronisation']]:
        return pulumi.get(self, "content_synchronisation")
    ...
    @property
    @pulumi.getter(name="enableSparseIndex")
    def enable_sparse_index(self) -> pulumi.Output[builtins.bool]:
        """
        Enable internal index support based on Cargo sparse index specifications, instead of the default git index. Default value is `false`.
        """
        return pulumi.get(self, "enable_sparse_index")
    ...
    @property
    @pulumi.getter(name="gitRegistryUrl")
    def git_registry_url(self) -> pulumi.Output[builtins.str]:
        """
        This is the index url, expected to be a git repository. Default value is `https://index.crates.io/`.
        """
        return pulumi.get(self, "git_registry_url")
