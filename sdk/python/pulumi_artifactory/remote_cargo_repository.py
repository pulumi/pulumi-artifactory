...
class RemoteCargoRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        RemoteCargoRepositoryArgs._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            git_registry_url=git_registry_url,
            key=key,
            url=url,
    ...
    def _configure(
             ...
             **kwargs):
        if git_registry_url is None and 'gitRegistryUrl' in kwargs:
            git_registry_url = kwargs['gitRegistryUrl']
        if git_registry_url is None:
            raise TypeError("Missing 'git_registry_url' argument")
        if key is None:
        ...
        _setter("git_registry_url", git_registry_url)
        _setter("key", key)
        _setter("url", url)
...
class _RemoteCargoRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _RemoteCargoRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            allow_any_host_auth=allow_any_host_auth,
            anonymous_access=anonymous_access,
            assumed_offline_period_secs=assumed_offline_period_secs,
...
class RemoteCargoRepository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RemoteCargoRepositoryArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if content_synchronisation is not None and not isinstance(content_synchronisation, RemoteCargoRepositoryContentSynchronisationArgs):
                content_synchronisation = content_synchronisation or {}
                def _setter(key, value):
                    content_synchronisation[key] = value
                RemoteCargoRepositoryContentSynchronisationArgs._configure(_setter, **content_synchronisation)
