...
class GetFileResult:
    ...
    def force_overwrite(self) -> Optional[_builtins.bool]:
    ...
    def path_is_aliased(self) -> Optional[_builtins.bool]:
...
def get_file(force_overwrite: Optional[_builtins.bool] = None,
             output_path: Optional[_builtins.str] = None,
             path: Optional[_builtins.str] = None,
             path_is_aliased: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool force_overwrite: If set to true, an existing file in the output_path will be overwritten. Default: `false`
    :param _builtins.str output_path: The local path the file should be downloaded to.
    :param _builtins.str path: The path to the file within the repository.
    :param _builtins.bool path_is_aliased: If set to `true`, the provider will get the artifact directly from Artifactory without attempting to resolve it or verify it and will delegate this to artifactory if the file exists. When using a smart remote repository, it is recommended to set this attribute to `true`. This is necessary to ensure that the provider fetches the artifact directly from Artifactory. If this attribute is not set or is set to `false`, there is a risk of fetching the `-cache` directory in Artifactory, potentially resulting in resource expiration and a 404 error.
