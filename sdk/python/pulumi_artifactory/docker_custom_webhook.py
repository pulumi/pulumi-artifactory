...
class _DockerCustomWebhookState:
    def __init__(__self__, *,
                 criteria: pulumi.Input[Optional['DockerCustomWebhookCriteriaArgs']] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input['DockerCustomWebhookHandlerArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def criteria(self) -> pulumi.Input[Optional['DockerCustomWebhookCriteriaArgs']]:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @criteria.setter
    def criteria(self, value: pulumi.Input[Optional['DockerCustomWebhookCriteriaArgs']]):
        pulumi.set(self, "criteria", value)
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DockerCustomWebhookHandlerArgs']]]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
    ...
    @handlers.setter
    def handlers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DockerCustomWebhookHandlerArgs']]]]):
        pulumi.set(self, "handlers", value)
...
@pulumi.type_token("artifactory:index/dockerCustomWebhook:DockerCustomWebhook")
class DockerCustomWebhook(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 criteria: pulumi.Input[Optional[Union['DockerCustomWebhookCriteriaArgs', 'DockerCustomWebhookCriteriaArgsDict', 'outputs.DockerCustomWebhookCriteria']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DockerCustomWebhookHandlerArgs', 'DockerCustomWebhookHandlerArgsDict', 'outputs.DockerCustomWebhookHandler']]]]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DockerCustomWebhookCriteriaArgs', 'DockerCustomWebhookCriteriaArgsDict', 'outputs.DockerCustomWebhookCriteria']] criteria: Specifies where the webhook will be applied on which repositories.
        :param pulumi.Input[_builtins.str] description: Webhook description. Max length 1000 characters.
        :param pulumi.Input[_builtins.bool] enabled: Status of webhook. Default to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `pushed`, `deleted`, `promoted`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DockerCustomWebhookHandlerArgs', 'DockerCustomWebhookHandlerArgsDict', 'outputs.DockerCustomWebhookHandler']]]] handlers: At least one is required.
        :param pulumi.Input[_builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DockerCustomWebhookHandlerArgs', 'DockerCustomWebhookHandlerArgsDict', 'outputs.DockerCustomWebhookHandler']]]]] = None,
            key: pulumi.Input[Optional[_builtins.str]] = None) -> 'DockerCustomWebhook':
        """
