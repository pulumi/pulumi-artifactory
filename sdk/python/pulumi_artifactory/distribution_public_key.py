...
class DistributionPublicKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias: Will be used as an identifier when uploading/retrieving the public key via REST API.
        :param pulumi.Input[builtins.str] public_key: The Public key to add as a trusted distribution GPG key.
...
class _DistributionPublicKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias: Will be used as an identifier when uploading/retrieving the public key via REST API.
        :param pulumi.Input[builtins.str] fingerprint: Returns the computed key fingerprint
        :param pulumi.Input[builtins.str] issued_by: Returns the name and eMail address of issuer
        :param pulumi.Input[builtins.str] issued_on: Returns the date/time when this GPG key was created
        :param pulumi.Input[builtins.str] key_id: Returns the key id by which this key is referenced in Artifactory
        :param pulumi.Input[builtins.str] public_key: The Public key to add as a trusted distribution GPG key.
               
               The following additional attributes are exported:
        :param pulumi.Input[builtins.str] valid_until: Returns the date/time when this GPG key expires.
        """
...
class DistributionPublicKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_id: Optional[pulumi.Input[builtins.str]] = None,
            public_key: Optional[pulumi.Input[builtins.str]] = None,
            valid_until: Optional[pulumi.Input[builtins.str]] = None) -> 'DistributionPublicKey':
        """
