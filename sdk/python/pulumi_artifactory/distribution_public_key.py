...
class _DistributionPublicKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] issued_on: Returns the date/time when this GPG key was created
        :param pulumi.Input[_builtins.str] key_id: Returns the key id by which this key is referenced in Artifactory
        :param pulumi.Input[_builtins.str] public_key: The Public key to add as a trusted distribution GPG key.
               
               The following additional attributes are exported:
        :param pulumi.Input[_builtins.str] valid_until: Returns the date/time when this GPG key expires.
        """
