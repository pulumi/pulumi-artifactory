...
class VirtualHelmRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 use_namespaces: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] use_namespaces: From Artifactory 7.24.1 (SaaS Version), you can explicitly state a specific aggregated local or remote repository to fetch from a virtual by assigning namespaces to local and remote repositories. See the documentation [here](https://www.jfrog.com/confluence/display/JFROG/Kubernetes+Helm+Chart+Repositories#KubernetesHelmChartRepositories-NamespaceSupportforHelmVirtualRepositories). Default is `false`.
        """
    ...
    def use_namespaces(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def use_namespaces(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class VirtualHelmRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repositories: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            retrieval_cache_period_seconds: pulumi.Input[Optional[_builtins.int]] = None,
            use_namespaces: pulumi.Input[Optional[_builtins.bool]] = None) -> 'VirtualHelmRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="useNamespaces")
    def use_namespaces(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        From Artifactory 7.24.1 (SaaS Version), you can explicitly state a specific aggregated local or remote repository to fetch from a virtual by assigning namespaces to local and remote repositories. See the documentation [here](https://www.jfrog.com/confluence/display/JFROG/Kubernetes+Helm+Chart+Repositories#KubernetesHelmChartRepositories-NamespaceSupportforHelmVirtualRepositories). Default is `false`.
        """
        return pulumi.get(self, "use_namespaces")
