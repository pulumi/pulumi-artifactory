...
__all__ = ['RemoteBazelRepositoryArgs', 'RemoteBazelRepository']

@pulumi.input_type
class RemoteBazelRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 content_synchronisation: pulumi.Input[Optional['RemoteBazelRepositoryContentSynchronisationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] url: The remote repo URL. For the Bazel Central Registry, use `https://bcr.bazel.build/`.
    ...
    def content_synchronisation(self) -> pulumi.Input[Optional['RemoteBazelRepositoryContentSynchronisationArgs']]:
        return pulumi.get(self, "content_synchronisation")

    @content_synchronisation.setter
    def content_synchronisation(self, value: pulumi.Input[Optional['RemoteBazelRepositoryContentSynchronisationArgs']]):
...
@pulumi.input_type
class _RemoteBazelRepositoryState:
    def __init__(__self__, *,
                 allow_any_host_auth: pulumi.Input[Optional[_builtins.bool]] = None,
                 archive_browsing_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 assumed_offline_period_secs: pulumi.Input[Optional[_builtins.int]] = None,
...
@pulumi.type_token("artifactory:index/remoteBazelRepository:RemoteBazelRepository")
class RemoteBazelRepository(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 cdn_redirect: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_tls_certificate: pulumi.Input[Optional[_builtins.str]] = None,
                 content_synchronisation: pulumi.Input[Optional[Union['RemoteBazelRepositoryContentSynchronisationArgs', 'RemoteBazelRepositoryContentSynchronisationArgsDict', 'outputs.RemoteBazelRepositoryContentSynchronisation']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 disable_proxy: pulumi.Input[Optional[_builtins.bool]] = None,
                 disable_url_normalization: pulumi.Input[Optional[_builtins.bool]] = None,
                 download_direct: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        my_remote_bazelmodules = artifactory.RemoteBazelRepository("my-remote-bazelmodules",
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: RemoteBazelRepositoryArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Creates a remote Bazel Modules repository that proxies and caches modules from a Bazel registry, such as the [Bazel Central Registry (BCR)](https://bcr.bazel.build/). See [Bazel Modules Repositories](https://docs.jfrog.com/artifactory/docs/bazel-modules-repositories).
        ...
        :param str resource_name: The name of the resource.
        :param RemoteBazelRepositoryArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RemoteBazelRepositoryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RemoteBazelRepositoryArgs.__new__(RemoteBazelRepositoryArgs)
        ...
        super(RemoteBazelRepository, __self__).__init__(
            'artifactory:index/remoteBazelRepository:RemoteBazelRepository',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            url: pulumi.Input[Optional[_builtins.str]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'RemoteBazelRepository':
        """
        Get an existing RemoteBazelRepository resource's state with the given name, id, and optional extra
        ...
        __props__ = _RemoteBazelRepositoryState.__new__(_RemoteBazelRepositoryState)
        ...
        __props__.__dict__["username"] = username
        __props__.__dict__["xray_index"] = xray_index
        return RemoteBazelRepository(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output[Optional['outputs.RemoteBazelRepositoryContentSynchronisation']]:
        return pulumi.get(self, "content_synchronisation")
