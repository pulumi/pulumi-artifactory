...
class LocalRpmRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] calculate_yum_metadata: Default: `false`.
        ...
        :param pulumi.Input[builtins.bool] enable_file_lists_indexing: Default: `false`.
        ...
        :param pulumi.Input[builtins.str] primary_keypair_ref: The primary GPG key to be used to sign packages.
        ...
        :param pulumi.Input[builtins.str] secondary_keypair_ref: The secondary GPG key to be used to sign packages.
        :param pulumi.Input[builtins.bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        :param pulumi.Input[builtins.str] yum_group_file_names: A comma separated list of XML file names containing RPM group component definitions. 
        ...
        :param pulumi.Input[builtins.int] yum_root_depth: The depth, relative to the repository's root folder, where RPM metadata is created. 
...
class LocalRpmRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            xray_index: Optional[pulumi.Input[builtins.bool]] = None,
            yum_group_file_names: Optional[pulumi.Input[builtins.str]] = None,
            yum_root_depth: Optional[pulumi.Input[builtins.int]] = None) -> 'LocalRpmRepository':
        """
    ...
    @property
    @pulumi.getter(name="calculateYumMetadata")
    def calculate_yum_metadata(self) -> pulumi.Output[builtins.bool]:
        """
        Default: `false`.
        """
        return pulumi.get(self, "calculate_yum_metadata")
    ...
    @property
    @pulumi.getter(name="enableFileListsIndexing")
    def enable_file_lists_indexing(self) -> pulumi.Output[builtins.bool]:
        """
        Default: `false`.
        """
        return pulumi.get(self, "enable_file_lists_indexing")
    ...
    @property
    @pulumi.getter(name="primaryKeypairRef")
    def primary_keypair_ref(self) -> pulumi.Output[builtins.str]:
        """
        The primary GPG key to be used to sign packages.
        """
        return pulumi.get(self, "primary_keypair_ref")
    ...
    @property
    @pulumi.getter(name="secondaryKeypairRef")
    def secondary_keypair_ref(self) -> pulumi.Output[builtins.str]:
        """
        The secondary GPG key to be used to sign packages.
        """
        return pulumi.get(self, "secondary_keypair_ref")
    ...
    @property
    @pulumi.getter(name="yumGroupFileNames")
    def yum_group_file_names(self) -> pulumi.Output[builtins.str]:
        """
        A comma separated list of XML file names containing RPM group component definitions. 
        Artifactory includes the group definitions as part of the calculated RPM metadata, as well as automatically
        generating a gzipped version of the group files, if required. Default is empty string.
    ...
    @property
    @pulumi.getter(name="yumRootDepth")
    def yum_root_depth(self) -> pulumi.Output[builtins.int]:
        """
        The depth, relative to the repository's root folder, where RPM metadata is created. 
        This is useful when your repository contains multiple RPM repositories under parallel hierarchies. For example, if
        your RPMs are stored under 'fedora/linux/$releasever/$basearch', specify a depth of 4. Once the number of snapshots
