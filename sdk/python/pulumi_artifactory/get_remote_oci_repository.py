...
__all__ = [
    ...
    'AwaitableGetRemoteOciRepositoryResult',
    'get_remote_oci_repository',
    'get_remote_oci_repository_output',
]

@pulumi.output_type
class GetRemoteOciRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteOciRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteOciRepositoryResult(GetRemoteOciRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteOciRepositoryResult(
...
def get_remote_oci_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemoteOciRepositoryContentSynchronisationArgs', 'GetRemoteOciRepositoryContentSynchronisationArgsDict']] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteOciRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteOciRepository:getRemoteOciRepository', __args__, opts=opts, typ=GetRemoteOciRepositoryResult).value

    return AwaitableGetRemoteOciRepositoryResult(
...
def get_remote_oci_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteOciRepositoryContentSynchronisationArgs', 'GetRemoteOciRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteOciRepositoryResult]:
    """
    Retrieves a remote OCI repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteOciRepository:getRemoteOciRepository', __args__, opts=opts, typ=GetRemoteOciRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteOciRepositoryResult(
