...
def get_remote_oci_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
...
def get_remote_oci_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
