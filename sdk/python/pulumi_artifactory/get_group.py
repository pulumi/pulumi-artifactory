...
class GetGroupResult:
    ...
    def admin_privileges(self) -> builtins.bool:
        """
    ...
    def auto_join(self) -> builtins.bool:
        """
    ...
    def policy_manager(self) -> Optional[builtins.bool]:
        """
    ...
    def realm_attributes(self) -> Optional[builtins.str]:
        """
    ...
    def reports_manager(self) -> Optional[builtins.bool]:
        """
    ...
    def users_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def watch_manager(self) -> Optional[builtins.bool]:
        """
...
def get_group(admin_privileges: Optional[builtins.bool] = None,
              auto_join: Optional[builtins.bool] = None,
              description: Optional[builtins.str] = None,
              external_id: Optional[builtins.str] = None,
              include_users: Optional[builtins.str] = None,
              name: Optional[builtins.str] = None,
              policy_manager: Optional[builtins.bool] = None,
              realm: Optional[builtins.str] = None,
              realm_attributes: Optional[builtins.str] = None,
              reports_manager: Optional[builtins.bool] = None,
              users_names: Optional[Sequence[builtins.str]] = None,
              watch_manager: Optional[builtins.bool] = None,
    ...
    :param builtins.bool admin_privileges: Any users added to this group will automatically be assigned with admin privileges in the system.
    :param builtins.bool auto_join: When this parameter is set, any new users defined in the system are automatically assigned to this group.
    :param builtins.str description: A description for the group
    :param builtins.str external_id: New external group ID used to configure the corresponding group in Azure AD.
    :param builtins.str include_users: Determines if the group's associated user list will return as an attribute. Default is `false`.
    :param builtins.str name: Name of the group.
    :param builtins.bool policy_manager: When this override is set, User in the group can set Xray security and compliance policies. Default value is `false`.
    :param builtins.str realm: The realm for the group.
    :param builtins.str realm_attributes: The realm attributes for the group.
    :param builtins.bool reports_manager: When this override is set, User in the group can manage Xray Reports on any resource type. Default value is `false`.
    :param Sequence[builtins.str] users_names: List of users assigned to the group. Set include_users to `true` to retrieve this list.
    :param builtins.bool watch_manager: When this override is set, User in the group can manage Xray Watches on any resource type. Default value is `false`.
    """
    __args__ = dict()
...
def get_group_output(admin_privileges: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     auto_join: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     external_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     include_users: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     name: Optional[pulumi.Input[builtins.str]] = None,
                     policy_manager: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     realm: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     realm_attributes: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     reports_manager: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     users_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                     watch_manager: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
