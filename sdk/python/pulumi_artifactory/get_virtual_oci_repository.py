...
class GetVirtualOciRepositoryResult:
    ...
    def resolve_oci_tags_by_timestamp(self) -> Optional[builtins.bool]:
        """
...
def get_virtual_oci_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
                               ...
                               resolve_oci_tags_by_timestamp: Optional[builtins.bool] = None,
    ...
    :param builtins.bool resolve_oci_tags_by_timestamp: (Optional) When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
    """
    __args__ = dict()
...
def get_virtual_oci_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                      ...
                                      resolve_oci_tags_by_timestamp: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
