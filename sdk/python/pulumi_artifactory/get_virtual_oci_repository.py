...
__all__ = [
    'GetVirtualOciRepositoryResult',
    'AwaitableGetVirtualOciRepositoryResult',
    'get_virtual_oci_repository',
    'get_virtual_oci_repository_output',
]

@pulumi.output_type
class GetVirtualOciRepositoryResult:
    """
    A collection of values returned by getVirtualOciRepository.
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, default_deployment_repo=None, description=None, excludes_pattern=None, hide_unauthorized_resources=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None, resolve_oci_tags_by_timestamp=None):
    ...
    def resolve_oci_tags_by_timestamp(self) -> Optional[_builtins.bool]:
        """
...
class AwaitableGetVirtualOciRepositoryResult(GetVirtualOciRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualOciRepositoryResult(
...
def get_virtual_oci_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                               ...
                               resolve_oci_tags_by_timestamp: Optional[_builtins.bool] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualOciRepositoryResult:
    """
    ...
    :param _builtins.bool resolve_oci_tags_by_timestamp: (Optional) When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualOciRepository:getVirtualOciRepository', __args__, opts=opts, typ=GetVirtualOciRepositoryResult).value

    return AwaitableGetVirtualOciRepositoryResult(
...
def get_virtual_oci_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                      ...
                                      resolve_oci_tags_by_timestamp: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualOciRepositoryResult]:
    """
    Retrieves a virtual OCI repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualOciRepository:getVirtualOciRepository', __args__, opts=opts, typ=GetVirtualOciRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualOciRepositoryResult(
        ...
        resolve_oci_tags_by_timestamp=pulumi.get(__response__, 'resolve_oci_tags_by_timestamp')))
