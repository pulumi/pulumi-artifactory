...
def get_local_sbt_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
...
def get_local_sbt_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
