...
class GetFederatedDebianRepositoryResult:
    ...
    def index_compression_formats(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def trivial_layout(self) -> Optional[_builtins.bool]:
...
class AwaitableGetFederatedDebianRepositoryResult(GetFederatedDebianRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedDebianRepositoryResult(
...
def get_federated_debian_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                    ...
                                    members: Optional[Sequence[Union['GetFederatedDebianRepositoryMemberArgs', 'GetFederatedDebianRepositoryMemberArgsDict']]] = None,
                                    ...
                                    trivial_layout: Optional[_builtins.bool] = None,
    ...
    :param Sequence[Union['GetFederatedDebianRepositoryMemberArgs', 'GetFederatedDebianRepositoryMemberArgsDict']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedDebianRepository:getFederatedDebianRepository', __args__, opts=opts, typ=GetFederatedDebianRepositoryResult).value

    return AwaitableGetFederatedDebianRepositoryResult(
...
def get_federated_debian_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                           ...
                                           index_compression_formats: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                           key: Optional[pulumi.Input[_builtins.str]] = None,
                                           members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedDebianRepositoryMemberArgs', 'GetFederatedDebianRepositoryMemberArgsDict']]]]] = None,
                                           ...
                                           trivial_layout: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                           xray_index: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedDebianRepositoryResult]:
    """
    Retrieves a federated Debian repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedDebianRepository:getFederatedDebianRepository', __args__, opts=opts, typ=GetFederatedDebianRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedDebianRepositoryResult(
