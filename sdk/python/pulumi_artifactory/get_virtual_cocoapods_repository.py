...
__all__ = [
    ...
    'AwaitableGetVirtualCocoapodsRepositoryResult',
    'get_virtual_cocoapods_repository',
    'get_virtual_cocoapods_repository_output',
]

@pulumi.output_type
class GetVirtualCocoapodsRepositoryResult:
    """
    A collection of values returned by getVirtualCocoapodsRepository.
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, default_deployment_repo=None, description=None, excludes_pattern=None, hide_unauthorized_resources=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None):
...
class AwaitableGetVirtualCocoapodsRepositoryResult(GetVirtualCocoapodsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualCocoapodsRepositoryResult(
...
def get_virtual_cocoapods_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualCocoapodsRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualCocoapodsRepository:getVirtualCocoapodsRepository', __args__, opts=opts, typ=GetVirtualCocoapodsRepositoryResult).value

    return AwaitableGetVirtualCocoapodsRepositoryResult(
...
def get_virtual_cocoapods_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualCocoapodsRepositoryResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualCocoapodsRepository:getVirtualCocoapodsRepository', __args__, opts=opts, typ=GetVirtualCocoapodsRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualCocoapodsRepositoryResult(
