...
__all__ = [
    ...
    'AwaitableGetRemoteSbtRepositoryResult',
    'get_remote_sbt_repository',
    'get_remote_sbt_repository_output',
]

@pulumi.output_type
class GetRemoteSbtRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteSbtRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteSbtRepositoryResult(GetRemoteSbtRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteSbtRepositoryResult(
...
def get_remote_sbt_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemoteSbtRepositoryContentSynchronisationArgs', 'GetRemoteSbtRepositoryContentSynchronisationArgsDict']] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteSbtRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteSbtRepository:getRemoteSbtRepository', __args__, opts=opts, typ=GetRemoteSbtRepositoryResult).value

    return AwaitableGetRemoteSbtRepositoryResult(
...
def get_remote_sbt_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteSbtRepositoryContentSynchronisationArgs', 'GetRemoteSbtRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteSbtRepositoryResult]:
    """
    Retrieves a remote SBT repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteSbtRepository:getRemoteSbtRepository', __args__, opts=opts, typ=GetRemoteSbtRepositoryResult)
