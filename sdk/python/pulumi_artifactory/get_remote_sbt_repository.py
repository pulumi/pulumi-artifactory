...
def get_remote_sbt_repository(allow_any_host_auth: Optional[builtins.bool] = None,
...
def get_remote_sbt_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
