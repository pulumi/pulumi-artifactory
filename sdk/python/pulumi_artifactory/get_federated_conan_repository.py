...
__all__ = [
    ...
    'AwaitableGetFederatedConanRepositoryResult',
    'get_federated_conan_repository',
    'get_federated_conan_repository_output',
]

@pulumi.output_type
class GetFederatedConanRepositoryResult:
    """
    A collection of values returned by getFederatedConanRepository.
    """
    def __init__(__self__, archive_browsing_enabled=None, blacked_out=None, cdn_redirect=None, cleanup_on_delete=None, description=None, disable_proxy=None, download_direct=None, excludes_pattern=None, force_conan_authentication=None, id=None, includes_pattern=None, key=None, members=None, notes=None, package_type=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, repo_layout_ref=None, xray_index=None):
...
class AwaitableGetFederatedConanRepositoryResult(GetFederatedConanRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedConanRepositoryResult(
...
def get_federated_conan_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedConanRepository:getFederatedConanRepository', __args__, opts=opts, typ=GetFederatedConanRepositoryResult).value

    return AwaitableGetFederatedConanRepositoryResult(
...
def get_federated_conan_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedConanRepositoryResult]:
    """
    Retrieves a federated Conan repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedConanRepository:getFederatedConanRepository', __args__, opts=opts, typ=GetFederatedConanRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedConanRepositoryResult(
