...
def get_local_alpine_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.str primary_keypair_ref: The RSA key to be used to sign alpine indices.
    """
    __args__ = dict()
...
def get_local_alpine_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
