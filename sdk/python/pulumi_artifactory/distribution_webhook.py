...
class DistributionWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `distribute_started`, `distribute_completed`, `distribute_aborted`, `distribute_failed, `delete_started`, `delete_completed`, `delete_failed`
...
class DistributionWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 criteria: Optional[pulumi.Input[Union['DistributionWebhookCriteriaArgs', 'DistributionWebhookCriteriaArgsDict']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 handlers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DistributionWebhookHandlerArgs', 'DistributionWebhookHandlerArgsDict']]]]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[builtins.bool] enabled: Status of webhook. Default to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `distribute_started`, `distribute_completed`, `distribute_aborted`, `distribute_failed, `delete_started`, `delete_completed`, `delete_failed`
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributionWebhookHandlerArgs', 'DistributionWebhookHandlerArgsDict']]]] handlers: At least one is required.
        :param pulumi.Input[builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            handlers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DistributionWebhookHandlerArgs', 'DistributionWebhookHandlerArgsDict']]]]] = None,
            key: Optional[pulumi.Input[builtins.str]] = None) -> 'DistributionWebhook':
        """
    ...
    @property
    @pulumi.getter
    def criteria(self) -> pulumi.Output[Optional['outputs.DistributionWebhookCriteria']]:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @property
    @pulumi.getter
    def handlers(self) -> pulumi.Output[Optional[Sequence['outputs.DistributionWebhookHandler']]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
