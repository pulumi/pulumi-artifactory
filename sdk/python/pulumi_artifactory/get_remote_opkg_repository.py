...
def get_remote_opkg_repository(allow_any_host_auth: Optional[builtins.bool] = None,
...
def get_remote_opkg_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
