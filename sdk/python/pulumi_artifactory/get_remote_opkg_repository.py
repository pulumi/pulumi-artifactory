...
__all__ = [
    'GetRemoteOpkgRepositoryResult',
    'AwaitableGetRemoteOpkgRepositoryResult',
    'get_remote_opkg_repository',
    'get_remote_opkg_repository_output',
]

@pulumi.output_type
class GetRemoteOpkgRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteOpkgRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteOpkgRepositoryResult(GetRemoteOpkgRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteOpkgRepositoryResult(
...
def get_remote_opkg_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                               ...
                               content_synchronisation: Optional[Union['GetRemoteOpkgRepositoryContentSynchronisationArgs', 'GetRemoteOpkgRepositoryContentSynchronisationArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteOpkgRepository:getRemoteOpkgRepository', __args__, opts=opts, typ=GetRemoteOpkgRepositoryResult).value

    return AwaitableGetRemoteOpkgRepositoryResult(
...
def get_remote_opkg_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteOpkgRepositoryContentSynchronisationArgs', 'GetRemoteOpkgRepositoryContentSynchronisationArgsDict']]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteOpkgRepositoryResult]:
    """
    Retrieves a remote Opkg repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteOpkgRepository:getRemoteOpkgRepository', __args__, opts=opts, typ=GetRemoteOpkgRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteOpkgRepositoryResult(
