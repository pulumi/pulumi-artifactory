...
__all__ = [
    'GetFederatedGoRepositoryResult',
    'AwaitableGetFederatedGoRepositoryResult',
    'get_federated_go_repository',
    'get_federated_go_repository_output',
]

@pulumi.output_type
class GetFederatedGoRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedGoRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedGoRepositoryResult(GetFederatedGoRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedGoRepositoryResult(
...
def get_federated_go_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                ...
                                members: Optional[Sequence[Union['GetFederatedGoRepositoryMemberArgs', 'GetFederatedGoRepositoryMemberArgsDict', 'outputs.GetFederatedGoRepositoryMemberResult']]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedGoRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedGoRepositoryMemberArgs', 'GetFederatedGoRepositoryMemberArgsDict', 'outputs.GetFederatedGoRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedGoRepository:getFederatedGoRepository', __args__, opts=opts, typ=GetFederatedGoRepositoryResult).value

    return AwaitableGetFederatedGoRepositoryResult(
...
def get_federated_go_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                       ...
                                       members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedGoRepositoryMemberArgs', 'GetFederatedGoRepositoryMemberArgsDict', 'outputs.GetFederatedGoRepositoryMemberResult']]]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedGoRepositoryResult]:
    """
    Retrieves a federated Go repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedGoRepository:getFederatedGoRepository', __args__, opts=opts, typ=GetFederatedGoRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedGoRepositoryResult(
