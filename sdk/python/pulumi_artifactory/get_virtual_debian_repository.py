...
__all__ = [
    'GetVirtualDebianRepositoryResult',
    'AwaitableGetVirtualDebianRepositoryResult',
    'get_virtual_debian_repository',
    'get_virtual_debian_repository_output',
]

@pulumi.output_type
class GetVirtualDebianRepositoryResult:
    """
    A collection of values returned by getVirtualDebianRepository.
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, debian_default_architectures=None, default_deployment_repo=None, description=None, excludes_pattern=None, id=None, includes_pattern=None, key=None, notes=None, optional_index_compression_formats=None, package_type=None, primary_keypair_ref=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None, retrieval_cache_period_seconds=None, secondary_keypair_ref=None):
        ...
        if debian_default_architectures and not isinstance(debian_default_architectures, str):
            raise TypeError("Expected argument 'debian_default_architectures' to be a str")
        ...
        if optional_index_compression_formats and not isinstance(optional_index_compression_formats, list):
            raise TypeError("Expected argument 'optional_index_compression_formats' to be a list")
    ...
    def debian_default_architectures(self) -> Optional[builtins.str]:
        """
    ...
    def optional_index_compression_formats(self) -> Sequence[builtins.str]:
        """
    ...
    def primary_keypair_ref(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_keypair_ref(self) -> Optional[builtins.str]:
        """
...
class AwaitableGetVirtualDebianRepositoryResult(GetVirtualDebianRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualDebianRepositoryResult(
            artifactory_requests_can_retrieve_remote_artifacts=self.artifactory_requests_can_retrieve_remote_artifacts,
            debian_default_architectures=self.debian_default_architectures,
            ...
            key=self.key,
            notes=self.notes,
            optional_index_compression_formats=self.optional_index_compression_formats,
...
def get_virtual_debian_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
                                  debian_default_architectures: Optional[builtins.str] = None,
                                  ...
                                  optional_index_compression_formats: Optional[Sequence[builtins.str]] = None,
                                  primary_keypair_ref: Optional[builtins.str] = None,
                                  ...
                                  secondary_keypair_ref: Optional[builtins.str] = None,
    ...
    :param builtins.str debian_default_architectures: (Optional) Specifying  architectures will speed up Artifactory's initial metadata indexing process. The default architecture values are amd64 and i386.
    :param builtins.str key: the identity key of the repo.
    :param Sequence[builtins.str] optional_index_compression_formats: (Optional) Index file formats you would like to create in addition to the default Gzip (.gzip extension). Supported values are `bz2`,`lzma` and `xz`. Default value is `bz2`.
    :param builtins.str primary_keypair_ref: (Optional) Primary keypair used to sign artifacts. Default is empty.
    :param builtins.int retrieval_cache_period_seconds: (Optional, Default: `7200`) This value refers to the number of seconds to cache metadata files before checking for newer versions on aggregated repositories. A value of 0 indicates no caching.
    :param builtins.str secondary_keypair_ref: (Optional) Secondary keypair used to sign artifacts. Default is empty.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualDebianRepository:getVirtualDebianRepository', __args__, opts=opts, typ=GetVirtualDebianRepositoryResult).value

    return AwaitableGetVirtualDebianRepositoryResult(
        artifactory_requests_can_retrieve_remote_artifacts=pulumi.get(__ret__, 'artifactory_requests_can_retrieve_remote_artifacts'),
        debian_default_architectures=pulumi.get(__ret__, 'debian_default_architectures'),
        ...
        optional_index_compression_formats=pulumi.get(__ret__, 'optional_index_compression_formats'),
...
def get_virtual_debian_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         debian_default_architectures: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         ...
                                         optional_index_compression_formats: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                         primary_keypair_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         ...
                                         secondary_keypair_ref: Optional[pulumi.Input[Optional[builtins.str]]] = None,
