...
class RemoteNugetRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] store_artifacts_locally: When set, the repository should store cached artifacts locally. When not set, artifacts are not stored locally, and
               ...
               servers.
        :param pulumi.Input[str] symbol_server_url: NuGet symbol server URL. Default value is `https://symbols.nuget.org/download/symbols`.
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        RemoteNugetRepositoryArgs._configure(
    ...
    def _configure(
        ...
        if download_context_path is None and 'downloadContextPath' in kwargs:
            download_context_path = kwargs['downloadContextPath']
        ...
        if feed_context_path is None and 'feedContextPath' in kwargs:
            feed_context_path = kwargs['feedContextPath']
        if force_nuget_authentication is None and 'forceNugetAuthentication' in kwargs:
            force_nuget_authentication = kwargs['forceNugetAuthentication']
        ...
        if symbol_server_url is None and 'symbolServerUrl' in kwargs:
            symbol_server_url = kwargs['symbolServerUrl']
        ...
        if v3_feed_url is None and 'v3FeedUrl' in kwargs:
            v3_feed_url = kwargs['v3FeedUrl']
        ...
        if download_context_path is not None:
            _setter("download_context_path", download_context_path)
        ...
        if feed_context_path is not None:
            _setter("feed_context_path", feed_context_path)
        if force_nuget_authentication is not None:
            _setter("force_nuget_authentication", force_nuget_authentication)
        ...
        if symbol_server_url is not None:
            _setter("symbol_server_url", symbol_server_url)
        ...
        if v3_feed_url is not None:
            _setter("v3_feed_url", v3_feed_url)
    ...
    def symbol_server_url(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def symbol_server_url(self, value: Optional[pulumi.Input[str]]):
...
class _RemoteNugetRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _RemoteNugetRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            allow_any_host_auth=allow_any_host_auth,
            assumed_offline_period_secs=assumed_offline_period_secs,
            blacked_out=blacked_out,
...
class RemoteNugetRepository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RemoteNugetRepositoryArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if content_synchronisation is not None and not isinstance(content_synchronisation, RemoteNugetRepositoryContentSynchronisationArgs):
                content_synchronisation = content_synchronisation or {}
                def _setter(key, value):
                    content_synchronisation[key] = value
                RemoteNugetRepositoryContentSynchronisationArgs._configure(_setter, **content_synchronisation)
    ...
    def get(resource_name: str,
            ...
            username: Optional[pulumi.Input[str]] = None,
            v3_feed_url: Optional[pulumi.Input[str]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'RemoteNugetRepository':
        """
    ...
    @property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output['outputs.RemoteNugetRepositoryContentSynchronisation']:
        return pulumi.get(self, "content_synchronisation")
    ...
    @property
    @pulumi.getter(name="symbolServerUrl")
    def symbol_server_url(self) -> pulumi.Output[Optional[str]]:
        """
        NuGet symbol server URL. Default value is `https://symbols.nuget.org/download/symbols`.
        """
        return pulumi.get(self, "symbol_server_url")
