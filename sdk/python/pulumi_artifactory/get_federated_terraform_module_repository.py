...
__all__ = [
    ...
    'AwaitableGetFederatedTerraformModuleRepositoryResult',
    'get_federated_terraform_module_repository',
    'get_federated_terraform_module_repository_output',
]

@pulumi.output_type
class GetFederatedTerraformModuleRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedTerraformModuleRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedTerraformModuleRepositoryResult(GetFederatedTerraformModuleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedTerraformModuleRepositoryResult(
...
def get_federated_terraform_module_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                              ...
                                              members: Optional[Sequence[Union['GetFederatedTerraformModuleRepositoryMemberArgs', 'GetFederatedTerraformModuleRepositoryMemberArgsDict', 'outputs.GetFederatedTerraformModuleRepositoryMemberResult']]] = None,
    ...
    :param Sequence[Union['GetFederatedTerraformModuleRepositoryMemberArgs', 'GetFederatedTerraformModuleRepositoryMemberArgsDict', 'outputs.GetFederatedTerraformModuleRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedTerraformModuleRepository:getFederatedTerraformModuleRepository', __args__, opts=opts, typ=GetFederatedTerraformModuleRepositoryResult).value

    return AwaitableGetFederatedTerraformModuleRepositoryResult(
...
def get_federated_terraform_module_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                                     ...
                                                     members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedTerraformModuleRepositoryMemberArgs', 'GetFederatedTerraformModuleRepositoryMemberArgsDict', 'outputs.GetFederatedTerraformModuleRepositoryMemberResult']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedTerraformModuleRepository:getFederatedTerraformModuleRepository', __args__, opts=opts, typ=GetFederatedTerraformModuleRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedTerraformModuleRepositoryResult(
