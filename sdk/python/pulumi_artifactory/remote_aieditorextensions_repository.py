...
__all__ = ['RemoteAieditorextensionsRepositoryArgs', 'RemoteAieditorextensionsRepository']

@pulumi.input_type
class RemoteAieditorextensionsRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 content_synchronisation: pulumi.Input[Optional['RemoteAieditorextensionsRepositoryContentSynchronisationArgs']] = None,
                 curated: pulumi.Input[Optional[_builtins.bool]] = None,
                 custom_http_headers: pulumi.Input[Optional[Sequence[pulumi.Input['RemoteAieditorextensionsRepositoryCustomHttpHeaderArgs']]]] = None,
                 ...
                 external_dependencies_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 external_dependencies_patterns: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.bool] enable_token_authentication: Enable token (Bearer) based authentication. Default value is `false`, matching the common remote default. OCI, Helm OCI, and Hugging Face remotes default to `true`.
        ...
        :param pulumi.Input[_builtins.bool] external_dependencies_enabled: When set, Artifactory can resolve extension dependencies from the external sources matching `external_dependencies_patterns`. Unlike other remote repository types, this defaults to `true` for AI-Editor Extensions because extension payloads are hosted on a CDN separate from the gallery URL.
        ...
        :param pulumi.Input[_builtins.str] mismatching_mime_types_override_list: The set of mime types that should override the block_mismatching_mime_types setting. Eg: 'application/json,application/xml'. Default value is empty.
        ...
        :param pulumi.Input[_builtins.bool] pass_through: Enable Pass-through for Curation Audit. When enabled, allows artifacts to pass through the Curation audit process. Default value is `false`.
        ...
        :param pulumi.Input[_builtins.bool] propagate_query_params: When set, if query params are included in the request to Artifactory, they will be passed on to the remote repository. Default value is `false`.
        ...
        :param pulumi.Input[_builtins.bool] retrieve_sha256_from_server: When set to `true`, Artifactory retrieves the SHA256 from the remote server if it is not cached in the remote repo. Default value is `false`.
    ...
    def content_synchronisation(self) -> pulumi.Input[Optional['RemoteAieditorextensionsRepositoryContentSynchronisationArgs']]:
        return pulumi.get(self, "content_synchronisation")

    @content_synchronisation.setter
    def content_synchronisation(self, value: pulumi.Input[Optional['RemoteAieditorextensionsRepositoryContentSynchronisationArgs']]):
    ...
    def custom_http_headers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RemoteAieditorextensionsRepositoryCustomHttpHeaderArgs']]]]:
        """
    ...
    def custom_http_headers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RemoteAieditorextensionsRepositoryCustomHttpHeaderArgs']]]]):
    ...
    def external_dependencies_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        When set, Artifactory can resolve extension dependencies from the external sources matching `external_dependencies_patterns`. Unlike other remote repository types, this defaults to `true` for AI-Editor Extensions because extension payloads are hosted on a CDN separate from the gallery URL.
        """
        return pulumi.get(self, "external_dependencies_enabled")

    @external_dependencies_enabled.setter
    def external_dependencies_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "external_dependencies_enabled", value)

    @_builtins.property
    @pulumi.getter(name="externalDependenciesPatterns")
    def external_dependencies_patterns(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        An allow list of Ant-style path patterns that determine which remote hosts external extension dependencies may be downloaded from. Only takes effect when `external_dependencies_enabled` is `true`, but Artifactory stores the patterns either way, so they may be set while it is `false`. Default value is `["**/**vsassets.io/**"]`. An empty list is not accepted — the provider requires at least one pattern.
        """
    ...
    def external_dependencies_patterns(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
@pulumi.input_type
class _RemoteAieditorextensionsRepositoryState:
    def __init__(__self__, *,
                 allow_any_host_auth: pulumi.Input[Optional[_builtins.bool]] = None,
                 archive_browsing_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 assumed_offline_period_secs: pulumi.Input[Optional[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.bool] blacked_out: (A.K.A 'Ignore Repository' on the UI) When set, the repository or its local cache do not participate in artifact resolution.
        :param pulumi.Input[_builtins.bool] block_mismatching_mime_types: If set, artifacts will fail to download if a mismatch is detected between requested and received mimetype, according to the list specified in the system properties file under blockedMismatchingMimeTypes. You can override by adding mimetypes to the override list 'mismatching_mime_types_override_list'.
        :param pulumi.Input[_builtins.bool] bypass_head_requests: Artifactory always enables this setting for AI-Editor Extensions repositories, rather than `false` as on other remote repository types, and rejects any request that tries to change it. It is therefore exposed as a read-only attribute that always reports `true` and cannot be set in configuration (setting it — even to `true` — produces a "read-only attribute" error).
        :param pulumi.Input[_builtins.bool] cdn_redirect: When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
        :param pulumi.Input[_builtins.str] client_tls_certificate: Client TLS certificate name.
        :param pulumi.Input[_builtins.bool] curated: Enable repository to be protected by the Curation service. Default value is `false`.
        :param pulumi.Input[Sequence[pulumi.Input['RemoteAieditorextensionsRepositoryCustomHttpHeaderArgs']]] custom_http_headers: Up to 5 custom HTTP headers sent on every outbound request to the remote URL. Requires Artifactory 7.146.0 or later. Header values are write-only: they are masked in plan output and never read back from Artifactory, so `pulumi import` cannot recover them. To remove all headers, remove the attribute. Each entry supports:
...
@pulumi.type_token("artifactory:index/remoteAieditorextensionsRepository:RemoteAieditorextensionsRepository")
class RemoteAieditorextensionsRepository(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RemoteAieditorextensionsRepositoryArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RemoteAieditorextensionsRepositoryArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RemoteAieditorextensionsRepositoryArgs.__new__(RemoteAieditorextensionsRepositoryArgs)
            ...
            __props__.__dict__["bypass_head_requests"] = None
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["password", "passwordWo"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(RemoteAieditorextensionsRepository, __self__).__init__(
            'artifactory:index/remoteAieditorextensionsRepository:RemoteAieditorextensionsRepository',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            url: pulumi.Input[Optional[_builtins.str]] = None,
            username: pulumi.Input[Optional[_builtins.str]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'RemoteAieditorextensionsRepository':
        """
        ...
        __props__ = _RemoteAieditorextensionsRepositoryState.__new__(_RemoteAieditorextensionsRepositoryState)
        ...
        __props__.__dict__["username"] = username
        __props__.__dict__["xray_index"] = xray_index
        return RemoteAieditorextensionsRepository(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="contentSynchronisation")
    def content_synchronisation(self) -> pulumi.Output[Optional['outputs.RemoteAieditorextensionsRepositoryContentSynchronisation']]:
        return pulumi.get(self, "content_synchronisation")
    ...
    @_builtins.property
    @pulumi.getter(name="customHttpHeaders")
    def custom_http_headers(self) -> pulumi.Output[Optional[Sequence['outputs.RemoteAieditorextensionsRepositoryCustomHttpHeader']]]:
        """
        Up to 5 custom HTTP headers sent on every outbound request to the remote URL. Requires Artifactory 7.146.0 or later. Header values are write-only: they are masked in plan output and never read back from Artifactory, so `pulumi import` cannot recover them. To remove all headers, remove the attribute. Each entry supports:
        """
        return pulumi.get(self, "custom_http_headers")
    ...
    @_builtins.property
    @pulumi.getter(name="externalDependenciesPatterns")
    def external_dependencies_patterns(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        An allow list of Ant-style path patterns that determine which remote hosts external extension dependencies may be downloaded from. Only takes effect when `external_dependencies_enabled` is `true`, but Artifactory stores the patterns either way, so they may be set while it is `false`. Default value is `["**/**vsassets.io/**"]`. An empty list is not accepted — the provider requires at least one pattern.
        """
        return pulumi.get(self, "external_dependencies_patterns")
