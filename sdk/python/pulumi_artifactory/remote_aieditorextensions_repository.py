...
class RemoteAieditorextensionsRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_token_authentication: Enable token (Bearer) based authentication. Default value is `false`. Note this differs from the Docker and OCI remote repository resources, which default it to `true`; `false` matches the Artifactory default for this package type.
