...
__all__ = [
    'GetLocalGoRepositoryResult',
    'AwaitableGetLocalGoRepositoryResult',
    'get_local_go_repository',
    'get_local_go_repository_output',
]

@pulumi.output_type
class GetLocalGoRepositoryResult:
    """
...
class AwaitableGetLocalGoRepositoryResult(GetLocalGoRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalGoRepositoryResult(
...
def get_local_go_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalGoRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalGoRepository:getLocalGoRepository', __args__, opts=opts, typ=GetLocalGoRepositoryResult).value

    return AwaitableGetLocalGoRepositoryResult(
...
def get_local_go_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalGoRepositoryResult]:
    """
    Retrieves a local go repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalGoRepository:getLocalGoRepository', __args__, opts=opts, typ=GetLocalGoRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalGoRepositoryResult(
