...
__all__ = [
    ...
    'AwaitableGetVirtualSwiftRepositoryResult',
    'get_virtual_swift_repository',
    'get_virtual_swift_repository_output',
]

@pulumi.output_type
class GetVirtualSwiftRepositoryResult:
    """
...
class AwaitableGetVirtualSwiftRepositoryResult(GetVirtualSwiftRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualSwiftRepositoryResult(
...
def get_virtual_swift_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualSwiftRepository:getVirtualSwiftRepository', __args__, opts=opts, typ=GetVirtualSwiftRepositoryResult).value

    return AwaitableGetVirtualSwiftRepositoryResult(
...
def get_virtual_swift_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualSwiftRepositoryResult]:
    """
    Retrieves a virtual Swift repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualSwiftRepository:getVirtualSwiftRepository', __args__, opts=opts, typ=GetVirtualSwiftRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualSwiftRepositoryResult(
