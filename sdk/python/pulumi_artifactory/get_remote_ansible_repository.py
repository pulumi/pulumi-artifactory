...
def get_remote_ansible_repository(allow_any_host_auth: Optional[bool] = None,
...
def get_remote_ansible_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[bool]]] = None,
