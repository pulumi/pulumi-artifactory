...
__all__ = [
    'GetRemoteAnsibleRepositoryResult',
    'AwaitableGetRemoteAnsibleRepositoryResult',
    'get_remote_ansible_repository',
    'get_remote_ansible_repository_output',
]

@pulumi.output_type
class GetRemoteAnsibleRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteAnsibleRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteAnsibleRepositoryResult(GetRemoteAnsibleRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteAnsibleRepositoryResult(
...
def get_remote_ansible_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                  ...
                                  content_synchronisation: Optional[Union['GetRemoteAnsibleRepositoryContentSynchronisationArgs', 'GetRemoteAnsibleRepositoryContentSynchronisationArgsDict']] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteAnsibleRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteAnsibleRepository:getRemoteAnsibleRepository', __args__, opts=opts, typ=GetRemoteAnsibleRepositoryResult).value

    return AwaitableGetRemoteAnsibleRepositoryResult(
...
def get_remote_ansible_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                         ...
                                         content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteAnsibleRepositoryContentSynchronisationArgs', 'GetRemoteAnsibleRepositoryContentSynchronisationArgsDict']]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteAnsibleRepositoryResult]:
    """
    Retrieves a remote Ansible repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteAnsibleRepository:getRemoteAnsibleRepository', __args__, opts=opts, typ=GetRemoteAnsibleRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteAnsibleRepositoryResult(
