...
class VirtualNugetRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] force_nuget_authentication: If set, user authentication is required when accessing the repository. An anonymous request will display an HTTP 401 error. This is also enforced when aggregated repositories support anonymous requests. Default is `false`.
...
class VirtualNugetRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_key: Optional[pulumi.Input[_builtins.str]] = None,
            repo_layout_ref: Optional[pulumi.Input[_builtins.str]] = None,
            repositories: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'VirtualNugetRepository':
        """
