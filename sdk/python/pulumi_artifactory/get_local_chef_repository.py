...
def get_local_chef_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.str key: (Required) the identity key of the repo.
...
def get_local_chef_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
