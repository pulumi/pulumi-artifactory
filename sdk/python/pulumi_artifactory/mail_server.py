...
class MailServerArgs:
    def __init__(__self__, *,
                 ...
                 artifactory_url: Optional[pulumi.Input[builtins.str]] = None,
                 from_: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 subject_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] enabled: When set, mail notifications are enabled.
        :param pulumi.Input[builtins.str] host: The mail server IP address / DNS.
        :param pulumi.Input[builtins.int] port: The port number of the mail server.
        :param pulumi.Input[builtins.str] artifactory_url: The Artifactory URL to to link to in all outgoing messages.
        :param pulumi.Input[builtins.str] from_: The 'from' address header to use in all outgoing messages.
        :param pulumi.Input[builtins.str] password: The password for authentication with the mail server.
        :param pulumi.Input[builtins.str] subject_prefix: A prefix to use for the subject of all outgoing mails.
        :param pulumi.Input[builtins.bool] use_ssl: When set to 'true', uses a secure connection to the mail server.
        :param pulumi.Input[builtins.bool] use_tls: When set to 'true', uses Transport Layer Security when connecting to the mail server.
        :param pulumi.Input[builtins.str] username: The username for authentication with the mail server.
        """
    ...
    def artifactory_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def artifactory_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subject_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subject_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MailServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            use_ssl: Optional[pulumi.Input[builtins.bool]] = None,
            use_tls: Optional[pulumi.Input[builtins.bool]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'MailServer':
        """
    ...
    @property
    @pulumi.getter(name="artifactoryUrl")
    def artifactory_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Artifactory URL to to link to in all outgoing messages.
        """
        return pulumi.get(self, "artifactory_url")
    ...
    @property
    @pulumi.getter(name="from")
    def from_(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The 'from' address header to use in all outgoing messages.
        """
        return pulumi.get(self, "from_")
    ...
    @property
    @pulumi.getter(name="subjectPrefix")
    def subject_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A prefix to use for the subject of all outgoing mails.
        """
        return pulumi.get(self, "subject_prefix")
    ...
    @property
    @pulumi.getter(name="useSsl")
    def use_ssl(self) -> pulumi.Output[builtins.bool]:
        """
        When set to 'true', uses a secure connection to the mail server.
        """
        return pulumi.get(self, "use_ssl")
    ...
    @property
    @pulumi.getter(name="useTls")
    def use_tls(self) -> pulumi.Output[builtins.bool]:
        """
        When set to 'true', uses Transport Layer Security when connecting to the mail server.
        """
        return pulumi.get(self, "use_tls")
