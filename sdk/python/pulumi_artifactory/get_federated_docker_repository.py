...
__all__ = [
    ...
    'AwaitableGetFederatedDockerRepositoryResult',
    'get_federated_docker_repository',
    'get_federated_docker_repository_output',
]

@pulumi.output_type
class GetFederatedDockerRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedDockerRepositoryMemberResult']]:
...
class AwaitableGetFederatedDockerRepositoryResult(GetFederatedDockerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedDockerRepositoryResult(
...
def get_federated_docker_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                    ...
                                    members: Optional[Sequence[Union['GetFederatedDockerRepositoryMemberArgs', 'GetFederatedDockerRepositoryMemberArgsDict']]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedDockerRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedDockerRepository:getFederatedDockerRepository', __args__, opts=opts, typ=GetFederatedDockerRepositoryResult).value

    return AwaitableGetFederatedDockerRepositoryResult(
...
def get_federated_docker_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                           ...
                                           members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedDockerRepositoryMemberArgs', 'GetFederatedDockerRepositoryMemberArgsDict']]]]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedDockerRepositoryResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedDockerRepository:getFederatedDockerRepository', __args__, opts=opts, typ=GetFederatedDockerRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedDockerRepositoryResult(
