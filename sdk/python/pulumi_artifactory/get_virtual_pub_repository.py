...
def get_virtual_pub_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
...
def get_virtual_pub_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualPubRepositoryResult]:
    """
    Retrieves a virtual Pub repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualPubRepository:getVirtualPubRepository', __args__, opts=opts, typ=GetVirtualPubRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualPubRepositoryResult(
