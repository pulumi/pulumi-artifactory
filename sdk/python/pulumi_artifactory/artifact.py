...
class ArtifactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] file_path: Path to the source file. Conflicts with `content_base64`. Either one of these attribute must be set.
        """
...
class _ArtifactState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] content_base64: Base64 content of the source file. Conflicts with `file_path`. Either one of these attribute must be set.
        :param pulumi.Input[_builtins.str] created: Timestamp when artifact is created.
        :param pulumi.Input[_builtins.str] created_by: User who deploys the artifact.
        :param pulumi.Input[_builtins.str] download_uri: Download URI of the artifact.
        :param pulumi.Input[_builtins.str] file_path: Path to the source file. Conflicts with `content_base64`. Either one of these attribute must be set.
        :param pulumi.Input[_builtins.str] mime_type: MIME type of the artifact.
        :param pulumi.Input[_builtins.str] path: The relative path in the target repository. Must begin with a '/'. You can add key-value matrix parameters to deploy the artifacts with properties. For more details, please refer to [Introducing Matrix Parameters](https://jfrog.com/help/r/jfrog-artifactory-documentation/using-properties-in-deployment-and-resolution).
        :param pulumi.Input[_builtins.str] repository: Name of the respository.
        :param pulumi.Input[_builtins.int] size: Size of the artifact, in bytes.
        :param pulumi.Input[_builtins.str] uri: URI of the artifact.
        """
...
class Artifact(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="checksumMd5")
    def checksum_md5(self) -> pulumi.Output[_builtins.str]:
        """
        MD5 checksum of the artifact.
        """
        return pulumi.get(self, "checksum_md5")
