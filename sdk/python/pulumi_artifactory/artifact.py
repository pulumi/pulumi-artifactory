...
class ArtifactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] path: The relative path in the target repository. Must begin with a '/'. You can add key-value matrix parameters to deploy the artifacts with properties. For more details, please refer to [Introducing Matrix Parameters](https://jfrog.com/help/r/jfrog-artifactory-documentation/using-properties-in-deployment-and-resolution).
        :param pulumi.Input[builtins.str] repository: Name of the respository.
        :param pulumi.Input[builtins.str] content_base64: Base64 content of the source file. Conflicts with `file_path`. Either one of these attribute must be set.
        :param pulumi.Input[builtins.str] file_path: Path to the source file. Conflicts with `content_base64`. Either one of these attribute must be set.
        """
...
class _ArtifactState:
    def __init__(__self__, *,
                 checksum_md5: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] checksum_md5: MD5 checksum of the artifact.
        :param pulumi.Input[builtins.str] checksum_sha1: SHA1 checksum of the artifact.
        :param pulumi.Input[builtins.str] checksum_sha256: SHA256 checksum of the artifact.
        :param pulumi.Input[builtins.str] content_base64: Base64 content of the source file. Conflicts with `file_path`. Either one of these attribute must be set.
        :param pulumi.Input[builtins.str] created: Timestamp when artifact is created.
        :param pulumi.Input[builtins.str] created_by: User who deploys the artifact.
        :param pulumi.Input[builtins.str] download_uri: Download URI of the artifact.
        :param pulumi.Input[builtins.str] file_path: Path to the source file. Conflicts with `content_base64`. Either one of these attribute must be set.
        :param pulumi.Input[builtins.str] mime_type: MIME type of the artifact.
        :param pulumi.Input[builtins.str] path: The relative path in the target repository. Must begin with a '/'. You can add key-value matrix parameters to deploy the artifacts with properties. For more details, please refer to [Introducing Matrix Parameters](https://jfrog.com/help/r/jfrog-artifactory-documentation/using-properties-in-deployment-and-resolution).
        :param pulumi.Input[builtins.str] repository: Name of the respository.
        :param pulumi.Input[builtins.int] size: Size of the artifact, in bytes.
        :param pulumi.Input[builtins.str] uri: URI of the artifact.
        """
    ...
    def checksum_md5(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @checksum_md5.setter
    def checksum_md5(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Artifact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repository: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'Artifact':
        """
    ...
    @property
    @pulumi.getter(name="checksumMd5")
    def checksum_md5(self) -> pulumi.Output[builtins.str]:
        """
        MD5 checksum of the artifact.
        """
        return pulumi.get(self, "checksum_md5")
