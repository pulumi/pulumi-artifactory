...
class BackupArgs:
    def __init__(__self__, *,
                 ...
                 create_archive: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 exclude_new_repositories: Optional[pulumi.Input[builtins.bool]] = None,
                 excluded_repositories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 export_mission_control: Optional[pulumi.Input[builtins.bool]] = None,
                 retention_period_hours: Optional[pulumi.Input[builtins.int]] = None,
                 send_mail_on_error: Optional[pulumi.Input[builtins.bool]] = None,
                 verify_disk_space: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] create_archive: If set to true, backups will be created within a Zip archive (Slow and CPU intensive). Default value is `false`
        :param pulumi.Input[builtins.bool] enabled: Flag to enable or disable the backup config. Default value is `true`.
        :param pulumi.Input[builtins.bool] exclude_new_repositories: When set to true, new repositories will not be automatically added to the backup. Default value is `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_repositories: List of excluded repositories from the backup.
        :param pulumi.Input[builtins.bool] export_mission_control: When set to true, mission control will not be automatically added to the backup. Default value is `false`.
        :param pulumi.Input[builtins.int] retention_period_hours: The number of hours to keep a backup before Artifactory will clean it up to free up disk space. Applicable only to non-incremental backups. Default value is 168 hours i.e. 7 days.
        :param pulumi.Input[builtins.bool] send_mail_on_error: If set to true, all Artifactory administrators will be notified by email if any problem is encountered during backup. Default value is `true`.
        :param pulumi.Input[builtins.bool] verify_disk_space: If set, Artifactory will verify that the backup target location has enough disk space available to hold the backed up data. If there is not enough space available, Artifactory will abort the backup and write a message in the log file. Applicable only to non-incremental backups. Default value is `false`.
        """
    ...
    def create_archive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_archive(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def exclude_new_repositories(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def exclude_new_repositories(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "exclude_new_repositories", value)

    @property
    @pulumi.getter(name="excludedRepositories")
    def excluded_repositories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def excluded_repositories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_repositories", value)

    @property
    @pulumi.getter(name="exportMissionControl")
    def export_mission_control(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def export_mission_control(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def send_mail_on_error(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def send_mail_on_error(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "send_mail_on_error", value)

    @property
    @pulumi.getter(name="verifyDiskSpace")
    def verify_disk_space(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def verify_disk_space(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Backup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_period_hours: Optional[pulumi.Input[builtins.int]] = None,
            send_mail_on_error: Optional[pulumi.Input[builtins.bool]] = None,
            verify_disk_space: Optional[pulumi.Input[builtins.bool]] = None) -> 'Backup':
        """
    ...
    @property
    @pulumi.getter(name="createArchive")
    def create_archive(self) -> pulumi.Output[builtins.bool]:
        """
        If set to true, backups will be created within a Zip archive (Slow and CPU intensive). Default value is `false`
        """
        return pulumi.get(self, "create_archive")
    ...
    @property
    @pulumi.getter(name="excludeNewRepositories")
    def exclude_new_repositories(self) -> pulumi.Output[builtins.bool]:
        """
        When set to true, new repositories will not be automatically added to the backup. Default value is `false`.
        """
        return pulumi.get(self, "exclude_new_repositories")
    ...
    @property
    @pulumi.getter(name="excludedRepositories")
    def excluded_repositories(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of excluded repositories from the backup.
        """
        return pulumi.get(self, "excluded_repositories")
    ...
    @property
    @pulumi.getter(name="exportMissionControl")
    def export_mission_control(self) -> pulumi.Output[builtins.bool]:
        """
        When set to true, mission control will not be automatically added to the backup. Default value is `false`.
        """
        return pulumi.get(self, "export_mission_control")
    ...
    @property
    @pulumi.getter(name="sendMailOnError")
    def send_mail_on_error(self) -> pulumi.Output[builtins.bool]:
        """
        If set to true, all Artifactory administrators will be notified by email if any problem is encountered during backup. Default value is `true`.
        """
        return pulumi.get(self, "send_mail_on_error")
    ...
    @property
    @pulumi.getter(name="verifyDiskSpace")
    def verify_disk_space(self) -> pulumi.Output[builtins.bool]:
        """
        If set, Artifactory will verify that the backup target location has enough disk space available to hold the backed up data. If there is not enough space available, Artifactory will abort the backup and write a message in the log file. Applicable only to non-incremental backups. Default value is `false`.
        """
        return pulumi.get(self, "verify_disk_space")
