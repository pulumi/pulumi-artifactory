...
__all__ = [
    'GetLocalMavenRepositoryResult',
    'AwaitableGetLocalMavenRepositoryResult',
    'get_local_maven_repository',
    'get_local_maven_repository_output',
]

@pulumi.output_type
class GetLocalMavenRepositoryResult:
    """
...
class AwaitableGetLocalMavenRepositoryResult(GetLocalMavenRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalMavenRepositoryResult(
...
def get_local_maven_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalMavenRepositoryResult:
    """
    ...
    * `suppress_pom_consistency_checks` - By default, Artifactory keeps your repositories healthy by refusing
    ...
    :param _builtins.str checksum_policy_type: Checksum policy determines how Artifactory behaves when a client checksum for a
           deployed resource is missing or conflicts with the locally calculated checksum (bad checksum). The options are:
           - `client-checksums`
           - `server-generated-checksums`. For more details, please refer
           to [Checksum Policy](https://www.jfrog.com/confluence/display/JFROG/Local+Repositories#LocalRepositories-ChecksumPolicy)
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalMavenRepository:getLocalMavenRepository', __args__, opts=opts, typ=GetLocalMavenRepositoryResult).value

    return AwaitableGetLocalMavenRepositoryResult(
...
def get_local_maven_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalMavenRepositoryResult]:
    """
    Retrieves a local Maven repository.
    ...
    * `suppress_pom_consistency_checks` - By default, Artifactory keeps your repositories healthy by refusing
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalMavenRepository:getLocalMavenRepository', __args__, opts=opts, typ=GetLocalMavenRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalMavenRepositoryResult(
