...
def get_remote_npm_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemoteNpmRepositoryContentSynchronisationArgs', 'GetRemoteNpmRepositoryContentSynchronisationArgsDict']] = None,
...
def get_remote_npm_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteNpmRepositoryContentSynchronisationArgs', 'GetRemoteNpmRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteNpmRepositoryResult]:
    """
    Retrieves a remote Npm repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteNpmRepository:getRemoteNpmRepository', __args__, opts=opts, typ=GetRemoteNpmRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteNpmRepositoryResult(
