...
class VirtualBowerRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 external_dependencies_remote_repo: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.bool] external_dependencies_enabled: When set, external dependencies are rewritten. Default value is false.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] external_dependencies_patterns: An Allow List of Ant-style path expressions that specify where external dependencies may be downloaded from. By default, this is set to ** which means that dependencies may be downloaded from any external source.
        :param pulumi.Input[_builtins.str] external_dependencies_remote_repo: The remote repository aggregated by this virtual repository in which the external dependency will be cached.
    ...
    def external_dependencies_remote_repo(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def external_dependencies_remote_repo(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class VirtualBowerRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_key: Optional[pulumi.Input[_builtins.str]] = None,
            repo_layout_ref: Optional[pulumi.Input[_builtins.str]] = None,
            repositories: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'VirtualBowerRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultDeploymentRepo")
    def default_deployment_repo(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Default repository to deploy artifacts.
        """
        return pulumi.get(self, "default_deployment_repo")
    ...
    @_builtins.property
    @pulumi.getter(name="externalDependenciesEnabled")
    def external_dependencies_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When set, external dependencies are rewritten. Default value is false.
        """
        return pulumi.get(self, "external_dependencies_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="externalDependenciesRemoteRepo")
    def external_dependencies_remote_repo(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The remote repository aggregated by this virtual repository in which the external dependency will be cached.
        """
        return pulumi.get(self, "external_dependencies_remote_repo")
    ...
    @_builtins.property
    @pulumi.getter
    def repositories(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The effective list of actual repositories included in this virtual repository.
        """
        return pulumi.get(self, "repositories")
