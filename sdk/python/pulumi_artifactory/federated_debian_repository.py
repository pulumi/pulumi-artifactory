...
class FederatedDebianRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 index_compression_formats: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 ...
                 trivial_layout: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] cleanup_on_delete: Delete all federated members on `terraform destroy` if set to `true`. Default is `false`. This attribute is added to match Terrform logic, so all the resources, created by the provider, must be removed on cleanup. Artifactory's behavior for the federated repositories is different, all the federated repositories stay after the user deletes the initial federated repository. **Caution**: if set to `true` all the repositories in the federation will be deleted, including repositories on other Artifactory instances in the "Circle of trust". This operation can not be reversed.
        ...
        :param pulumi.Input[_builtins.str] primary_keypair_ref: Primary keypair used to sign artifacts. Default value is empty.
        ...
        :param pulumi.Input[_builtins.str] secondary_keypair_ref: Secondary keypair used to sign artifacts.
        :param pulumi.Input[_builtins.bool] trivial_layout: When set, the repository will use the deprecated trivial layout.
    ...
    def index_compression_formats(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def trivial_layout(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def trivial_layout(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _FederatedDebianRepositoryState:
    def __init__(__self__, *,
                 ...
                 members: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedDebianRepositoryMemberArgs']]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FederatedDebianRepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedDebianRepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
class FederatedDebianRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 index_compression_formats: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FederatedDebianRepositoryMemberArgs', 'FederatedDebianRepositoryMemberArgsDict', 'outputs.FederatedDebianRepositoryMember']]]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
                 primary_keypair_ref: pulumi.Input[Optional[_builtins.str]] = None,
                 priority_resolution: pulumi.Input[Optional[_builtins.bool]] = None,
                 project_environments: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] includes_pattern: Comma-separated list of artifact patterns to include when evaluating artifact requests in the form of `x/y/**/z/*`. This is a single string of comma-separated values, not a list of strings. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`**/*`).
        :param pulumi.Input[_builtins.str] key: the identity key of the repo.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FederatedDebianRepositoryMemberArgs', 'FederatedDebianRepositoryMemberArgsDict', 'outputs.FederatedDebianRepositoryMember']]]] members: The list of Federated members and must contain this repository URL (configured base URL
               `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
               Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
        :param pulumi.Input[_builtins.str] notes: Internal description.
    ...
    def get(resource_name: str,
            ...
            secondary_keypair_ref: pulumi.Input[Optional[_builtins.str]] = None,
            trivial_layout: pulumi.Input[Optional[_builtins.bool]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FederatedDebianRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="indexCompressionFormats")
    def index_compression_formats(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        return pulumi.get(self, "index_compression_formats")
    ...
    @_builtins.property
    @pulumi.getter(name="primaryKeypairRef")
    def primary_keypair_ref(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Primary keypair used to sign artifacts. Default value is empty.
        """
        return pulumi.get(self, "primary_keypair_ref")
    ...
    @pulumi.getter(name="trivialLayout")
    @_utilities.deprecated("""You shouldn't be using this""")
    def trivial_layout(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        When set, the repository will use the deprecated trivial layout.
        """
        return pulumi.get(self, "trivial_layout")
