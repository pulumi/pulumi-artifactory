...
class ArtifactCustomWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `deployed`, `deleted`, `moved`, `copied`, `cached`.
...
class ArtifactCustomWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 criteria: Optional[pulumi.Input[Union['ArtifactCustomWebhookCriteriaArgs', 'ArtifactCustomWebhookCriteriaArgsDict']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 handlers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ArtifactCustomWebhookHandlerArgs', 'ArtifactCustomWebhookHandlerArgsDict']]]]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ArtifactCustomWebhookCriteriaArgs', 'ArtifactCustomWebhookCriteriaArgsDict']] criteria: Specifies where the webhook will be applied on which repositories.
        :param pulumi.Input[builtins.str] description: Webhook description. Max length 1000 characters.
        :param pulumi.Input[builtins.bool] enabled: Status of webhook. Default to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `deployed`, `deleted`, `moved`, `copied`, `cached`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ArtifactCustomWebhookHandlerArgs', 'ArtifactCustomWebhookHandlerArgsDict']]]] handlers: At least one is required.
        :param pulumi.Input[builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            handlers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ArtifactCustomWebhookHandlerArgs', 'ArtifactCustomWebhookHandlerArgsDict']]]]] = None,
            key: Optional[pulumi.Input[builtins.str]] = None) -> 'ArtifactCustomWebhook':
        """
    ...
    @property
    @pulumi.getter
    def criteria(self) -> pulumi.Output[Optional['outputs.ArtifactCustomWebhookCriteria']]:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @property
    @pulumi.getter
    def handlers(self) -> pulumi.Output[Optional[Sequence['outputs.ArtifactCustomWebhookHandler']]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
