...
__all__ = [
    ...
    'AwaitableGetFederatedOciRepositoryResult',
    'get_federated_oci_repository',
    'get_federated_oci_repository_output',
]

@pulumi.output_type
class GetFederatedOciRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedOciRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedOciRepositoryResult(GetFederatedOciRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedOciRepositoryResult(
...
def get_federated_oci_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedOciRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedOciRepository:getFederatedOciRepository', __args__, opts=opts, typ=GetFederatedOciRepositoryResult).value

    return AwaitableGetFederatedOciRepositoryResult(
...
def get_federated_oci_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedOciRepositoryMemberArgs', 'GetFederatedOciRepositoryMemberArgsDict']]]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedOciRepositoryResult]:
    """
    Retrieves a federated OCI repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedOciRepository:getFederatedOciRepository', __args__, opts=opts, typ=GetFederatedOciRepositoryResult)
