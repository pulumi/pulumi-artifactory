...
class _ArtifactoryReleaseBundleCustomWebhookState:
    def __init__(__self__, *,
                 criteria: pulumi.Input[Optional['ArtifactoryReleaseBundleCustomWebhookCriteriaArgs']] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input['ArtifactoryReleaseBundleCustomWebhookHandlerArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def criteria(self) -> pulumi.Input[Optional['ArtifactoryReleaseBundleCustomWebhookCriteriaArgs']]:
        """
        Specifies where the webhook will be applied on which repositories.
        """
        return pulumi.get(self, "criteria")
    ...
    @criteria.setter
    def criteria(self, value: pulumi.Input[Optional['ArtifactoryReleaseBundleCustomWebhookCriteriaArgs']]):
        pulumi.set(self, "criteria", value)
    ...
    @_builtins.property
    @pulumi.getter
    def handlers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ArtifactoryReleaseBundleCustomWebhookHandlerArgs']]]]:
        """
        At least one is required.
        """
        return pulumi.get(self, "handlers")
    ...
    @handlers.setter
    def handlers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ArtifactoryReleaseBundleCustomWebhookHandlerArgs']]]]):
        pulumi.set(self, "handlers", value)
...
@pulumi.type_token("artifactory:index/artifactoryReleaseBundleCustomWebhook:ArtifactoryReleaseBundleCustomWebhook")
class ArtifactoryReleaseBundleCustomWebhook(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 criteria: pulumi.Input[Optional[Union['ArtifactoryReleaseBundleCustomWebhookCriteriaArgs', 'ArtifactoryReleaseBundleCustomWebhookCriteriaArgsDict', 'outputs.ArtifactoryReleaseBundleCustomWebhookCriteria']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ArtifactoryReleaseBundleCustomWebhookHandlerArgs', 'ArtifactoryReleaseBundleCustomWebhookHandlerArgsDict', 'outputs.ArtifactoryReleaseBundleCustomWebhookHandler']]]]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ArtifactoryReleaseBundleCustomWebhookCriteriaArgs', 'ArtifactoryReleaseBundleCustomWebhookCriteriaArgsDict', 'outputs.ArtifactoryReleaseBundleCustomWebhookCriteria']] criteria: Specifies where the webhook will be applied on which repositories.
        :param pulumi.Input[_builtins.str] description: Webhook description. Max length 1000 characters.
        :param pulumi.Input[_builtins.bool] enabled: Status of webhook. Default to `true`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `received`, `delete_started`, `delete_completed`, `delete_failed`
        :param pulumi.Input[Sequence[pulumi.Input[Union['ArtifactoryReleaseBundleCustomWebhookHandlerArgs', 'ArtifactoryReleaseBundleCustomWebhookHandlerArgsDict', 'outputs.ArtifactoryReleaseBundleCustomWebhookHandler']]]] handlers: At least one is required.
        :param pulumi.Input[_builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ArtifactoryReleaseBundleCustomWebhookHandlerArgs', 'ArtifactoryReleaseBundleCustomWebhookHandlerArgsDict', 'outputs.ArtifactoryReleaseBundleCustomWebhookHandler']]]]] = None,
            key: pulumi.Input[Optional[_builtins.str]] = None) -> 'ArtifactoryReleaseBundleCustomWebhook':
        """
