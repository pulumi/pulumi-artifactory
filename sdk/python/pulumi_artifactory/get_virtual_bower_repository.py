...
def get_virtual_bower_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool external_dependencies_enabled: (Optional) When set, external dependencies are rewritten. Default value is false.
    :param Sequence[_builtins.str] external_dependencies_patterns: (Optional) An Allow List of Ant-style path expressions that specify where external dependencies may be downloaded from. By default, this is set to ** which means that dependencies may be downloaded from any external source.
    :param _builtins.str external_dependencies_remote_repo: (Optional) The remote repository aggregated by this virtual repository in which the external dependency will be cached.
...
def get_virtual_bower_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        external_dependencies_remote_repo: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
