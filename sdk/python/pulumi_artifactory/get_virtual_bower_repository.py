...
class GetVirtualBowerRepositoryResult:
    ...
    def external_dependencies_remote_repo(self) -> Optional[builtins.str]:
        """
...
def get_virtual_bower_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
                                 ...
                                 external_dependencies_remote_repo: Optional[builtins.str] = None,
    ...
    :param builtins.bool external_dependencies_enabled: (Optional) When set, external dependencies are rewritten. Default value is false.
    :param Sequence[builtins.str] external_dependencies_patterns: (Optional) An Allow List of Ant-style path expressions that specify where external dependencies may be downloaded from. By default, this is set to ** which means that dependencies may be downloaded from any external source.
    :param builtins.str external_dependencies_remote_repo: (Optional) The remote repository aggregated by this virtual repository in which the external dependency will be cached.
...
def get_virtual_bower_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                        ...
                                        external_dependencies_remote_repo: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualBowerRepositoryResult]:
    """
    Retrieves a virtual Bower repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualBowerRepository:getVirtualBowerRepository', __args__, opts=opts, typ=GetVirtualBowerRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualBowerRepositoryResult(
