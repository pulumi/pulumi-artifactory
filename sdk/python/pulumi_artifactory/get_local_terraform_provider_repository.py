...
__all__ = [
    ...
    'AwaitableGetLocalTerraformProviderRepositoryResult',
    'get_local_terraform_provider_repository',
    'get_local_terraform_provider_repository_output',
]

@pulumi.output_type
class GetLocalTerraformProviderRepositoryResult:
    """
...
class AwaitableGetLocalTerraformProviderRepositoryResult(GetLocalTerraformProviderRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalTerraformProviderRepositoryResult(
...
def get_local_terraform_provider_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str notes: (Optional)
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalTerraformProviderRepository:getLocalTerraformProviderRepository', __args__, opts=opts, typ=GetLocalTerraformProviderRepositoryResult).value

    return AwaitableGetLocalTerraformProviderRepositoryResult(
...
def get_local_terraform_provider_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalTerraformProviderRepository:getLocalTerraformProviderRepository', __args__, opts=opts, typ=GetLocalTerraformProviderRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalTerraformProviderRepositoryResult(
