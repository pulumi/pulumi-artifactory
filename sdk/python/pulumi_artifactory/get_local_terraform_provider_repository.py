...
def get_local_terraform_provider_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.str description: (Optional)
    :param builtins.str key: the identity key of the repo.
    :param builtins.str notes: (Optional)
    """
    __args__ = dict()
...
def get_local_terraform_provider_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
