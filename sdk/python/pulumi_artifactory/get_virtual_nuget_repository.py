...
def get_virtual_nuget_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
    ...
    :param builtins.bool force_nuget_authentication: (Optional) If set, user authentication is required when accessing the repository. An anonymous request will display an HTTP 401 error. This is also enforced when aggregated repositories support anonymous requests. Default is `false`.
...
def get_virtual_nuget_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
