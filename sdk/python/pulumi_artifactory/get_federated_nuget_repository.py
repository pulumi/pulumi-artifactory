...
__all__ = [
    'GetFederatedNugetRepositoryResult',
    'AwaitableGetFederatedNugetRepositoryResult',
    'get_federated_nuget_repository',
    'get_federated_nuget_repository_output',
]

@pulumi.output_type
class GetFederatedNugetRepositoryResult:
    """
    A collection of values returned by getFederatedNugetRepository.
    """
    def __init__(__self__, archive_browsing_enabled=None, blacked_out=None, cdn_redirect=None, cleanup_on_delete=None, description=None, disable_proxy=None, download_direct=None, excludes_pattern=None, force_nuget_authentication=None, id=None, includes_pattern=None, key=None, max_unique_snapshots=None, members=None, notes=None, package_type=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, repo_layout_ref=None, xray_index=None):
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedNugetRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedNugetRepositoryResult(GetFederatedNugetRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedNugetRepositoryResult(
...
def get_federated_nuget_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                   ...
                                   members: Optional[Sequence[Union['GetFederatedNugetRepositoryMemberArgs', 'GetFederatedNugetRepositoryMemberArgsDict']]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedNugetRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedNugetRepositoryMemberArgs', 'GetFederatedNugetRepositoryMemberArgsDict']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedNugetRepository:getFederatedNugetRepository', __args__, opts=opts, typ=GetFederatedNugetRepositoryResult).value

    return AwaitableGetFederatedNugetRepositoryResult(
...
def get_federated_nuget_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                          ...
                                          members: Optional[pulumi.Input[Optional[Sequence[Union['GetFederatedNugetRepositoryMemberArgs', 'GetFederatedNugetRepositoryMemberArgsDict']]]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedNugetRepositoryResult]:
    """
    Retrieves a federated Nuget repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedNugetRepository:getFederatedNugetRepository', __args__, opts=opts, typ=GetFederatedNugetRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedNugetRepositoryResult(
