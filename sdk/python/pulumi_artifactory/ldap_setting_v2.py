...
class LdapSettingV2Args:
    def __init__(__self__, *,
                 ...
                 ldap_url: pulumi.Input[builtins.str],
                 allow_user_to_access_profile: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_create_user: Optional[pulumi.Input[builtins.bool]] = None,
                 email_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ldap_poisoning_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 manager_dn: Optional[pulumi.Input[builtins.str]] = None,
                 manager_password: Optional[pulumi.Input[builtins.str]] = None,
                 paging_support_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 search_base: Optional[pulumi.Input[builtins.str]] = None,
                 search_filter: Optional[pulumi.Input[builtins.str]] = None,
                 search_sub_tree: Optional[pulumi.Input[builtins.bool]] = None,
                 user_dn_pattern: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LdapSettingV2 resource.
        :param pulumi.Input[builtins.str] key: Ldap setting name.
        :param pulumi.Input[builtins.str] ldap_url: Location of the LDAP server in the following format: `ldap://myldapserver/dc=sampledomain,dc=com`
        :param pulumi.Input[builtins.bool] allow_user_to_access_profile: Auto created users will have access to their profile page and will be able to perform actions such as generating an API key. Default value is `false`.
        :param pulumi.Input[builtins.bool] auto_create_user: When set, users are automatically created when using LDAP. Otherwise, users are transient and associated with auto-join groups defined in Artifactory. Default value is `true`.
        :param pulumi.Input[builtins.str] email_attribute: An attribute that can be used to map a user's email address to a user created automatically in Artifactory. Default value is`mail`.
        :param pulumi.Input[builtins.bool] enabled: Flag to enable or disable the ldap setting. Default value is `true`.
        :param pulumi.Input[builtins.bool] ldap_poisoning_protection: When this is set to `true`, an empty or missing usernames array will detach all users from the group.
        :param pulumi.Input[builtins.str] manager_dn: The full DN of the user that binds to the LDAP server to perform user searches. Only used with `search` authentication.
        :param pulumi.Input[builtins.str] manager_password: The password of the user that binds to the LDAP server to perform the search. Only used with `search` authentication.
        :param pulumi.Input[builtins.bool] paging_support_enabled: When set, supports paging results for the LDAP server. This feature requires that the LDAP server supports a PagedResultsControl configuration. Default value is `true`.
        :param pulumi.Input[builtins.str] search_base: A context name to search in relative to the base DN of the LDAP URL. For example, 'ou=users' With the LDAP Group Add-on enabled, it is possible to enter multiple search base entries separated by a pipe ('|') character.
        :param pulumi.Input[builtins.str] search_filter: A filter expression used to search for the user DN used in LDAP authentication. This is an LDAP search filter (as defined in 'RFC 2254') with optional arguments. In this case, the username is the only argument, and is denoted by '{0}'. Possible examples are: (uid={0}) - This searches for a username match on the attribute. Authentication to LDAP is performed from the DN found if successful.
        :param pulumi.Input[builtins.bool] search_sub_tree: When set, enables deep search through the sub tree of the LDAP URL + search base. Default value is `true`.
        :param pulumi.Input[builtins.str] user_dn_pattern: A DN pattern that can be used to log users directly in to LDAP. This pattern is used to create a DN string for 'direct' user authentication where the pattern is relative to the base DN in the LDAP URL. The pattern argument {0} is replaced with the username. This only works if anonymous binding is allowed and a direct user DN can be used, which is not the default case for Active Directory (use User DN search filter instead). Example: uid={0},ou=People. Default value is blank/empty.
        """
    ...
    def ldap_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ldap_url.setter
    def ldap_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ldap_url", value)

    @property
    @pulumi.getter(name="allowUserToAccessProfile")
    def allow_user_to_access_profile(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_user_to_access_profile(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_user_to_access_profile", value)

    @property
    @pulumi.getter(name="autoCreateUser")
    def auto_create_user(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_create_user(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ldap_poisoning_protection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ldap_poisoning_protection(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ldap_poisoning_protection", value)

    @property
    @pulumi.getter(name="managerDn")
    def manager_dn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @manager_dn.setter
    def manager_dn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def paging_support_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def paging_support_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "paging_support_enabled", value)

    @property
    @pulumi.getter(name="searchBase")
    def search_base(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @search_base.setter
    def search_base(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def search_sub_tree(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def search_sub_tree(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "search_sub_tree", value)

    @property
    @pulumi.getter(name="userDnPattern")
    def user_dn_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_dn_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LdapSettingV2State:
    def __init__(__self__, *,
                 ...
                 ldap_poisoning_protection: Optional[pulumi.Input[builtins.bool]] = None,
                 ldap_url: Optional[pulumi.Input[builtins.str]] = None,
                 manager_dn: Optional[pulumi.Input[builtins.str]] = None,
                 manager_password: Optional[pulumi.Input[builtins.str]] = None,
                 paging_support_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 search_base: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ldapUrl")
    def ldap_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Location of the LDAP server in the following format: `ldap://myldapserver/dc=sampledomain,dc=com`
        """
        return pulumi.get(self, "ldap_url")
    ...
    @ldap_url.setter
    def ldap_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ldap_url", value)
...
@pulumi.type_token("artifactory:index/ldapSettingV2:LdapSettingV2")
class LdapSettingV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            search_filter: Optional[pulumi.Input[builtins.str]] = None,
            search_sub_tree: Optional[pulumi.Input[builtins.bool]] = None,
            user_dn_pattern: Optional[pulumi.Input[builtins.str]] = None) -> 'LdapSettingV2':
        """
    ...
    @property
    @pulumi.getter(name="allowUserToAccessProfile")
    def allow_user_to_access_profile(self) -> pulumi.Output[builtins.bool]:
        """
        Auto created users will have access to their profile page and will be able to perform actions such as generating an API key. Default value is `false`.
        """
        return pulumi.get(self, "allow_user_to_access_profile")
    ...
    @property
    @pulumi.getter(name="autoCreateUser")
    def auto_create_user(self) -> pulumi.Output[builtins.bool]:
        """
        When set, users are automatically created when using LDAP. Otherwise, users are transient and associated with auto-join groups defined in Artifactory. Default value is `true`.
        """
        return pulumi.get(self, "auto_create_user")
    ...
    @property
    @pulumi.getter(name="emailAttribute")
    def email_attribute(self) -> pulumi.Output[builtins.str]:
        """
        An attribute that can be used to map a user's email address to a user created automatically in Artifactory. Default value is`mail`.
        """
        return pulumi.get(self, "email_attribute")
    ...
    @property
    @pulumi.getter(name="ldapPoisoningProtection")
    def ldap_poisoning_protection(self) -> pulumi.Output[builtins.bool]:
        """
        When this is set to `true`, an empty or missing usernames array will detach all users from the group.
        """
        return pulumi.get(self, "ldap_poisoning_protection")
    ...
    @property
    @pulumi.getter(name="ldapUrl")
    def ldap_url(self) -> pulumi.Output[builtins.str]:
        """
        Location of the LDAP server in the following format: `ldap://myldapserver/dc=sampledomain,dc=com`
        """
        return pulumi.get(self, "ldap_url")
    ...
    @property
    @pulumi.getter(name="managerDn")
    def manager_dn(self) -> pulumi.Output[builtins.str]:
        """
        The full DN of the user that binds to the LDAP server to perform user searches. Only used with `search` authentication.
        """
        return pulumi.get(self, "manager_dn")
    ...
    @property
    @pulumi.getter(name="managerPassword")
    def manager_password(self) -> pulumi.Output[builtins.str]:
        """
        The password of the user that binds to the LDAP server to perform the search. Only used with `search` authentication.
        """
        return pulumi.get(self, "manager_password")
    ...
    @property
    @pulumi.getter(name="pagingSupportEnabled")
    def paging_support_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        When set, supports paging results for the LDAP server. This feature requires that the LDAP server supports a PagedResultsControl configuration. Default value is `true`.
        """
        return pulumi.get(self, "paging_support_enabled")
    ...
    @property
    @pulumi.getter(name="searchBase")
    def search_base(self) -> pulumi.Output[builtins.str]:
        """
        A context name to search in relative to the base DN of the LDAP URL. For example, 'ou=users' With the LDAP Group Add-on enabled, it is possible to enter multiple search base entries separated by a pipe ('|') character.
        """
        return pulumi.get(self, "search_base")
    ...
    @property
    @pulumi.getter(name="searchSubTree")
    def search_sub_tree(self) -> pulumi.Output[builtins.bool]:
        """
        When set, enables deep search through the sub tree of the LDAP URL + search base. Default value is `true`.
        """
        return pulumi.get(self, "search_sub_tree")
    ...
    @property
    @pulumi.getter(name="userDnPattern")
    def user_dn_pattern(self) -> pulumi.Output[builtins.str]:
        """
        A DN pattern that can be used to log users directly in to LDAP. This pattern is used to create a DN string for 'direct' user authentication where the pattern is relative to the base DN in the LDAP URL. The pattern argument {0} is replaced with the username. This only works if anonymous binding is allowed and a direct user DN can be used, which is not the default case for Active Directory (use User DN search filter instead). Example: uid={0},ou=People. Default value is blank/empty.
        """
        return pulumi.get(self, "user_dn_pattern")
