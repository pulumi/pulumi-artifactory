...
class RemoteHelmociRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 enable_token_authentication: Optional[pulumi.Input[_builtins.bool]] = None,
                 excludes_pattern: Optional[pulumi.Input[_builtins.str]] = None,
                 external_dependencies_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 external_dependencies_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] url: This is a URL to the remote registry. Consider using HTTPS to ensure a secure connection.
        ...
        :param pulumi.Input[_builtins.bool] enable_token_authentication: Enable token (Bearer) based authentication.
        ...
        :param pulumi.Input[_builtins.str] project_id: Use this attribute to enter your GCR, GAR Project Id to limit the scope of this remote repo to a specific project in your third-party registry. When leaving this field blank or unset, remote repositories that support project id will default to their default project as you have set up in your account.
    ...
    def enable_token_authentication(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def enable_token_authentication(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def external_dependencies_enabled(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def external_dependencies_enabled(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "external_dependencies_enabled", value)

    @_builtins.property
    @pulumi.getter(name="externalDependenciesPatterns")
    def external_dependencies_patterns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Optional include patterns to match external URLs. Ant-style path expressions are supported (*, **, ?). For example, specifying `**/github.com/**` will only allow downloading foreign layers from github.com host. By default, this is set to `**` in the UI, which means that foreign layers may be downloaded from any external hosts. Due to SDKv2 limitations, we can't set the default value for the list. This value `**` must be assigned to the attribute manually, if user don't specify any other non-default values. We don't want to make this attribute required, but it must be set to avoid the state drift on update. Note: Artifactory assigns `**` on update if HCL doesn't have the attribute set or the list is empty.
        """
    ...
    def external_dependencies_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class RemoteHelmociRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'RemoteHelmociRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="externalDependenciesEnabled")
    def external_dependencies_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Also known as 'Foreign Layers Caching' on the UI.
        """
        return pulumi.get(self, "external_dependencies_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="externalDependenciesPatterns")
    def external_dependencies_patterns(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Optional include patterns to match external URLs. Ant-style path expressions are supported (*, **, ?). For example, specifying `**/github.com/**` will only allow downloading foreign layers from github.com host. By default, this is set to `**` in the UI, which means that foreign layers may be downloaded from any external hosts. Due to SDKv2 limitations, we can't set the default value for the list. This value `**` must be assigned to the attribute manually, if user don't specify any other non-default values. We don't want to make this attribute required, but it must be set to avoid the state drift on update. Note: Artifactory assigns `**` on update if HCL doesn't have the attribute set or the list is empty.
        """
        return pulumi.get(self, "external_dependencies_patterns")
