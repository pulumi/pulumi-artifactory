...
__all__ = [
    'GetLocalPuppetRepositoryResult',
    'AwaitableGetLocalPuppetRepositoryResult',
    'get_local_puppet_repository',
    'get_local_puppet_repository_output',
]

@pulumi.output_type
class GetLocalPuppetRepositoryResult:
    """
...
class AwaitableGetLocalPuppetRepositoryResult(GetLocalPuppetRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalPuppetRepositoryResult(
...
def get_local_puppet_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalPuppetRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalPuppetRepository:getLocalPuppetRepository', __args__, opts=opts, typ=GetLocalPuppetRepositoryResult).value

    return AwaitableGetLocalPuppetRepositoryResult(
...
def get_local_puppet_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalPuppetRepositoryResult]:
    """
    Retrieves a local puppet repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalPuppetRepository:getLocalPuppetRepository', __args__, opts=opts, typ=GetLocalPuppetRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalPuppetRepositoryResult(
