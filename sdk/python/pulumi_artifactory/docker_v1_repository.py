...
class DockerV1RepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        DockerV1RepositoryArgs._configure(
...
class _DockerV1RepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _DockerV1RepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class DockerV1Repository(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DockerV1RepositoryArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: Optional[pulumi.Input[str]] = None,
            tag_retention: Optional[pulumi.Input[int]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'DockerV1Repository':
        """
