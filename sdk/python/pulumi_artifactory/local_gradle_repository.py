...
class LocalGradleRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        terraform_local_test_gradle_repo_basic = artifactory.index.local_gradle_repository.LocalGradleRepository("terraform-local-test-gradle-repo-basic",
    ...
    def get(resource_name: str,
            ...
            snapshot_version_behavior: Optional[pulumi.Input[str]] = None,
            suppress_pom_consistency_checks: Optional[pulumi.Input[bool]] = None,
            xray_index: Optional[pulumi.Input[bool]] = None) -> 'LocalGradleRepository':
        """
