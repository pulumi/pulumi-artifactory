...
class LocalGradleRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] checksum_policy_type: Checksum policy determines how Artifactory behaves when a client checksum for a deployed
        ...
        :param pulumi.Input[_builtins.bool] handle_releases: If set, Artifactory allows you to deploy release artifacts into this repository. Default is `true`.
        :param pulumi.Input[_builtins.bool] handle_snapshots: If set, Artifactory allows you to deploy snapshot artifacts into this repository. Default is `true`.
...
class LocalGradleRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_version_behavior: pulumi.Input[Optional[_builtins.str]] = None,
            suppress_pom_consistency_checks: pulumi.Input[Optional[_builtins.bool]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'LocalGradleRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="checksumPolicyType")
    def checksum_policy_type(self) -> pulumi.Output[_builtins.str]:
        """
        Checksum policy determines how Artifactory behaves when a client checksum for a deployed
        resource is missing or conflicts with the locally calculated checksum (bad checksum). The options are
        `client-checksums` and `generated-checksums`. For more details,
    ...
    @_builtins.property
    @pulumi.getter(name="snapshotVersionBehavior")
    def snapshot_version_behavior(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the naming convention for Maven SNAPSHOT versions.
        The options are -
        """
