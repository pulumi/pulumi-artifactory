...
__all__ = [
    ...
    'AwaitableGetRemotePubRepositoryResult',
    'get_remote_pub_repository',
    'get_remote_pub_repository_output',
]

@pulumi.output_type
class GetRemotePubRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemotePubRepositoryContentSynchronisationResult':
...
class AwaitableGetRemotePubRepositoryResult(GetRemotePubRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemotePubRepositoryResult(
...
def get_remote_pub_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemotePubRepositoryContentSynchronisationArgs', 'GetRemotePubRepositoryContentSynchronisationArgsDict']] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemotePubRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemotePubRepository:getRemotePubRepository', __args__, opts=opts, typ=GetRemotePubRepositoryResult).value

    return AwaitableGetRemotePubRepositoryResult(
...
def get_remote_pub_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemotePubRepositoryContentSynchronisationArgs', 'GetRemotePubRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemotePubRepositoryResult]:
    """
    Retrieves a remote Pub repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemotePubRepository:getRemotePubRepository', __args__, opts=opts, typ=GetRemotePubRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemotePubRepositoryResult(
