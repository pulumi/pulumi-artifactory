...
__all__ = [
    ...
    'AwaitableGetLocalGenericRepositoryResult',
    'get_local_generic_repository',
    'get_local_generic_repository_output',
]

@pulumi.output_type
class GetLocalGenericRepositoryResult:
    """
...
class AwaitableGetLocalGenericRepositoryResult(GetLocalGenericRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalGenericRepositoryResult(
...
def get_local_generic_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalGenericRepository:getLocalGenericRepository', __args__, opts=opts, typ=GetLocalGenericRepositoryResult).value

    return AwaitableGetLocalGenericRepositoryResult(
...
def get_local_generic_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalGenericRepositoryResult]:
    """
    Retrieves a local generic repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalGenericRepository:getLocalGenericRepository', __args__, opts=opts, typ=GetLocalGenericRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalGenericRepositoryResult(
