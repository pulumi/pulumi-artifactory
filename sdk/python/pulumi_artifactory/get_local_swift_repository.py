...
__all__ = [
    'GetLocalSwiftRepositoryResult',
    'AwaitableGetLocalSwiftRepositoryResult',
    'get_local_swift_repository',
    'get_local_swift_repository_output',
]

@pulumi.output_type
class GetLocalSwiftRepositoryResult:
    """
...
class AwaitableGetLocalSwiftRepositoryResult(GetLocalSwiftRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalSwiftRepositoryResult(
...
def get_local_swift_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalSwiftRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalSwiftRepository:getLocalSwiftRepository', __args__, opts=opts, typ=GetLocalSwiftRepositoryResult).value

    return AwaitableGetLocalSwiftRepositoryResult(
...
def get_local_swift_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalSwiftRepositoryResult]:
    """
    Retrieves a local swift repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalSwiftRepository:getLocalSwiftRepository', __args__, opts=opts, typ=GetLocalSwiftRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalSwiftRepositoryResult(
