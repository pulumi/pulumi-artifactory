...
__all__ = [
    'GetVirtualTerraformRepositoryResult',
    'AwaitableGetVirtualTerraformRepositoryResult',
    'get_virtual_terraform_repository',
    'get_virtual_terraform_repository_output',
]

@pulumi.output_type
class GetVirtualTerraformRepositoryResult:
    """
...
class AwaitableGetVirtualTerraformRepositoryResult(GetVirtualTerraformRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualTerraformRepositoryResult(
...
def get_virtual_terraform_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualTerraformRepository:getVirtualTerraformRepository', __args__, opts=opts, typ=GetVirtualTerraformRepositoryResult).value

    return AwaitableGetVirtualTerraformRepositoryResult(
...
def get_virtual_terraform_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualTerraformRepository:getVirtualTerraformRepository', __args__, opts=opts, typ=GetVirtualTerraformRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualTerraformRepositoryResult(
