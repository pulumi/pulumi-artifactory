...
class _FederatedOciRepositoryState:
    def __init__(__self__, *,
                 ...
                 max_unique_tags: pulumi.Input[Optional[_builtins.int]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedOciRepositoryMemberArgs']]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FederatedOciRepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedOciRepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
class FederatedOciRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: pulumi.Input[Optional[_builtins.str]] = None,
            tag_retention: pulumi.Input[Optional[_builtins.int]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FederatedOciRepository':
        """
