...
class FederatedOciRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_unique_tags: The maximum number of unique tags of a single OCI image to store in this repository. Once the number tags for an image
        ...
        :param pulumi.Input[_builtins.int] tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up number.
...
class FederatedOciRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: Optional[pulumi.Input[_builtins.str]] = None,
            tag_retention: Optional[pulumi.Input[_builtins.int]] = None,
            xray_index: Optional[pulumi.Input[_builtins.bool]] = None) -> 'FederatedOciRepository':
        """
