...
__all__ = [
    'GetRemoteAlpineRepositoryResult',
    'AwaitableGetRemoteAlpineRepositoryResult',
    'get_remote_alpine_repository',
    'get_remote_alpine_repository_output',
]

@pulumi.output_type
class GetRemoteAlpineRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteAlpineRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteAlpineRepositoryResult(GetRemoteAlpineRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteAlpineRepositoryResult(
...
def get_remote_alpine_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                 ...
                                 content_synchronisation: Optional[Union['GetRemoteAlpineRepositoryContentSynchronisationArgs', 'GetRemoteAlpineRepositoryContentSynchronisationArgsDict']] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteAlpineRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteAlpineRepository:getRemoteAlpineRepository', __args__, opts=opts, typ=GetRemoteAlpineRepositoryResult).value

    return AwaitableGetRemoteAlpineRepositoryResult(
...
def get_remote_alpine_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteAlpineRepositoryContentSynchronisationArgs', 'GetRemoteAlpineRepositoryContentSynchronisationArgsDict']]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteAlpineRepositoryResult]:
    """
    Retrieves a remote Alpine repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteAlpineRepository:getRemoteAlpineRepository', __args__, opts=opts, typ=GetRemoteAlpineRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteAlpineRepositoryResult(
