...
class _FederatedConanRepositoryState:
    def __init__(__self__, *,
                 ...
                 members: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedConanRepositoryMemberArgs']]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FederatedConanRepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedConanRepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
class FederatedConanRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            proxy: pulumi.Input[Optional[_builtins.str]] = None,
            repo_layout_ref: pulumi.Input[Optional[_builtins.str]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FederatedConanRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="forceConanAuthentication")
    def force_conan_authentication(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Force basic authentication credentials in order to use this repository. Default value is 'false'.
        """
        return pulumi.get(self, "force_conan_authentication")
