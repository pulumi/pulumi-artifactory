...
__all__ = [
    ...
    'AwaitableGetVirtualRpmRepositoryResult',
    'get_virtual_rpm_repository',
    'get_virtual_rpm_repository_output',
]

@pulumi.output_type
class GetVirtualRpmRepositoryResult:
    """
...
class AwaitableGetVirtualRpmRepositoryResult(GetVirtualRpmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualRpmRepositoryResult(
...
def get_virtual_rpm_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str primary_keypair_ref: (Optional) The primary GPG key to be used to sign packages.
    :param _builtins.str secondary_keypair_ref: (Optional) The secondary GPG key to be used to sign packages.
    """
    __args__ = dict()
    ...
    return AwaitableGetVirtualRpmRepositoryResult(
...
def get_virtual_rpm_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
