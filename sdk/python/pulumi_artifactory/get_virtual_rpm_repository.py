...
def get_virtual_rpm_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
    ...
    :param builtins.str primary_keypair_ref: (Optional) The primary GPG key to be used to sign packages.
    :param builtins.str secondary_keypair_ref: (Optional) The secondary GPG key to be used to sign packages.
    """
    __args__ = dict()
...
def get_virtual_rpm_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
