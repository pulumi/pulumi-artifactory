...
__all__ = [
    'GetLocalNixRepositoryResult',
    'AwaitableGetLocalNixRepositoryResult',
    'get_local_nix_repository',
    'get_local_nix_repository_output',
]

@pulumi.output_type
class GetLocalNixRepositoryResult:
    """
    ...
    def download_direct(self) -> _builtins.bool:
    ...
    def priority_resolution(self) -> _builtins.bool:
    ...
    def property_sets(self) -> Sequence[_builtins.str]:
    ...
    def xray_index(self) -> _builtins.bool:
        return pulumi.get(self, "xray_index")


class AwaitableGetLocalNixRepositoryResult(GetLocalNixRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalNixRepositoryResult(
...
def get_local_nix_repository(key: Optional[_builtins.str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalNixRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalNixRepository:getLocalNixRepository', __args__, opts=opts, typ=GetLocalNixRepositoryResult).value

    return AwaitableGetLocalNixRepositoryResult(
...
def get_local_nix_repository_output(key: pulumi.Input[Optional[_builtins.str]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalNixRepositoryResult]:
    """
    Retrieves configuration for a local Nix repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalNixRepository:getLocalNixRepository', __args__, opts=opts, typ=GetLocalNixRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalNixRepositoryResult(
