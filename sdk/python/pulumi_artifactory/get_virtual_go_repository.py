...
def get_virtual_go_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
    ...
    :param builtins.bool external_dependencies_enabled: (Optional) Shorthand for "Enable 'go-import' Meta Tags" on the UI. This must be set to true in order to use the allow list. 
           When checked (default), Artifactory will automatically follow remote VCS roots in 'go-import' meta tags to download remote modules.
    :param Sequence[builtins.str] external_dependencies_patterns: (Optional) 'go-import' Allow List on the UI.
...
def get_virtual_go_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
