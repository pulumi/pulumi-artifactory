...
__all__ = ['AnonymousUserArgs', 'AnonymousUser']
...
class AnonymousUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: (Optional) Username for anonymous user. This should not be set in the HCL, or change after importing into Terraform
               state.
        """
        if name is not None:
...
class AnonymousUser(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AnonymousUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AnonymousUserArgs.__new__(AnonymousUserArgs)

            __props__.__dict__["name"] = name
        super(AnonymousUser, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'AnonymousUser':
        """
