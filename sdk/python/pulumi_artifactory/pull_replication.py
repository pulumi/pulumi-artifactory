...
class PullReplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] check_binary_existence_in_filestore: When true, enables distributed checksum storage. For more information, see
        ...
        :param pulumi.Input[builtins.bool] enable_event_replication: When set, each event will trigger replication of the artifacts changed in this event. This can be any type of event on artifact, e.g. added, deleted or property change.
        :param pulumi.Input[builtins.bool] enabled: When set, this replication will be enabled when saved.
        :param pulumi.Input[builtins.str] password: Required for local repository, but not needed for remote repository.
        :param pulumi.Input[builtins.str] path_prefix: Only artifacts that located in path that matches the subpath within the remote repository will be replicated.
        :param pulumi.Input[builtins.str] proxy: Proxy key from Artifactory Proxies setting
        :param pulumi.Input[builtins.bool] sync_deletes: When set, items that were deleted locally should also be deleted remotely (also applies to properties metadata).
        :param pulumi.Input[builtins.bool] sync_properties: When set, the task also synchronizes the properties of replicated artifacts.
        :param pulumi.Input[builtins.bool] sync_statistics: When set, artifact download statistics will also be replicated. Set to avoid inadvertent cleanup at the target instance when setting up replication for disaster recovery.
        :param pulumi.Input[builtins.str] url: The URL of the target local repository on a remote Artifactory server. For some package types, you need to prefix the repository key in the URL with api/<pkg>. 
        ...
        :param pulumi.Input[builtins.str] username: Required for local repository, but not needed for remote repository.
        """
...
class PullReplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sync_statistics: Optional[pulumi.Input[builtins.bool]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'PullReplication':
        """
    ...
    @property
    @pulumi.getter(name="checkBinaryExistenceInFilestore")
    def check_binary_existence_in_filestore(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, enables distributed checksum storage. For more information, see
        [Optimizing Repository Replication with Checksum-Based Storage](https://www.jfrog.com/confluence/display/JFROG/Repository+Replication#RepositoryReplication-OptimizingRepositoryReplicationUsingStorageLevelSynchronizationOptions).
        """
    ...
    @property
    @pulumi.getter(name="enableEventReplication")
    def enable_event_replication(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set, each event will trigger replication of the artifacts changed in this event. This can be any type of event on artifact, e.g. added, deleted or property change.
        """
        return pulumi.get(self, "enable_event_replication")
