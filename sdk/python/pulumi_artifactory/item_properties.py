...
class ItemPropertiesArgs:
    def __init__(__self__, *,
                 properties: pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]],
                 repo_key: pulumi.Input[builtins.str],
                 is_recursive: Optional[pulumi.Input[builtins.bool]] = None,
                 item_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ItemProperties resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]] properties: Map of key and list of values.
        :param pulumi.Input[builtins.str] repo_key: Respository key.
        :param pulumi.Input[builtins.bool] is_recursive: Add this property to the selected folder and to all of artifacts and folders under this folder. Default to `false`
        :param pulumi.Input[builtins.str] item_path: The relative path of the item (file/folder/repository). Leave unset for repository.
        """
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]:
        """
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]):
    ...
    def is_recursive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_recursive.setter
    def is_recursive(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_recursive", value)

    @property
    @pulumi.getter(name="itemPath")
    def item_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @item_path.setter
    def item_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ItemPropertiesState:
    def __init__(__self__, *,
                 is_recursive: Optional[pulumi.Input[builtins.bool]] = None,
                 item_path: Optional[pulumi.Input[builtins.str]] = None,
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None,
    ...
    @property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]:
        """
        Map of key and list of values.
        """
        return pulumi.get(self, "properties")
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]]):
        pulumi.set(self, "properties", value)
...
class ItemProperties(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            item_path: Optional[pulumi.Input[builtins.str]] = None,
            properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]]] = None,
            repo_key: Optional[pulumi.Input[builtins.str]] = None) -> 'ItemProperties':
        """
    ...
    @property
    @pulumi.getter(name="isRecursive")
    def is_recursive(self) -> pulumi.Output[builtins.bool]:
        """
        Add this property to the selected folder and to all of artifacts and folders under this folder. Default to `false`
        """
        return pulumi.get(self, "is_recursive")
    ...
    @property
    @pulumi.getter(name="itemPath")
    def item_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The relative path of the item (file/folder/repository). Leave unset for repository.
        """
        return pulumi.get(self, "item_path")
    ...
    @property
    @pulumi.getter
    def properties(self) -> pulumi.Output[Mapping[str, Sequence[builtins.str]]]:
        """
        Map of key and list of values.
        """
        return pulumi.get(self, "properties")
