...
__all__ = [
    'GetRemoteNixRepositoryResult',
    'AwaitableGetRemoteNixRepositoryResult',
    'get_remote_nix_repository',
    'get_remote_nix_repository_output',
]

@pulumi.output_type
class GetRemoteNixRepositoryResult:
    """
...
class AwaitableGetRemoteNixRepositoryResult(GetRemoteNixRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteNixRepositoryResult(
...
def get_remote_nix_repository(key: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteNixRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteNixRepository:getRemoteNixRepository', __args__, opts=opts, typ=GetRemoteNixRepositoryResult).value

    return AwaitableGetRemoteNixRepositoryResult(
...
def get_remote_nix_repository_output(key: pulumi.Input[Optional[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteNixRepositoryResult]:
    """
    Retrieves configuration for a remote Nix repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteNixRepository:getRemoteNixRepository', __args__, opts=opts, typ=GetRemoteNixRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteNixRepositoryResult(
