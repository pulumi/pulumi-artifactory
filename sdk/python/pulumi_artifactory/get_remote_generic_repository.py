...
class GetRemoteGenericRepositoryResult:
    ...
    def propagate_query_params(self) -> Optional[builtins.bool]:
        """
...
def get_remote_generic_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                                  ...
                                  propagate_query_params: Optional[builtins.bool] = None,
    ...
    :param builtins.bool propagate_query_params: (Optional, Default: `false`) When set, if query params are included in the request to Artifactory, they will be passed on to the remote repository.
    """
    __args__ = dict()
...
def get_remote_generic_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         ...
                                         propagate_query_params: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
