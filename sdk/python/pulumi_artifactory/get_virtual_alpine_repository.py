...
def get_virtual_alpine_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[builtins.bool] = None,
    ...
    :param builtins.str primary_keypair_ref: (Optional) Primary keypair used to sign artifacts. Default value is empty.
...
def get_virtual_alpine_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
