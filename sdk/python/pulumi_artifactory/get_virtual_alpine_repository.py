...
class AwaitableGetVirtualAlpineRepositoryResult(GetVirtualAlpineRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualAlpineRepositoryResult(
...
def get_virtual_alpine_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    :param _builtins.str primary_keypair_ref: (Optional) Primary keypair used to sign artifacts. Default value is empty.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualAlpineRepository:getVirtualAlpineRepository', __args__, opts=opts, typ=GetVirtualAlpineRepositoryResult).value

    return AwaitableGetVirtualAlpineRepositoryResult(
...
def get_virtual_alpine_repository_output(artifactory_requests_can_retrieve_remote_artifacts: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualAlpineRepositoryResult]:
    """
    Retrieves a virtual Alpine repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualAlpineRepository:getVirtualAlpineRepository', __args__, opts=opts, typ=GetVirtualAlpineRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualAlpineRepositoryResult(
