...
__all__ = [
    'GetFederatedBowerRepositoryResult',
    'AwaitableGetFederatedBowerRepositoryResult',
    'get_federated_bower_repository',
    'get_federated_bower_repository_output',
]

@pulumi.output_type
class GetFederatedBowerRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedBowerRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedBowerRepositoryResult(GetFederatedBowerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedBowerRepositoryResult(
...
def get_federated_bower_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                   ...
                                   members: Optional[Sequence[Union['GetFederatedBowerRepositoryMemberArgs', 'GetFederatedBowerRepositoryMemberArgsDict', 'outputs.GetFederatedBowerRepositoryMemberResult']]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedBowerRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedBowerRepositoryMemberArgs', 'GetFederatedBowerRepositoryMemberArgsDict', 'outputs.GetFederatedBowerRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedBowerRepository:getFederatedBowerRepository', __args__, opts=opts, typ=GetFederatedBowerRepositoryResult).value

    return AwaitableGetFederatedBowerRepositoryResult(
...
def get_federated_bower_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                          ...
                                          members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedBowerRepositoryMemberArgs', 'GetFederatedBowerRepositoryMemberArgsDict', 'outputs.GetFederatedBowerRepositoryMemberResult']]]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedBowerRepositoryResult]:
    """
    Retrieves a federated Bower repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedBowerRepository:getFederatedBowerRepository', __args__, opts=opts, typ=GetFederatedBowerRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedBowerRepositoryResult(
