...
__all__ = [
    'GetVirtualPypiRepositoryResult',
    'AwaitableGetVirtualPypiRepositoryResult',
    'get_virtual_pypi_repository',
    'get_virtual_pypi_repository_output',
]

@pulumi.output_type
class GetVirtualPypiRepositoryResult:
    """
...
class AwaitableGetVirtualPypiRepositoryResult(GetVirtualPypiRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualPypiRepositoryResult(
...
def get_virtual_pypi_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualPypiRepository:getVirtualPypiRepository', __args__, opts=opts, typ=GetVirtualPypiRepositoryResult).value

    return AwaitableGetVirtualPypiRepositoryResult(
...
def get_virtual_pypi_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualPypiRepository:getVirtualPypiRepository', __args__, opts=opts, typ=GetVirtualPypiRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualPypiRepositoryResult(
