...
def get_virtual_ivy_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
...
def get_virtual_ivy_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualIvyRepositoryResult]:
    """
    Retrieves a virtual Ivy repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualIvyRepository:getVirtualIvyRepository', __args__, opts=opts, typ=GetVirtualIvyRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualIvyRepositoryResult(
