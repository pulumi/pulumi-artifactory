...
class GetRemoteComposerRepositoryResult:
    ...
    def __init__(__self__, allow_any_host_auth=None, archive_browsing_enabled=None, assumed_offline_period_secs=None, blacked_out=None, block_mismatching_mime_types=None, bypass_head_requests=None, cdn_redirect=None, client_tls_certificate=None, composer_registry_url=None, content_synchronisation=None, description=None, disable_proxy=None, disable_url_normalization=None, download_direct=None, enable_cookie_management=None, excludes_pattern=None, hard_fail=None, id=None, includes_pattern=None, key=None, list_remote_folder_items=None, local_address=None, metadata_retrieval_timeout_secs=None, mismatching_mime_types_override_list=None, missed_cache_period_seconds=None, notes=None, offline=None, package_type=None, password=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, query_params=None, remote_repo_layout_ref=None, repo_layout_ref=None, retrieval_cache_period_seconds=None, share_configuration=None, socket_timeout_millis=None, store_artifacts_locally=None, synchronize_properties=None, unused_artifacts_cleanup_period_hours=None, url=None, username=None, vcs_git_download_url=None, vcs_git_provider=None, xray_index=None):
        ...
        if composer_registry_url and not isinstance(composer_registry_url, str):
            raise TypeError("Expected argument 'composer_registry_url' to be a str")
        ...
        if vcs_git_download_url and not isinstance(vcs_git_download_url, str):
            raise TypeError("Expected argument 'vcs_git_download_url' to be a str")
        pulumi.set(__self__, "vcs_git_download_url", vcs_git_download_url)
        if vcs_git_provider and not isinstance(vcs_git_provider, str):
            raise TypeError("Expected argument 'vcs_git_provider' to be a str")
    ...
    def composer_registry_url(self) -> Optional[_builtins.str]:
        """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteComposerRepositoryContentSynchronisationResult':
    ...
    def vcs_git_download_url(self) -> Optional[_builtins.str]:
        """
...
class AwaitableGetRemoteComposerRepositoryResult(GetRemoteComposerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteComposerRepositoryResult(
            ...
            composer_registry_url=self.composer_registry_url,
            ...
            vcs_git_download_url=self.vcs_git_download_url,
            vcs_git_provider=self.vcs_git_provider,
            xray_index=self.xray_index)


def get_remote_composer_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                   ...
                                   composer_registry_url: Optional[_builtins.str] = None,
                                   content_synchronisation: Optional[Union['GetRemoteComposerRepositoryContentSynchronisationArgs', 'GetRemoteComposerRepositoryContentSynchronisationArgsDict']] = None,
                                   ...
                                   vcs_git_download_url: Optional[_builtins.str] = None,
                                   vcs_git_provider: Optional[_builtins.str] = None,
    ...
    :param _builtins.str composer_registry_url: (Optional) Proxy remote Composer repository. Default value is `https://packagist.org`.
    ...
    :param _builtins.str vcs_git_provider: (Optional) Artifactory supports proxying the following Git providers out-of-the-box: GitHub or a remote Artifactory instance. Default value is `GITHUB`. Possible values are: `GITHUB`, `BITBUCKET`, `OLDSTASH`, `STASH`, `ARTIFACTORY`, `CUSTOM`.
    """
    __args__ = dict()
    ...
    __args__['composerRegistryUrl'] = composer_registry_url
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteComposerRepository:getRemoteComposerRepository', __args__, opts=opts, typ=GetRemoteComposerRepositoryResult).value

    return AwaitableGetRemoteComposerRepositoryResult(
        ...
        composer_registry_url=pulumi.get(__ret__, 'composer_registry_url'),
...
def get_remote_composer_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                          ...
                                          composer_registry_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteComposerRepositoryContentSynchronisationArgs', 'GetRemoteComposerRepositoryContentSynchronisationArgsDict']]]] = None,
                                          ...
                                          vcs_git_download_url: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          vcs_git_provider: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          xray_index: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteComposerRepositoryResult]:
    """
    Retrieves a remote Composer repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteComposerRepository:getRemoteComposerRepository', __args__, opts=opts, typ=GetRemoteComposerRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteComposerRepositoryResult(
        ...
        composer_registry_url=pulumi.get(__response__, 'composer_registry_url'),
        ...
        vcs_git_download_url=pulumi.get(__response__, 'vcs_git_download_url'),
        vcs_git_provider=pulumi.get(__response__, 'vcs_git_provider'),
