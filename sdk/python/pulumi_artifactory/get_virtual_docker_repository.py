...
__all__ = [
    'GetVirtualDockerRepositoryResult',
    'AwaitableGetVirtualDockerRepositoryResult',
    'get_virtual_docker_repository',
    'get_virtual_docker_repository_output',
]

@pulumi.output_type
class GetVirtualDockerRepositoryResult:
    """
    A collection of values returned by getVirtualDockerRepository.
    """
    def __init__(__self__, artifactory_requests_can_retrieve_remote_artifacts=None, default_deployment_repo=None, description=None, excludes_pattern=None, hide_unauthorized_resources=None, id=None, includes_pattern=None, key=None, notes=None, package_type=None, project_environments=None, project_key=None, repo_layout_ref=None, repositories=None, resolve_docker_tags_by_timestamp=None):
        ...
        if resolve_docker_tags_by_timestamp and not isinstance(resolve_docker_tags_by_timestamp, bool):
            raise TypeError("Expected argument 'resolve_docker_tags_by_timestamp' to be a bool")
    ...
    def resolve_docker_tags_by_timestamp(self) -> Optional[_builtins.bool]:
        """
...
class AwaitableGetVirtualDockerRepositoryResult(GetVirtualDockerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualDockerRepositoryResult(
            ...
            resolve_docker_tags_by_timestamp=self.resolve_docker_tags_by_timestamp)


def get_virtual_docker_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                  ...
                                  resolve_docker_tags_by_timestamp: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool resolve_docker_tags_by_timestamp: (Optional) When enabled, in cases where the same Docker tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualDockerRepository:getVirtualDockerRepository', __args__, opts=opts, typ=GetVirtualDockerRepositoryResult).value

    return AwaitableGetVirtualDockerRepositoryResult(
        ...
        resolve_docker_tags_by_timestamp=pulumi.get(__ret__, 'resolve_docker_tags_by_timestamp'))
def get_virtual_docker_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         resolve_docker_tags_by_timestamp: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetVirtualDockerRepositoryResult(
        ...
        resolve_docker_tags_by_timestamp=pulumi.get(__response__, 'resolve_docker_tags_by_timestamp')))
