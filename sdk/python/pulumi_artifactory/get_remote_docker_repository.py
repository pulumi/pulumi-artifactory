...
class GetRemoteDockerRepositoryResult:
    ...
    def enable_token_authentication(self) -> builtins.bool:
        """
...
def get_remote_docker_repository(allow_any_host_auth: Optional[builtins.bool] = None,
                                 ...
                                 block_pushing_schema1: Optional[builtins.bool] = None,
                                 ...
                                 enable_token_authentication: Optional[builtins.bool] = None,
    ...
    :param builtins.bool block_pushing_schema1: (Optional) When set, Artifactory will block the pulling of Docker images with manifest v2 schema 1 from the remote repository (i.e. the upstream). It will be possible to pull images with manifest v2 schema 1 that exist in the cache.
    :param builtins.bool disable_url_normalization: (Optional) Whether to disable URL normalization.
    :param builtins.bool enable_token_authentication: (Optional) Enable token (Bearer) based authentication.
    :param builtins.bool external_dependencies_enabled: (Optional) Also known as 'Foreign Layers Caching' on the UI.
...
def get_remote_docker_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                        ...
                                        block_pushing_schema1: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                        ...
                                        enable_token_authentication: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
