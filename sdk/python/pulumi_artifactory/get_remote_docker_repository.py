...
class GetRemoteDockerRepositoryResult:
    ...
    def block_pushing_schema1(self) -> _builtins.bool:
        """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteDockerRepositoryContentSynchronisationResult':
    ...
    def enable_token_authentication(self) -> _builtins.bool:
        """
...
class AwaitableGetRemoteDockerRepositoryResult(GetRemoteDockerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteDockerRepositoryResult(
...
def get_remote_docker_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                 ...
                                 block_pushing_schema1: Optional[_builtins.bool] = None,
                                 ...
                                 content_synchronisation: Optional[Union['GetRemoteDockerRepositoryContentSynchronisationArgs', 'GetRemoteDockerRepositoryContentSynchronisationArgsDict']] = None,
    ...
    :param _builtins.bool block_pushing_schema1: (Optional) When set, Artifactory will block the pulling of Docker images with manifest v2 schema 1 from the remote repository (i.e. the upstream). It will be possible to pull images with manifest v2 schema 1 that exist in the cache.
    :param _builtins.bool disable_url_normalization: (Optional) Whether to disable URL normalization.
    :param _builtins.bool enable_token_authentication: (Optional) Enable token (Bearer) based authentication.
    :param _builtins.bool external_dependencies_enabled: (Optional) Also known as 'Foreign Layers Caching' on the UI.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteDockerRepository:getRemoteDockerRepository', __args__, opts=opts, typ=GetRemoteDockerRepositoryResult).value

    return AwaitableGetRemoteDockerRepositoryResult(
...
def get_remote_docker_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        block_pushing_schema1: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteDockerRepositoryContentSynchronisationArgs', 'GetRemoteDockerRepositoryContentSynchronisationArgsDict']]]] = None,
                                        ...
                                        enable_token_authentication: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
