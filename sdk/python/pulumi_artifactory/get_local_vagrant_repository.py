...
def get_local_vagrant_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
...
def get_local_vagrant_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
