...
__all__ = [
    'GetLocalVagrantRepositoryResult',
    'AwaitableGetLocalVagrantRepositoryResult',
    'get_local_vagrant_repository',
    'get_local_vagrant_repository_output',
]

@pulumi.output_type
class GetLocalVagrantRepositoryResult:
    """
...
class AwaitableGetLocalVagrantRepositoryResult(GetLocalVagrantRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalVagrantRepositoryResult(
...
def get_local_vagrant_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalVagrantRepository:getLocalVagrantRepository', __args__, opts=opts, typ=GetLocalVagrantRepositoryResult).value

    return AwaitableGetLocalVagrantRepositoryResult(
...
def get_local_vagrant_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalVagrantRepositoryResult]:
    """
    Retrieves a local vagrant repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalVagrantRepository:getLocalVagrantRepository', __args__, opts=opts, typ=GetLocalVagrantRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalVagrantRepositoryResult(
