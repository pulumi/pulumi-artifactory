...
class GetLocalRpmRepositoryResult:
    ...
    def calculate_yum_metadata(self) -> Optional[builtins.bool]:
        """
        Default: `false`.
        """
    ...
    def enable_file_lists_indexing(self) -> Optional[builtins.bool]:
        """
        Default: `false`.
        """
    ...
    def yum_group_file_names(self) -> Optional[builtins.str]:
        """
    ...
    def yum_root_depth(self) -> Optional[builtins.int]:
        """
...
def get_local_rpm_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
                             blacked_out: Optional[builtins.bool] = None,
                             calculate_yum_metadata: Optional[builtins.bool] = None,
                             cdn_redirect: Optional[builtins.bool] = None,
                             description: Optional[builtins.str] = None,
                             download_direct: Optional[builtins.bool] = None,
                             enable_file_lists_indexing: Optional[builtins.bool] = None,
                             ...
                             yum_group_file_names: Optional[builtins.str] = None,
                             yum_root_depth: Optional[builtins.int] = None,
    ...
    :param builtins.bool calculate_yum_metadata: Default: `false`.
    :param builtins.bool enable_file_lists_indexing: Default: `false`.
    :param builtins.str key: the identity key of the repo.
    :param builtins.str primary_keypair_ref: The primary GPG key to be used to sign packages.
    :param builtins.str secondary_keypair_ref: The secondary GPG key to be used to sign packages.
    :param builtins.str yum_group_file_names: A comma separated list of XML file names containing RPM group component
           definitions. Artifactory includes the group definitions as part of the calculated RPM metadata, as well as
           automatically generating a gzipped version of the group files, if required. Default is empty string.
    :param builtins.int yum_root_depth: The depth, relative to the repository's root folder, where RPM metadata is created. This
           is useful when your repository contains multiple RPM repositories under parallel hierarchies. For example, if your
           RPMs are stored under 'fedora/linux/$releasever/$basearch', specify a depth of 4. Once the number of snapshots exceeds
           this setting, older versions are removed. A value of 0 (default) indicates there is no limit, and unique snapshots are
           not cleaned up.
...
def get_local_rpm_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    blacked_out: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    calculate_yum_metadata: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    ...
                                    enable_file_lists_indexing: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    ...
                                    yum_group_file_names: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    yum_root_depth: Optional[pulumi.Input[Optional[builtins.int]]] = None,
