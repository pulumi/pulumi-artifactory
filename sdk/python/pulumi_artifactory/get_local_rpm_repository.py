...
class AwaitableGetLocalRpmRepositoryResult(GetLocalRpmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalRpmRepositoryResult(
...
def get_local_rpm_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool calculate_yum_metadata: Default: `false`.
    :param _builtins.bool enable_file_lists_indexing: Default: `false`.
    :param _builtins.str key: the identity key of the repo.
    :param _builtins.str primary_keypair_ref: The primary GPG key to be used to sign packages.
    :param _builtins.str secondary_keypair_ref: The secondary GPG key to be used to sign packages.
    :param _builtins.str yum_group_file_names: A comma separated list of XML file names containing RPM group component
           definitions. Artifactory includes the group definitions as part of the calculated RPM metadata, as well as
           automatically generating a gzipped version of the group files, if required. Default is empty string.
    :param _builtins.int yum_root_depth: The depth, relative to the repository's root folder, where RPM metadata is created. This
           is useful when your repository contains multiple RPM repositories under parallel hierarchies. For example, if your
           RPMs are stored under 'fedora/linux/$releasever/$basearch', specify a depth of 4. Once the number of snapshots exceeds
           this setting, older versions are removed. A value of 0 (default) indicates there is no limit, and unique snapshots are
           not cleaned up.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalRpmRepository:getLocalRpmRepository', __args__, opts=opts, typ=GetLocalRpmRepositoryResult).value

    return AwaitableGetLocalRpmRepositoryResult(
...
def get_local_rpm_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    blacked_out: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    calculate_yum_metadata: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ...
                                    enable_file_lists_indexing: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ...
                                    yum_group_file_names: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    yum_root_depth: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
