...
__all__ = [
    'GetFederatedComposerRepositoryResult',
    'AwaitableGetFederatedComposerRepositoryResult',
    'get_federated_composer_repository',
    'get_federated_composer_repository_output',
]

@pulumi.output_type
class GetFederatedComposerRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedComposerRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedComposerRepositoryResult(GetFederatedComposerRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedComposerRepositoryResult(
...
def get_federated_composer_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                      ...
                                      members: Optional[Sequence[Union['GetFederatedComposerRepositoryMemberArgs', 'GetFederatedComposerRepositoryMemberArgsDict', 'outputs.GetFederatedComposerRepositoryMemberResult']]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedComposerRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedComposerRepositoryMemberArgs', 'GetFederatedComposerRepositoryMemberArgsDict', 'outputs.GetFederatedComposerRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedComposerRepository:getFederatedComposerRepository', __args__, opts=opts, typ=GetFederatedComposerRepositoryResult).value

    return AwaitableGetFederatedComposerRepositoryResult(
...
def get_federated_composer_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                             ...
                                             members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedComposerRepositoryMemberArgs', 'GetFederatedComposerRepositoryMemberArgsDict', 'outputs.GetFederatedComposerRepositoryMemberResult']]]]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedComposerRepositoryResult]:
    """
    Retrieves a federated Composer repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedComposerRepository:getFederatedComposerRepository', __args__, opts=opts, typ=GetFederatedComposerRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedComposerRepositoryResult(
