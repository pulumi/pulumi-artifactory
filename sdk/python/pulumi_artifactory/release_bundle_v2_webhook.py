...
__all__ = ['ReleaseBundleV2WebhookArgs', 'ReleaseBundleV2Webhook']
...
class ReleaseBundleV2WebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `release_bundle_v2_started`, `release_bundle_v2_failed`, `release_bundle_v2_completed`.
...
@pulumi.input_type
class _ReleaseBundleV2WebhookState:
    def __init__(__self__, *,
                 criteria: Optional[pulumi.Input['ReleaseBundleV2WebhookCriteriaArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
...
@pulumi.type_token("artifactory:index/releaseBundleV2Webhook:ReleaseBundleV2Webhook")
class ReleaseBundleV2Webhook(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 criteria: Optional[pulumi.Input[Union['ReleaseBundleV2WebhookCriteriaArgs', 'ReleaseBundleV2WebhookCriteriaArgsDict']]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 handlers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ReleaseBundleV2WebhookHandlerArgs', 'ReleaseBundleV2WebhookHandlerArgsDict']]]]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: ReleaseBundleV2WebhookArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides an Artifactory webhook resource. This can be used to register and manage Artifactory webhook subscription which enables you to be notified or notify other users when such events take place in Artifactory.
        ...
        :param str resource_name: The name of the resource.
        :param ReleaseBundleV2WebhookArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ReleaseBundleV2WebhookArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(ReleaseBundleV2Webhook, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            event_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            handlers: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ReleaseBundleV2WebhookHandlerArgs', 'ReleaseBundleV2WebhookHandlerArgsDict']]]]] = None,
            key: Optional[pulumi.Input[builtins.str]] = None) -> 'ReleaseBundleV2Webhook':
        """
        ...
        __props__ = _ReleaseBundleV2WebhookState.__new__(_ReleaseBundleV2WebhookState)
        ...
        __props__.__dict__["handlers"] = handlers
        __props__.__dict__["key"] = key
        return ReleaseBundleV2Webhook(resource_name, opts=opts, __props__=__props__)
