...
__all__ = [
    'GetVirtualGemsRepositoryResult',
    'AwaitableGetVirtualGemsRepositoryResult',
    'get_virtual_gems_repository',
    'get_virtual_gems_repository_output',
]

@pulumi.output_type
class GetVirtualGemsRepositoryResult:
    """
...
class AwaitableGetVirtualGemsRepositoryResult(GetVirtualGemsRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualGemsRepositoryResult(
...
def get_virtual_gems_repository(artifactory_requests_can_retrieve_remote_artifacts: Optional[_builtins.bool] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVirtualGemsRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getVirtualGemsRepository:getVirtualGemsRepository', __args__, opts=opts, typ=GetVirtualGemsRepositoryResult).value

    return AwaitableGetVirtualGemsRepositoryResult(
...
def get_virtual_gems_repository_output(artifactory_requests_can_retrieve_remote_artifacts: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualGemsRepositoryResult]:
    """
    Retrieves a virtual Gems repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getVirtualGemsRepository:getVirtualGemsRepository', __args__, opts=opts, typ=GetVirtualGemsRepositoryResult)
    return __ret__.apply(lambda __response__: GetVirtualGemsRepositoryResult(
