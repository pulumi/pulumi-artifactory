...
class DebianRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] index_compression_formats: The options are Bzip2 (.bz2 extension) (default), LZMA (.lzma extension)
               and XZ (.xz extension).
        :param pulumi.Input[str] notes: Internal description.
        :param pulumi.Input[str] primary_keypair_ref: The primary RSA key to be used to sign packages.
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        DebianRepositoryArgs._configure(
...
class _DebianRepositoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] xray_index: Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via
               Xray settings.
        """
        _DebianRepositoryState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            archive_browsing_enabled=archive_browsing_enabled,
            blacked_out=blacked_out,
            cdn_redirect=cdn_redirect,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DebianRepositoryArgs._configure(_setter, **kwargs)
