...
__all__ = [
    ...
    'AwaitableGetLocalOpkgRepositoryResult',
    'get_local_opkg_repository',
    'get_local_opkg_repository_output',
]

@pulumi.output_type
class GetLocalOpkgRepositoryResult:
    """
...
class AwaitableGetLocalOpkgRepositoryResult(GetLocalOpkgRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalOpkgRepositoryResult(
...
def get_local_opkg_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalOpkgRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalOpkgRepository:getLocalOpkgRepository', __args__, opts=opts, typ=GetLocalOpkgRepositoryResult).value

    return AwaitableGetLocalOpkgRepositoryResult(
...
def get_local_opkg_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalOpkgRepositoryResult]:
    """
    Retrieves a local opkg repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalOpkgRepository:getLocalOpkgRepository', __args__, opts=opts, typ=GetLocalOpkgRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalOpkgRepositoryResult(
