...
class GeneralSecurityArgs:
    def __init__(__self__, *,
                 ...
                 encryption_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a GeneralSecurity resource.
        :param pulumi.Input[builtins.bool] enable_anonymous_access: Enable anonymous access.  Default value is `false`.
        :param pulumi.Input[builtins.str] encryption_policy: Determines the password requirements from users identified to Artifactory from a remote client such as Maven. The
    ...
    def encryption_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryption_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GeneralSecurity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enable_anonymous_access: Optional[pulumi.Input[builtins.bool]] = None,
            encryption_policy: Optional[pulumi.Input[builtins.str]] = None) -> 'GeneralSecurity':
        """
    ...
    @property
    @pulumi.getter(name="enableAnonymousAccess")
    def enable_anonymous_access(self) -> pulumi.Output[builtins.bool]:
        """
        Enable anonymous access.  Default value is `false`.
        """
        return pulumi.get(self, "enable_anonymous_access")
    ...
    @property
    @pulumi.getter(name="encryptionPolicy")
    def encryption_policy(self) -> pulumi.Output[builtins.str]:
        """
        Determines the password requirements from users identified to Artifactory from a remote client such as Maven. The
        options are: (1) `SUPPORTED` (default): Users can authenticate using secure encrypted passwords or clear-text passwords.
        (2) `REQUIRED`: Users must authenticate using secure encrypted passwords. Clear-text authentication fails. (3)
