...
__all__ = [
    ...
    'AwaitableGetFederatedCranRepositoryResult',
    'get_federated_cran_repository',
    'get_federated_cran_repository_output',
]

@pulumi.output_type
class GetFederatedCranRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedCranRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedCranRepositoryResult(GetFederatedCranRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedCranRepositoryResult(
...
def get_federated_cran_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                  ...
                                  members: Optional[Sequence[Union['GetFederatedCranRepositoryMemberArgs', 'GetFederatedCranRepositoryMemberArgsDict', 'outputs.GetFederatedCranRepositoryMemberResult']]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedCranRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedCranRepositoryMemberArgs', 'GetFederatedCranRepositoryMemberArgsDict', 'outputs.GetFederatedCranRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedCranRepository:getFederatedCranRepository', __args__, opts=opts, typ=GetFederatedCranRepositoryResult).value

    return AwaitableGetFederatedCranRepositoryResult(
...
def get_federated_cran_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                         ...
                                         members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedCranRepositoryMemberArgs', 'GetFederatedCranRepositoryMemberArgsDict', 'outputs.GetFederatedCranRepositoryMemberResult']]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedCranRepositoryResult]:
    """
    Retrieves a federated Cran repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedCranRepository:getFederatedCranRepository', __args__, opts=opts, typ=GetFederatedCranRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedCranRepositoryResult(
