...
__all__ = [
    ...
    'AwaitableGetRemoteChefRepositoryResult',
    'get_remote_chef_repository',
    'get_remote_chef_repository_output',
]

@pulumi.output_type
class GetRemoteChefRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteChefRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteChefRepositoryResult(GetRemoteChefRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteChefRepositoryResult(
...
def get_remote_chef_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                               ...
                               content_synchronisation: Optional[Union['GetRemoteChefRepositoryContentSynchronisationArgs', 'GetRemoteChefRepositoryContentSynchronisationArgsDict']] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteChefRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteChefRepository:getRemoteChefRepository', __args__, opts=opts, typ=GetRemoteChefRepositoryResult).value

    return AwaitableGetRemoteChefRepositoryResult(
...
def get_remote_chef_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                      ...
                                      content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteChefRepositoryContentSynchronisationArgs', 'GetRemoteChefRepositoryContentSynchronisationArgsDict']]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteChefRepositoryResult]:
    """
    Retrieves a remote Chef repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteChefRepository:getRemoteChefRepository', __args__, opts=opts, typ=GetRemoteChefRepositoryResult)
