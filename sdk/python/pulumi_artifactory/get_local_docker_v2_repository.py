...
def get_local_docker_v2_repository(archive_browsing_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.bool block_pushing_schema1: When set, Artifactory will block the pushing of Docker images with manifest v2
           schema 1 to this repository.
    :param builtins.str key: the identity key of the repo.
    :param builtins.int max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository.
           Once the number tags for an image exceeds this setting, older tags are removed. A value of 0 (default) indicates there
           is no limit. This only applies to manifest v2.
    :param builtins.int tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up
           number. This only applies to manifest V2.
    """
    __args__ = dict()
...
def get_local_docker_v2_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
