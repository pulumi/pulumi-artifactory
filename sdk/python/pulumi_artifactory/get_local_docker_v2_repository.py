...
__all__ = [
    'GetLocalDockerV2RepositoryResult',
    'AwaitableGetLocalDockerV2RepositoryResult',
    'get_local_docker_v2_repository',
    'get_local_docker_v2_repository_output',
]

@pulumi.output_type
class GetLocalDockerV2RepositoryResult:
    """
...
class AwaitableGetLocalDockerV2RepositoryResult(GetLocalDockerV2RepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalDockerV2RepositoryResult(
...
def get_local_docker_v2_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalDockerV2RepositoryResult:
    """
    ...
    :param _builtins.bool block_pushing_schema1: When set, Artifactory will block the pushing of Docker images with manifest v2
           schema 1 to this repository.
    :param _builtins.str key: the identity key of the repo.
    :param _builtins.int max_unique_tags: The maximum number of unique tags of a single Docker image to store in this repository.
           Once the number tags for an image exceeds this setting, older tags are removed. A value of 0 (default) indicates there
           is no limit. This only applies to manifest v2.
    :param _builtins.int tag_retention: If greater than 1, overwritten tags will be saved by their digest, up to the set up
           number. This only applies to manifest V2.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalDockerV2Repository:getLocalDockerV2Repository', __args__, opts=opts, typ=GetLocalDockerV2RepositoryResult).value

    return AwaitableGetLocalDockerV2RepositoryResult(
...
def get_local_docker_v2_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalDockerV2RepositoryResult]:
    """
    Retrieves a local Docker (V2) repository resource
