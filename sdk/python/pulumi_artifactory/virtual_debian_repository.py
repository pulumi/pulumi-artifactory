...
class VirtualDebianRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] optional_index_compression_formats: Index file formats you would like to create in addition to the default Gzip (.gzip extension). Supported values are `bz2`,`lzma` and `xz`. Default value is `bz2`.
        :param pulumi.Input[_builtins.str] primary_keypair_ref: Primary keypair used to sign artifacts. Default is empty.
        ...
        :param pulumi.Input[_builtins.str] secondary_keypair_ref: Secondary keypair used to sign artifacts. Default is empty.
        """
...
class VirtualDebianRepository(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="debianDefaultArchitectures")
    def debian_default_architectures(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifying  architectures will speed up Artifactory's initial metadata indexing process. The default architecture values are amd64 and i386.
        """
        return pulumi.get(self, "debian_default_architectures")
    ...
    @_builtins.property
    @pulumi.getter(name="optionalIndexCompressionFormats")
    def optional_index_compression_formats(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Index file formats you would like to create in addition to the default Gzip (.gzip extension). Supported values are `bz2`,`lzma` and `xz`. Default value is `bz2`.
        """
        return pulumi.get(self, "optional_index_compression_formats")
