...
class GetFederatedRpmRepositoryResult:
    ...
    """
    def __init__(__self__, archive_browsing_enabled=None, blacked_out=None, calculate_yum_metadata=None, cdn_redirect=None, cleanup_on_delete=None, description=None, disable_proxy=None, download_direct=None, enable_file_lists_indexing=None, excludes_pattern=None, id=None, includes_pattern=None, key=None, members=None, notes=None, package_type=None, primary_keypair_ref=None, priority_resolution=None, project_environments=None, project_key=None, property_sets=None, proxy=None, repo_layout_ref=None, secondary_keypair_ref=None, xray_index=None, yum_group_file_names=None, yum_root_depth=None):
    ...
    def calculate_yum_metadata(self) -> Optional[_builtins.bool]:
    ...
    def enable_file_lists_indexing(self) -> Optional[_builtins.bool]:
    ...
    def yum_group_file_names(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "yum_group_file_names")

    @_builtins.property
    @pulumi.getter(name="yumRootDepth")
    def yum_root_depth(self) -> Optional[_builtins.int]:
...
def get_federated_rpm_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 blacked_out: Optional[_builtins.bool] = None,
                                 calculate_yum_metadata: Optional[_builtins.bool] = None,
                                 ...
                                 enable_file_lists_indexing: Optional[_builtins.bool] = None,
                                 excludes_pattern: Optional[_builtins.str] = None,
                                 includes_pattern: Optional[_builtins.str] = None,
                                 key: Optional[_builtins.str] = None,
                                 members: Optional[Sequence[Union['GetFederatedRpmRepositoryMemberArgs', 'GetFederatedRpmRepositoryMemberArgsDict', 'outputs.GetFederatedRpmRepositoryMemberResult']]] = None,
                                 ...
                                 yum_group_file_names: Optional[_builtins.str] = None,
                                 yum_root_depth: Optional[_builtins.int] = None,
    ...
    :param Sequence[Union['GetFederatedRpmRepositoryMemberArgs', 'GetFederatedRpmRepositoryMemberArgsDict', 'outputs.GetFederatedRpmRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
...
def get_federated_rpm_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        blacked_out: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        calculate_yum_metadata: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        enable_file_lists_indexing: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedRpmRepositoryMemberArgs', 'GetFederatedRpmRepositoryMemberArgsDict', 'outputs.GetFederatedRpmRepositoryMemberResult']]]]] = None,
                                        ...
                                        yum_group_file_names: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        yum_root_depth: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
