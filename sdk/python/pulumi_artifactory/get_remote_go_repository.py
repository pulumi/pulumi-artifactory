...
def get_remote_go_repository(allow_any_host_auth: Optional[builtins.bool] = None,
    ...
    :param builtins.str vcs_git_provider: (Optional) Artifactory supports proxying the following Git providers out-of-the-box: GitHub or a remote Artifactory instance. Default value is `ARTIFACTORY`.
    """
    __args__ = dict()
...
def get_remote_go_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
