...
class GetRemoteGoRepositoryResult:
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteGoRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteGoRepositoryResult(GetRemoteGoRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteGoRepositoryResult(
...
def get_remote_go_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                             ...
                             content_synchronisation: Optional[Union['GetRemoteGoRepositoryContentSynchronisationArgs', 'GetRemoteGoRepositoryContentSynchronisationArgsDict']] = None,
    ...
    :param _builtins.str vcs_git_provider: (Optional) Artifactory supports proxying the following Git providers out-of-the-box: GitHub or a remote Artifactory instance. Default value is `ARTIFACTORY`.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteGoRepository:getRemoteGoRepository', __args__, opts=opts, typ=GetRemoteGoRepositoryResult).value

    return AwaitableGetRemoteGoRepositoryResult(
...
def get_remote_go_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ...
                                    content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteGoRepositoryContentSynchronisationArgs', 'GetRemoteGoRepositoryContentSynchronisationArgsDict']]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteGoRepositoryResult]:
    """
    Retrieves a remote Go repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteGoRepository:getRemoteGoRepository', __args__, opts=opts, typ=GetRemoteGoRepositoryResult)
