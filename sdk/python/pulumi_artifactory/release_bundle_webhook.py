...
class ReleaseBundleWebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ReleaseBundleWebhookCriteriaArgs'] criteria: Specifies where the webhook will be applied, on which release bundles or distributions.
...
class ReleaseBundleWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ReleaseBundleWebhook resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[pulumi.InputType['ReleaseBundleWebhookCriteriaArgs']] criteria: Specifies where the webhook will be applied, on which release bundles or distributions.
        :param pulumi.Input[str] description: Description of webhook. Max length 1000 characters.
        :param pulumi.Input[bool] enabled: Status of webhook. Default to 'true'
        :param pulumi.Input[Sequence[pulumi.Input[str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow
               values: created, signed, deleted
