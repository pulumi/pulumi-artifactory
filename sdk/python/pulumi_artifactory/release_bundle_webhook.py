...
class ReleaseBundleWebhookArgs:
    def __init__(__self__, *,
        ...
        """
        ReleaseBundleWebhookArgs._configure(
...
class _ReleaseBundleWebhookState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        _ReleaseBundleWebhookState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            criteria=criteria,
            description=description,
            enabled=enabled,
...
class ReleaseBundleWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ReleaseBundleWebhookArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if criteria is not None and not isinstance(criteria, ReleaseBundleWebhookCriteriaArgs):
                criteria = criteria or {}
                def _setter(key, value):
                    criteria[key] = value
                ReleaseBundleWebhookCriteriaArgs._configure(_setter, **criteria)
