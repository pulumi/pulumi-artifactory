...
class ReleaseBundleWebhook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 criteria: pulumi.Input[Optional[Union['ReleaseBundleWebhookCriteriaArgs', 'ReleaseBundleWebhookCriteriaArgsDict']]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 event_types: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 handlers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReleaseBundleWebhookHandlerArgs', 'ReleaseBundleWebhookHandlerArgsDict']]]]] = None,
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['ReleaseBundleWebhookCriteriaArgs', 'ReleaseBundleWebhookCriteriaArgsDict']] criteria: Specifies where the webhook will be applied on which repositories.
        :param pulumi.Input[_builtins.str] description: Webhook description. Max length 1000 characters.
        :param pulumi.Input[_builtins.bool] enabled: Status of webhook. Default to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_types: List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `created`, `signed`, `deleted`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReleaseBundleWebhookHandlerArgs', 'ReleaseBundleWebhookHandlerArgsDict']]]] handlers: At least one is required.
        :param pulumi.Input[_builtins.str] key: The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
        """
        ...
    @overload
