...
__all__ = [
    'GetFederatedVagrantRepositoryResult',
    'AwaitableGetFederatedVagrantRepositoryResult',
    'get_federated_vagrant_repository',
    'get_federated_vagrant_repository_output',
]

@pulumi.output_type
class GetFederatedVagrantRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedVagrantRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedVagrantRepositoryResult(GetFederatedVagrantRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedVagrantRepositoryResult(
...
def get_federated_vagrant_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                     ...
                                     members: Optional[Sequence[Union['GetFederatedVagrantRepositoryMemberArgs', 'GetFederatedVagrantRepositoryMemberArgsDict', 'outputs.GetFederatedVagrantRepositoryMemberResult']]] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedVagrantRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedVagrantRepositoryMemberArgs', 'GetFederatedVagrantRepositoryMemberArgsDict', 'outputs.GetFederatedVagrantRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedVagrantRepository:getFederatedVagrantRepository', __args__, opts=opts, typ=GetFederatedVagrantRepositoryResult).value

    return AwaitableGetFederatedVagrantRepositoryResult(
...
def get_federated_vagrant_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                            ...
                                            members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedVagrantRepositoryMemberArgs', 'GetFederatedVagrantRepositoryMemberArgsDict', 'outputs.GetFederatedVagrantRepositoryMemberResult']]]]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedVagrantRepositoryResult]:
    """
    Retrieves a federated Vagrant repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedVagrantRepository:getFederatedVagrantRepository', __args__, opts=opts, typ=GetFederatedVagrantRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedVagrantRepositoryResult(
