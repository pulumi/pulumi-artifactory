...
class LocalMavenRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] checksum_policy_type: Checksum policy determines how Artifactory behaves when a client checksum for a deployed resource is missing or conflicts with the locally calculated checksum (bad checksum). The options are:
               - `client-checksums`
...
class LocalMavenRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_version_behavior: pulumi.Input[Optional[_builtins.str]] = None,
            suppress_pom_consistency_checks: pulumi.Input[Optional[_builtins.bool]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'LocalMavenRepository':
        """
