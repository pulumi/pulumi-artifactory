...
class FederatedMavenRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 checksum_policy_type: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 snapshot_version_behavior: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def checksum_policy_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def checksum_policy_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def snapshot_version_behavior(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def snapshot_version_behavior(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _FederatedMavenRepositoryState:
    def __init__(__self__, *,
                 ...
                 max_unique_snapshots: pulumi.Input[Optional[_builtins.int]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedMavenRepositoryMemberArgs']]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FederatedMavenRepositoryMemberArgs']]]]:
        """
        The list of Federated members and must contain this repository URL (configured base URL
        `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
        Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
    ...
    @members.setter
    def members(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FederatedMavenRepositoryMemberArgs']]]]):
        pulumi.set(self, "members", value)
...
class FederatedMavenRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 key: pulumi.Input[Optional[_builtins.str]] = None,
                 max_unique_snapshots: pulumi.Input[Optional[_builtins.int]] = None,
                 members: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FederatedMavenRepositoryMemberArgs', 'FederatedMavenRepositoryMemberArgsDict', 'outputs.FederatedMavenRepositoryMember']]]]] = None,
                 notes: pulumi.Input[Optional[_builtins.str]] = None,
                 priority_resolution: pulumi.Input[Optional[_builtins.bool]] = None,
                 project_environments: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 project_key: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] max_unique_snapshots: The maximum number of unique snapshots of a single artifact to store.
               Once the number of snapshots exceeds this setting, older versions are removed.
               A value of 0 (default) indicates there is no limit, and unique snapshots are not cleaned up.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FederatedMavenRepositoryMemberArgs', 'FederatedMavenRepositoryMemberArgsDict', 'outputs.FederatedMavenRepositoryMember']]]] members: The list of Federated members and must contain this repository URL (configured base URL
               `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
               Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
               to set up Federated repositories correctly.
        :param pulumi.Input[_builtins.str] notes: Internal description.
    ...
    def get(resource_name: str,
            ...
            snapshot_version_behavior: pulumi.Input[Optional[_builtins.str]] = None,
            suppress_pom_consistency_checks: pulumi.Input[Optional[_builtins.bool]] = None,
            xray_index: pulumi.Input[Optional[_builtins.bool]] = None) -> 'FederatedMavenRepository':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="handleReleases")
    def handle_releases(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If set, Artifactory allows you to deploy release artifacts into this repository.
        """
        return pulumi.get(self, "handle_releases")
    ...
    @_builtins.property
    @pulumi.getter(name="handleSnapshots")
    def handle_snapshots(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        If set, Artifactory allows you to deploy snapshot artifacts into this repository.
        """
        return pulumi.get(self, "handle_snapshots")
