...
class VirtualPuppetRepository(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a VirtualPuppetRepository resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            repo_layout_ref: Optional[pulumi.Input[str]] = None,
            repositories: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            retrieval_cache_period_seconds: Optional[pulumi.Input[int]] = None) -> 'VirtualPuppetRepository':
        """
