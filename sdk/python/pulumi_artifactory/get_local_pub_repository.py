...
__all__ = [
    'GetLocalPubRepositoryResult',
    'AwaitableGetLocalPubRepositoryResult',
    'get_local_pub_repository',
    'get_local_pub_repository_output',
]

@pulumi.output_type
class GetLocalPubRepositoryResult:
    """
...
class AwaitableGetLocalPubRepositoryResult(GetLocalPubRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalPubRepositoryResult(
...
def get_local_pub_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalPubRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getLocalPubRepository:getLocalPubRepository', __args__, opts=opts, typ=GetLocalPubRepositoryResult).value

    return AwaitableGetLocalPubRepositoryResult(
...
def get_local_pub_repository_output(archive_browsing_enabled: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalPubRepositoryResult]:
    """
    Retrieves a local pub repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getLocalPubRepository:getLocalPubRepository', __args__, opts=opts, typ=GetLocalPubRepositoryResult)
    return __ret__.apply(lambda __response__: GetLocalPubRepositoryResult(
