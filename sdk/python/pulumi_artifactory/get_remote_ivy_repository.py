...
__all__ = [
    'GetRemoteIvyRepositoryResult',
    'AwaitableGetRemoteIvyRepositoryResult',
    'get_remote_ivy_repository',
    'get_remote_ivy_repository_output',
]

@pulumi.output_type
class GetRemoteIvyRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteIvyRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteIvyRepositoryResult(GetRemoteIvyRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteIvyRepositoryResult(
...
def get_remote_ivy_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                              ...
                              content_synchronisation: Optional[Union['GetRemoteIvyRepositoryContentSynchronisationArgs', 'GetRemoteIvyRepositoryContentSynchronisationArgsDict']] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRemoteIvyRepositoryResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteIvyRepository:getRemoteIvyRepository', __args__, opts=opts, typ=GetRemoteIvyRepositoryResult).value

    return AwaitableGetRemoteIvyRepositoryResult(
...
def get_remote_ivy_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                     ...
                                     content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteIvyRepositoryContentSynchronisationArgs', 'GetRemoteIvyRepositoryContentSynchronisationArgsDict']]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteIvyRepositoryResult]:
    """
    Retrieves a remote Ivy repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteIvyRepository:getRemoteIvyRepository', __args__, opts=opts, typ=GetRemoteIvyRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteIvyRepositoryResult(
