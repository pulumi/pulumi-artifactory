...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 tfc_credential_tag_name: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] access_token: This is a access token that can be given to you by your admin under `User Management > Access Tokens`. If not set, the
               'api_key' attribute value will be used.
        :param pulumi.Input[builtins.str] api_key: API key. If `access_token` attribute, `JFROG_ACCESS_TOKEN` or `ARTIFACTORY_ACCESS_TOKEN` environment variable is set,
               the provider will ignore this attribute.
        :param pulumi.Input[builtins.str] oidc_provider_name: OIDC provider name. See [Configure an OIDC
               Integration](https://jfrog.com/help/r/jfrog-platform-administration-documentation/configure-an-oidc-integration) for
               more details.
        :param pulumi.Input[builtins.str] url: Artifactory URL.
        """
...
By end of Q4 2024, API Keys will be deprecated all together and the option to use them will no longer be available. See [JFrog API deprecation process](https://jfrog.com/help/r/jfrog-platform-administration-documentation/jfrog-api-key-deprecation-process) for more details.""")
    ...
    def tfc_credential_tag_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "tfc_credential_tag_name")

    @tfc_credential_tag_name.setter
    def tfc_credential_tag_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("pulumi:providers:artifactory")
...
By end of Q4 2024, API Keys will be deprecated all together and the option to use them will no longer be available. See [JFrog API deprecation process](https://jfrog.com/help/r/jfrog-platform-administration-documentation/jfrog-api-key-deprecation-process) for more details.""")
    ...
    @property
    @pulumi.getter(name="oidcProviderName")
    def oidc_provider_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        OIDC provider name. See [Configure an OIDC
        Integration](https://jfrog.com/help/r/jfrog-platform-administration-documentation/configure-an-oidc-integration) for
        more details.
    ...
    @property
    @pulumi.getter(name="tfcCredentialTagName")
    def tfc_credential_tag_name(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "tfc_credential_tag_name")
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:artifactory/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)
