...
__all__ = [
    ...
    'AwaitableGetFederatedCondaRepositoryResult',
    'get_federated_conda_repository',
    'get_federated_conda_repository_output',
]

@pulumi.output_type
class GetFederatedCondaRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedCondaRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedCondaRepositoryResult(GetFederatedCondaRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedCondaRepositoryResult(
...
def get_federated_conda_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                   ...
                                   members: Optional[Sequence[Union['GetFederatedCondaRepositoryMemberArgs', 'GetFederatedCondaRepositoryMemberArgsDict', 'outputs.GetFederatedCondaRepositoryMemberResult']]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedCondaRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedCondaRepositoryMemberArgs', 'GetFederatedCondaRepositoryMemberArgsDict', 'outputs.GetFederatedCondaRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedCondaRepository:getFederatedCondaRepository', __args__, opts=opts, typ=GetFederatedCondaRepositoryResult).value

    return AwaitableGetFederatedCondaRepositoryResult(
...
def get_federated_conda_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                          ...
                                          members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedCondaRepositoryMemberArgs', 'GetFederatedCondaRepositoryMemberArgsDict', 'outputs.GetFederatedCondaRepositoryMemberResult']]]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedCondaRepositoryResult]:
    """
    Retrieves a federated Conda repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedCondaRepository:getFederatedCondaRepository', __args__, opts=opts, typ=GetFederatedCondaRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedCondaRepositoryResult(
