...
__all__ = [
    'GetRemoteDebianRepositoryResult',
    'AwaitableGetRemoteDebianRepositoryResult',
    'get_remote_debian_repository',
    'get_remote_debian_repository_output',
]

@pulumi.output_type
class GetRemoteDebianRepositoryResult:
    """
    ...
    def content_synchronisation(self) -> 'outputs.GetRemoteDebianRepositoryContentSynchronisationResult':
...
class AwaitableGetRemoteDebianRepositoryResult(GetRemoteDebianRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRemoteDebianRepositoryResult(
...
def get_remote_debian_repository(allow_any_host_auth: Optional[_builtins.bool] = None,
                                 ...
                                 content_synchronisation: Optional[Union['GetRemoteDebianRepositoryContentSynchronisationArgs', 'GetRemoteDebianRepositoryContentSynchronisationArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getRemoteDebianRepository:getRemoteDebianRepository', __args__, opts=opts, typ=GetRemoteDebianRepositoryResult).value

    return AwaitableGetRemoteDebianRepositoryResult(
...
def get_remote_debian_repository_output(allow_any_host_auth: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                        ...
                                        content_synchronisation: Optional[pulumi.Input[Optional[Union['GetRemoteDebianRepositoryContentSynchronisationArgs', 'GetRemoteDebianRepositoryContentSynchronisationArgsDict']]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRemoteDebianRepositoryResult]:
    """
    Retrieves a remote Debian repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getRemoteDebianRepository:getRemoteDebianRepository', __args__, opts=opts, typ=GetRemoteDebianRepositoryResult)
    return __ret__.apply(lambda __response__: GetRemoteDebianRepositoryResult(
