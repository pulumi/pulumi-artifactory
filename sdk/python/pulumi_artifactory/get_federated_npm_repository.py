...
__all__ = [
    'GetFederatedNpmRepositoryResult',
    'AwaitableGetFederatedNpmRepositoryResult',
    'get_federated_npm_repository',
    'get_federated_npm_repository_output',
]

@pulumi.output_type
class GetFederatedNpmRepositoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def members(self) -> Optional[Sequence['outputs.GetFederatedNpmRepositoryMemberResult']]:
        """
...
class AwaitableGetFederatedNpmRepositoryResult(GetFederatedNpmRepositoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetFederatedNpmRepositoryResult(
...
def get_federated_npm_repository(archive_browsing_enabled: Optional[_builtins.bool] = None,
                                 ...
                                 members: Optional[Sequence[Union['GetFederatedNpmRepositoryMemberArgs', 'GetFederatedNpmRepositoryMemberArgsDict', 'outputs.GetFederatedNpmRepositoryMemberResult']]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFederatedNpmRepositoryResult:
    """
    ...
    :param Sequence[Union['GetFederatedNpmRepositoryMemberArgs', 'GetFederatedNpmRepositoryMemberArgsDict', 'outputs.GetFederatedNpmRepositoryMemberResult']] members: The list of Federated members and must contain this repository URL (configured base URL
           `/artifactory/` + repo `key`). Note that each of the federated members will need to have a base URL set.
           Please follow the [instruction](https://www.jfrog.com/confluence/display/JFROG/Working+with+Federated+Repositories#WorkingwithFederatedRepositories-SettingUpaFederatedRepository)
           to set up Federated repositories correctly.
    ...
    __ret__ = pulumi.runtime.invoke('artifactory:index/getFederatedNpmRepository:getFederatedNpmRepository', __args__, opts=opts, typ=GetFederatedNpmRepositoryResult).value

    return AwaitableGetFederatedNpmRepositoryResult(
...
def get_federated_npm_repository_output(archive_browsing_enabled: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        ...
                                        members: pulumi.Input[Optional[Optional[Sequence[Union['GetFederatedNpmRepositoryMemberArgs', 'GetFederatedNpmRepositoryMemberArgsDict', 'outputs.GetFederatedNpmRepositoryMemberResult']]]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFederatedNpmRepositoryResult]:
    """
    Retrieves a federated Npm repository.
    ...
    __ret__ = pulumi.runtime.invoke_output('artifactory:index/getFederatedNpmRepository:getFederatedNpmRepository', __args__, opts=opts, typ=GetFederatedNpmRepositoryResult)
    return __ret__.apply(lambda __response__: GetFederatedNpmRepositoryResult(
