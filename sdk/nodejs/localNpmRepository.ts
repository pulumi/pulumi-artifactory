...
export class LocalNpmRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalNpmRepositoryState, opts?: pulumi.CustomResourceOptions): LocalNpmRepository {
        return new LocalNpmRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localNpmRepository:LocalNpmRepository';

    /**
     * Returns true if the given object is an instance of LocalNpmRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalNpmRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalNpmRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalNpmRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalNpmRepositoryArgs | LocalNpmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalNpmRepositoryState | undefined;
            ...
            const args = argsOrState as LocalNpmRepositoryArgs | undefined;
        ...
        super(LocalNpmRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalNpmRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
 ...
 */
export interface LocalNpmRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
