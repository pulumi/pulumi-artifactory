...
export function getFederatedConanRepository(args: GetFederatedConanRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedConanRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedConanRepository:getFederatedConanRepository", {
 ...
 */
export interface GetFederatedConanRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedConanRepositoryMember[];
    notes?: string;
 ...
 */
export interface GetFederatedConanRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedConanRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedConanRepository.
 */
export interface GetFederatedConanRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedConanRepositoryMemberArgs>[] | undefined>;
