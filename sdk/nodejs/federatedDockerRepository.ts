 ...
 *
 * const terraform_federated_test_docker_repo = new artifactory.index/federatedDockerRepository.FederatedDockerRepository("terraform-federated-test-docker-repo", {
...
export class FederatedDockerRepository extends pulumi.CustomResource {
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedDockerRepositoryMember[]>;
    /**
