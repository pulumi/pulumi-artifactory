...
export function getFederatedNpmRepository(args: GetFederatedNpmRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedNpmRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedNpmRepository:getFederatedNpmRepository", {
 ...
 */
export interface GetFederatedNpmRepositoryArgs {
 ...
 */
export interface GetFederatedNpmRepositoryResult {
 ...
 * A collection of arguments for invoking getFederatedNpmRepository.
 */
export interface GetFederatedNpmRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedNpmRepositoryMemberArgs>[] | undefined>;
