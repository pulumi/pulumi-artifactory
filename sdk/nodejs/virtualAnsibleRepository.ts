 ...
 *
 * const my_ansible_virtual = new artifactory.VirtualAnsibleRepository("my-ansible-virtual", {
 ...
 * ```
 */
export class VirtualAnsibleRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualAnsibleRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualAnsibleRepository {
        return new VirtualAnsibleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualAnsibleRepository:VirtualAnsibleRepository';

    /**
     * Returns true if the given object is an instance of VirtualAnsibleRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualAnsibleRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualAnsibleRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: VirtualAnsibleRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualAnsibleRepositoryArgs | VirtualAnsibleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualAnsibleRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualAnsibleRepositoryArgs | undefined;
        ...
        super(VirtualAnsibleRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualAnsibleRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualAnsibleRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
