...
export function getRemoteSwiftRepository(args: GetRemoteSwiftRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteSwiftRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteSwiftRepository:getRemoteSwiftRepository", {
 ...
 */
export interface GetRemoteSwiftRepositoryArgs {
    ...
    contentSynchronisation?: inputs.GetRemoteSwiftRepositoryContentSynchronisation;
    description?: string;
 ...
 */
export interface GetRemoteSwiftRepositoryResult {
    ...
    readonly contentSynchronisation: outputs.GetRemoteSwiftRepositoryContentSynchronisation;
 ...
 * A collection of arguments for invoking getRemoteSwiftRepository.
 */
export interface GetRemoteSwiftRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteSwiftRepositoryContentSynchronisationArgs | undefined>;
