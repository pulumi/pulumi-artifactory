...
export class LocalPubRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalPubRepositoryState, opts?: pulumi.CustomResourceOptions): LocalPubRepository {
        return new LocalPubRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localPubRepository:LocalPubRepository';

    /**
     * Returns true if the given object is an instance of LocalPubRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalPubRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalPubRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalPubRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalPubRepositoryArgs | LocalPubRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalPubRepositoryState | undefined;
            ...
            const args = argsOrState as LocalPubRepositoryArgs | undefined;
        ...
        super(LocalPubRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalPubRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalPubRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
