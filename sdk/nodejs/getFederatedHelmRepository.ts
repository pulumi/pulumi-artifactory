...
export function getFederatedHelmRepository(args: GetFederatedHelmRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedHelmRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedHelmRepository:getFederatedHelmRepository", {
 ...
 */
export interface GetFederatedHelmRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedHelmRepositoryMember[];
    notes?: string;
 ...
 */
export interface GetFederatedHelmRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedHelmRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedHelmRepository.
 */
export interface GetFederatedHelmRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedHelmRepositoryMemberArgs>[] | undefined>;
