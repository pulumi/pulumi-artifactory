...
export class FederatedGenericRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedGenericRepositoryMember[]>;
    /**
...
export interface FederatedGenericRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedGenericRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
