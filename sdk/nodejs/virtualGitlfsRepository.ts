...
export class VirtualGitlfsRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualGitlfsRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualGitlfsRepository {
        return new VirtualGitlfsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualGitlfsRepository:VirtualGitlfsRepository';

    /**
     * Returns true if the given object is an instance of VirtualGitlfsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualGitlfsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualGitlfsRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualGitlfsRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualGitlfsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualGitlfsRepositoryArgs | VirtualGitlfsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualGitlfsRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualGitlfsRepositoryArgs | undefined;
        ...
        super(VirtualGitlfsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualGitlfsRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualGitlfsRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
