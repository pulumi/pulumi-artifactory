 ...
 *
 * const terraform_local_test_generic_repo = new artifactory.index/localGenericRepository.LocalGenericRepository("terraform-local-test-generic-repo", {key: "terraform-local-test-generic-repo"});
 * ```
 *
 * ## Import
 *
...
export class LocalGenericRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalGenericRepositoryState, opts?: pulumi.CustomResourceOptions): LocalGenericRepository {
        return new LocalGenericRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localGenericRepository:LocalGenericRepository';

    /**
     * Returns true if the given object is an instance of LocalGenericRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalGenericRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalGenericRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalGenericRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalGenericRepositoryArgs | LocalGenericRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalGenericRepositoryState | undefined;
            ...
            const args = argsOrState as LocalGenericRepositoryArgs | undefined;
        ...
        super(LocalGenericRepository.__pulumiType, name, resourceInputs, opts);
    }
}
