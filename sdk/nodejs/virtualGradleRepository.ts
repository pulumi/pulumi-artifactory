 ...
 *
 * const foo_gradle = new artifactory.index/virtualGradleRepository.VirtualGradleRepository("foo-gradle", {
 ...
 * ```
 */
export class VirtualGradleRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualGradleRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualGradleRepository {
        return new VirtualGradleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualGradleRepository:VirtualGradleRepository';

    /**
     * Returns true if the given object is an instance of VirtualGradleRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualGradleRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualGradleRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: VirtualGradleRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualGradleRepositoryArgs | VirtualGradleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualGradleRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualGradleRepositoryArgs | undefined;
        ...
        super(VirtualGradleRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualGradleRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualGradleRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
