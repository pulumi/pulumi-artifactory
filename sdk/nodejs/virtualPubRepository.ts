 ...
 *
 * const foo_pub = new artifactory.index/virtualPubRepository.VirtualPubRepository("foo-pub", {
 ...
 * ```
 */
export class VirtualPubRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualPubRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualPubRepository {
        return new VirtualPubRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualPubRepository:VirtualPubRepository';

    /**
     * Returns true if the given object is an instance of VirtualPubRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualPubRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualPubRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: VirtualPubRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualPubRepositoryArgs | VirtualPubRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualPubRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualPubRepositoryArgs | undefined;
        ...
        super(VirtualPubRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualPubRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualPubRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
