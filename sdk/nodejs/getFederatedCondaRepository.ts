...
export function getFederatedCondaRepository(args: GetFederatedCondaRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedCondaRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedCondaRepository:getFederatedCondaRepository", {
 ...
 */
export interface GetFederatedCondaRepositoryArgs {
 ...
 */
export interface GetFederatedCondaRepositoryResult {
 ...
 * A collection of arguments for invoking getFederatedCondaRepository.
 */
export interface GetFederatedCondaRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedCondaRepositoryMemberArgs>[] | undefined>;
