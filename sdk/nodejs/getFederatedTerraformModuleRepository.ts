 ...
 */
export interface GetFederatedTerraformModuleRepositoryArgs {
 ...
 */
export interface GetFederatedTerraformModuleRepositoryResult {
 ...
 * ```
 */
export function getFederatedTerraformModuleRepositoryOutput(args: GetFederatedTerraformModuleRepositoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFederatedTerraformModuleRepositoryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
 ...
 * A collection of arguments for invoking getFederatedTerraformModuleRepository.
 */
export interface GetFederatedTerraformModuleRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedTerraformModuleRepositoryMemberArgs>[] | undefined>;
