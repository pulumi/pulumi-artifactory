...
export function getFederatedCranRepository(args: GetFederatedCranRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedCranRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedCranRepository:getFederatedCranRepository", {
 ...
 */
export interface GetFederatedCranRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedCranRepositoryMember[];
    notes?: string;
...
export interface GetFederatedCranRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedCranRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedCranRepository.
 */
export interface GetFederatedCranRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedCranRepositoryMemberArgs>[] | undefined>;
