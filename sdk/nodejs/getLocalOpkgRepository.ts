...
export function getLocalOpkgRepository(args: GetLocalOpkgRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalOpkgRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getLocalOpkgRepository:getLocalOpkgRepository", {
 ...
 */
export interface GetLocalOpkgRepositoryArgs {
 ...
 */
export interface GetLocalOpkgRepositoryResult {
 ...
 * A collection of arguments for invoking getLocalOpkgRepository.
 */
export interface GetLocalOpkgRepositoryOutputArgs {
