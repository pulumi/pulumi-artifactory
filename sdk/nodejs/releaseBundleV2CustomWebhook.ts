...
export class ReleaseBundleV2CustomWebhook extends pulumi.CustomResource {
     ...
     */
    declare public readonly criteria: pulumi.Output<outputs.ReleaseBundleV2CustomWebhookCriteria>;
    /**
     ...
     */
    declare public readonly handlers: pulumi.Output<outputs.ReleaseBundleV2CustomWebhookHandler[]>;
    /**
...
export interface ReleaseBundleV2CustomWebhookState {
     ...
     * Specifies where the webhook will be applied on which repositories.
     */
    criteria?: pulumi.Input<inputs.ReleaseBundleV2CustomWebhookCriteria | undefined>;
    /**
     * Webhook description. Max length 1000 characters.
     */
     ...
     * At least one is required.
     */
    handlers?: pulumi.Input<pulumi.Input<inputs.ReleaseBundleV2CustomWebhookHandler>[] | undefined>;
    /**
     * The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
     */
