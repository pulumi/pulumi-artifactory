 ...
 * ```
 */
export class VirtualSwiftRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualSwiftRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualSwiftRepository {
        return new VirtualSwiftRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualSwiftRepository:VirtualSwiftRepository';

    /**
     * Returns true if the given object is an instance of VirtualSwiftRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualSwiftRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualSwiftRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualSwiftRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualSwiftRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualSwiftRepositoryArgs | VirtualSwiftRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualSwiftRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualSwiftRepositoryArgs | undefined;
        ...
        super(VirtualSwiftRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualSwiftRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualSwiftRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
