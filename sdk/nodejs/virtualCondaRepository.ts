 ...
 *
 * const foo_conda = new artifactory.index/virtualCondaRepository.VirtualCondaRepository("foo-conda", {
...
export class VirtualCondaRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualCondaRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualCondaRepository {
        return new VirtualCondaRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualCondaRepository:VirtualCondaRepository';

    /**
     * Returns true if the given object is an instance of VirtualCondaRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualCondaRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualCondaRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualCondaRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualCondaRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualCondaRepositoryArgs | VirtualCondaRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualCondaRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualCondaRepositoryArgs | undefined;
        ...
        super(VirtualCondaRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualCondaRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualCondaRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
