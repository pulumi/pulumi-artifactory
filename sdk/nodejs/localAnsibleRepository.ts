 ...
 * ```
 */
export class LocalAnsibleRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalAnsibleRepositoryState, opts?: pulumi.CustomResourceOptions): LocalAnsibleRepository {
        return new LocalAnsibleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localAnsibleRepository:LocalAnsibleRepository';

    /**
     * Returns true if the given object is an instance of LocalAnsibleRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalAnsibleRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalAnsibleRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalAnsibleRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalAnsibleRepositoryArgs | LocalAnsibleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as LocalAnsibleRepositoryArgs | undefined;
 ...
 */
export interface LocalAnsibleRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalAnsibleRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
