 ...
 */
export interface GetLocalTerraformbackendRepositoryArgs {
 ...
 */
export interface GetLocalTerraformbackendRepositoryResult {
 ...
 * ```
 */
export function getLocalTerraformbackendRepositoryOutput(args: GetLocalTerraformbackendRepositoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLocalTerraformbackendRepositoryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
 ...
 * A collection of arguments for invoking getLocalTerraformbackendRepository.
 */
export interface GetLocalTerraformbackendRepositoryOutputArgs {
