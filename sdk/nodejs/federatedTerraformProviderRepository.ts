 ...
 * ```
 */
export class FederatedTerraformProviderRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedTerraformProviderRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedTerraformProviderRepository {
        return new FederatedTerraformProviderRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedTerraformProviderRepository:FederatedTerraformProviderRepository';
     ...
     */
    public static isInstance(obj: any): obj is FederatedTerraformProviderRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedTerraformProviderRepository.__pulumiType;
    }
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedTerraformProviderRepositoryMember[]>;
    /**
    ...
    constructor(name: string, argsOrState?: FederatedTerraformProviderRepositoryArgs | FederatedTerraformProviderRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedTerraformProviderRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedTerraformProviderRepositoryArgs | undefined;
        ...
        super(FederatedTerraformProviderRepository.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface FederatedTerraformProviderRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedTerraformProviderRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
