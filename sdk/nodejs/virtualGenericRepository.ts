...
export class VirtualGenericRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualGenericRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualGenericRepository {
        return new VirtualGenericRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualGenericRepository:VirtualGenericRepository';

    /**
     * Returns true if the given object is an instance of VirtualGenericRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualGenericRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualGenericRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualGenericRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualGenericRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualGenericRepositoryArgs | VirtualGenericRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualGenericRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualGenericRepositoryArgs | undefined;
        ...
        super(VirtualGenericRepository.__pulumiType, name, resourceInputs, opts);
    }
}
