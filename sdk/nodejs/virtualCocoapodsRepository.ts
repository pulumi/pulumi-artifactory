 ...
 *
 * const foo_cocoapods = new artifactory.VirtualCocoapodsRepository("foo-cocoapods", {
 *     key: "foo-cocoapods",
 *     repositories: [],
 ...
 * ```
 */
export class VirtualCocoapodsRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualCocoapodsRepository {
        return new VirtualCocoapodsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualCocoapodsRepository:VirtualCocoapodsRepository';

    /**
     * Returns true if the given object is an instance of VirtualCocoapodsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualCocoapodsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualCocoapodsRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: VirtualCocoapodsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualCocoapodsRepositoryArgs | VirtualCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(VirtualCocoapodsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
