 ...
 *
 * const terraform_federated_test_nuget_repo = new artifactory.index/federatedNugetRepository.FederatedNugetRepository("terraform-federated-test-nuget-repo", {
 ...
 * ```
 */
export class FederatedNugetRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedNugetRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedNugetRepository {
        return new FederatedNugetRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedNugetRepository:FederatedNugetRepository';

    /**
     * Returns true if the given object is an instance of FederatedNugetRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedNugetRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedNugetRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FederatedNugetRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedNugetRepositoryArgs | FederatedNugetRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FederatedNugetRepository.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface FederatedNugetRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedNugetRepositoryMember>[]>;
    /**
     * Internal description.
     */
