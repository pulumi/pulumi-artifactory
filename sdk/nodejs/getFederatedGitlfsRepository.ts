...
export function getFederatedGitlfsRepository(args: GetFederatedGitlfsRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedGitlfsRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedGitlfsRepository:getFederatedGitlfsRepository", {
 ...
 */
export interface GetFederatedGitlfsRepositoryArgs {
 ...
 */
export interface GetFederatedGitlfsRepositoryResult {
 ...
 * A collection of arguments for invoking getFederatedGitlfsRepository.
 */
export interface GetFederatedGitlfsRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedGitlfsRepositoryMemberArgs>[] | undefined>;
