...
export class ScopedToken extends pulumi.CustomResource {
     ...
     */
    declare public readonly expiresIn: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly ignoreMissingTokenWarning: pulumi.Output<boolean>;
    /**
     * Also create a reference token which can be used like an API key. Default is `false`.
     */
    declare public readonly includeReferenceToken: pulumi.Output<boolean>;
    /**
     * Returns the token issued at date/time.
     */
    declare public /*out*/ readonly issuedAt: pulumi.Output<number>;
    /**
     ...
     */
    declare public /*out*/ readonly referenceToken: pulumi.Output<string>;
    /**
     * Refresh token.
     */
     ...
     */
    declare public readonly refreshable: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: ScopedTokenArgs | ScopedTokenState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ignoreMissingTokenWarning"] = state?.ignoreMissingTokenWarning;
            resourceInputs["includeReferenceToken"] = state?.includeReferenceToken;
            resourceInputs["issuedAt"] = state?.issuedAt;
            resourceInputs["issuer"] = state?.issuer;
            resourceInputs["projectKey"] = state?.projectKey;
            resourceInputs["referenceToken"] = state?.referenceToken;
            resourceInputs["refreshToken"] = state?.refreshToken;
            resourceInputs["refreshable"] = state?.refreshable;
            ...
            resourceInputs["ignoreMissingTokenWarning"] = args?.ignoreMissingTokenWarning;
            resourceInputs["includeReferenceToken"] = args?.includeReferenceToken;
            resourceInputs["projectKey"] = args?.projectKey;
            resourceInputs["refreshable"] = args?.refreshable;
