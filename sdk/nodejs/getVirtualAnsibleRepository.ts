 ...
 *
 * const virtual_ansible = artifactory.getVirtualAnsibleRepository({
 *     key: "virtual-ansible",
 * });
 * ```
 */
 ...
 */
export interface GetVirtualAnsibleRepositoryArgs {
 ...
 */
export interface GetVirtualAnsibleRepositoryResult {
 ...
 * A collection of arguments for invoking getVirtualAnsibleRepository.
 */
export interface GetVirtualAnsibleRepositoryOutputArgs {
