 ...
 *
 * const remote_maven = artifactory.getRemoteMavenRepository({
 *     key: "remote-maven",
 * });
 * ```
 */
...
export interface GetRemoteMavenRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteMavenRepositoryContentSynchronisationArgs | undefined>;
