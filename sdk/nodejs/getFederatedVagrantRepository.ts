...
export function getFederatedVagrantRepository(args: GetFederatedVagrantRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedVagrantRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedVagrantRepository:getFederatedVagrantRepository", {
 ...
 */
export interface GetFederatedVagrantRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedVagrantRepositoryMember[];
    notes?: string;
...
export interface GetFederatedVagrantRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedVagrantRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedVagrantRepository.
 */
export interface GetFederatedVagrantRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedVagrantRepositoryMemberArgs>[] | undefined>;
