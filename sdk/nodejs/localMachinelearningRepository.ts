 ...
 * ```
 */
export class LocalMachinelearningRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalMachinelearningRepositoryState, opts?: pulumi.CustomResourceOptions): LocalMachinelearningRepository {
        return new LocalMachinelearningRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localMachinelearningRepository:LocalMachinelearningRepository';

    /**
     * Returns true if the given object is an instance of LocalMachinelearningRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalMachinelearningRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalMachinelearningRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalMachinelearningRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalMachinelearningRepositoryArgs | LocalMachinelearningRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalMachinelearningRepositoryState | undefined;
        ...
        super(LocalMachinelearningRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalMachinelearningRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
 ...
 */
export interface LocalMachinelearningRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
