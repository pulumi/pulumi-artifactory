 ...
 * ```
 */
export class FederatedReleasebundlesRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedReleasebundlesRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedReleasebundlesRepository {
        return new FederatedReleasebundlesRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedReleasebundlesRepository:FederatedReleasebundlesRepository';

    /**
     * Returns true if the given object is an instance of FederatedReleasebundlesRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedReleasebundlesRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedReleasebundlesRepository.__pulumiType;
    }
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedReleasebundlesRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedReleasebundlesRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedReleasebundlesRepositoryArgs | FederatedReleasebundlesRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedReleasebundlesRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedReleasebundlesRepositoryArgs | undefined;
        ...
        super(FederatedReleasebundlesRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedReleasebundlesRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedReleasebundlesRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedReleasebundlesRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members: pulumi.Input<pulumi.Input<inputs.FederatedReleasebundlesRepositoryMember>[]>;
    /**
     * Internal description.
     */
    notes?: pulumi.Input<string | undefined>;
