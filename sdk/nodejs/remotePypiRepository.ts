...
export class RemotePypiRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemotePypiRepositoryState, opts?: pulumi.CustomResourceOptions): RemotePypiRepository {
        return new RemotePypiRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remotePypiRepository:RemotePypiRepository';

    /**
     * Returns true if the given object is an instance of RemotePypiRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemotePypiRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemotePypiRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemotePypiRepositoryContentSynchronisation | undefined>;
    /**
     ...
     */
    declare public readonly pypiRegistryUrl: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly pypiRepositorySuffix: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: RemotePypiRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemotePypiRepositoryArgs | RemotePypiRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemotePypiRepositoryState | undefined;
            ...
            resourceInputs["pypiRegistryUrl"] = state?.pypiRegistryUrl;
            resourceInputs["pypiRepositorySuffix"] = state?.pypiRepositorySuffix;
            ...
            resourceInputs["pypiRegistryUrl"] = args?.pypiRegistryUrl;
            resourceInputs["pypiRepositorySuffix"] = args?.pypiRepositorySuffix;
...
export interface RemotePypiRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemotePypiRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
