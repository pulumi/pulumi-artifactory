...
export function getRemoteGemsRepository(args: GetRemoteGemsRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteGemsRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteGemsRepository:getRemoteGemsRepository", {
 ...
 */
export interface GetRemoteGemsRepositoryArgs {
    ...
    contentSynchronisation?: inputs.GetRemoteGemsRepositoryContentSynchronisation;
    description?: string;
 ...
 */
export interface GetRemoteGemsRepositoryResult {
    ...
    readonly contentSynchronisation: outputs.GetRemoteGemsRepositoryContentSynchronisation;
...
export function getRemoteGemsRepositoryOutput(args: GetRemoteGemsRepositoryOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRemoteGemsRepositoryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("artifactory:index/getRemoteGemsRepository:getRemoteGemsRepository", {
        "allowAnyHostAuth": args.allowAnyHostAuth,
        "archiveBrowsingEnabled": args.archiveBrowsingEnabled,
        "assumedOfflinePeriodSecs": args.assumedOfflinePeriodSecs,
        "blackedOut": args.blackedOut,
 ...
 * A collection of arguments for invoking getRemoteGemsRepository.
 */
export interface GetRemoteGemsRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteGemsRepositoryContentSynchronisationArgs>;
