...
export class VirtualDockerRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualDockerRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualDockerRepository {
        return new VirtualDockerRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualDockerRepository:VirtualDockerRepository';

    /**
     * Returns true if the given object is an instance of VirtualDockerRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualDockerRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualDockerRepository.__pulumiType;
    }
     ...
     */
    declare public readonly resolveDockerTagsByTimestamp: pulumi.Output<boolean | undefined>;
     ...
     */
    constructor(name: string, args: VirtualDockerRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualDockerRepositoryArgs | VirtualDockerRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualDockerRepositoryState | undefined;
            ...
            resourceInputs["resolveDockerTagsByTimestamp"] = state?.resolveDockerTagsByTimestamp;
        } else {
            ...
            resourceInputs["resolveDockerTagsByTimestamp"] = args?.resolveDockerTagsByTimestamp;
            resourceInputs["packageType"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(VirtualDockerRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualDockerRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
     ...
     * When enabled, in cases where the same Docker tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
     */
    resolveDockerTagsByTimestamp?: pulumi.Input<boolean | undefined>;
}

/**
 * The set of arguments for constructing a VirtualDockerRepository resource.
 */
export interface VirtualDockerRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
    artifactoryRequestsCanRetrieveRemoteArtifacts?: pulumi.Input<boolean | undefined>;
