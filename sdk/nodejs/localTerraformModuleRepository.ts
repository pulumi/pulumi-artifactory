 ...
 *
 * const terraform_local_test_terraform_module_repo = new artifactory.index/localTerraformModuleRepository.LocalTerraformModuleRepository("terraform-local-test-terraform-module-repo", {key: "terraform-local-test-terraform-module-repo"});
 * ```
 *
 * ## Import
 *
 ...
 * ```
 */
export class LocalTerraformModuleRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalTerraformModuleRepositoryState, opts?: pulumi.CustomResourceOptions): LocalTerraformModuleRepository {
        return new LocalTerraformModuleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository';
     ...
     */
    public static isInstance(obj: any): obj is LocalTerraformModuleRepository {
    ...
    constructor(name: string, argsOrState?: LocalTerraformModuleRepositoryArgs | LocalTerraformModuleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalTerraformModuleRepositoryState | undefined;
            ...
            const args = argsOrState as LocalTerraformModuleRepositoryArgs | undefined;
