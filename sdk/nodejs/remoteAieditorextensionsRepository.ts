 ...
 * ```
 */
export class RemoteAieditorextensionsRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteAieditorextensionsRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteAieditorextensionsRepository {
        return new RemoteAieditorextensionsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteAieditorextensionsRepository:RemoteAieditorextensionsRepository';

    /**
     * Returns true if the given object is an instance of RemoteAieditorextensionsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteAieditorextensionsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteAieditorextensionsRepository.__pulumiType;
    }
     ...
     */
    declare public /*out*/ readonly bypassHeadRequests: pulumi.Output<boolean>;
    /**
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteAieditorextensionsRepositoryContentSynchronisation | undefined>;
    /**
     ...
     */
    declare public readonly customHttpHeaders: pulumi.Output<outputs.RemoteAieditorextensionsRepositoryCustomHttpHeader[] | undefined>;
    /**
     * Public description.
     */
     ...
     */
    declare public readonly externalDependenciesPatterns: pulumi.Output<string[]>;
    /**
     ...
     */
    constructor(name: string, args: RemoteAieditorextensionsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteAieditorextensionsRepositoryArgs | RemoteAieditorextensionsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteAieditorextensionsRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteAieditorextensionsRepositoryArgs | undefined;
            ...
            resourceInputs["bypassHeadRequests"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const secretOpts = { additionalSecretOutputs: ["password", "passwordWo"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(RemoteAieditorextensionsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteAieditorextensionsRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteAieditorextensionsRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service. Default value is `false`.
     */
     ...
     * Up to 5 custom HTTP headers sent on every outbound request to the remote URL. Requires Artifactory 7.146.0 or later. Header values are write-only: they are masked in plan output and never read back from Artifactory, so `pulumi import` cannot recover them. To remove all headers, remove the attribute. Each entry supports:
     */
    customHttpHeaders?: pulumi.Input<pulumi.Input<inputs.RemoteAieditorextensionsRepositoryCustomHttpHeader>[] | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteAieditorextensionsRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
