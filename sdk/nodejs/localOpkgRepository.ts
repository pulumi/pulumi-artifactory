 ...
 *
 * const terraform_local_test_opkg_repo = new artifactory.index/localOpkgRepository.LocalOpkgRepository("terraform-local-test-opkg-repo", {key: "terraform-local-test-opkg-repo"});
 * ```
 *
 * ## Import
 *
...
export class LocalOpkgRepository extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: LocalOpkgRepositoryArgs | LocalOpkgRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LocalOpkgRepository.__pulumiType, name, resourceInputs, opts);
    }
}
