...
export function getFederatedGenericRepository(args: GetFederatedGenericRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedGenericRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedGenericRepository:getFederatedGenericRepository", {
 ...
 */
export interface GetFederatedGenericRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedGenericRepositoryMember[];
    notes?: string;
...
export interface GetFederatedGenericRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedGenericRepositoryMember[];
 ...
 * ```
 */
export function getFederatedGenericRepositoryOutput(args: GetFederatedGenericRepositoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFederatedGenericRepositoryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("artifactory:index/getFederatedGenericRepository:getFederatedGenericRepository", {
        "archiveBrowsingEnabled": args.archiveBrowsingEnabled,
        "blackedOut": args.blackedOut,
        "cdnRedirect": args.cdnRedirect,
        "cleanupOnDelete": args.cleanupOnDelete,
 ...
 * A collection of arguments for invoking getFederatedGenericRepository.
 */
export interface GetFederatedGenericRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedGenericRepositoryMemberArgs>[] | undefined>;
