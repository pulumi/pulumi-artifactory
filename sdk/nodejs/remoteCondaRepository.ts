...
export class RemoteCondaRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteCondaRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteCondaRepository {
        return new RemoteCondaRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteCondaRepository:RemoteCondaRepository';

    /**
     * Returns true if the given object is an instance of RemoteCondaRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteCondaRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteCondaRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteCondaRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
    ...
    /**
     * Create a RemoteCondaRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RemoteCondaRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteCondaRepositoryArgs | RemoteCondaRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteCondaRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteCondaRepositoryArgs | undefined;
        ...
        super(RemoteCondaRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteCondaRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteCondaRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteCondaRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
