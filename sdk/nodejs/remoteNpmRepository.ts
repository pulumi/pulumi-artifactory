...
export class RemoteNpmRepository extends pulumi.CustomResource {
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteNpmRepositoryContentSynchronisation | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteNpmRepositoryArgs | RemoteNpmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(RemoteNpmRepository.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface RemoteNpmRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteNpmRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
