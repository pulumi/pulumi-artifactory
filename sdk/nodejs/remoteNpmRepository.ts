 ...
 * ```
 */
export class RemoteNpmRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteNpmRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteNpmRepository {
        return new RemoteNpmRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteNpmRepository:RemoteNpmRepository';

    /**
     * Returns true if the given object is an instance of RemoteNpmRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteNpmRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteNpmRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: RemoteNpmRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteNpmRepositoryArgs | RemoteNpmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteNpmRepositoryState | undefined;
            ...
            inputs["listRemoteFolderItems"] = state ? state.listRemoteFolderItems : undefined;
            inputs["localAddress"] = state ? state.localAddress : undefined;
            inputs["mismatchingMimeTypesOverrideList"] = state ? state.mismatchingMimeTypesOverrideList : undefined;
            ...
            const args = argsOrState as RemoteNpmRepositoryArgs | undefined;
            ...
            inputs["listRemoteFolderItems"] = args ? args.listRemoteFolderItems : undefined;
            inputs["localAddress"] = args ? args.localAddress : undefined;
            inputs["mismatchingMimeTypesOverrideList"] = args ? args.mismatchingMimeTypesOverrideList : undefined;
        ...
        super(RemoteNpmRepository.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface RemoteNpmRepositoryState {
    /**
     * Also known as 'Lenient Host Authentication', Allow credentials of this repository to be used on requests redirected to
     * any other host.
     */
 ...
 */
export interface RemoteNpmRepositoryArgs {
    /**
     * Also known as 'Lenient Host Authentication', Allow credentials of this repository to be used on requests redirected to
     * any other host.
     */
