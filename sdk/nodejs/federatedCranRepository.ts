...
export class FederatedCranRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedCranRepositoryMember[]>;
    /**
...
export interface FederatedCranRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedCranRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
