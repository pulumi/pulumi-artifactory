...
export class LocalCargoRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalCargoRepositoryState, opts?: pulumi.CustomResourceOptions): LocalCargoRepository {
        return new LocalCargoRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localCargoRepository:LocalCargoRepository';

    /**
     * Returns true if the given object is an instance of LocalCargoRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalCargoRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalCargoRepository.__pulumiType;
    }
     ...
     */
    declare public readonly anonymousAccess: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly enableSparseIndex: pulumi.Output<boolean>;
    /**
     ...
     */
    constructor(name: string, args: LocalCargoRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalCargoRepositoryArgs | LocalCargoRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalCargoRepositoryState | undefined;
            ...
            const args = argsOrState as LocalCargoRepositoryArgs | undefined;
