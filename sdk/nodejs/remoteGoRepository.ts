...
export class RemoteGoRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteGoRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteGoRepository {
        return new RemoteGoRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteGoRepository:RemoteGoRepository';

    /**
     * Returns true if the given object is an instance of RemoteGoRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteGoRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteGoRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteGoRepositoryContentSynchronisation | undefined>;
    /**
    ...
    /**
     * Create a RemoteGoRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RemoteGoRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteGoRepositoryArgs | RemoteGoRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteGoRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteGoRepositoryArgs | undefined;
        ...
        super(RemoteGoRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteGoRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteGoRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
 ...
 */
export interface RemoteGoRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
