...
export class RemoteHuggingfacemlRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteHuggingfacemlRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteHuggingfacemlRepository {
        return new RemoteHuggingfacemlRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteHuggingfacemlRepository:RemoteHuggingfacemlRepository';

    /**
     * Returns true if the given object is an instance of RemoteHuggingfacemlRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteHuggingfacemlRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteHuggingfacemlRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteHuggingfacemlRepositoryContentSynchronisation | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RemoteHuggingfacemlRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteHuggingfacemlRepositoryArgs | RemoteHuggingfacemlRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteHuggingfacemlRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteHuggingfacemlRepositoryArgs | undefined;
 ...
 */
export interface RemoteHuggingfacemlRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteHuggingfacemlRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
 ...
 */
export interface RemoteHuggingfacemlRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
