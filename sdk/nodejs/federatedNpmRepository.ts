...
export class FederatedNpmRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedNpmRepositoryMember[]>;
    /**
...
export interface FederatedNpmRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedNpmRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
