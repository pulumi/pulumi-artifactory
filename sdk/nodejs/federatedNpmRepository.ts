 ...
 *
 * const terraform_federated_test_npm_repo = new artifactory.index/federatedNpmRepository.FederatedNpmRepository("terraform-federated-test-npm-repo", {
 ...
 * ```
 */
export class FederatedNpmRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedNpmRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedNpmRepository {
        return new FederatedNpmRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedNpmRepository:FederatedNpmRepository';

    /**
     * Returns true if the given object is an instance of FederatedNpmRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedNpmRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedNpmRepository.__pulumiType;
    }
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedNpmRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedNpmRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedNpmRepositoryArgs | FederatedNpmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedNpmRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedNpmRepositoryArgs | undefined;
        ...
        super(FederatedNpmRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedNpmRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedNpmRepositoryMember>[]>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedNpmRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
