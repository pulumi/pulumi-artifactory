 ...
 * ```
 */
export class RemoteRpmRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteRpmRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteRpmRepository {
        return new RemoteRpmRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteRpmRepository:RemoteRpmRepository';

    /**
     * Returns true if the given object is an instance of RemoteRpmRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteRpmRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteRpmRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteRpmRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    constructor(name: string, args: RemoteRpmRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteRpmRepositoryArgs | RemoteRpmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteRpmRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteRpmRepositoryArgs | undefined;
        ...
        super(RemoteRpmRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteRpmRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteRpmRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteRpmRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
