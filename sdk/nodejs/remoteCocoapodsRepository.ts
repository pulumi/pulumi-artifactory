...
export class RemoteCocoapodsRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteCocoapodsRepository {
        return new RemoteCocoapodsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteCocoapodsRepository:RemoteCocoapodsRepository';

    /**
     * Returns true if the given object is an instance of RemoteCocoapodsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteCocoapodsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteCocoapodsRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteCocoapodsRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
    ...
    /**
     * Create a RemoteCocoapodsRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RemoteCocoapodsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteCocoapodsRepositoryArgs | RemoteCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteCocoapodsRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteCocoapodsRepositoryArgs | undefined;
 ...
 */
export interface RemoteCocoapodsRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteCocoapodsRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     * Proxy remote CocoaPods Specs repositories. Default value is `https://github.com/CocoaPods/Specs`.
     */
    podsSpecsRepoUrl?: pulumi.Input<string | undefined>;
    /**
     * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
     */
 ...
 */
export interface RemoteCocoapodsRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
