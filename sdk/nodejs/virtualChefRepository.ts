 ...
 *
 * const foo_chef = new artifactory.index/virtualChefRepository.VirtualChefRepository("foo-chef", {
 ...
 * ```
 */
export class VirtualChefRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualChefRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualChefRepository {
        return new VirtualChefRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualChefRepository:VirtualChefRepository';

    /**
     * Returns true if the given object is an instance of VirtualChefRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualChefRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualChefRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualChefRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualChefRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualChefRepositoryArgs | VirtualChefRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualChefRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualChefRepositoryArgs | undefined;
        ...
        super(VirtualChefRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualChefRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualChefRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
