 ...
 * ```
 */
export class FederatedChefRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedChefRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedChefRepository {
        return new FederatedChefRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedChefRepository:FederatedChefRepository';

    /**
     * Returns true if the given object is an instance of FederatedChefRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedChefRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedChefRepository.__pulumiType;
    }
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedChefRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedChefRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedChefRepositoryArgs | FederatedChefRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedChefRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedChefRepositoryArgs | undefined;
        ...
        super(FederatedChefRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedChefRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedChefRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedChefRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members: pulumi.Input<pulumi.Input<inputs.FederatedChefRepositoryMember>[]>;
    /**
     * Internal description.
     */
    notes?: pulumi.Input<string | undefined>;
