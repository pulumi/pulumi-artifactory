...
export class RemoteGradleRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteGradleRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteGradleRepository {
        return new RemoteGradleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteGradleRepository:RemoteGradleRepository';

    /**
     * Returns true if the given object is an instance of RemoteGradleRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteGradleRepository {
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteGradleRepositoryContentSynchronisation | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteGradleRepositoryArgs | RemoteGradleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteGradleRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteGradleRepositoryArgs | undefined;
...
export interface RemoteGradleRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteGradleRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
