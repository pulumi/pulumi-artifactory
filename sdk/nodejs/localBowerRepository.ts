...
export class LocalBowerRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalBowerRepositoryState, opts?: pulumi.CustomResourceOptions): LocalBowerRepository {
        return new LocalBowerRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localBowerRepository:LocalBowerRepository';

    /**
     * Returns true if the given object is an instance of LocalBowerRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalBowerRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalBowerRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalBowerRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalBowerRepositoryArgs | LocalBowerRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalBowerRepositoryState | undefined;
            ...
            const args = argsOrState as LocalBowerRepositoryArgs | undefined;
        ...
        super(LocalBowerRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalBowerRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalBowerRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
