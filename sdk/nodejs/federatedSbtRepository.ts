...
export class FederatedSbtRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedSbtRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedSbtRepository {
        return new FederatedSbtRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedSbtRepository:FederatedSbtRepository';

    /**
     * Returns true if the given object is an instance of FederatedSbtRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedSbtRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedSbtRepository.__pulumiType;
    }
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedSbtRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedSbtRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedSbtRepositoryArgs | FederatedSbtRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedSbtRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedSbtRepositoryArgs | undefined;
        ...
        super(FederatedSbtRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedSbtRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedSbtRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedSbtRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
