...
export class RemoteGenericRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteGenericRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteGenericRepository {
        return new RemoteGenericRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteGenericRepository:RemoteGenericRepository';

    /**
     * Returns true if the given object is an instance of RemoteGenericRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteGenericRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteGenericRepository.__pulumiType;
    }
    ...
    public readonly contentSynchronisation!: pulumi.Output<outputs.RemoteGenericRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    constructor(name: string, args: RemoteGenericRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteGenericRepositoryArgs | RemoteGenericRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteGenericRepositoryState | undefined;
        ...
        super(RemoteGenericRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteGenericRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any
     * other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteGenericRepositoryContentSynchronisation>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteGenericRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any
     * other host.
     */
