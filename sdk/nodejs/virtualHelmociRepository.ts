 ...
 * ```
 */
export class VirtualHelmociRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualHelmociRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualHelmociRepository {
        return new VirtualHelmociRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualHelmociRepository:VirtualHelmociRepository';

    /**
     * Returns true if the given object is an instance of VirtualHelmociRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualHelmociRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualHelmociRepository.__pulumiType;
    }
     ...
     */
    declare public readonly resolveOciTagsByTimestamp: pulumi.Output<boolean | undefined>;
     ...
     */
    constructor(name: string, args: VirtualHelmociRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualHelmociRepositoryArgs | VirtualHelmociRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualHelmociRepositoryState | undefined;
            ...
            resourceInputs["resolveOciTagsByTimestamp"] = state?.resolveOciTagsByTimestamp;
        } else {
            const args = argsOrState as VirtualHelmociRepositoryArgs | undefined;
            ...
            resourceInputs["resolveOciTagsByTimestamp"] = args?.resolveOciTagsByTimestamp;
            resourceInputs["packageType"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(VirtualHelmociRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualHelmociRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
 ...
 */
export interface VirtualHelmociRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
    artifactoryRequestsCanRetrieveRemoteArtifacts?: pulumi.Input<boolean>;
