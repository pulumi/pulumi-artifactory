...
export class VirtualHelmRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualHelmRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualHelmRepository {
        return new VirtualHelmRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualHelmRepository:VirtualHelmRepository';

    /**
     * Returns true if the given object is an instance of VirtualHelmRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualHelmRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualHelmRepository.__pulumiType;
    }
     ...
     */
    declare public readonly useNamespaces: pulumi.Output<boolean | undefined>;
     ...
     */
    constructor(name: string, args: VirtualHelmRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualHelmRepositoryArgs | VirtualHelmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualHelmRepositoryState | undefined;
            ...
            resourceInputs["useNamespaces"] = state?.useNamespaces;
        } else {
            const args = argsOrState as VirtualHelmRepositoryArgs | undefined;
            ...
            resourceInputs["useNamespaces"] = args?.useNamespaces;
            resourceInputs["packageType"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(VirtualHelmRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualHelmRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
 ...
 */
export interface VirtualHelmRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
    artifactoryRequestsCanRetrieveRemoteArtifacts?: pulumi.Input<boolean>;
