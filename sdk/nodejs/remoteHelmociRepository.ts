 ...
 * ```
 */
export class RemoteHelmociRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteHelmociRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteHelmociRepository {
        return new RemoteHelmociRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteHelmociRepository:RemoteHelmociRepository';

    /**
     * Returns true if the given object is an instance of RemoteHelmociRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteHelmociRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteHelmociRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteHelmociRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    constructor(name: string, args: RemoteHelmociRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteHelmociRepositoryArgs | RemoteHelmociRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteHelmociRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteHelmociRepositoryArgs | undefined;
        ...
        super(RemoteHelmociRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteHelmociRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteHelmociRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteHelmociRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
