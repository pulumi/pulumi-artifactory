 ...
 * ```
 */
export class RemoteAnsibleRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteAnsibleRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteAnsibleRepository {
        return new RemoteAnsibleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteAnsibleRepository:RemoteAnsibleRepository';

    /**
     * Returns true if the given object is an instance of RemoteAnsibleRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteAnsibleRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteAnsibleRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteAnsibleRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    constructor(name: string, args: RemoteAnsibleRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteAnsibleRepositoryArgs | RemoteAnsibleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteAnsibleRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteAnsibleRepositoryArgs | undefined;
        ...
        super(RemoteAnsibleRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteAnsibleRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteAnsibleRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteAnsibleRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
