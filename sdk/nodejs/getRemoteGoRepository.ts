 ...
 *
 * const remote_go = artifactory.getRemoteGoRepository({
 *     key: "remote-go",
 * });
 * ```
 */
export function getRemoteGoRepository(args: GetRemoteGoRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteGoRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteGoRepository:getRemoteGoRepository", {
 ...
 */
export interface GetRemoteGoRepositoryArgs {
 ...
 */
export interface GetRemoteGoRepositoryResult {
 ...
 * A collection of arguments for invoking getRemoteGoRepository.
 */
export interface GetRemoteGoRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteGoRepositoryContentSynchronisationArgs | undefined>;
