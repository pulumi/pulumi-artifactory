...
export class RemoteConanRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteConanRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteConanRepository {
        return new RemoteConanRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteConanRepository:RemoteConanRepository';

    /**
     * Returns true if the given object is an instance of RemoteConanRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteConanRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteConanRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteConanRepositoryContentSynchronisation | undefined>;
    /**
     ...
     */
    declare public readonly forceConanAuthentication: pulumi.Output<boolean>;
    /**
     ...
     */
    constructor(name: string, args: RemoteConanRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteConanRepositoryArgs | RemoteConanRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteConanRepositoryState | undefined;
        ...
        super(RemoteConanRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteConanRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteConanRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
 ...
 */
export interface RemoteConanRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
