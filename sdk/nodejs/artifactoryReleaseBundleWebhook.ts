...
export class ArtifactoryReleaseBundleWebhook extends pulumi.CustomResource {
     ...
     */
    declare public readonly criteria: pulumi.Output<outputs.ArtifactoryReleaseBundleWebhookCriteria>;
    /**
     ...
     */
    declare public readonly handlers: pulumi.Output<outputs.ArtifactoryReleaseBundleWebhookHandler[]>;
    /**
...
export interface ArtifactoryReleaseBundleWebhookState {
     ...
     * Specifies where the webhook will be applied on which repositories.
     */
    criteria?: pulumi.Input<inputs.ArtifactoryReleaseBundleWebhookCriteria | undefined>;
    /**
     * Webhook description. Max length 1000 characters.
     */
     ...
     * At least one is required.
     */
    handlers?: pulumi.Input<pulumi.Input<inputs.ArtifactoryReleaseBundleWebhookHandler>[] | undefined>;
    /**
     * The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
     */
