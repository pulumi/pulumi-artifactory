...
export function getRemotePuppetRepository(args: GetRemotePuppetRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemotePuppetRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemotePuppetRepository:getRemotePuppetRepository", {
 ...
 */
export interface GetRemotePuppetRepositoryArgs {
 ...
 */
export interface GetRemotePuppetRepositoryResult {
 ...
 * A collection of arguments for invoking getRemotePuppetRepository.
 */
export interface GetRemotePuppetRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemotePuppetRepositoryContentSynchronisationArgs | undefined>;
