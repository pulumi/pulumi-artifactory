 ...
 *
 * const my_remote_jetbrainsplugins = new artifactory.RemoteJetbrainspluginsRepository("my-remote-jetbrainsplugins", {
 ...
 * ```
 */
export class RemoteJetbrainspluginsRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteJetbrainspluginsRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteJetbrainspluginsRepository {
        return new RemoteJetbrainspluginsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteJetbrainspluginsRepository:RemoteJetbrainspluginsRepository';

    /**
     * Returns true if the given object is an instance of RemoteJetbrainspluginsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteJetbrainspluginsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteJetbrainspluginsRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteJetbrainspluginsRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    constructor(name: string, args: RemoteJetbrainspluginsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteJetbrainspluginsRepositoryArgs | RemoteJetbrainspluginsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteJetbrainspluginsRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteJetbrainspluginsRepositoryArgs | undefined;
        ...
        super(RemoteJetbrainspluginsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteJetbrainspluginsRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteJetbrainspluginsRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteJetbrainspluginsRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
