 ...
 *
 * const terraform_local_test_terraform_provider_repo = new artifactory.index/localTerraformProviderRepository.LocalTerraformProviderRepository("terraform-local-test-terraform-provider-repo", {key: "terraform-local-test-terraform-provider-repo"});
 * ```
 *
 * ## Import
 *
