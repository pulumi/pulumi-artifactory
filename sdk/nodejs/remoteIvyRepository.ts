 ...
 *
 * const ivy_remote = new artifactory.index/remoteIvyRepository.RemoteIvyRepository("ivy-remote", {
...
export class RemoteIvyRepository extends pulumi.CustomResource {
    ...
    public readonly contentSynchronisation!: pulumi.Output<outputs.RemoteIvyRepositoryContentSynchronisation>;
    /**
     * Public description.
     */
