...
export class RemoteComposerRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly composerRegistryUrl: pulumi.Output<string>;
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteComposerRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
    ...
    constructor(name: string, argsOrState?: RemoteComposerRepositoryArgs | RemoteComposerRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["composerRegistryUrl"] = state?.composerRegistryUrl;
            ...
            resourceInputs["composerRegistryUrl"] = args?.composerRegistryUrl;
...
export interface RemoteComposerRepositoryState {
     ...
     * Proxy remote Composer repository. Default value is `https://packagist.org`.
     */
    composerRegistryUrl?: pulumi.Input<string | undefined>;
    contentSynchronisation?: pulumi.Input<inputs.RemoteComposerRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
