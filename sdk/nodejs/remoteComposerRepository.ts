...
export class RemoteComposerRepository extends pulumi.CustomResource {
     ...
     */
    public readonly composerRegistryUrl!: pulumi.Output<string>;
    public readonly contentSynchronisation!: pulumi.Output<outputs.RemoteComposerRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
