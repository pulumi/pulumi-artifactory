 ...
 *
 * const artifactoryLocalTestDockerV1Repository = new artifactory.DockerV1Repository("artifactoryLocalTestDockerV1Repository", {key: "artifactory_local_test_docker_v1_repository"});
 * ```
 */
export function getLocalDockerV1Repository(args: GetLocalDockerV1RepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetLocalDockerV1RepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getLocalDockerV1Repository:getLocalDockerV1Repository", {
 ...
 */
export interface GetLocalDockerV1RepositoryArgs {
 ...
 */
export interface GetLocalDockerV1RepositoryResult {
    /**
 ...
 * A collection of arguments for invoking getLocalDockerV1Repository.
 */
export interface GetLocalDockerV1RepositoryOutputArgs {
