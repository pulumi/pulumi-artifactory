...
export class DebianRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly ddebSupported: pulumi.Output<boolean>;
    /**
     * Public description.
     */
     ...
     */
    declare public readonly trivialLayout: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: DebianRepositoryArgs | DebianRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ddebSupported"] = state?.ddebSupported;
            ...
            resourceInputs["ddebSupported"] = args?.ddebSupported;
...
export interface DebianRepositoryState {
     ...
     * When set, enable indexing with debug symbols (.ddeb).
     */
    ddebSupported?: pulumi.Input<boolean | undefined>;
    /**
     * Public description.
     */
