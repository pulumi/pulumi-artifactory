...
export class LocalHuggingfacemlRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalHuggingfacemlRepositoryState, opts?: pulumi.CustomResourceOptions): LocalHuggingfacemlRepository {
        return new LocalHuggingfacemlRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localHuggingfacemlRepository:LocalHuggingfacemlRepository';

    /**
     * Returns true if the given object is an instance of LocalHuggingfacemlRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalHuggingfacemlRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalHuggingfacemlRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalHuggingfacemlRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalHuggingfacemlRepositoryArgs | LocalHuggingfacemlRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalHuggingfacemlRepositoryState | undefined;
            ...
            const args = argsOrState as LocalHuggingfacemlRepositoryArgs | undefined;
        ...
        super(LocalHuggingfacemlRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalHuggingfacemlRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
 ...
 */
export interface LocalHuggingfacemlRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
