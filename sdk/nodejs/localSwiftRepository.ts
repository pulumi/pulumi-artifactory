 ...
 *
 * const terraform_local_test_swift_repo = new artifactory.index/localSwiftRepository.LocalSwiftRepository("terraform-local-test-swift-repo", {key: "terraform-local-test-swift-repo"});
 * ```
 *
 * ## Import
 *
...
export class LocalSwiftRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalSwiftRepositoryState, opts?: pulumi.CustomResourceOptions): LocalSwiftRepository {
        return new LocalSwiftRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localSwiftRepository:LocalSwiftRepository';

    /**
     * Returns true if the given object is an instance of LocalSwiftRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalSwiftRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalSwiftRepository.__pulumiType;
    }
    ...
    /**
     * Create a LocalSwiftRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: LocalSwiftRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalSwiftRepositoryArgs | LocalSwiftRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalSwiftRepositoryState | undefined;
            ...
            const args = argsOrState as LocalSwiftRepositoryArgs | undefined;
        ...
        super(LocalSwiftRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalSwiftRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalSwiftRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
