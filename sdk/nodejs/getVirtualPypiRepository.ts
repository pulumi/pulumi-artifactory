 ...
 *
 * const virtual_pypi = artifactory.getVirtualPypiRepository({
 *     key: "virtual-pypi",
 * });
 * ```
 */
export function getVirtualPypiRepository(args: GetVirtualPypiRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualPypiRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getVirtualPypiRepository:getVirtualPypiRepository", {
 ...
 */
export interface GetVirtualPypiRepositoryArgs {
 ...
 */
export interface GetVirtualPypiRepositoryResult {
 ...
 * A collection of arguments for invoking getVirtualPypiRepository.
 */
export interface GetVirtualPypiRepositoryOutputArgs {
