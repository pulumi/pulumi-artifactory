 ...
 *
 * const terraform_local_test_cran_repo = new artifactory.index/localCranRepository.LocalCranRepository("terraform-local-test-cran-repo", {key: "terraform-local-test-cran-repo"});
 * ```
 *
 * ## Import
 *
...
export class LocalCranRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalCranRepositoryState, opts?: pulumi.CustomResourceOptions): LocalCranRepository {
        return new LocalCranRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localCranRepository:LocalCranRepository';

    /**
     * Returns true if the given object is an instance of LocalCranRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalCranRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalCranRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalCranRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalCranRepositoryArgs | LocalCranRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalCranRepositoryState | undefined;
            ...
            const args = argsOrState as LocalCranRepositoryArgs | undefined;
        ...
        super(LocalCranRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalCranRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalCranRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
