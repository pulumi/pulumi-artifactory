...
export function getRemoteCondaRepository(args: GetRemoteCondaRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteCondaRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteCondaRepository:getRemoteCondaRepository", {
 ...
 */
export interface GetRemoteCondaRepositoryArgs {
 ...
 */
export interface GetRemoteCondaRepositoryResult {
 ...
 * A collection of arguments for invoking getRemoteCondaRepository.
 */
export interface GetRemoteCondaRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteCondaRepositoryContentSynchronisationArgs | undefined>;
