...
export class LocalHelmociRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalHelmociRepositoryState, opts?: pulumi.CustomResourceOptions): LocalHelmociRepository {
        return new LocalHelmociRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localHelmociRepository:LocalHelmociRepository';

    /**
     * Returns true if the given object is an instance of LocalHelmociRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalHelmociRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalHelmociRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalHelmociRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalHelmociRepositoryArgs | LocalHelmociRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as LocalHelmociRepositoryArgs | undefined;
        ...
        super(LocalHelmociRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalHelmociRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
 ...
 */
export interface LocalHelmociRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
