 ...
 */
export interface GetFederatedAnsibleRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedAnsibleRepositoryMember[];
    notes?: string;
 ...
 */
export interface GetFederatedAnsibleRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedAnsibleRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedAnsibleRepository.
 */
export interface GetFederatedAnsibleRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedAnsibleRepositoryMemberArgs>[] | undefined>;
