...
export interface ArtifactoryReleaseBundleCustomWebhookState {
     ...
     * Specifies where the webhook will be applied on which repositories.
     */
    criteria?: pulumi.Input<inputs.ArtifactoryReleaseBundleCustomWebhookCriteria | undefined>;
    /**
     * Webhook description. Max length 1000 characters.
     */
     ...
     * At least one is required.
     */
    handlers?: pulumi.Input<pulumi.Input<inputs.ArtifactoryReleaseBundleCustomWebhookHandler>[] | undefined>;
    /**
     * The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
     */
