 ...
 * ```
 */
export class RemoteHexRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteHexRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteHexRepository {
        return new RemoteHexRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteHexRepository:RemoteHexRepository';

    /**
     * Returns true if the given object is an instance of RemoteHexRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteHexRepository {
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteHexRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
    ...
    constructor(name: string, argsOrState?: RemoteHexRepositoryArgs | RemoteHexRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteHexRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteHexRepositoryArgs | undefined;
...
export interface RemoteHexRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteHexRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
