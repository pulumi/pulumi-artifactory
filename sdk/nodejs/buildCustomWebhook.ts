...
export class BuildCustomWebhook extends pulumi.CustomResource {
     ...
     */
    declare public readonly criteria: pulumi.Output<outputs.BuildCustomWebhookCriteria>;
    /**
     ...
     */
    declare public readonly handlers: pulumi.Output<outputs.BuildCustomWebhookHandler[]>;
    /**
    ...
    constructor(name: string, argsOrState?: BuildCustomWebhookArgs | BuildCustomWebhookState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BuildCustomWebhook.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface BuildCustomWebhookState {
     ...
     * Specifies where the webhook will be applied on which repositories.
     */
    criteria?: pulumi.Input<inputs.BuildCustomWebhookCriteria | undefined>;
    /**
     * Webhook description. Max length 1000 characters.
     */
     ...
     * At least one is required.
     */
    handlers?: pulumi.Input<pulumi.Input<inputs.BuildCustomWebhookHandler>[] | undefined>;
    /**
     * The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
     */
