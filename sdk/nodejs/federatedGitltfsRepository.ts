...
export class FederatedGitltfsRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedGitltfsRepositoryMember[]>;
    /**
...
export interface FederatedGitltfsRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedGitltfsRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
