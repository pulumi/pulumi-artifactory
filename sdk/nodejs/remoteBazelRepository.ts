 ...
 *
 * const my_remote_bazelmodules = new artifactory.RemoteBazelRepository("my-remote-bazelmodules", {
 ...
 * ```
 */
export class RemoteBazelRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteBazelRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteBazelRepository {
        return new RemoteBazelRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteBazelRepository:RemoteBazelRepository';

    /**
     * Returns true if the given object is an instance of RemoteBazelRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteBazelRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteBazelRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteBazelRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    constructor(name: string, args: RemoteBazelRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteBazelRepositoryArgs | RemoteBazelRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteBazelRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteBazelRepositoryArgs | undefined;
        ...
        super(RemoteBazelRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteBazelRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteBazelRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteBazelRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
