...
export class RemoteMavenRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteMavenRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteMavenRepository {
        return new RemoteMavenRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteMavenRepository:RemoteMavenRepository';

    /**
     * Returns true if the given object is an instance of RemoteMavenRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteMavenRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteMavenRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteMavenRepositoryContentSynchronisation | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteMavenRepositoryArgs | RemoteMavenRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteMavenRepositoryState | undefined;
        ...
        super(RemoteMavenRepository.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface RemoteMavenRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteMavenRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
