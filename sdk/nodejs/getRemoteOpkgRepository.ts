...
export function getRemoteOpkgRepository(args: GetRemoteOpkgRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteOpkgRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteOpkgRepository:getRemoteOpkgRepository", {
 ...
 */
export interface GetRemoteOpkgRepositoryArgs {
 ...
 */
export interface GetRemoteOpkgRepositoryResult {
 ...
 * A collection of arguments for invoking getRemoteOpkgRepository.
 */
export interface GetRemoteOpkgRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteOpkgRepositoryContentSynchronisationArgs | undefined>;
