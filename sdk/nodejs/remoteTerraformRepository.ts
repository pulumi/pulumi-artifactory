...
export class RemoteTerraformRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteTerraformRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteTerraformRepository {
        return new RemoteTerraformRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteTerraformRepository:RemoteTerraformRepository';
     ...
     */
    public static isInstance(obj: any): obj is RemoteTerraformRepository {
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteTerraformRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
    ...
    constructor(name: string, argsOrState?: RemoteTerraformRepositoryArgs | RemoteTerraformRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteTerraformRepositoryState | undefined;
            ...
            resourceInputs["terraformProvidersUrl"] = state?.terraformProvidersUrl;
            resourceInputs["terraformRegistryUrl"] = state?.terraformRegistryUrl;
            ...
            const args = argsOrState as RemoteTerraformRepositoryArgs | undefined;
            ...
            resourceInputs["terraformProvidersUrl"] = args?.terraformProvidersUrl;
            resourceInputs["terraformRegistryUrl"] = args?.terraformRegistryUrl;
...
export interface RemoteTerraformRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteTerraformRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
