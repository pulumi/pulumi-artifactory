 ...
 * ```
 */
export class FederatedDebianRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedDebianRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedDebianRepository {
        return new FederatedDebianRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedDebianRepository:FederatedDebianRepository';

    /**
     * Returns true if the given object is an instance of FederatedDebianRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedDebianRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedDebianRepository.__pulumiType;
    }
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedDebianRepositoryMember[]>;
    /**
     ...
     */
    declare public readonly trivialLayout: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    constructor(name: string, args: FederatedDebianRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedDebianRepositoryArgs | FederatedDebianRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedDebianRepositoryState | undefined;
            ...
            resourceInputs["trivialLayout"] = state?.trivialLayout;
            resourceInputs["xrayIndex"] = state?.xrayIndex;
        } else {
            const args = argsOrState as FederatedDebianRepositoryArgs | undefined;
            ...
            resourceInputs["trivialLayout"] = args?.trivialLayout;
            resourceInputs["xrayIndex"] = args?.xrayIndex;
            resourceInputs["packageType"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(FederatedDebianRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedDebianRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedDebianRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedDebianRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members: pulumi.Input<pulumi.Input<inputs.FederatedDebianRepositoryMember>[]>;
    /**
     * Internal description.
     */
    notes?: pulumi.Input<string | undefined>;
