 ...
 *
 * const federated_test_docker_repo = artifactory.getFederatedDockerV2Repository({
 ...
 * ```
 */
export function getFederatedDockerV2RepositoryOutput(args: GetFederatedDockerV2RepositoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFederatedDockerV2RepositoryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetFederatedDockerV2RepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedDockerV2RepositoryMemberArgs>[] | undefined>;
