 ...
 *
 * const terraform_federated_test_ivy_repo = new artifactory.index/federatedIvyRepository.FederatedIvyRepository("terraform-federated-test-ivy-repo", {
...
export class FederatedIvyRepository extends pulumi.CustomResource {
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedIvyRepositoryMember[]>;
    /**
