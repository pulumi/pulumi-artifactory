 ...
 *
 * const terraform_federated_test_conda_repo = new artifactory.index/federatedCondaRepository.FederatedCondaRepository("terraform-federated-test-conda-repo", {
 ...
 * ```
 */
export class FederatedCondaRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedCondaRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedCondaRepository {
        return new FederatedCondaRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedCondaRepository:FederatedCondaRepository';

    /**
     * Returns true if the given object is an instance of FederatedCondaRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedCondaRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedCondaRepository.__pulumiType;
    }
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedCondaRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedCondaRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedCondaRepositoryArgs | FederatedCondaRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedCondaRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedCondaRepositoryArgs | undefined;
        ...
        super(FederatedCondaRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedCondaRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedCondaRepositoryMember>[]>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedCondaRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
