...
export class FederatedCondaRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedCondaRepositoryMember[]>;
    /**
...
export interface FederatedCondaRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedCondaRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
