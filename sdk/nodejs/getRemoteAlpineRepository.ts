 ...
 *
 * const remote_alpine = artifactory.getRemoteAlpineRepository({
 *     key: "remote-alpine",
 * });
 * ```
 */
export function getRemoteAlpineRepository(args: GetRemoteAlpineRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteAlpineRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteAlpineRepository:getRemoteAlpineRepository", {
...
export interface GetRemoteAlpineRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteAlpineRepositoryContentSynchronisationArgs | undefined>;
