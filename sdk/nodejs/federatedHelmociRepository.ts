 ...
 * ```
 */
export class FederatedHelmociRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedHelmociRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedHelmociRepository {
        return new FederatedHelmociRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedHelmociRepository:FederatedHelmociRepository';

    /**
     * Returns true if the given object is an instance of FederatedHelmociRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedHelmociRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedHelmociRepository.__pulumiType;
    }
     ...
     */
    declare public readonly maxUniqueTags: pulumi.Output<number | undefined>;
    /**
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedHelmociRepositoryMember[]>;
    /**
     ...
     */
    declare public readonly tagRetention: pulumi.Output<number | undefined>;
    /**
     ...
     */
    constructor(name: string, args: FederatedHelmociRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedHelmociRepositoryArgs | FederatedHelmociRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedHelmociRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedHelmociRepositoryArgs | undefined;
            ...
            resourceInputs["maxUniqueTags"] = args?.maxUniqueTags;
            ...
            resourceInputs["tagRetention"] = args?.tagRetention;
            resourceInputs["xrayIndex"] = args?.xrayIndex;
            resourceInputs["packageType"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(FederatedHelmociRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedHelmociRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedHelmociRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedHelmociRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members: pulumi.Input<pulumi.Input<inputs.FederatedHelmociRepositoryMember>[]>;
    /**
     * Internal description.
     */
    notes?: pulumi.Input<string | undefined>;
