 ...
 * ```
 */
export class LocalHexRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalHexRepositoryState, opts?: pulumi.CustomResourceOptions): LocalHexRepository {
        return new LocalHexRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localHexRepository:LocalHexRepository';

    /**
     * Returns true if the given object is an instance of LocalHexRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalHexRepository {
    ...
    constructor(name: string, argsOrState?: LocalHexRepositoryArgs | LocalHexRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalHexRepositoryState | undefined;
            ...
            const args = argsOrState as LocalHexRepositoryArgs | undefined;
