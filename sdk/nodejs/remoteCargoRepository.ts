...
export class RemoteCargoRepository extends pulumi.CustomResource {
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteCargoRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    declare public readonly gitRegistryUrl: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteCargoRepositoryArgs | RemoteCargoRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["gitRegistryUrl"] = state?.gitRegistryUrl;
            ...
            resourceInputs["gitRegistryUrl"] = args?.gitRegistryUrl;
...
export interface RemoteCargoRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteCargoRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
