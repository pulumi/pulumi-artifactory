...
export function getFederatedSwiftRepository(args: GetFederatedSwiftRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetFederatedSwiftRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getFederatedSwiftRepository:getFederatedSwiftRepository", {
 ...
 */
export interface GetFederatedSwiftRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedSwiftRepositoryMember[];
    notes?: string;
...
export interface GetFederatedSwiftRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedSwiftRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedSwiftRepository.
 */
export interface GetFederatedSwiftRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedSwiftRepositoryMemberArgs>[] | undefined>;
