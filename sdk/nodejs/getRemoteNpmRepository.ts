...
export function getRemoteNpmRepository(args: GetRemoteNpmRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteNpmRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteNpmRepository:getRemoteNpmRepository", {
 ...
 */
export interface GetRemoteNpmRepositoryArgs {
 ...
 */
export interface GetRemoteNpmRepositoryResult {
 ...
 * A collection of arguments for invoking getRemoteNpmRepository.
 */
export interface GetRemoteNpmRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteNpmRepositoryContentSynchronisationArgs | undefined>;
