 ...
 *
 * const foo_composer = new artifactory.index/virtualComposerRepository.VirtualComposerRepository("foo-composer", {
 ...
 * ```
 */
export class VirtualComposerRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualComposerRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualComposerRepository {
        return new VirtualComposerRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualComposerRepository:VirtualComposerRepository';

    /**
     * Returns true if the given object is an instance of VirtualComposerRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualComposerRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualComposerRepository.__pulumiType;
    }
    ...
    /**
     * Create a VirtualComposerRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualComposerRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualComposerRepositoryArgs | VirtualComposerRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualComposerRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualComposerRepositoryArgs | undefined;
        ...
        super(VirtualComposerRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualComposerRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
 ...
 */
export interface VirtualComposerRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by
     * another Artifactory instance.
     */
