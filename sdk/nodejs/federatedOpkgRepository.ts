 ...
 *
 * const terraform_federated_test_opkg_repo = new artifactory.index/federatedOpkgRepository.FederatedOpkgRepository("terraform-federated-test-opkg-repo", {
...
export class FederatedOpkgRepository extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: FederatedOpkgRepositoryArgs | FederatedOpkgRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(FederatedOpkgRepository.__pulumiType, name, resourceInputs, opts);
    }
}
