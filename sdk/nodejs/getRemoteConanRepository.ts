 ...
 *
 * const remote_conan = artifactory.getRemoteConanRepository({
 *     key: "remote-conan",
 * });
 * ```
 */
 ...
 */
export interface GetRemoteConanRepositoryArgs {
 ...
 */
export interface GetRemoteConanRepositoryResult {
 ...
 * A collection of arguments for invoking getRemoteConanRepository.
 */
export interface GetRemoteConanRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteConanRepositoryContentSynchronisationArgs | undefined>;
