...
export class DockerWebhook extends pulumi.CustomResource {
     ...
     */
    declare public readonly criteria: pulumi.Output<outputs.DockerWebhookCriteria | undefined>;
    /**
     ...
     */
    declare public readonly handlers: pulumi.Output<outputs.DockerWebhookHandler[] | undefined>;
    /**
