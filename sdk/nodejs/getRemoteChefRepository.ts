...
export function getRemoteChefRepository(args: GetRemoteChefRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteChefRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getRemoteChefRepository:getRemoteChefRepository", {
 ...
 */
export interface GetRemoteChefRepositoryArgs {
    ...
    contentSynchronisation?: inputs.GetRemoteChefRepositoryContentSynchronisation;
    description?: string;
 ...
 */
export interface GetRemoteChefRepositoryResult {
    ...
    readonly contentSynchronisation: outputs.GetRemoteChefRepositoryContentSynchronisation;
 ...
 * A collection of arguments for invoking getRemoteChefRepository.
 */
export interface GetRemoteChefRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteChefRepositoryContentSynchronisationArgs | undefined>;
