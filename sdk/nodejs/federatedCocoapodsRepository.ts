 ...
 *
 * const terraform_federated_test_cocoapods_repo = new artifactory.index/federatedCocoapodsRepository.FederatedCocoapodsRepository("terraform-federated-test-cocoapods-repo", {
...
export class FederatedCocoapodsRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedCocoapodsRepository {
        return new FederatedCocoapodsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository';

    /**
     * Returns true if the given object is an instance of FederatedCocoapodsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedCocoapodsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedCocoapodsRepository.__pulumiType;
    }
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedCocoapodsRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedCocoapodsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedCocoapodsRepositoryArgs | FederatedCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedCocoapodsRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedCocoapodsRepositoryArgs | undefined;
        ...
        super(FederatedCocoapodsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedCocoapodsRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedCocoapodsRepositoryMember>[]>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedCocoapodsRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
