 ...
 *
 * const terraform_federated_test_terraformModule_repo = new artifactory.index/federatedTerraformModuleRepository.FederatedTerraformModuleRepository("terraform-federated-test-terraformModule-repo", {
 ...
 * ```
 */
export class FederatedTerraformModuleRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedTerraformModuleRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedTerraformModuleRepository {
        return new FederatedTerraformModuleRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedTerraformModuleRepository:FederatedTerraformModuleRepository';
     ...
     */
    public static isInstance(obj: any): obj is FederatedTerraformModuleRepository {
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedTerraformModuleRepositoryMember[]>;
    /**
    ...
    constructor(name: string, argsOrState?: FederatedTerraformModuleRepositoryArgs | FederatedTerraformModuleRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedTerraformModuleRepositoryState | undefined;
            ...
            const args = argsOrState as FederatedTerraformModuleRepositoryArgs | undefined;
