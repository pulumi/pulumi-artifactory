...
export class FederatedTerraformModuleRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedTerraformModuleRepositoryMember[]>;
    /**
...
export interface FederatedTerraformModuleRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedTerraformModuleRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
