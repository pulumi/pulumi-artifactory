 ...
 * ```
 */
export class FederatedDockerV2Repository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedDockerV2RepositoryState, opts?: pulumi.CustomResourceOptions): FederatedDockerV2Repository {
        return new FederatedDockerV2Repository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedDockerV2Repository:FederatedDockerV2Repository';

    /**
     * Returns true if the given object is an instance of FederatedDockerV2Repository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedDockerV2Repository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedDockerV2Repository.__pulumiType;
    }
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedDockerV2RepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedDockerV2RepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedDockerV2RepositoryArgs | FederatedDockerV2RepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedDockerV2RepositoryState | undefined;
            ...
            const args = argsOrState as FederatedDockerV2RepositoryArgs | undefined;
        ...
        super(FederatedDockerV2Repository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedDockerV2RepositoryState {
    /**
     * The Docker API version to use. This cannot be set
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedDockerV2RepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedDockerV2RepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
     * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
     */
     ...
     * to set up Federated repositories correctly.
     */
    members: pulumi.Input<pulumi.Input<inputs.FederatedDockerV2RepositoryMember>[]>;
    /**
     * Internal description.
     */
    notes?: pulumi.Input<string | undefined>;
