 ...
 *
 * const federated_test_puppet_repo = artifactory.getFederatedPuppetRepository({
...
export interface GetFederatedPuppetRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedPuppetRepositoryMemberArgs>[] | undefined>;
