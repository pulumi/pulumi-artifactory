 ...
 * ```
 */
export function getRemoteAnsibleRepository(args: GetRemoteAnsibleRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetRemoteAnsibleRepositoryResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("artifactory:index/getRemoteAnsibleRepository:getRemoteAnsibleRepository", {
 ...
 */
export interface GetRemoteAnsibleRepositoryArgs {
    ...
    contentSynchronisation?: inputs.GetRemoteAnsibleRepositoryContentSynchronisation;
    description?: string;
 ...
 */
export interface GetRemoteAnsibleRepositoryResult {
    ...
    readonly contentSynchronisation: outputs.GetRemoteAnsibleRepositoryContentSynchronisation;
...
export function getRemoteAnsibleRepositoryOutput(args: GetRemoteAnsibleRepositoryOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRemoteAnsibleRepositoryResult> {
    return pulumi.output(args).apply((a: any) => getRemoteAnsibleRepository(a, opts))
}

/**
 * A collection of arguments for invoking getRemoteAnsibleRepository.
 */
export interface GetRemoteAnsibleRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteAnsibleRepositoryContentSynchronisationArgs>;
