...
export class RemoteHelmRepository extends pulumi.CustomResource {
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteHelmRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     */
    declare public readonly helmChartsBaseUrl: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: RemoteHelmRepositoryArgs | RemoteHelmRepositoryState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["helmChartsBaseUrl"] = state?.helmChartsBaseUrl;
            ...
            resourceInputs["helmChartsBaseUrl"] = args?.helmChartsBaseUrl;
...
export interface RemoteHelmRepositoryState {
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteHelmRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
     ...
     * Base URL for the translation of chart source URLs in the index.yaml of virtual repos. Artifactory will only translate URLs matching the index.yamls hostname or URLs starting with this base url. Support http/https/oci protocol scheme.
     */
    helmChartsBaseUrl?: pulumi.Input<string | undefined>;
    /**
     * List of comma-separated artifact patterns to include when evaluating artifact requests in the form of `x/y/**&#47;z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`**&#47;*`).
     */
