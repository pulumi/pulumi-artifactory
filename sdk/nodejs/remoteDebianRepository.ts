 ...
 * ```
 */
export class RemoteDebianRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteDebianRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteDebianRepository {
        return new RemoteDebianRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteDebianRepository:RemoteDebianRepository';

    /**
     * Returns true if the given object is an instance of RemoteDebianRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteDebianRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteDebianRepository.__pulumiType;
    }
    ...
    public readonly contentSynchronisation!: pulumi.Output<outputs.RemoteDebianRepositoryContentSynchronisation | undefined>;
    /**
     * Public description.
     */
    ...
    /**
     * Create a RemoteDebianRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RemoteDebianRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteDebianRepositoryArgs | RemoteDebianRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteDebianRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteDebianRepositoryArgs | undefined;
        ...
        super(RemoteDebianRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteDebianRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any
     * other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteDebianRepositoryContentSynchronisation>;
    /**
     * Public description.
     */
 ...
 */
export interface RemoteDebianRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any
     * other host.
     */
