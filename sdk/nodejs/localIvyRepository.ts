 ...
 *
 * const terraform_local_test_ivy_repo = new artifactory.index/localIvyRepository.LocalIvyRepository("terraform-local-test-ivy-repo", {key: "terraform-local-test-ivy-repo"});
 * ```
 *
 * ## Import
 *
