 ...
 */
export interface GetFederatedGoRepositoryArgs {
     ...
     */
    members?: inputs.GetFederatedGoRepositoryMember[];
    notes?: string;
 ...
 */
export interface GetFederatedGoRepositoryResult {
     ...
     * to set up Federated repositories correctly.
     */
    readonly members?: outputs.GetFederatedGoRepositoryMember[];
 ...
 * A collection of arguments for invoking getFederatedGoRepository.
 */
export interface GetFederatedGoRepositoryOutputArgs {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.GetFederatedGoRepositoryMemberArgs>[] | undefined>;
