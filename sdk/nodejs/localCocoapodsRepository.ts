 ...
 *
 * const terraform_local_test_cocoapods_repo = new artifactory.index/localCocoapodsRepository.LocalCocoapodsRepository("terraform-local-test-cocoapods-repo", {key: "terraform-local-test-cocoapods-repo"});
 * ```
 *
 * ## Import
 *
...
export class LocalCocoapodsRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions): LocalCocoapodsRepository {
        return new LocalCocoapodsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localCocoapodsRepository:LocalCocoapodsRepository';

    /**
     * Returns true if the given object is an instance of LocalCocoapodsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalCocoapodsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalCocoapodsRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalCocoapodsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalCocoapodsRepositoryArgs | LocalCocoapodsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalCocoapodsRepositoryState | undefined;
            ...
            const args = argsOrState as LocalCocoapodsRepositoryArgs | undefined;
        ...
        super(LocalCocoapodsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalCocoapodsRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalCocoapodsRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
