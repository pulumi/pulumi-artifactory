...
export class DistributionCustomWebhook extends pulumi.CustomResource {
     ...
     */
    declare public readonly criteria: pulumi.Output<outputs.DistributionCustomWebhookCriteria | undefined>;
    /**
     ...
     */
    declare public readonly handlers: pulumi.Output<outputs.DistributionCustomWebhookHandler[] | undefined>;
    /**
