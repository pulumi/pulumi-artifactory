 ...
 *
 * const remote_rpm = artifactory.getRemoteRpmRepository({
 *     key: "remote-rpm",
 * });
 * ```
 */
...
export interface GetRemoteRpmRepositoryOutputArgs {
    ...
    contentSynchronisation?: pulumi.Input<inputs.GetRemoteRpmRepositoryContentSynchronisationArgs | undefined>;
