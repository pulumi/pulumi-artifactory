...
export class VirtualBowerRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualBowerRepositoryState, opts?: pulumi.CustomResourceOptions): VirtualBowerRepository {
        return new VirtualBowerRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/virtualBowerRepository:VirtualBowerRepository';

    /**
     * Returns true if the given object is an instance of VirtualBowerRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualBowerRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualBowerRepository.__pulumiType;
    }
     ...
     */
    declare public readonly externalDependenciesEnabled: pulumi.Output<boolean | undefined>;
    /**
    ...
    /**
     * Create a VirtualBowerRepository resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: VirtualBowerRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualBowerRepositoryArgs | VirtualBowerRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualBowerRepositoryState | undefined;
            ...
            const args = argsOrState as VirtualBowerRepositoryArgs | undefined;
        ...
        super(VirtualBowerRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualBowerRepositoryState {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
 ...
 */
export interface VirtualBowerRepositoryArgs {
    /**
     * Whether the virtual repository should search through remote repositories when trying to resolve an artifact requested by another Artifactory instance.
     */
    artifactoryRequestsCanRetrieveRemoteArtifacts?: pulumi.Input<boolean>;
