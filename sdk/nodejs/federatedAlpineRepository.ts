...
export class FederatedAlpineRepository extends pulumi.CustomResource {
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedAlpineRepositoryMember[]>;
    /**
...
export interface FederatedAlpineRepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedAlpineRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
