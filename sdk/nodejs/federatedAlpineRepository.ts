 ...
 *
 * const terraform_federated_test_alpine_repo = new artifactory.index/federatedAlpineRepository.FederatedAlpineRepository("terraform-federated-test-alpine-repo", {
