 ...
 * ```
 */
export class FederatedCargoRepository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedCargoRepositoryState, opts?: pulumi.CustomResourceOptions): FederatedCargoRepository {
        return new FederatedCargoRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedCargoRepository:FederatedCargoRepository';

    /**
     * Returns true if the given object is an instance of FederatedCargoRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedCargoRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedCargoRepository.__pulumiType;
    }
     ...
     */
    declare public readonly anonymousAccess: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly enableSparseIndex: pulumi.Output<boolean | undefined>;
    /**
    ...
    declare public readonly indexCompressionFormats: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    declare public readonly members: pulumi.Output<outputs.FederatedCargoRepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedCargoRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedCargoRepositoryArgs | FederatedCargoRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedCargoRepositoryState | undefined;
            resourceInputs["anonymousAccess"] = state?.anonymousAccess;
            ...
            resourceInputs["enableSparseIndex"] = state?.enableSparseIndex;
            resourceInputs["excludesPattern"] = state?.excludesPattern;
            resourceInputs["includesPattern"] = state?.includesPattern;
            resourceInputs["indexCompressionFormats"] = state?.indexCompressionFormats;
            ...
            const args = argsOrState as FederatedCargoRepositoryArgs | undefined;
            ...
            resourceInputs["anonymousAccess"] = args?.anonymousAccess;
            ...
            resourceInputs["enableSparseIndex"] = args?.enableSparseIndex;
            resourceInputs["excludesPattern"] = args?.excludesPattern;
            resourceInputs["includesPattern"] = args?.includesPattern;
            resourceInputs["indexCompressionFormats"] = args?.indexCompressionFormats;
        ...
        super(FederatedCargoRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedCargoRepositoryState {
    /**
     * Cargo client does not send credentials when performing download and search for crates. Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous access option. Default value is 'false'.
     */
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedCargoRepositoryMember>[] | undefined>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedCargoRepositoryArgs {
    /**
     * Cargo client does not send credentials when performing download and search for crates. Enable this to allow anonymous access to these resources (only), note that this will override the security anonymous access option. Default value is 'false'.
     */
    anonymousAccess?: pulumi.Input<boolean | undefined>;
     ...
     * to set up Federated repositories correctly.
     */
    members: pulumi.Input<pulumi.Input<inputs.FederatedCargoRepositoryMember>[]>;
    /**
     * Internal description.
     */
    notes?: pulumi.Input<string | undefined>;
