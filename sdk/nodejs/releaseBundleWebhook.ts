 ...
 *
 * const release_bundle_webhook = new artifactory.index/releaseBundleWebhook.ReleaseBundleWebhook("release-bundle-webhook", {
 *     criteria: {
...
export class ReleaseBundleWebhook extends pulumi.CustomResource {
     ...
     */
    public readonly handlers!: pulumi.Output<outputs.ReleaseBundleWebhookHandler[]>;
    /**
