...
export class LocalComposerRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalComposerRepositoryState, opts?: pulumi.CustomResourceOptions): LocalComposerRepository {
        return new LocalComposerRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/localComposerRepository:LocalComposerRepository';

    /**
     * Returns true if the given object is an instance of LocalComposerRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LocalComposerRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LocalComposerRepository.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: LocalComposerRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LocalComposerRepositoryArgs | LocalComposerRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LocalComposerRepositoryState | undefined;
            ...
            const args = argsOrState as LocalComposerRepositoryArgs | undefined;
        ...
        super(LocalComposerRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface LocalComposerRepositoryState {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
 ...
 */
export interface LocalComposerRepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
