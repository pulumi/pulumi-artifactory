...
export class ArtifactPropertyCustomWebhook extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ArtifactPropertyCustomWebhookState, opts?: pulumi.CustomResourceOptions): ArtifactPropertyCustomWebhook {
        return new ArtifactPropertyCustomWebhook(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/artifactPropertyCustomWebhook:ArtifactPropertyCustomWebhook';
     ...
     */
    public static isInstance(obj: any): obj is ArtifactPropertyCustomWebhook {
     ...
     */
    declare public readonly criteria: pulumi.Output<outputs.ArtifactPropertyCustomWebhookCriteria>;
    /**
     ...
     */
    declare public readonly handlers: pulumi.Output<outputs.ArtifactPropertyCustomWebhookHandler[]>;
    /**
    ...
    constructor(name: string, argsOrState?: ArtifactPropertyCustomWebhookArgs | ArtifactPropertyCustomWebhookState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ArtifactPropertyCustomWebhookState | undefined;
            ...
            const args = argsOrState as ArtifactPropertyCustomWebhookArgs | undefined;
...
export interface ArtifactPropertyCustomWebhookState {
     ...
     * Specifies where the webhook will be applied on which repositories.
     */
    criteria?: pulumi.Input<inputs.ArtifactPropertyCustomWebhookCriteria | undefined>;
    /**
     * Webhook description. Max length 1000 characters.
     */
     ...
     * At least one is required.
     */
    handlers?: pulumi.Input<pulumi.Input<inputs.ArtifactPropertyCustomWebhookHandler>[] | undefined>;
    /**
     * The identity key of the webhook. Must be between 2 and 200 characters. Cannot contain spaces.
     */
