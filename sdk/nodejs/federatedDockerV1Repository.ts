 ...
 *
 * const terraform_federated_test_docker_repo = new artifactory.index/federatedDockerV1Repository.FederatedDockerV1Repository("terraform-federated-test-docker-repo", {
 ...
 * ```
 */
export class FederatedDockerV1Repository extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FederatedDockerV1RepositoryState, opts?: pulumi.CustomResourceOptions): FederatedDockerV1Repository {
        return new FederatedDockerV1Repository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/federatedDockerV1Repository:FederatedDockerV1Repository';

    /**
     * Returns true if the given object is an instance of FederatedDockerV1Repository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FederatedDockerV1Repository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FederatedDockerV1Repository.__pulumiType;
    }
     ...
     */
    public readonly members!: pulumi.Output<outputs.FederatedDockerV1RepositoryMember[]>;
    /**
     ...
     */
    constructor(name: string, args: FederatedDockerV1RepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FederatedDockerV1RepositoryArgs | FederatedDockerV1RepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FederatedDockerV1RepositoryState | undefined;
            ...
            const args = argsOrState as FederatedDockerV1RepositoryArgs | undefined;
        ...
        super(FederatedDockerV1Repository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FederatedDockerV1RepositoryState {
     ...
     * to set up Federated repositories correctly.
     */
    members?: pulumi.Input<pulumi.Input<inputs.FederatedDockerV1RepositoryMember>[]>;
    /**
     * Internal description.
     */
 ...
 */
export interface FederatedDockerV1RepositoryArgs {
    /**
     * When set, you may view content such as HTML or Javadoc files directly from Artifactory. This may not be safe and
     * therefore requires strict content moderation to prevent malicious users from uploading content that may compromise
     * security (e.g., cross-site scripting attacks).
