...
export class RemoteGemsRepository extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RemoteGemsRepositoryState, opts?: pulumi.CustomResourceOptions): RemoteGemsRepository {
        return new RemoteGemsRepository(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'artifactory:index/remoteGemsRepository:RemoteGemsRepository';

    /**
     * Returns true if the given object is an instance of RemoteGemsRepository.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RemoteGemsRepository {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RemoteGemsRepository.__pulumiType;
    }
    ...
    declare public readonly contentSynchronisation: pulumi.Output<outputs.RemoteGemsRepositoryContentSynchronisation | undefined>;
    /**
     ...
     */
    constructor(name: string, args: RemoteGemsRepositoryArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RemoteGemsRepositoryArgs | RemoteGemsRepositoryState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RemoteGemsRepositoryState | undefined;
            ...
            const args = argsOrState as RemoteGemsRepositoryArgs | undefined;
        ...
        super(RemoteGemsRepository.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RemoteGemsRepositoryState {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    ...
    contentSynchronisation?: pulumi.Input<inputs.RemoteGemsRepositoryContentSynchronisation | undefined>;
    /**
     * Enable repository to be protected by the Curation service.
     */
 ...
 */
export interface RemoteGemsRepositoryArgs {
    /**
     * 'Lenient Host Authentication' in the UI. Allow credentials of this repository to be used on requests redirected to any other host.
     */
    allowAnyHostAuth?: pulumi.Input<boolean | undefined>;
