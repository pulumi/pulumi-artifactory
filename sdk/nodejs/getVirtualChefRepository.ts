...
export function getVirtualChefRepository(args: GetVirtualChefRepositoryArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualChefRepositoryResult> {
    ...
    return pulumi.runtime.invoke("artifactory:index/getVirtualChefRepository:getVirtualChefRepository", {
 ...
 */
export interface GetVirtualChefRepositoryArgs {
 ...
 */
export interface GetVirtualChefRepositoryResult {
 ...
 * A collection of arguments for invoking getVirtualChefRepository.
 */
export interface GetVirtualChefRepositoryOutputArgs {
