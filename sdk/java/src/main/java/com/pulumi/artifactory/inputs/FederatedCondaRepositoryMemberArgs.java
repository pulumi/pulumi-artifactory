...
public final class FederatedCondaRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedCondaRepositoryMemberArgs Empty = new FederatedCondaRepositoryMemberArgs();
    ...
    private FederatedCondaRepositoryMemberArgs() {}

    private FederatedCondaRepositoryMemberArgs(FederatedCondaRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedCondaRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedCondaRepositoryMemberArgs();
        }

        public Builder(FederatedCondaRepositoryMemberArgs defaults) {
            $ = new FederatedCondaRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedCondaRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedCondaRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedCondaRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
