...
@CustomType
public final class ArtifactLifecycleCustomWebhookHandler {
    /**
    ...
    public static Builder builder(ArtifactLifecycleCustomWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(ArtifactLifecycleCustomWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ArtifactLifecycleCustomWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        public ArtifactLifecycleCustomWebhookHandler build() {
            final var _resultValue = new ArtifactLifecycleCustomWebhookHandler();
