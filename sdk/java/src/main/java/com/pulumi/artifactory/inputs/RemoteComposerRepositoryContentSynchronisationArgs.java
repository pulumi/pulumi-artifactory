...
public final class RemoteComposerRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteComposerRepositoryContentSynchronisationArgs Empty = new RemoteComposerRepositoryContentSynchronisationArgs();
    ...
    private RemoteComposerRepositoryContentSynchronisationArgs() {}

    private RemoteComposerRepositoryContentSynchronisationArgs(RemoteComposerRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteComposerRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteComposerRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteComposerRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteComposerRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteComposerRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
