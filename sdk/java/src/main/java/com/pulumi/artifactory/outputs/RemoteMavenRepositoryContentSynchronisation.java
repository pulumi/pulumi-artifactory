...
@CustomType
public final class RemoteMavenRepositoryContentSynchronisation {
    ...
    private RemoteMavenRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteMavenRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteMavenRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteMavenRepositoryContentSynchronisation build() {
            return new RemoteMavenRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
