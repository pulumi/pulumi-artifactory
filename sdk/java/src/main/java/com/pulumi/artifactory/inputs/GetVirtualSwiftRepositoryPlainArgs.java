...
public final class GetVirtualSwiftRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualSwiftRepositoryPlainArgs Empty = new GetVirtualSwiftRepositoryPlainArgs();
    ...
    private GetVirtualSwiftRepositoryPlainArgs() {}

    private GetVirtualSwiftRepositoryPlainArgs(GetVirtualSwiftRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualSwiftRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualSwiftRepositoryPlainArgs();
        }

        public Builder(GetVirtualSwiftRepositoryPlainArgs defaults) {
            $ = new GetVirtualSwiftRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualSwiftRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualSwiftRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
