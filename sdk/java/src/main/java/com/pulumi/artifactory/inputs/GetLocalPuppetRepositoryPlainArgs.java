...
public final class GetLocalPuppetRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalPuppetRepositoryPlainArgs Empty = new GetLocalPuppetRepositoryPlainArgs();
    ...
    private GetLocalPuppetRepositoryPlainArgs() {}

    private GetLocalPuppetRepositoryPlainArgs(GetLocalPuppetRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalPuppetRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalPuppetRepositoryPlainArgs();
        }

        public Builder(GetLocalPuppetRepositoryPlainArgs defaults) {
            $ = new GetLocalPuppetRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalPuppetRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalPuppetRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
