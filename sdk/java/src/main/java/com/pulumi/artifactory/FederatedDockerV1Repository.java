...
public class FederatedDockerV1Repository extends com.pulumi.resources.CustomResource {
    ...
    public FederatedDockerV1Repository(String name, FederatedDockerV1RepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedDockerV1Repository:FederatedDockerV1Repository", name, args == null ? FederatedDockerV1RepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
