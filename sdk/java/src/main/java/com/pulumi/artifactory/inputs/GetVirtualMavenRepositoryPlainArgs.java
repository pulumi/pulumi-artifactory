...
public final class GetVirtualMavenRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualMavenRepositoryPlainArgs Empty = new GetVirtualMavenRepositoryPlainArgs();
    ...
    private GetVirtualMavenRepositoryPlainArgs() {}

    private GetVirtualMavenRepositoryPlainArgs(GetVirtualMavenRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualMavenRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualMavenRepositoryPlainArgs();
        }

        public Builder(GetVirtualMavenRepositoryPlainArgs defaults) {
            $ = new GetVirtualMavenRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualMavenRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualMavenRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
