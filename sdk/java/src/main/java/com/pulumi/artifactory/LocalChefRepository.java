...
import com.pulumi.artifactory.inputs.LocalChefRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localChefRepository:LocalChefRepository")
public class LocalChefRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalChefRepository(java.lang.String name) {
        this(name, LocalChefRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalChefRepository(java.lang.String name, LocalChefRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalChefRepository(java.lang.String name, LocalChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localChefRepository:LocalChefRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalChefRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localChefRepository:LocalChefRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalChefRepositoryArgs makeArgs(LocalChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalChefRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalChefRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalChefRepository(name, id, state, options);
    }
}
