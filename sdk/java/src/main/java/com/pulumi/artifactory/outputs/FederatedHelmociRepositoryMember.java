...
public final class FederatedHelmociRepositoryMember {
    ...
    public static Builder builder(FederatedHelmociRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedHelmociRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedHelmociRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
