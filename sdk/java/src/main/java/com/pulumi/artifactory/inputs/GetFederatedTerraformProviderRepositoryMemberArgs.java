...
public final class GetFederatedTerraformProviderRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetFederatedTerraformProviderRepositoryMemberArgs() {}

    private GetFederatedTerraformProviderRepositoryMemberArgs(GetFederatedTerraformProviderRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedTerraformProviderRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedTerraformProviderRepositoryMemberArgs();
        }

        public Builder(GetFederatedTerraformProviderRepositoryMemberArgs defaults) {
            $ = new GetFederatedTerraformProviderRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedTerraformProviderRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedTerraformProviderRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedTerraformProviderRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
