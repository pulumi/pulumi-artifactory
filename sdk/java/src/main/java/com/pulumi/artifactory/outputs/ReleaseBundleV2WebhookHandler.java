...
@CustomType
public final class ReleaseBundleV2WebhookHandler {
    /**
    ...
    private ReleaseBundleV2WebhookHandler() {}
    /**
     * @return Custom HTTP headers you wish to use to invoke the Webhook, comprise of key/value pair.
     * 
     */
    ...
    public static Builder builder(ReleaseBundleV2WebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSecretForSigning;
        public Builder() {}
        public Builder(ReleaseBundleV2WebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleV2WebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public ReleaseBundleV2WebhookHandler build() {
            final var _resultValue = new ReleaseBundleV2WebhookHandler();
