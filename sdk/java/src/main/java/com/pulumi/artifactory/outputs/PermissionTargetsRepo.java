...
import com.pulumi.artifactory.outputs.PermissionTargetsRepoActions;
...
@CustomType
public final class PermissionTargetsRepo {
    /**
     * @return -
     * 
     */
    private final @Nullable PermissionTargetsRepoActions actions;
    /**
    ...
    private PermissionTargetsRepo(
        @CustomType.Parameter("actions") @Nullable PermissionTargetsRepoActions actions,
     ...
     * 
     */
    public Optional<PermissionTargetsRepoActions> actions() {
    ...
    public static Builder builder(PermissionTargetsRepo defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable PermissionTargetsRepoActions actions;
        ...
        public Builder(PermissionTargetsRepo defaults) {
        ...
        public Builder actions(@Nullable PermissionTargetsRepoActions actions) {
            this.actions = actions;
            return this;
        }
        ...
        }        public PermissionTargetsRepo build() {
            return new PermissionTargetsRepo(actions, excludesPatterns, includesPatterns, repositories);
        }
    }
}
