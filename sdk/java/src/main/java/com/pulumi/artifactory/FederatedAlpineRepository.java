...
public class FederatedAlpineRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedAlpineRepository(java.lang.String name) {
     ...
     */
    public FederatedAlpineRepository(java.lang.String name, FederatedAlpineRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedAlpineRepository(java.lang.String name, FederatedAlpineRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedAlpineRepository:FederatedAlpineRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedAlpineRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedAlpineRepository:FederatedAlpineRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedAlpineRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
