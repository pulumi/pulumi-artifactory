...
@CustomType
public final class RemoteDockerRepositoryContentSynchronisation {
    ...
    private RemoteDockerRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteDockerRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteDockerRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteDockerRepositoryContentSynchronisation build() {
            return new RemoteDockerRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
