...
public final class DockerV2RepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final DockerV2RepositoryState Empty = new DockerV2RepositoryState();
    ...
    /**
     * @return The Docker API version to use.
     * 
     */
    ...
    private DockerV2RepositoryState() {}

    private DockerV2RepositoryState(DockerV2RepositoryState $) {
    ...
    public static Builder builder(DockerV2RepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DockerV2RepositoryState();
        }

        public Builder(DockerV2RepositoryState defaults) {
            $ = new DockerV2RepositoryState(Objects.requireNonNull(defaults));
        }

        /**
         * @param apiVersion The Docker API version to use.
         * 
         * @return builder
         * 
         */
        ...
        public DockerV2RepositoryState build() {
            return $;
        }
    }
