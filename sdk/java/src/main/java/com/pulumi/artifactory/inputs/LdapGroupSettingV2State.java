...
public final class LdapGroupSettingV2State extends com.pulumi.resources.ResourceArgs {

    public static final LdapGroupSettingV2State Empty = new LdapGroupSettingV2State();
    ...
    private LdapGroupSettingV2State() {}

    private LdapGroupSettingV2State(LdapGroupSettingV2State $) {
    ...
    public static Builder builder(LdapGroupSettingV2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LdapGroupSettingV2State();
        }

        public Builder(LdapGroupSettingV2State defaults) {
            $ = new LdapGroupSettingV2State(Objects.requireNonNull(defaults));
        }
        ...
        public LdapGroupSettingV2State build() {
            return $;
        }
    }
