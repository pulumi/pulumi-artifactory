...
import com.pulumi.artifactory.inputs.GetFederatedHelmRepositoryMember;
...
public final class GetFederatedHelmRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedHelmRepositoryPlainArgs Empty = new GetFederatedHelmRepositoryPlainArgs();
     ...
     * 
     */
    public Optional<List<GetFederatedHelmRepositoryMember>> members() {
    ...
    private GetFederatedHelmRepositoryPlainArgs() {}

    private GetFederatedHelmRepositoryPlainArgs(GetFederatedHelmRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetFederatedHelmRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedHelmRepositoryPlainArgs();
        }

        public Builder(GetFederatedHelmRepositoryPlainArgs defaults) {
            $ = new GetFederatedHelmRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedHelmRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetFederatedHelmRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
