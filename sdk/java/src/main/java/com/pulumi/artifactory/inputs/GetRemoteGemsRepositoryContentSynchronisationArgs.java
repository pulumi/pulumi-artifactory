...
public final class GetRemoteGemsRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteGemsRepositoryContentSynchronisationArgs Empty = new GetRemoteGemsRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteGemsRepositoryContentSynchronisationArgs() {}

    private GetRemoteGemsRepositoryContentSynchronisationArgs(GetRemoteGemsRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteGemsRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteGemsRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteGemsRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteGemsRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteGemsRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
