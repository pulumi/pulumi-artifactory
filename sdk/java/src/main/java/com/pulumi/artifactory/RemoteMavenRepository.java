...
public class RemoteMavenRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteMavenRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteMavenRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteMavenRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteMavenRepository(java.lang.String name) {
     ...
     */
    public RemoteMavenRepository(java.lang.String name, RemoteMavenRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteMavenRepository(java.lang.String name, RemoteMavenRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteMavenRepository:RemoteMavenRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteMavenRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteMavenRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteMavenRepository:RemoteMavenRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteMavenRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteMavenRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
