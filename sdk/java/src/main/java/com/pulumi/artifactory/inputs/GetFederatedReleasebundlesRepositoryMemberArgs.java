...
public final class GetFederatedReleasebundlesRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedReleasebundlesRepositoryMemberArgs Empty = new GetFederatedReleasebundlesRepositoryMemberArgs();
    ...
    private GetFederatedReleasebundlesRepositoryMemberArgs() {}

    private GetFederatedReleasebundlesRepositoryMemberArgs(GetFederatedReleasebundlesRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedReleasebundlesRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedReleasebundlesRepositoryMemberArgs();
        }

        public Builder(GetFederatedReleasebundlesRepositoryMemberArgs defaults) {
            $ = new GetFederatedReleasebundlesRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedReleasebundlesRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedReleasebundlesRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedReleasebundlesRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
