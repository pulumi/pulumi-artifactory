...
import com.pulumi.artifactory.inputs.FederatedHuggingfacemlRepositoryState;
import com.pulumi.artifactory.outputs.FederatedHuggingfacemlRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedHuggingfacemlRepository:FederatedHuggingfacemlRepository")
public class FederatedHuggingfacemlRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedHuggingfacemlRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedHuggingfacemlRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedHuggingfacemlRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedHuggingfacemlRepository(java.lang.String name) {
        this(name, FederatedHuggingfacemlRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedHuggingfacemlRepository(java.lang.String name, FederatedHuggingfacemlRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedHuggingfacemlRepository(java.lang.String name, FederatedHuggingfacemlRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedHuggingfacemlRepository:FederatedHuggingfacemlRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedHuggingfacemlRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedHuggingfacemlRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedHuggingfacemlRepository:FederatedHuggingfacemlRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedHuggingfacemlRepositoryArgs makeArgs(FederatedHuggingfacemlRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedHuggingfacemlRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedHuggingfacemlRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedHuggingfacemlRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
