...
@CustomType
public final class RemoteVcsRepositoryContentSynchronisation {
    ...
    private RemoteVcsRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteVcsRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteVcsRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteVcsRepositoryContentSynchronisation build() {
            return new RemoteVcsRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
