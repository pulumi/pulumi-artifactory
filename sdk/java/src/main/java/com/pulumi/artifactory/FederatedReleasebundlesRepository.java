...
import com.pulumi.artifactory.inputs.FederatedReleasebundlesRepositoryState;
import com.pulumi.artifactory.outputs.FederatedReleasebundlesRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedReleasebundlesRepository:FederatedReleasebundlesRepository")
public class FederatedReleasebundlesRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    /**
     * @return the identity key of the repo. Repository name for this package type myst chave following format: `&lt;project_name&gt;-release-bundles-v2`. Project myst exist before the repository was created.
     * 
     */
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedReleasebundlesRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedReleasebundlesRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedReleasebundlesRepositoryMember>> members() {
        return this.members;
    }
    /**
    ...
    /**
     * @return Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash. Even thought we don&#39;t recommend using this attribute to assign all other repository types to the project, in the scope of this specific package type, it is necessary to have theis attribute.
     * 
     */
     ...
     */
    public FederatedReleasebundlesRepository(java.lang.String name) {
        this(name, FederatedReleasebundlesRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedReleasebundlesRepository(java.lang.String name, FederatedReleasebundlesRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedReleasebundlesRepository(java.lang.String name, FederatedReleasebundlesRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedReleasebundlesRepository:FederatedReleasebundlesRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedReleasebundlesRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedReleasebundlesRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedReleasebundlesRepository:FederatedReleasebundlesRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedReleasebundlesRepositoryArgs makeArgs(FederatedReleasebundlesRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedReleasebundlesRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedReleasebundlesRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedReleasebundlesRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
