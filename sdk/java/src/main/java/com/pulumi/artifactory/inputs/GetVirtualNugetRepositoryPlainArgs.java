...
public final class GetVirtualNugetRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualNugetRepositoryPlainArgs Empty = new GetVirtualNugetRepositoryPlainArgs();
    ...
    private GetVirtualNugetRepositoryPlainArgs() {}

    private GetVirtualNugetRepositoryPlainArgs(GetVirtualNugetRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualNugetRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualNugetRepositoryPlainArgs();
        }

        public Builder(GetVirtualNugetRepositoryPlainArgs defaults) {
            $ = new GetVirtualNugetRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualNugetRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualNugetRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
