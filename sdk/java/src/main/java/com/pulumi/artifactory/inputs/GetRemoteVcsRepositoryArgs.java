...
import com.pulumi.artifactory.inputs.GetRemoteVcsRepositoryContentSynchronisationArgs;
...
public final class GetRemoteVcsRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteVcsRepositoryArgs Empty = new GetRemoteVcsRepositoryArgs();
    ...
    private @Nullable Output<GetRemoteVcsRepositoryContentSynchronisationArgs> contentSynchronisation;

    public Optional<Output<GetRemoteVcsRepositoryContentSynchronisationArgs>> contentSynchronisation() {
    ...
    private GetRemoteVcsRepositoryArgs() {}

    private GetRemoteVcsRepositoryArgs(GetRemoteVcsRepositoryArgs $) {
    ...
    public static Builder builder(GetRemoteVcsRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteVcsRepositoryArgs();
        }

        public Builder(GetRemoteVcsRepositoryArgs defaults) {
            $ = new GetRemoteVcsRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable Output<GetRemoteVcsRepositoryContentSynchronisationArgs> contentSynchronisation) {
            $.contentSynchronisation = contentSynchronisation;
            return this;
        }

        public Builder contentSynchronisation(GetRemoteVcsRepositoryContentSynchronisationArgs contentSynchronisation) {
        ...
        /**
         * @param vcsGitProvider (Optional) Artifactory supports proxying the following Git providers out-of-the-box: GitHub (GITHUB), GitHub Enterprise (GITHUBENTERPRISE), BitBucket Cloud (BITBUCKET), BitBucket Server (STASH), GitLab (GITLAB), or a remote Artifactory instance. Use CUSTOM for a custom URL. Allowed values are: `GITHUB`, `GITHUBENTERPRISE`, `BITBUCKET`, `OLDSTASH`, `STASH`, `ARTIFACTORY`, `GITLAB`, `CUSTOM`. Default value is `GITHUB`.
         * 
         * @return builder
         * 
         */
        ...
        public GetRemoteVcsRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetRemoteVcsRepositoryArgs", "key");
            }
            return $;
        }
    }
