...
public final class GetFederatedHuggingfacemlRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedHuggingfacemlRepositoryMemberArgs Empty = new GetFederatedHuggingfacemlRepositoryMemberArgs();
    ...
    private GetFederatedHuggingfacemlRepositoryMemberArgs() {}

    private GetFederatedHuggingfacemlRepositoryMemberArgs(GetFederatedHuggingfacemlRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedHuggingfacemlRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedHuggingfacemlRepositoryMemberArgs();
        }

        public Builder(GetFederatedHuggingfacemlRepositoryMemberArgs defaults) {
            $ = new GetFederatedHuggingfacemlRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedHuggingfacemlRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedHuggingfacemlRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedHuggingfacemlRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
