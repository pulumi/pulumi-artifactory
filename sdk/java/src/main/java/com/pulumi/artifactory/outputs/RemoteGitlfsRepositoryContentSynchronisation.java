...
@CustomType
public final class RemoteGitlfsRepositoryContentSynchronisation {
    ...
    private RemoteGitlfsRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteGitlfsRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGitlfsRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteGitlfsRepositoryContentSynchronisation build() {
            return new RemoteGitlfsRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
