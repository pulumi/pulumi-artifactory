...
public final class DistributionWebhookCriteriaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DistributionWebhookCriteriaArgs(DistributionWebhookCriteriaArgs $) {
    ...
    public static Builder builder(DistributionWebhookCriteriaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DistributionWebhookCriteriaArgs();
        }

        public Builder(DistributionWebhookCriteriaArgs defaults) {
