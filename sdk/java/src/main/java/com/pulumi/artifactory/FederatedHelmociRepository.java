...
public class FederatedHelmociRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedHelmociRepository(String name) {
     ...
     */
    public FederatedHelmociRepository(String name, FederatedHelmociRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedHelmociRepository get(String name, Output<String> id, @Nullable FederatedHelmociRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
