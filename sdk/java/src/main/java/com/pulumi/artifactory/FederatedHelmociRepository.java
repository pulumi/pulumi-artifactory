...
import com.pulumi.artifactory.inputs.FederatedHelmociRepositoryState;
import com.pulumi.artifactory.outputs.FederatedHelmociRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedHelmociRepository:FederatedHelmociRepository")
public class FederatedHelmociRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedHelmociRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedHelmociRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedHelmociRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedHelmociRepository(java.lang.String name) {
        this(name, FederatedHelmociRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedHelmociRepository(java.lang.String name, FederatedHelmociRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedHelmociRepository(java.lang.String name, FederatedHelmociRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedHelmociRepository:FederatedHelmociRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedHelmociRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedHelmociRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedHelmociRepository:FederatedHelmociRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedHelmociRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedHelmociRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
