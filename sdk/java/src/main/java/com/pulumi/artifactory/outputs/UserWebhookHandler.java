...
@CustomType
public final class UserWebhookHandler {
    /**
    ...
    public static Builder builder(UserWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSecretForSigning;
        public Builder() {}
        public Builder(UserWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("UserWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public UserWebhookHandler build() {
            final var _resultValue = new UserWebhookHandler();
