...
import com.pulumi.artifactory.inputs.GetFederatedDockerV1RepositoryMemberArgs;
...
public final class GetFederatedDockerV1RepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedDockerV1RepositoryArgs Empty = new GetFederatedDockerV1RepositoryArgs();
     ...
     */
    @Import(name="members")
    private @Nullable Output<List<GetFederatedDockerV1RepositoryMemberArgs>> members;
     ...
     * 
     */
    public Optional<Output<List<GetFederatedDockerV1RepositoryMemberArgs>>> members() {
    ...
    private GetFederatedDockerV1RepositoryArgs() {}

    private GetFederatedDockerV1RepositoryArgs(GetFederatedDockerV1RepositoryArgs $) {
    ...
    public static Builder builder(GetFederatedDockerV1RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedDockerV1RepositoryArgs();
        }

        public Builder(GetFederatedDockerV1RepositoryArgs defaults) {
            $ = new GetFederatedDockerV1RepositoryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder members(@Nullable Output<List<GetFederatedDockerV1RepositoryMemberArgs>> members) {
            $.members = members;
            return this;
        }
         ...
         * 
         */
        public Builder members(List<GetFederatedDockerV1RepositoryMemberArgs> members) {
         ...
         * 
         */
        public Builder members(GetFederatedDockerV1RepositoryMemberArgs... members) {
        ...
        public GetFederatedDockerV1RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetFederatedDockerV1RepositoryArgs", "key");
            }
            return $;
        }
    }
