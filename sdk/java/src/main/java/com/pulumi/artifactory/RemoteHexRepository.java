...
import com.pulumi.artifactory.inputs.RemoteHexRepositoryState;
import com.pulumi.artifactory.outputs.RemoteHexRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteHexRepository:RemoteHexRepository")
public class RemoteHexRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteHexRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteHexRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteHexRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteHexRepository(java.lang.String name) {
        this(name, RemoteHexRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteHexRepository(java.lang.String name, RemoteHexRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteHexRepository(java.lang.String name, RemoteHexRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteHexRepository:RemoteHexRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteHexRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteHexRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteHexRepository:RemoteHexRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteHexRepositoryArgs makeArgs(RemoteHexRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteHexRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteHexRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteHexRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteHexRepository(name, id, state, options);
    }
}
