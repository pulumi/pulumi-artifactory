...
public final class FederatedGemsRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedGemsRepositoryMemberArgs Empty = new FederatedGemsRepositoryMemberArgs();
    ...
    private FederatedGemsRepositoryMemberArgs() {}

    private FederatedGemsRepositoryMemberArgs(FederatedGemsRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedGemsRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedGemsRepositoryMemberArgs();
        }

        public Builder(FederatedGemsRepositoryMemberArgs defaults) {
            $ = new FederatedGemsRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedGemsRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedGemsRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedGemsRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
