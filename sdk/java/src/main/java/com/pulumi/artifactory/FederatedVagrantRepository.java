...
public class FederatedVagrantRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedVagrantRepositoryMember.class}, tree="[0,1]")
     ...
     */
    public FederatedVagrantRepository(java.lang.String name) {
     ...
     */
    public FederatedVagrantRepository(java.lang.String name, FederatedVagrantRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedVagrantRepository(java.lang.String name, FederatedVagrantRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedVagrantRepository:FederatedVagrantRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedVagrantRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedVagrantRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedVagrantRepository:FederatedVagrantRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedVagrantRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedVagrantRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
