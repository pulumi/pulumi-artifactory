...
@CustomType
public final class RemoteCargoRepositoryContentSynchronisation {
    ...
    private RemoteCargoRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteCargoRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteCargoRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteCargoRepositoryContentSynchronisation build() {
            return new RemoteCargoRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
