...
public class VirtualPuppetRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualPuppetRepository(java.lang.String name) {
     ...
     */
    public VirtualPuppetRepository(java.lang.String name, VirtualPuppetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualPuppetRepository(java.lang.String name, VirtualPuppetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPuppetRepository:VirtualPuppetRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualPuppetRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPuppetRepository:VirtualPuppetRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualPuppetRepositoryArgs makeArgs(VirtualPuppetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualPuppetRepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualPuppetRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
