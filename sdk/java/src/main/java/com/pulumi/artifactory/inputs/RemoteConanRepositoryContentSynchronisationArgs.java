...
public final class RemoteConanRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteConanRepositoryContentSynchronisationArgs Empty = new RemoteConanRepositoryContentSynchronisationArgs();
    ...
    private RemoteConanRepositoryContentSynchronisationArgs() {}

    private RemoteConanRepositoryContentSynchronisationArgs(RemoteConanRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteConanRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteConanRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteConanRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteConanRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteConanRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
