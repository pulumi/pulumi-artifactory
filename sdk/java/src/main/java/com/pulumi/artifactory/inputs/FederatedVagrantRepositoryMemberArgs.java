...
public final class FederatedVagrantRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedVagrantRepositoryMemberArgs Empty = new FederatedVagrantRepositoryMemberArgs();
    ...
    private FederatedVagrantRepositoryMemberArgs() {}

    private FederatedVagrantRepositoryMemberArgs(FederatedVagrantRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedVagrantRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedVagrantRepositoryMemberArgs();
        }

        public Builder(FederatedVagrantRepositoryMemberArgs defaults) {
            $ = new FederatedVagrantRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedVagrantRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedVagrantRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedVagrantRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
