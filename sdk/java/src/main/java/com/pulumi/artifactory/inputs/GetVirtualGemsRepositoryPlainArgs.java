...
public final class GetVirtualGemsRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualGemsRepositoryPlainArgs Empty = new GetVirtualGemsRepositoryPlainArgs();
    ...
    private GetVirtualGemsRepositoryPlainArgs() {}

    private GetVirtualGemsRepositoryPlainArgs(GetVirtualGemsRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualGemsRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualGemsRepositoryPlainArgs();
        }

        public Builder(GetVirtualGemsRepositoryPlainArgs defaults) {
            $ = new GetVirtualGemsRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualGemsRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualGemsRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
