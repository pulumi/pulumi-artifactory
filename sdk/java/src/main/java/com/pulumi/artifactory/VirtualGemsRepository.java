...
public class VirtualGemsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualGemsRepository(java.lang.String name) {
     ...
     */
    public VirtualGemsRepository(java.lang.String name, VirtualGemsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualGemsRepository(java.lang.String name, VirtualGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGemsRepository:VirtualGemsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualGemsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGemsRepository:VirtualGemsRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VirtualGemsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
