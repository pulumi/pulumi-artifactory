...
@CustomType
public final class FederatedPuppetRepositoryMember {
    /**
    ...
    private FederatedPuppetRepositoryMember() {}
    /**
     * @return Admin access token for this member Artifactory instance. Used in conjunction with `cleanup_on_delete` attribute when Access Federation for access tokens is not enabled.
     * 
     */
    ...
    public static Builder builder(FederatedPuppetRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(FederatedPuppetRepositoryMember defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedPuppetRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedPuppetRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
