...
public final class RemoteCargoRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteCargoRepositoryContentSynchronisationArgs Empty = new RemoteCargoRepositoryContentSynchronisationArgs();
    ...
    private RemoteCargoRepositoryContentSynchronisationArgs() {}

    private RemoteCargoRepositoryContentSynchronisationArgs(RemoteCargoRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteCargoRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteCargoRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteCargoRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteCargoRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteCargoRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
