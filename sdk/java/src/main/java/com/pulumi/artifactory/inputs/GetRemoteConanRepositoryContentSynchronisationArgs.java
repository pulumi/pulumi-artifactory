...
public final class GetRemoteConanRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteConanRepositoryContentSynchronisationArgs Empty = new GetRemoteConanRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteConanRepositoryContentSynchronisationArgs() {}

    private GetRemoteConanRepositoryContentSynchronisationArgs(GetRemoteConanRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteConanRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteConanRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteConanRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteConanRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteConanRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
