...
public final class GetVirtualCocoapodsRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualCocoapodsRepositoryPlainArgs Empty = new GetVirtualCocoapodsRepositoryPlainArgs();
    ...
    private GetVirtualCocoapodsRepositoryPlainArgs() {}

    private GetVirtualCocoapodsRepositoryPlainArgs(GetVirtualCocoapodsRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualCocoapodsRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualCocoapodsRepositoryPlainArgs();
        }

        public Builder(GetVirtualCocoapodsRepositoryPlainArgs defaults) {
            $ = new GetVirtualCocoapodsRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualCocoapodsRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualCocoapodsRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
