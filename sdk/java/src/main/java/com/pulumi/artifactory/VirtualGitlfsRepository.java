...
public class VirtualGitlfsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualGitlfsRepository(java.lang.String name) {
     ...
     */
    public VirtualGitlfsRepository(java.lang.String name, VirtualGitlfsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualGitlfsRepository(java.lang.String name, VirtualGitlfsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGitlfsRepository:VirtualGitlfsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualGitlfsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGitlfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGitlfsRepository:VirtualGitlfsRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VirtualGitlfsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGitlfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
