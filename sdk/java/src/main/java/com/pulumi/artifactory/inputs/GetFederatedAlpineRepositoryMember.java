...
public final class GetFederatedAlpineRepositoryMember extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetFederatedAlpineRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedAlpineRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedAlpineRepositoryMember", "url");
            }
            return $;
        }
    }
