...
@CustomType
public final class DestinationWebhookCriteria {
    /**
    ...
    private DestinationWebhookCriteria() {}
    /**
     * @return Trigger on any release bundle
     * 
     */
    ...
    public static Builder builder(DestinationWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> registeredReleaseBundleNames;
        public Builder() {}
        public Builder(DestinationWebhookCriteria defaults) {
        ...
        public Builder anyReleaseBundle(Boolean anyReleaseBundle) {
            if (anyReleaseBundle == null) {
              throw new MissingRequiredPropertyException("DestinationWebhookCriteria", "anyReleaseBundle");
            }
        ...
        public Builder registeredReleaseBundleNames(List<String> registeredReleaseBundleNames) {
            if (registeredReleaseBundleNames == null) {
              throw new MissingRequiredPropertyException("DestinationWebhookCriteria", "registeredReleaseBundleNames");
            }
        ...
        public DestinationWebhookCriteria build() {
            final var _resultValue = new DestinationWebhookCriteria();
