...
public final class ArtifactWebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ArtifactWebhookHandlerArgs Empty = new ArtifactWebhookHandlerArgs();
    ...
    private ArtifactWebhookHandlerArgs() {}

    private ArtifactWebhookHandlerArgs(ArtifactWebhookHandlerArgs $) {
    ...
    public static Builder builder(ArtifactWebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ArtifactWebhookHandlerArgs();
        }

        public Builder(ArtifactWebhookHandlerArgs defaults) {
            $ = new ArtifactWebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ArtifactWebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ArtifactWebhookHandlerArgs", "url");
            }
            return $;
        }
    }
