...
public final class FederatedCondaRepositoryMember {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedCondaRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedCondaRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
        public FederatedCondaRepositoryMember build() {
            final var _resultValue = new FederatedCondaRepositoryMember();
