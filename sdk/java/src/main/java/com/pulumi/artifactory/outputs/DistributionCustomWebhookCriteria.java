...
@CustomType
public final class DistributionCustomWebhookCriteria {
    /**
    ...
    private DistributionCustomWebhookCriteria() {}
    /**
     * @return Trigger on any release bundle.
     * 
     */
    ...
    public static Builder builder(DistributionCustomWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> registeredReleaseBundleNames;
        public Builder() {}
        public Builder(DistributionCustomWebhookCriteria defaults) {
        ...
        public Builder anyReleaseBundle(Boolean anyReleaseBundle) {
            if (anyReleaseBundle == null) {
              throw new MissingRequiredPropertyException("DistributionCustomWebhookCriteria", "anyReleaseBundle");
            }
        ...
        public Builder registeredReleaseBundleNames(List<String> registeredReleaseBundleNames) {
            if (registeredReleaseBundleNames == null) {
              throw new MissingRequiredPropertyException("DistributionCustomWebhookCriteria", "registeredReleaseBundleNames");
            }
        ...
        public DistributionCustomWebhookCriteria build() {
            final var _resultValue = new DistributionCustomWebhookCriteria();
