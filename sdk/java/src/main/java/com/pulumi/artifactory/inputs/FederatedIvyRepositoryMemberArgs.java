...
public final class FederatedIvyRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedIvyRepositoryMemberArgs Empty = new FederatedIvyRepositoryMemberArgs();
    ...
    private FederatedIvyRepositoryMemberArgs() {}

    private FederatedIvyRepositoryMemberArgs(FederatedIvyRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedIvyRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedIvyRepositoryMemberArgs();
        }

        public Builder(FederatedIvyRepositoryMemberArgs defaults) {
            $ = new FederatedIvyRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedIvyRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedIvyRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedIvyRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
