...
public final class RemoteSwiftRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteSwiftRepositoryContentSynchronisationArgs Empty = new RemoteSwiftRepositoryContentSynchronisationArgs();
    ...
    private RemoteSwiftRepositoryContentSynchronisationArgs() {}

    private RemoteSwiftRepositoryContentSynchronisationArgs(RemoteSwiftRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteSwiftRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteSwiftRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteSwiftRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteSwiftRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteSwiftRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
