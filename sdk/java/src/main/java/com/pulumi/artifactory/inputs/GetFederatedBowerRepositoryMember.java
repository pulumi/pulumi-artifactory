...
public final class GetFederatedBowerRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedBowerRepositoryMember Empty = new GetFederatedBowerRepositoryMember();
    ...
    private GetFederatedBowerRepositoryMember() {}

    private GetFederatedBowerRepositoryMember(GetFederatedBowerRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedBowerRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedBowerRepositoryMember();
        }

        public Builder(GetFederatedBowerRepositoryMember defaults) {
            $ = new GetFederatedBowerRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedBowerRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedBowerRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedBowerRepositoryMember", "url");
            }
            return $;
        }
    }
