...
public final class FederatedDockerV1RepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedDockerV1RepositoryArgs Empty = new FederatedDockerV1RepositoryArgs();
    ...
    private Output<List<FederatedDockerV1RepositoryMemberArgs>> members;
     ...
     * 
     */
    public Output<List<FederatedDockerV1RepositoryMemberArgs>> members() {
        return this.members;
    }
    ...
    private FederatedDockerV1RepositoryArgs() {}

    private FederatedDockerV1RepositoryArgs(FederatedDockerV1RepositoryArgs $) {
    ...
    public static Builder builder(FederatedDockerV1RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedDockerV1RepositoryArgs();
        }

        public Builder(FederatedDockerV1RepositoryArgs defaults) {
            $ = new FederatedDockerV1RepositoryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder members(Output<List<FederatedDockerV1RepositoryMemberArgs>> members) {
            $.members = members;
            return this;
        }
         ...
         * 
         */
        public Builder members(List<FederatedDockerV1RepositoryMemberArgs> members) {
         ...
         * 
         */
        public Builder members(FederatedDockerV1RepositoryMemberArgs... members) {
        ...
        public FederatedDockerV1RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("FederatedDockerV1RepositoryArgs", "key");
            }
            if ($.members == null) {
                throw new MissingRequiredPropertyException("FederatedDockerV1RepositoryArgs", "members");
            }
            return $;
        }
    }
