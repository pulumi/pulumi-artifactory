...
@CustomType
public final class GetFederatedSbtRepositoryMember {
    /**
    ...
    public static Builder builder(GetFederatedSbtRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetFederatedSbtRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetFederatedSbtRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
