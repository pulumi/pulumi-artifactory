...
public final class FederatedSbtRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedSbtRepositoryMemberArgs Empty = new FederatedSbtRepositoryMemberArgs();
    ...
    private FederatedSbtRepositoryMemberArgs() {}

    private FederatedSbtRepositoryMemberArgs(FederatedSbtRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedSbtRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedSbtRepositoryMemberArgs();
        }

        public Builder(FederatedSbtRepositoryMemberArgs defaults) {
            $ = new FederatedSbtRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedSbtRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedSbtRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedSbtRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
