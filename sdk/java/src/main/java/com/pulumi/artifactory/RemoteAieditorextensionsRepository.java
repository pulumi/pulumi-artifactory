...
import com.pulumi.artifactory.inputs.RemoteAieditorextensionsRepositoryState;
import com.pulumi.artifactory.outputs.RemoteAieditorextensionsRepositoryContentSynchronisation;
import com.pulumi.artifactory.outputs.RemoteAieditorextensionsRepositoryCustomHttpHeader;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteAieditorextensionsRepository:RemoteAieditorextensionsRepository")
public class RemoteAieditorextensionsRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteAieditorextensionsRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteAieditorextensionsRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteAieditorextensionsRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     * 
     */
    @Export(name="customHttpHeaders", refs={List.class,RemoteAieditorextensionsRepositoryCustomHttpHeader.class}, tree="[0,1]")
    private Output</* @Nullable */ List<RemoteAieditorextensionsRepositoryCustomHttpHeader>> customHttpHeaders;

    /**
     * @return Up to 5 custom HTTP headers sent on every outbound request to the remote URL. Requires Artifactory 7.146.0 or later. Header values are write-only: they are masked in plan output and never read back from Artifactory, so `pulumi import` cannot recover them. To remove all headers, remove the attribute. Each entry supports:
     * 
     */
    public Output<Optional<List<RemoteAieditorextensionsRepositoryCustomHttpHeader>>> customHttpHeaders() {
     ...
     */
    public RemoteAieditorextensionsRepository(java.lang.String name) {
        this(name, RemoteAieditorextensionsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteAieditorextensionsRepository(java.lang.String name, RemoteAieditorextensionsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteAieditorextensionsRepository(java.lang.String name, RemoteAieditorextensionsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAieditorextensionsRepository:RemoteAieditorextensionsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteAieditorextensionsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteAieditorextensionsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAieditorextensionsRepository:RemoteAieditorextensionsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteAieditorextensionsRepositoryArgs makeArgs(RemoteAieditorextensionsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteAieditorextensionsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteAieditorextensionsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteAieditorextensionsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
