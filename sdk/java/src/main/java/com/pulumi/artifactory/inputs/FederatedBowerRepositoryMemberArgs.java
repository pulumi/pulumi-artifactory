...
public final class FederatedBowerRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedBowerRepositoryMemberArgs Empty = new FederatedBowerRepositoryMemberArgs();
    ...
    private FederatedBowerRepositoryMemberArgs() {}

    private FederatedBowerRepositoryMemberArgs(FederatedBowerRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedBowerRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedBowerRepositoryMemberArgs();
        }

        public Builder(FederatedBowerRepositoryMemberArgs defaults) {
            $ = new FederatedBowerRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedBowerRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedBowerRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedBowerRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
