...
@CustomType
public final class GetLocalAlpineRepositoryResult {
    ...
    public static Builder builder(GetLocalAlpineRepositoryResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean xrayIndex;
        public Builder() {}
        public Builder(GetLocalAlpineRepositoryResult defaults) {
        ...
        public GetLocalAlpineRepositoryResult build() {
            final var _resultValue = new GetLocalAlpineRepositoryResult();
