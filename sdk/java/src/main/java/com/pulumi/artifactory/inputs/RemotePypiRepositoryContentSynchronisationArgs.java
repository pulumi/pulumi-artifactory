...
public final class RemotePypiRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemotePypiRepositoryContentSynchronisationArgs Empty = new RemotePypiRepositoryContentSynchronisationArgs();
    ...
    private RemotePypiRepositoryContentSynchronisationArgs() {}

    private RemotePypiRepositoryContentSynchronisationArgs(RemotePypiRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemotePypiRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemotePypiRepositoryContentSynchronisationArgs();
        }

        public Builder(RemotePypiRepositoryContentSynchronisationArgs defaults) {
            $ = new RemotePypiRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemotePypiRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
