...
@CustomType
public final class RemotePubRepositoryContentSynchronisation {
    ...
    private RemotePubRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemotePubRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemotePubRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemotePubRepositoryContentSynchronisation build() {
            return new RemotePubRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
