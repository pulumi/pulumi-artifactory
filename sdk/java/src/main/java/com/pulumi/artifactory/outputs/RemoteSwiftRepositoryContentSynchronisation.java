...
@CustomType
public final class RemoteSwiftRepositoryContentSynchronisation {
    ...
    private RemoteSwiftRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteSwiftRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteSwiftRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteSwiftRepositoryContentSynchronisation build() {
            return new RemoteSwiftRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
