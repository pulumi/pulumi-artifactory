...
import com.pulumi.artifactory.inputs.PermissionTargetsBuildActionsArgs;
...
public final class PermissionTargetsBuildArgs extends com.pulumi.resources.ResourceArgs {

    public static final PermissionTargetsBuildArgs Empty = new PermissionTargetsBuildArgs();

    @Import(name="actions")
    private @Nullable Output<PermissionTargetsBuildActionsArgs> actions;

    public Optional<Output<PermissionTargetsBuildActionsArgs>> actions() {
    ...
    private PermissionTargetsBuildArgs() {}

    private PermissionTargetsBuildArgs(PermissionTargetsBuildArgs $) {
    ...
    public static Builder builder(PermissionTargetsBuildArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PermissionTargetsBuildArgs();
        }

        public Builder(PermissionTargetsBuildArgs defaults) {
            $ = new PermissionTargetsBuildArgs(Objects.requireNonNull(defaults));
        }

        public Builder actions(@Nullable Output<PermissionTargetsBuildActionsArgs> actions) {
            $.actions = actions;
            return this;
        }

        public Builder actions(PermissionTargetsBuildActionsArgs actions) {
        ...
        public PermissionTargetsBuildArgs build() {
