...
import com.pulumi.artifactory.inputs.RemoteNixRepositoryState;
import com.pulumi.artifactory.outputs.RemoteNixRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteNixRepository:RemoteNixRepository")
public class RemoteNixRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteNixRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteNixRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteNixRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    /**
     * @return URL of the upstream Nix binary cache.
     * 
     */
     ...
     */
    public RemoteNixRepository(java.lang.String name) {
        this(name, RemoteNixRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteNixRepository(java.lang.String name, RemoteNixRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteNixRepository(java.lang.String name, RemoteNixRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteNixRepository:RemoteNixRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteNixRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteNixRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteNixRepository:RemoteNixRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteNixRepositoryArgs makeArgs(RemoteNixRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteNixRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteNixRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteNixRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteNixRepository(name, id, state, options);
    }
}
