...
public final class GetRemoteComposerRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteComposerRepositoryContentSynchronisationArgs Empty = new GetRemoteComposerRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteComposerRepositoryContentSynchronisationArgs() {}

    private GetRemoteComposerRepositoryContentSynchronisationArgs(GetRemoteComposerRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteComposerRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteComposerRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteComposerRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteComposerRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteComposerRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
