...
public final class RemoteChefRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteChefRepositoryContentSynchronisationArgs Empty = new RemoteChefRepositoryContentSynchronisationArgs();
    ...
    private RemoteChefRepositoryContentSynchronisationArgs() {}

    private RemoteChefRepositoryContentSynchronisationArgs(RemoteChefRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteChefRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteChefRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteChefRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteChefRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteChefRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
