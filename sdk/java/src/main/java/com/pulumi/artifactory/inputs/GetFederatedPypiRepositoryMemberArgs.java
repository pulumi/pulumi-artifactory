...
public final class GetFederatedPypiRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedPypiRepositoryMemberArgs Empty = new GetFederatedPypiRepositoryMemberArgs();
    ...
    private GetFederatedPypiRepositoryMemberArgs() {}

    private GetFederatedPypiRepositoryMemberArgs(GetFederatedPypiRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedPypiRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedPypiRepositoryMemberArgs();
        }

        public Builder(GetFederatedPypiRepositoryMemberArgs defaults) {
            $ = new GetFederatedPypiRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedPypiRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedPypiRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedPypiRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
