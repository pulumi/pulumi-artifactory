 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.index_virtualCondaRepository.VirtualCondaRepository;
 * import com.pulumi.artifactory.index_virtualCondaRepository.VirtualCondaRepositoryArgs;
 * import java.util.List;
...
public class VirtualCondaRepository extends com.pulumi.resources.CustomResource {
    ...
    public VirtualCondaRepository(String name, VirtualCondaRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualCondaRepository:VirtualCondaRepository", name, args == null ? VirtualCondaRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
