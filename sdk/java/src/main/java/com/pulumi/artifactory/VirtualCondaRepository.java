...
public class VirtualCondaRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualCondaRepository(String name) {
     ...
     */
    public VirtualCondaRepository(String name, VirtualCondaRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualCondaRepository(String name, VirtualCondaRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualCondaRepository:VirtualCondaRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualCondaRepository(String name, Output<String> id, @Nullable VirtualCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualCondaRepository:VirtualCondaRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static VirtualCondaRepository get(String name, Output<String> id, @Nullable VirtualCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
