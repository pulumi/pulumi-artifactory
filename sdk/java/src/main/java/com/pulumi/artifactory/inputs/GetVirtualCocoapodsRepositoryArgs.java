...
public final class GetVirtualCocoapodsRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualCocoapodsRepositoryArgs Empty = new GetVirtualCocoapodsRepositoryArgs();
    ...
    private GetVirtualCocoapodsRepositoryArgs() {}

    private GetVirtualCocoapodsRepositoryArgs(GetVirtualCocoapodsRepositoryArgs $) {
    ...
    public static Builder builder(GetVirtualCocoapodsRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualCocoapodsRepositoryArgs();
        }

        public Builder(GetVirtualCocoapodsRepositoryArgs defaults) {
            $ = new GetVirtualCocoapodsRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualCocoapodsRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualCocoapodsRepositoryArgs", "key");
            }
            return $;
        }
    }
