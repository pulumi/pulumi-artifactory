...
public final class BuildWebhookState extends com.pulumi.resources.ResourceArgs {

    public static final BuildWebhookState Empty = new BuildWebhookState();
    ...
    private BuildWebhookState() {}

    private BuildWebhookState(BuildWebhookState $) {
    ...
    public static Builder builder(BuildWebhookState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BuildWebhookState();
        }

        public Builder(BuildWebhookState defaults) {
            $ = new BuildWebhookState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder criteria(BuildWebhookCriteriaArgs criteria) {
        ...
        public BuildWebhookState build() {
            return $;
        }
    }
