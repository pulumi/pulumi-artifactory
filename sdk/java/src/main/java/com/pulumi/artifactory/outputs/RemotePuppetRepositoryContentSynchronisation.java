...
@CustomType
public final class RemotePuppetRepositoryContentSynchronisation {
    ...
    private RemotePuppetRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemotePuppetRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemotePuppetRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemotePuppetRepositoryContentSynchronisation build() {
            return new RemotePuppetRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
