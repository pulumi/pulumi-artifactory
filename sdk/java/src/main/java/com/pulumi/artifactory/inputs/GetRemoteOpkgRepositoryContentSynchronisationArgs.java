...
public final class GetRemoteOpkgRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteOpkgRepositoryContentSynchronisationArgs Empty = new GetRemoteOpkgRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteOpkgRepositoryContentSynchronisationArgs() {}

    private GetRemoteOpkgRepositoryContentSynchronisationArgs(GetRemoteOpkgRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteOpkgRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteOpkgRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteOpkgRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteOpkgRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteOpkgRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
