...
public class RemoteDebianRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteDebianRepositoryContentSynchronisation.class, parameters={})
    private Output<RemoteDebianRepositoryContentSynchronisation> contentSynchronisation;

    public Output<RemoteDebianRepositoryContentSynchronisation> contentSynchronisation() {
     ...
     */
    public RemoteDebianRepository(String name) {
     ...
     */
    public RemoteDebianRepository(String name, RemoteDebianRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteDebianRepository get(String name, Output<String> id, @Nullable RemoteDebianRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
