...
public final class GetLocalGitlfsRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalGitlfsRepositoryPlainArgs Empty = new GetLocalGitlfsRepositoryPlainArgs();
    ...
    private GetLocalGitlfsRepositoryPlainArgs() {}

    private GetLocalGitlfsRepositoryPlainArgs(GetLocalGitlfsRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalGitlfsRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalGitlfsRepositoryPlainArgs();
        }

        public Builder(GetLocalGitlfsRepositoryPlainArgs defaults) {
            $ = new GetLocalGitlfsRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalGitlfsRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalGitlfsRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
