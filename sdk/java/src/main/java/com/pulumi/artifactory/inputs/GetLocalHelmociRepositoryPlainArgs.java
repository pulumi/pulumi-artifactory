...
public final class GetLocalHelmociRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalHelmociRepositoryPlainArgs Empty = new GetLocalHelmociRepositoryPlainArgs();
    ...
    private GetLocalHelmociRepositoryPlainArgs() {}

    private GetLocalHelmociRepositoryPlainArgs(GetLocalHelmociRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalHelmociRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalHelmociRepositoryPlainArgs();
        }

        public Builder(GetLocalHelmociRepositoryPlainArgs defaults) {
            $ = new GetLocalHelmociRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalHelmociRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalHelmociRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
