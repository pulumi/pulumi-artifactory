...
public final class GetFederatedGemsRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedGemsRepositoryMemberArgs Empty = new GetFederatedGemsRepositoryMemberArgs();
    ...
    private GetFederatedGemsRepositoryMemberArgs() {}

    private GetFederatedGemsRepositoryMemberArgs(GetFederatedGemsRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedGemsRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedGemsRepositoryMemberArgs();
        }

        public Builder(GetFederatedGemsRepositoryMemberArgs defaults) {
            $ = new GetFederatedGemsRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedGemsRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedGemsRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedGemsRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
