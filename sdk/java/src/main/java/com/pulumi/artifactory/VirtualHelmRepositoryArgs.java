...
public final class VirtualHelmRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualHelmRepositoryArgs Empty = new VirtualHelmRepositoryArgs();
    ...
    private @Nullable Output<Boolean> useNamespaces;
     ...
     * 
     */
    public Optional<Output<Boolean>> useNamespaces() {
        return Optional.ofNullable(this.useNamespaces);
    }

    private VirtualHelmRepositoryArgs() {}

    private VirtualHelmRepositoryArgs(VirtualHelmRepositoryArgs $) {
    ...
    public static Builder builder(VirtualHelmRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualHelmRepositoryArgs();
        }

        public Builder(VirtualHelmRepositoryArgs defaults) {
            $ = new VirtualHelmRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param useNamespaces From Artifactory 7.24.1 (SaaS Version), you can explicitly state a specific aggregated local or remote repository to fetch from a virtual by assigning namespaces to local and remote repositories. See the documentation [here](https://www.jfrog.com/confluence/display/JFROG/Kubernetes+Helm+Chart+Repositories#KubernetesHelmChartRepositories-NamespaceSupportforHelmVirtualRepositories). Default is `false`.
         * 
         * @return builder
         * 
         */
        public Builder useNamespaces(@Nullable Output<Boolean> useNamespaces) {
         ...
         * 
         */
        public Builder useNamespaces(Boolean useNamespaces) {
            return useNamespaces(Output.of(useNamespaces));
        }

        public VirtualHelmRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("VirtualHelmRepositoryArgs", "key");
            }
            return $;
        }
    }
