...
public final class GetVirtualCranRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualCranRepositoryPlainArgs Empty = new GetVirtualCranRepositoryPlainArgs();
    ...
    private GetVirtualCranRepositoryPlainArgs() {}

    private GetVirtualCranRepositoryPlainArgs(GetVirtualCranRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualCranRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualCranRepositoryPlainArgs();
        }

        public Builder(GetVirtualCranRepositoryPlainArgs defaults) {
            $ = new GetVirtualCranRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualCranRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualCranRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
