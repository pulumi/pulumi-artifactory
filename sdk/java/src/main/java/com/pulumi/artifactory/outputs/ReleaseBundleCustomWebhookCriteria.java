...
@CustomType
public final class ReleaseBundleCustomWebhookCriteria {
    /**
    ...
    private ReleaseBundleCustomWebhookCriteria() {}
    /**
     * @return Trigger on any release bundle.
     * 
     */
    ...
    public static Builder builder(ReleaseBundleCustomWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> registeredReleaseBundleNames;
        public Builder() {}
        public Builder(ReleaseBundleCustomWebhookCriteria defaults) {
        ...
        public Builder anyReleaseBundle(Boolean anyReleaseBundle) {
            if (anyReleaseBundle == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleCustomWebhookCriteria", "anyReleaseBundle");
            }
