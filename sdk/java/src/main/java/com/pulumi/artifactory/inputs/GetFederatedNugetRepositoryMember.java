...
public final class GetFederatedNugetRepositoryMember extends com.pulumi.resources.InvokeArgs {
    ...
    private GetFederatedNugetRepositoryMember() {}

    private GetFederatedNugetRepositoryMember(GetFederatedNugetRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedNugetRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedNugetRepositoryMember();
        }

        public Builder(GetFederatedNugetRepositoryMember defaults) {
        ...
        public GetFederatedNugetRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedNugetRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedNugetRepositoryMember", "url");
            }
            return $;
        }
    }
