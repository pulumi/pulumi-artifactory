...
public final class MavenRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final MavenRepositoryArgs Empty = new MavenRepositoryArgs();
    ...
    private MavenRepositoryArgs() {}

    private MavenRepositoryArgs(MavenRepositoryArgs $) {
    ...
    public static Builder builder(MavenRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MavenRepositoryArgs();
        }

        public Builder(MavenRepositoryArgs defaults) {
            $ = new MavenRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MavenRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("MavenRepositoryArgs", "key");
            }
            return $;
        }
    }
