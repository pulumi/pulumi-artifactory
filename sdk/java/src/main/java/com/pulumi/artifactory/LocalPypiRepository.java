...
import com.pulumi.artifactory.inputs.LocalPypiRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localPypiRepository:LocalPypiRepository")
public class LocalPypiRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalPypiRepository(java.lang.String name) {
        this(name, LocalPypiRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalPypiRepository(java.lang.String name, LocalPypiRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalPypiRepository(java.lang.String name, LocalPypiRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localPypiRepository:LocalPypiRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalPypiRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localPypiRepository:LocalPypiRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalPypiRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
