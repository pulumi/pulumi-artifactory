...
public class LocalPypiRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalPypiRepository(String name) {
     ...
     */
    public LocalPypiRepository(String name, LocalPypiRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static LocalPypiRepository get(String name, Output<String> id, @Nullable LocalPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
