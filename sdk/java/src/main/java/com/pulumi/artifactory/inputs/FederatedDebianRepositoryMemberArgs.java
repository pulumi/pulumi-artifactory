...
public final class FederatedDebianRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedDebianRepositoryMemberArgs Empty = new FederatedDebianRepositoryMemberArgs();
    ...
    private FederatedDebianRepositoryMemberArgs() {}

    private FederatedDebianRepositoryMemberArgs(FederatedDebianRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedDebianRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedDebianRepositoryMemberArgs();
        }

        public Builder(FederatedDebianRepositoryMemberArgs defaults) {
            $ = new FederatedDebianRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedDebianRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedDebianRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedDebianRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
