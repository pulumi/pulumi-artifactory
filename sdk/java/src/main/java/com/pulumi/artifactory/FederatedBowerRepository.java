...
public class FederatedBowerRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedBowerRepositoryMember.class}, tree="[0,1]")
     ...
     */
    public FederatedBowerRepository(java.lang.String name) {
     ...
     */
    public FederatedBowerRepository(java.lang.String name, FederatedBowerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedBowerRepository(java.lang.String name, FederatedBowerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedBowerRepository:FederatedBowerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedBowerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedBowerRepository:FederatedBowerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedBowerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
