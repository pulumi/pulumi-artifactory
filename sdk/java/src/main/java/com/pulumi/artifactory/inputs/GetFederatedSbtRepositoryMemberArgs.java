...
public final class GetFederatedSbtRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedSbtRepositoryMemberArgs Empty = new GetFederatedSbtRepositoryMemberArgs();
    ...
    private GetFederatedSbtRepositoryMemberArgs() {}

    private GetFederatedSbtRepositoryMemberArgs(GetFederatedSbtRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedSbtRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedSbtRepositoryMemberArgs();
        }

        public Builder(GetFederatedSbtRepositoryMemberArgs defaults) {
            $ = new GetFederatedSbtRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedSbtRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedSbtRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedSbtRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
