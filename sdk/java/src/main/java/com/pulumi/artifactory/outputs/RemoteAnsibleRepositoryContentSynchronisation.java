...
@CustomType
public final class RemoteAnsibleRepositoryContentSynchronisation {
    /**
    ...
    private RemoteAnsibleRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteAnsibleRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteAnsibleRepositoryContentSynchronisation defaults) {
        ...
        public RemoteAnsibleRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteAnsibleRepositoryContentSynchronisation();
