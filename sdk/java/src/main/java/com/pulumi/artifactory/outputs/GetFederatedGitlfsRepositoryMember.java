...
@CustomType
public final class GetFederatedGitlfsRepositoryMember {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetFederatedGitlfsRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetFederatedGitlfsRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
        public GetFederatedGitlfsRepositoryMember build() {
            final var _resultValue = new GetFederatedGitlfsRepositoryMember();
