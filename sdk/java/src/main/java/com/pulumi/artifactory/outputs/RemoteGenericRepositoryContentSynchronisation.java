...
@CustomType
public final class RemoteGenericRepositoryContentSynchronisation {
    ...
    public static Builder builder(RemoteGenericRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGenericRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteGenericRepositoryContentSynchronisation build() {
            return new RemoteGenericRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
