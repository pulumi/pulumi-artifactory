...
public class FederatedSwiftRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedSwiftRepositoryMember.class})
     ...
     */
    public FederatedSwiftRepository(String name) {
     ...
     */
    public FederatedSwiftRepository(String name, FederatedSwiftRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedSwiftRepository get(String name, Output<String> id, @Nullable FederatedSwiftRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
