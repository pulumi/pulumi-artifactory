...
public final class LocalHelmociRepositoryState extends com.pulumi.resources.ResourceArgs {
    ...
    private LocalHelmociRepositoryState() {}
    ...
    public static Builder builder(LocalHelmociRepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalHelmociRepositoryState();
        }

        public Builder(LocalHelmociRepositoryState defaults) {
            $ = new LocalHelmociRepositoryState(Objects.requireNonNull(defaults));
        }
        ...
        public LocalHelmociRepositoryState build() {
            return $;
        }
    }
