...
public class RemotePuppetRepository extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ RemotePuppetRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemotePuppetRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemotePuppetRepository(java.lang.String name) {
     ...
     */
    public RemotePuppetRepository(java.lang.String name, RemotePuppetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemotePuppetRepository(java.lang.String name, RemotePuppetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remotePuppetRepository:RemotePuppetRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemotePuppetRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemotePuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remotePuppetRepository:RemotePuppetRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemotePuppetRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemotePuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
