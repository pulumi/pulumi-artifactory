...
public class LocalGitltfsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalGitltfsRepository(java.lang.String name) {
     ...
     */
    public LocalGitltfsRepository(java.lang.String name, LocalGitltfsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalGitltfsRepository(java.lang.String name, LocalGitltfsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGitltfsRepository:LocalGitltfsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalGitltfsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGitltfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGitltfsRepository:LocalGitltfsRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalGitltfsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGitltfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
