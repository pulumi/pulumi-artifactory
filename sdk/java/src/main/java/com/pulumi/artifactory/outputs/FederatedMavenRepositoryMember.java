...
@CustomType
public final class FederatedMavenRepositoryMember {
    /**
    ...
    private FederatedMavenRepositoryMember() {}
    /**
     * @return Admin access token for this member Artifactory instance. Used in conjunction with `cleanup_on_delete` attribute when Access Federation for access tokens is not enabled.
     * 
     */
    ...
    public static Builder builder(FederatedMavenRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(FederatedMavenRepositoryMember defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedMavenRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedMavenRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
