...
public final class GetLocalDockerV2RepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalDockerV2RepositoryArgs Empty = new GetLocalDockerV2RepositoryArgs();
    ...
    private GetLocalDockerV2RepositoryArgs() {}

    private GetLocalDockerV2RepositoryArgs(GetLocalDockerV2RepositoryArgs $) {
    ...
    public static Builder builder(GetLocalDockerV2RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalDockerV2RepositoryArgs();
        }

        public Builder(GetLocalDockerV2RepositoryArgs defaults) {
            $ = new GetLocalDockerV2RepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalDockerV2RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalDockerV2RepositoryArgs", "key");
            }
            return $;
        }
    }
