...
public class RemoteSwiftRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteSwiftRepositoryContentSynchronisation.class, parameters={})
     ...
     */
    public RemoteSwiftRepository(String name) {
     ...
     */
    public RemoteSwiftRepository(String name, RemoteSwiftRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteSwiftRepository get(String name, Output<String> id, @Nullable RemoteSwiftRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
