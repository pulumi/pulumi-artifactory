...
import com.pulumi.artifactory.inputs.RemoteSwiftRepositoryState;
import com.pulumi.artifactory.outputs.RemoteSwiftRepositoryContentSynchronisation;
...
public class RemoteSwiftRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteSwiftRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteSwiftRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteSwiftRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteSwiftRepository(java.lang.String name) {
        this(name, RemoteSwiftRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteSwiftRepository(java.lang.String name, RemoteSwiftRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteSwiftRepository(java.lang.String name, RemoteSwiftRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteSwiftRepository:RemoteSwiftRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteSwiftRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteSwiftRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteSwiftRepository:RemoteSwiftRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteSwiftRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteSwiftRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteSwiftRepository(name, id, state, options);
    }
}
