...
public final class FederatedDockerRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedDockerRepositoryMemberArgs Empty = new FederatedDockerRepositoryMemberArgs();
    ...
    private FederatedDockerRepositoryMemberArgs() {}

    private FederatedDockerRepositoryMemberArgs(FederatedDockerRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedDockerRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedDockerRepositoryMemberArgs();
        }

        public Builder(FederatedDockerRepositoryMemberArgs defaults) {
            $ = new FederatedDockerRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedDockerRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedDockerRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedDockerRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
