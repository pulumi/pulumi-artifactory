...
import com.pulumi.artifactory.inputs.RemoteDockerRepositoryState;
import com.pulumi.artifactory.outputs.RemoteDockerRepositoryContentSynchronisation;
 ...
 *             .externalDependenciesPatterns(&#34;**{@literal /}hub.docker.io/**&#34;)
...
public class RemoteDockerRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteDockerRepositoryContentSynchronisation.class, parameters={})
    private Output<RemoteDockerRepositoryContentSynchronisation> contentSynchronisation;

    public Output<RemoteDockerRepositoryContentSynchronisation> contentSynchronisation() {
     ...
     * 
     */
    @Export(name="enableTokenAuthentication", type=Boolean.class, parameters={})
