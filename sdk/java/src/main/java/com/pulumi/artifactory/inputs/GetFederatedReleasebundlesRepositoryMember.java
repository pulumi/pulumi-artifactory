...
public final class GetFederatedReleasebundlesRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedReleasebundlesRepositoryMember Empty = new GetFederatedReleasebundlesRepositoryMember();
    ...
    private GetFederatedReleasebundlesRepositoryMember() {}

    private GetFederatedReleasebundlesRepositoryMember(GetFederatedReleasebundlesRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedReleasebundlesRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedReleasebundlesRepositoryMember();
        }

        public Builder(GetFederatedReleasebundlesRepositoryMember defaults) {
            $ = new GetFederatedReleasebundlesRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedReleasebundlesRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedReleasebundlesRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedReleasebundlesRepositoryMember", "url");
            }
            return $;
        }
    }
