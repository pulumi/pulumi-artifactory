...
public class LocalOciRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalOciRepository(java.lang.String name) {
     ...
     */
    public LocalOciRepository(java.lang.String name, LocalOciRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalOciRepository(java.lang.String name, LocalOciRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localOciRepository:LocalOciRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalOciRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalOciRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localOciRepository:LocalOciRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalOciRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalOciRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
