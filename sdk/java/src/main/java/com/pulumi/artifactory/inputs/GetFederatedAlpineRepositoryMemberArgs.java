...
public final class GetFederatedAlpineRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedAlpineRepositoryMemberArgs Empty = new GetFederatedAlpineRepositoryMemberArgs();
    ...
    private GetFederatedAlpineRepositoryMemberArgs() {}

    private GetFederatedAlpineRepositoryMemberArgs(GetFederatedAlpineRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedAlpineRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedAlpineRepositoryMemberArgs();
        }

        public Builder(GetFederatedAlpineRepositoryMemberArgs defaults) {
            $ = new GetFederatedAlpineRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedAlpineRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedAlpineRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedAlpineRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
