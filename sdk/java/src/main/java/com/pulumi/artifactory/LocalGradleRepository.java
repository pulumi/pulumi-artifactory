...
public class LocalGradleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalGradleRepository(String name) {
     ...
     */
    public LocalGradleRepository(String name, LocalGradleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGradleRepository:LocalGradleRepository", name, args == null ? LocalGradleRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private LocalGradleRepository(String name, Output<String> id, @Nullable LocalGradleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGradleRepository:LocalGradleRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalGradleRepository get(String name, Output<String> id, @Nullable LocalGradleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
