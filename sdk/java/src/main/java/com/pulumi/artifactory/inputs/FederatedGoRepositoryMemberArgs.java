...
public final class FederatedGoRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedGoRepositoryMemberArgs Empty = new FederatedGoRepositoryMemberArgs();
    ...
    private FederatedGoRepositoryMemberArgs() {}

    private FederatedGoRepositoryMemberArgs(FederatedGoRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedGoRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedGoRepositoryMemberArgs();
        }

        public Builder(FederatedGoRepositoryMemberArgs defaults) {
            $ = new FederatedGoRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedGoRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedGoRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedGoRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
