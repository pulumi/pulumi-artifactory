...
@CustomType
public final class GetFederatedCocoapodsRepositoryMember {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetFederatedCocoapodsRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetFederatedCocoapodsRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
