...
public class LocalGenericRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalGenericRepository(String name) {
     ...
     */
    public LocalGenericRepository(String name, LocalGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGenericRepository:LocalGenericRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LocalGenericRepository(String name, Output<String> id, @Nullable LocalGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGenericRepository:LocalGenericRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalGenericRepository get(String name, Output<String> id, @Nullable LocalGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
