...
import com.pulumi.artifactory.inputs.LocalGenericRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localGenericRepository:LocalGenericRepository")
public class LocalGenericRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    /**
     * @return A mandatory identifier for the repository that must be unique.
     * It cannot begin with a number or contain spaces or special characters.
     * 
     */
     ...
     */
    public LocalGenericRepository(java.lang.String name) {
        this(name, LocalGenericRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalGenericRepository(java.lang.String name, LocalGenericRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalGenericRepository(java.lang.String name, LocalGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGenericRepository:LocalGenericRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalGenericRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGenericRepository:LocalGenericRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalGenericRepositoryArgs makeArgs(LocalGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalGenericRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalGenericRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
