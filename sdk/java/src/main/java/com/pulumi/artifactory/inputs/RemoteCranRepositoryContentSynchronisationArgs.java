...
public final class RemoteCranRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteCranRepositoryContentSynchronisationArgs Empty = new RemoteCranRepositoryContentSynchronisationArgs();
    ...
    private RemoteCranRepositoryContentSynchronisationArgs() {}

    private RemoteCranRepositoryContentSynchronisationArgs(RemoteCranRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteCranRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteCranRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteCranRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteCranRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteCranRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
