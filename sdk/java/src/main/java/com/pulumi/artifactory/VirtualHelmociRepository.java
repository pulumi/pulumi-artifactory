...
public class VirtualHelmociRepository extends com.pulumi.resources.CustomResource {
    ...
    public VirtualHelmociRepository(String name, VirtualHelmociRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualHelmociRepository:VirtualHelmociRepository", name, args == null ? VirtualHelmociRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
