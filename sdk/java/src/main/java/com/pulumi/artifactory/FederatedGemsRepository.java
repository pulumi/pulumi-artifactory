...
public class FederatedGemsRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedGemsRepositoryMember.class}, tree="[0,1]")
     ...
     */
    public FederatedGemsRepository(java.lang.String name) {
     ...
     */
    public FederatedGemsRepository(java.lang.String name, FederatedGemsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedGemsRepository(java.lang.String name, FederatedGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGemsRepository:FederatedGemsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedGemsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGemsRepository:FederatedGemsRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedGemsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
