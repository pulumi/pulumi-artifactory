...
public final class LocalNpmRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalNpmRepositoryArgs Empty = new LocalNpmRepositoryArgs();
    ...
    private LocalNpmRepositoryArgs() {}

    private LocalNpmRepositoryArgs(LocalNpmRepositoryArgs $) {
    ...
    public static Builder builder(LocalNpmRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalNpmRepositoryArgs();
        }

        public Builder(LocalNpmRepositoryArgs defaults) {
            $ = new LocalNpmRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LocalNpmRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("LocalNpmRepositoryArgs", "key");
            }
            return $;
        }
    }
