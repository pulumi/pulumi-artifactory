...
public final class GetVirtualConanRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualConanRepositoryPlainArgs Empty = new GetVirtualConanRepositoryPlainArgs();
    ...
    private GetVirtualConanRepositoryPlainArgs() {}

    private GetVirtualConanRepositoryPlainArgs(GetVirtualConanRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualConanRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualConanRepositoryPlainArgs();
        }

        public Builder(GetVirtualConanRepositoryPlainArgs defaults) {
            $ = new GetVirtualConanRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualConanRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualConanRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
