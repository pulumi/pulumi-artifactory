...
@CustomType
public final class ReleaseBundleV2CustomWebhookHandler {
    /**
    ...
    private ReleaseBundleV2CustomWebhookHandler() {}
    /**
     * @return HTTP headers you wish to use to invoke the Webhook, comprise key/value pair.
     * 
     */
    ...
    public static Builder builder(ReleaseBundleV2CustomWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(ReleaseBundleV2CustomWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleV2CustomWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        public ReleaseBundleV2CustomWebhookHandler build() {
            final var _resultValue = new ReleaseBundleV2CustomWebhookHandler();
