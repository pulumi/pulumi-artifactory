...
@CustomType
public final class ArtifactPropertyCustomWebhookHandler {
    /**
    ...
    private ArtifactPropertyCustomWebhookHandler() {}
    /**
     * @return HTTP headers you wish to use to invoke the Webhook, comprise key/value pair.
     * 
     */
    ...
    public static Builder builder(ArtifactPropertyCustomWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(ArtifactPropertyCustomWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ArtifactPropertyCustomWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
