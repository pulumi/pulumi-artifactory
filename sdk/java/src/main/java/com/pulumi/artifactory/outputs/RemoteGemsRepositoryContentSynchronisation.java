...
@CustomType
public final class RemoteGemsRepositoryContentSynchronisation {
    ...
    private RemoteGemsRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteGemsRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGemsRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteGemsRepositoryContentSynchronisation build() {
            return new RemoteGemsRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
