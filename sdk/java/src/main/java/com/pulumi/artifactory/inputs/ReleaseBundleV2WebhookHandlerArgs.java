...
public final class ReleaseBundleV2WebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReleaseBundleV2WebhookHandlerArgs Empty = new ReleaseBundleV2WebhookHandlerArgs();
    ...
    private ReleaseBundleV2WebhookHandlerArgs() {}

    private ReleaseBundleV2WebhookHandlerArgs(ReleaseBundleV2WebhookHandlerArgs $) {
    ...
    public static Builder builder(ReleaseBundleV2WebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseBundleV2WebhookHandlerArgs();
        }

        public Builder(ReleaseBundleV2WebhookHandlerArgs defaults) {
            $ = new ReleaseBundleV2WebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReleaseBundleV2WebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ReleaseBundleV2WebhookHandlerArgs", "url");
            }
            return $;
        }
    }
