...
public final class FederatedNugetRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedNugetRepositoryMemberArgs Empty = new FederatedNugetRepositoryMemberArgs();
    ...
    private FederatedNugetRepositoryMemberArgs() {}

    private FederatedNugetRepositoryMemberArgs(FederatedNugetRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedNugetRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedNugetRepositoryMemberArgs();
        }

        public Builder(FederatedNugetRepositoryMemberArgs defaults) {
            $ = new FederatedNugetRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedNugetRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedNugetRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedNugetRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
