...
public final class GetRemotePubRepositoryContentSynchronisation extends com.pulumi.resources.InvokeArgs {

    public static final GetRemotePubRepositoryContentSynchronisation Empty = new GetRemotePubRepositoryContentSynchronisation();
    ...
    private GetRemotePubRepositoryContentSynchronisation(GetRemotePubRepositoryContentSynchronisation $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemotePubRepositoryContentSynchronisation();
        }

        public Builder(GetRemotePubRepositoryContentSynchronisation defaults) {
            $ = new GetRemotePubRepositoryContentSynchronisation(Objects.requireNonNull(defaults));
        }
