...
import com.pulumi.artifactory.RemoteJetbrainspluginsRepositoryArgs;
import com.pulumi.artifactory.Utilities;
import com.pulumi.artifactory.inputs.RemoteJetbrainspluginsRepositoryState;
import com.pulumi.artifactory.outputs.RemoteJetbrainspluginsRepositoryContentSynchronisation;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.RemoteJetbrainspluginsRepository;
 * import com.pulumi.artifactory.RemoteJetbrainspluginsRepositoryArgs;
 ...
 *         var my_remote_jetbrainsplugins = new RemoteJetbrainspluginsRepository("my-remote-jetbrainsplugins", RemoteJetbrainspluginsRepositoryArgs.builder()
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteJetbrainspluginsRepository:RemoteJetbrainspluginsRepository")
public class RemoteJetbrainspluginsRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteJetbrainspluginsRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteJetbrainspluginsRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteJetbrainspluginsRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    /**
     * @return Enable token (Bearer) based authentication. When set, use an access token as `password` (username may be empty) so Artifactory authenticates to the remote with a Bearer token instead of Basic auth. Default is `false` for most package types; OCI, Helm OCI, and Hugging Face remotes default to `true`.
     * 
     */
    ...
    /**
     * @return `repoLayoutRef` defaults to `simple-default`.
     * 
     * There are no JetBrains Plugins specific attributes: the package type contributes only `url` to the
     * repository contract, so everything else comes from the common remote repository arguments.
     * 
    ...
    /**
     * @return The remote repo URL. Use `https://plugins.jetbrains.com` for the JetBrains Marketplace.
     * Artifactory applies no default URL over the REST API and rejects the request with
     * `No URL defined for remote repository` if it is omitted.
     * 
     */
     ...
     */
    public RemoteJetbrainspluginsRepository(java.lang.String name) {
        this(name, RemoteJetbrainspluginsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteJetbrainspluginsRepository(java.lang.String name, RemoteJetbrainspluginsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteJetbrainspluginsRepository(java.lang.String name, RemoteJetbrainspluginsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteJetbrainspluginsRepository:RemoteJetbrainspluginsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteJetbrainspluginsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteJetbrainspluginsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteJetbrainspluginsRepository:RemoteJetbrainspluginsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteJetbrainspluginsRepositoryArgs makeArgs(RemoteJetbrainspluginsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteJetbrainspluginsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteJetbrainspluginsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteJetbrainspluginsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteJetbrainspluginsRepository(name, id, state, options);
    }
}
