...
@CustomType
public final class ReleaseBundleV2WebhookCriteria {
    /**
    ...
    public static Builder builder(ReleaseBundleV2WebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        public Builder anyReleaseBundle(Boolean anyReleaseBundle) {
            if (anyReleaseBundle == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleV2WebhookCriteria", "anyReleaseBundle");
            }
        ...
        public ReleaseBundleV2WebhookCriteria build() {
            final var _resultValue = new ReleaseBundleV2WebhookCriteria();
