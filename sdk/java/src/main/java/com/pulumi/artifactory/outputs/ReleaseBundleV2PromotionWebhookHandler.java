...
@CustomType
public final class ReleaseBundleV2PromotionWebhookHandler {
    /**
    ...
    private ReleaseBundleV2PromotionWebhookHandler() {}
    /**
     * @return Custom HTTP headers you wish to use to invoke the Webhook, comprise of key/value pair.
     * 
     */
    ...
    public static Builder builder(ReleaseBundleV2PromotionWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSecretForSigning;
        public Builder() {}
        public Builder(ReleaseBundleV2PromotionWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleV2PromotionWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public ReleaseBundleV2PromotionWebhookHandler build() {
            final var _resultValue = new ReleaseBundleV2PromotionWebhookHandler();
