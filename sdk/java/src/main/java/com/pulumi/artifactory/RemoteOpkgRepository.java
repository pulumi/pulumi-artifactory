...
import com.pulumi.artifactory.inputs.RemoteOpkgRepositoryState;
import com.pulumi.artifactory.outputs.RemoteOpkgRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteOpkgRepository:RemoteOpkgRepository")
public class RemoteOpkgRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteOpkgRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteOpkgRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteOpkgRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteOpkgRepository(java.lang.String name) {
        this(name, RemoteOpkgRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteOpkgRepository(java.lang.String name, RemoteOpkgRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteOpkgRepository(java.lang.String name, RemoteOpkgRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteOpkgRepository:RemoteOpkgRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteOpkgRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteOpkgRepository:RemoteOpkgRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteOpkgRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteOpkgRepository(name, id, state, options);
    }
}
