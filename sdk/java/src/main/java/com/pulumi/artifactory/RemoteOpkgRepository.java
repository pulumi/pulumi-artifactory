...
public class RemoteOpkgRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteOpkgRepositoryContentSynchronisation.class, parameters={})
     ...
     */
    public RemoteOpkgRepository(String name) {
     ...
     */
    public RemoteOpkgRepository(String name, RemoteOpkgRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteOpkgRepository get(String name, Output<String> id, @Nullable RemoteOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
