...
import com.pulumi.artifactory.inputs.GetRemoteP2RepositoryContentSynchronisationArgs;
...
public final class GetRemoteP2RepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteP2RepositoryArgs Empty = new GetRemoteP2RepositoryArgs();
    ...
    private @Nullable Output<GetRemoteP2RepositoryContentSynchronisationArgs> contentSynchronisation;

    public Optional<Output<GetRemoteP2RepositoryContentSynchronisationArgs>> contentSynchronisation() {
    ...
    private GetRemoteP2RepositoryArgs() {}

    private GetRemoteP2RepositoryArgs(GetRemoteP2RepositoryArgs $) {
    ...
    public static Builder builder(GetRemoteP2RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteP2RepositoryArgs();
        }

        public Builder(GetRemoteP2RepositoryArgs defaults) {
            $ = new GetRemoteP2RepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable Output<GetRemoteP2RepositoryContentSynchronisationArgs> contentSynchronisation) {
            $.contentSynchronisation = contentSynchronisation;
            return this;
        }

        public Builder contentSynchronisation(GetRemoteP2RepositoryContentSynchronisationArgs contentSynchronisation) {
        ...
        public GetRemoteP2RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetRemoteP2RepositoryArgs", "key");
            }
            return $;
        }
    }
