...
@CustomType
public final class RemoteHuggingfacemlRepositoryContentSynchronisation {
    ...
    private RemoteHuggingfacemlRepositoryContentSynchronisation() {}
    ...
    public static Builder builder(RemoteHuggingfacemlRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteHuggingfacemlRepositoryContentSynchronisation defaults) {
        ...
        public RemoteHuggingfacemlRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteHuggingfacemlRepositoryContentSynchronisation();
