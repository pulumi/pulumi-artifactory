...
public final class PermissionTargetReleaseBundleActionsGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PermissionTargetReleaseBundleActionsGroupArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PermissionTargetReleaseBundleActionsGroupArgs", "name");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("PermissionTargetReleaseBundleActionsGroupArgs", "permissions");
            }
            return $;
        }
    }
