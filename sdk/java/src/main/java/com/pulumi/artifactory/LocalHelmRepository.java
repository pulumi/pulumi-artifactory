...
public class LocalHelmRepository extends com.pulumi.resources.CustomResource {
    ...
    public LocalHelmRepository(String name, LocalHelmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localHelmRepository:LocalHelmRepository", name, args == null ? LocalHelmRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
