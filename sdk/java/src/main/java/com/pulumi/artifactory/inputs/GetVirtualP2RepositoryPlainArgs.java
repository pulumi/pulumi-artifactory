...
public final class GetVirtualP2RepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualP2RepositoryPlainArgs Empty = new GetVirtualP2RepositoryPlainArgs();
    ...
    private GetVirtualP2RepositoryPlainArgs() {}

    private GetVirtualP2RepositoryPlainArgs(GetVirtualP2RepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualP2RepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualP2RepositoryPlainArgs();
        }

        public Builder(GetVirtualP2RepositoryPlainArgs defaults) {
            $ = new GetVirtualP2RepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualP2RepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualP2RepositoryPlainArgs", "key");
            }
            return $;
        }
    }
