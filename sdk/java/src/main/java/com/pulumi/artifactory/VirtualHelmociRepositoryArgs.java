...
public final class VirtualHelmociRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualHelmociRepositoryArgs Empty = new VirtualHelmociRepositoryArgs();
     ...
     * 
     */
    @Import(name="resolveOciTagsByTimestamp")
    private @Nullable Output<Boolean> resolveOciTagsByTimestamp;
     ...
     * 
     */
    public Optional<Output<Boolean>> resolveOciTagsByTimestamp() {
        return Optional.ofNullable(this.resolveOciTagsByTimestamp);
    }

    private VirtualHelmociRepositoryArgs() {}

    private VirtualHelmociRepositoryArgs(VirtualHelmociRepositoryArgs $) {
    ...
    public static Builder builder(VirtualHelmociRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualHelmociRepositoryArgs();
        }

        public Builder(VirtualHelmociRepositoryArgs defaults) {
            $ = new VirtualHelmociRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param resolveOciTagsByTimestamp When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
         * 
         * @return builder
         * 
         */
        public Builder resolveOciTagsByTimestamp(@Nullable Output<Boolean> resolveOciTagsByTimestamp) {
         ...
         * 
         */
        public Builder resolveOciTagsByTimestamp(Boolean resolveOciTagsByTimestamp) {
            return resolveOciTagsByTimestamp(Output.of(resolveOciTagsByTimestamp));
        }

        public VirtualHelmociRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("VirtualHelmociRepositoryArgs", "key");
            }
            return $;
        }
    }
