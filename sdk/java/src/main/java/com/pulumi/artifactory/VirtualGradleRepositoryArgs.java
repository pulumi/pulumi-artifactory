...
public final class VirtualGradleRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualGradleRepositoryArgs Empty = new VirtualGradleRepositoryArgs();
    ...
    private VirtualGradleRepositoryArgs() {}

    private VirtualGradleRepositoryArgs(VirtualGradleRepositoryArgs $) {
    ...
    public static Builder builder(VirtualGradleRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGradleRepositoryArgs();
        }

        public Builder(VirtualGradleRepositoryArgs defaults) {
            $ = new VirtualGradleRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param forceMavenAuthentication User authentication is required when accessing the repository. An anonymous request will display an HTTP 401 error. This is also enforced when aggregated repositories support anonymous requests.
         * 
         * @return builder
         * 
         */
        ...
        public VirtualGradleRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("VirtualGradleRepositoryArgs", "key");
            }
            return $;
        }
    }
