...
@CustomType
public final class RemoteGradleRepositoryContentSynchronisation {
    ...
    private RemoteGradleRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteGradleRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGradleRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            ...
            return new RemoteGradleRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
