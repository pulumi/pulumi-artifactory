...
public final class GetRemoteAlpineRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteAlpineRepositoryContentSynchronisationArgs Empty = new GetRemoteAlpineRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteAlpineRepositoryContentSynchronisationArgs() {}

    private GetRemoteAlpineRepositoryContentSynchronisationArgs(GetRemoteAlpineRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteAlpineRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteAlpineRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteAlpineRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteAlpineRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteAlpineRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
