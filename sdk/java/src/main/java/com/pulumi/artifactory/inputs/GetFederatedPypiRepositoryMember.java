...
public final class GetFederatedPypiRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedPypiRepositoryMember Empty = new GetFederatedPypiRepositoryMember();
    ...
    private GetFederatedPypiRepositoryMember() {}

    private GetFederatedPypiRepositoryMember(GetFederatedPypiRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedPypiRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedPypiRepositoryMember();
        }

        public Builder(GetFederatedPypiRepositoryMember defaults) {
            $ = new GetFederatedPypiRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedPypiRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedPypiRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedPypiRepositoryMember", "url");
            }
            return $;
        }
    }
