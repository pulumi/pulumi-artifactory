...
public class FederatedGenericRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedGenericRepository(java.lang.String name) {
     ...
     */
    public FederatedGenericRepository(java.lang.String name, FederatedGenericRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedGenericRepository(java.lang.String name, FederatedGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGenericRepository:FederatedGenericRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedGenericRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGenericRepository:FederatedGenericRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedGenericRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
