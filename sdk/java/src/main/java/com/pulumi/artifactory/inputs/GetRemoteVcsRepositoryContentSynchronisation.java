...
public final class GetRemoteVcsRepositoryContentSynchronisation extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteVcsRepositoryContentSynchronisation Empty = new GetRemoteVcsRepositoryContentSynchronisation();
    ...
    private GetRemoteVcsRepositoryContentSynchronisation() {}

    private GetRemoteVcsRepositoryContentSynchronisation(GetRemoteVcsRepositoryContentSynchronisation $) {
    ...
    public static Builder builder(GetRemoteVcsRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteVcsRepositoryContentSynchronisation();
        }

        public Builder(GetRemoteVcsRepositoryContentSynchronisation defaults) {
            $ = new GetRemoteVcsRepositoryContentSynchronisation(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteVcsRepositoryContentSynchronisation build() {
            return $;
        }
    }
