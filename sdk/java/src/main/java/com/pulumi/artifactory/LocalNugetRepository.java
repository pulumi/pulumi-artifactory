...
public class LocalNugetRepository extends com.pulumi.resources.CustomResource {
    ...
    public LocalNugetRepository(String name, LocalNugetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNugetRepository:LocalNugetRepository", name, args == null ? LocalNugetRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
