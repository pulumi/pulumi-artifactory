...
import com.pulumi.artifactory.inputs.LocalNugetRepositoryState;
...
public class LocalNugetRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalNugetRepository(java.lang.String name) {
        this(name, LocalNugetRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalNugetRepository(java.lang.String name, LocalNugetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalNugetRepository(java.lang.String name, LocalNugetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNugetRepository:LocalNugetRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalNugetRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalNugetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNugetRepository:LocalNugetRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalNugetRepositoryArgs makeArgs(LocalNugetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalNugetRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalNugetRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalNugetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
