...
public class LocalNugetRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalNugetRepository(String name) {
     ...
     */
    public LocalNugetRepository(String name, LocalNugetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalNugetRepository(String name, LocalNugetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNugetRepository:LocalNugetRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LocalNugetRepository(String name, Output<String> id, @Nullable LocalNugetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNugetRepository:LocalNugetRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalNugetRepository get(String name, Output<String> id, @Nullable LocalNugetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
