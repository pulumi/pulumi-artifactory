...
@CustomType
public final class ArtifactWebhookHandler {
    /**
    ...
    public static Builder builder(ArtifactWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSecretForSigning;
        public Builder() {}
        public Builder(ArtifactWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ArtifactWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public ArtifactWebhookHandler build() {
            final var _resultValue = new ArtifactWebhookHandler();
