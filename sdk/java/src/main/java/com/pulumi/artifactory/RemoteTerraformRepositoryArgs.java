...
public final class RemoteTerraformRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteTerraformRepositoryArgs Empty = new RemoteTerraformRepositoryArgs();
    ...
    private RemoteTerraformRepositoryArgs() {}

    private RemoteTerraformRepositoryArgs(RemoteTerraformRepositoryArgs $) {
    ...
    public static Builder builder(RemoteTerraformRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteTerraformRepositoryArgs();
        }

        public Builder(RemoteTerraformRepositoryArgs defaults) {
            $ = new RemoteTerraformRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param terraformProvidersUrl The base URL of the Provider&#39;s storage API.
         * When using Smart remote repositories, set the URL to `&lt;base_Artifactory_URL&gt;/api/terraform/repokey/providers`.
         * 
         * @return builder
         * 
        ...
        /**
         * @param terraformRegistryUrl The base URL of the registry API.
         * When using Smart Remote Repositories, set the URL to `&lt;base_Artifactory_URL&gt;/api/terraform/repokey`.
         * 
         * @return builder
         * 
        ...
        public RemoteTerraformRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("RemoteTerraformRepositoryArgs", "key");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("RemoteTerraformRepositoryArgs", "url");
            }
            return $;
        }
    }
