...
public class VirtualCranRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualCranRepository(java.lang.String name) {
     ...
     */
    public VirtualCranRepository(java.lang.String name, VirtualCranRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualCranRepository(java.lang.String name, VirtualCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualCranRepository:VirtualCranRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualCranRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualCranRepository:VirtualCranRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualCranRepositoryArgs makeArgs(VirtualCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualCranRepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualCranRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
