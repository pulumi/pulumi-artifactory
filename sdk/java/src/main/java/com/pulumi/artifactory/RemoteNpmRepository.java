...
import com.pulumi.artifactory.inputs.RemoteNpmRepositoryState;
import com.pulumi.artifactory.outputs.RemoteNpmRepositoryContentSynchronisation;
...
public class RemoteNpmRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteNpmRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteNpmRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteNpmRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteNpmRepository(java.lang.String name) {
        this(name, RemoteNpmRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteNpmRepository(java.lang.String name, RemoteNpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteNpmRepository(java.lang.String name, RemoteNpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteNpmRepository:RemoteNpmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteNpmRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteNpmRepository:RemoteNpmRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteNpmRepositoryArgs makeArgs(RemoteNpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteNpmRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteNpmRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
