...
public final class LocalSbtRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalSbtRepositoryArgs Empty = new LocalSbtRepositoryArgs();
    ...
    private LocalSbtRepositoryArgs() {}
    ...
    public static Builder builder(LocalSbtRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalSbtRepositoryArgs();
        }

        public Builder(LocalSbtRepositoryArgs defaults) {
            $ = new LocalSbtRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LocalSbtRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("LocalSbtRepositoryArgs", "key");
            }
            return $;
        }
    }
