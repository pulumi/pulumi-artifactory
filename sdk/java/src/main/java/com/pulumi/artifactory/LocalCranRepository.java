...
import com.pulumi.artifactory.inputs.LocalCranRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localCranRepository:LocalCranRepository")
public class LocalCranRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalCranRepository(java.lang.String name) {
        this(name, LocalCranRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalCranRepository(java.lang.String name, LocalCranRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalCranRepository(java.lang.String name, LocalCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localCranRepository:LocalCranRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalCranRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localCranRepository:LocalCranRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalCranRepositoryArgs makeArgs(LocalCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalCranRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalCranRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
