...
import com.pulumi.artifactory.inputs.LocalVagrantRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localVagrantRepository:LocalVagrantRepository")
public class LocalVagrantRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalVagrantRepository(java.lang.String name) {
        this(name, LocalVagrantRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalVagrantRepository(java.lang.String name, LocalVagrantRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalVagrantRepository(java.lang.String name, LocalVagrantRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localVagrantRepository:LocalVagrantRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalVagrantRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalVagrantRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localVagrantRepository:LocalVagrantRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalVagrantRepositoryArgs makeArgs(LocalVagrantRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalVagrantRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalVagrantRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalVagrantRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
