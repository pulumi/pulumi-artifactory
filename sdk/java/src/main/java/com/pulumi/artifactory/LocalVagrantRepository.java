...
public class LocalVagrantRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalVagrantRepository(String name) {
     ...
     */
    public LocalVagrantRepository(String name, LocalVagrantRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalVagrantRepository(String name, LocalVagrantRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localVagrantRepository:LocalVagrantRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LocalVagrantRepository(String name, Output<String> id, @Nullable LocalVagrantRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localVagrantRepository:LocalVagrantRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalVagrantRepository get(String name, Output<String> id, @Nullable LocalVagrantRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
