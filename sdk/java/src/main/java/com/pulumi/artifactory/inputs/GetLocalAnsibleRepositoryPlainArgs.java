...
public final class GetLocalAnsibleRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalAnsibleRepositoryPlainArgs Empty = new GetLocalAnsibleRepositoryPlainArgs();
    ...
    private GetLocalAnsibleRepositoryPlainArgs() {}

    private GetLocalAnsibleRepositoryPlainArgs(GetLocalAnsibleRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalAnsibleRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalAnsibleRepositoryPlainArgs();
        }

        public Builder(GetLocalAnsibleRepositoryPlainArgs defaults) {
            $ = new GetLocalAnsibleRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param primaryKeypairRef The RSA key to be used to sign Ansible indices.
         * 
         * @return builder
         * 
         */
        ...
        public GetLocalAnsibleRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalAnsibleRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
