...
@CustomType
public final class DockerWebhookCriteria {
    /**
    ...
    public static Builder builder(DockerWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> repoKeys;
        public Builder() {}
        public Builder(DockerWebhookCriteria defaults) {
        ...
        public Builder anyFederated(Boolean anyFederated) {
            if (anyFederated == null) {
              throw new MissingRequiredPropertyException("DockerWebhookCriteria", "anyFederated");
            }
        ...
        public DockerWebhookCriteria build() {
            final var _resultValue = new DockerWebhookCriteria();
