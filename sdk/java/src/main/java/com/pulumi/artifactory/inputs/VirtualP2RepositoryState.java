...
public final class VirtualP2RepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final VirtualP2RepositoryState Empty = new VirtualP2RepositoryState();
    ...
    private VirtualP2RepositoryState() {}

    private VirtualP2RepositoryState(VirtualP2RepositoryState $) {
    ...
    public static Builder builder(VirtualP2RepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualP2RepositoryState();
        }

        public Builder(VirtualP2RepositoryState defaults) {
            $ = new VirtualP2RepositoryState(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualP2RepositoryState build() {
            return $;
        }
    }
