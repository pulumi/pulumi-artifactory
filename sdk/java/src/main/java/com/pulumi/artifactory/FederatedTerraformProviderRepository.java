...
import com.pulumi.artifactory.inputs.FederatedTerraformProviderRepositoryState;
import com.pulumi.artifactory.outputs.FederatedTerraformProviderRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedTerraformProviderRepository:FederatedTerraformProviderRepository")
public class FederatedTerraformProviderRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedTerraformProviderRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedTerraformProviderRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedTerraformProviderRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedTerraformProviderRepository(java.lang.String name) {
        this(name, FederatedTerraformProviderRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedTerraformProviderRepository(java.lang.String name, FederatedTerraformProviderRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedTerraformProviderRepository(java.lang.String name, FederatedTerraformProviderRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedTerraformProviderRepository:FederatedTerraformProviderRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedTerraformProviderRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedTerraformProviderRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedTerraformProviderRepository:FederatedTerraformProviderRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedTerraformProviderRepositoryArgs makeArgs(FederatedTerraformProviderRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedTerraformProviderRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedTerraformProviderRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedTerraformProviderRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new FederatedTerraformProviderRepository(name, id, state, options);
    }
}
