...
public final class GetRemoteGradleRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteGradleRepositoryContentSynchronisationArgs Empty = new GetRemoteGradleRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteGradleRepositoryContentSynchronisationArgs() {}

    private GetRemoteGradleRepositoryContentSynchronisationArgs(GetRemoteGradleRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteGradleRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteGradleRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteGradleRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteGradleRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteGradleRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
