...
public final class GetFederatedIvyRepositoryMember extends com.pulumi.resources.InvokeArgs {
    ...
    private GetFederatedIvyRepositoryMember() {}

    private GetFederatedIvyRepositoryMember(GetFederatedIvyRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedIvyRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedIvyRepositoryMember();
        }

        public Builder(GetFederatedIvyRepositoryMember defaults) {
        ...
        public GetFederatedIvyRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedIvyRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedIvyRepositoryMember", "url");
            }
            return $;
        }
    }
