...
public final class GetLocalAlpineRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalAlpineRepositoryPlainArgs Empty = new GetLocalAlpineRepositoryPlainArgs();
    ...
    private GetLocalAlpineRepositoryPlainArgs() {}

    private GetLocalAlpineRepositoryPlainArgs(GetLocalAlpineRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalAlpineRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalAlpineRepositoryPlainArgs();
        }

        public Builder(GetLocalAlpineRepositoryPlainArgs defaults) {
            $ = new GetLocalAlpineRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalAlpineRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalAlpineRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
