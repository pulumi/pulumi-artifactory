...
public final class GetVirtualHelmociRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualHelmociRepositoryArgs Empty = new GetVirtualHelmociRepositoryArgs();
    ...
    private GetVirtualHelmociRepositoryArgs() {}

    private GetVirtualHelmociRepositoryArgs(GetVirtualHelmociRepositoryArgs $) {
    ...
    public static Builder builder(GetVirtualHelmociRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualHelmociRepositoryArgs();
        }

        public Builder(GetVirtualHelmociRepositoryArgs defaults) {
            $ = new GetVirtualHelmociRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param resolveOciTagsByTimestamp (Optional) When enabled, in cases where the same OCI tag exists in two or more of the aggregated repositories, Artifactory will return the tag that has the latest timestamp. Default values is `false`.
         * 
         * @return builder
         * 
         */
        ...
        public GetVirtualHelmociRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualHelmociRepositoryArgs", "key");
            }
            return $;
        }
    }
