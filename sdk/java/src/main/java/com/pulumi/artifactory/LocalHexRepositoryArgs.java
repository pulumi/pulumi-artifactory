...
public final class LocalHexRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalHexRepositoryArgs Empty = new LocalHexRepositoryArgs();
    ...
    private LocalHexRepositoryArgs() {}

    private LocalHexRepositoryArgs(LocalHexRepositoryArgs $) {
    ...
    public static Builder builder(LocalHexRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalHexRepositoryArgs();
        }

        public Builder(LocalHexRepositoryArgs defaults) {
            $ = new LocalHexRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LocalHexRepositoryArgs build() {
            if ($.hexPrimaryKeypairRef == null) {
                throw new MissingRequiredPropertyException("LocalHexRepositoryArgs", "hexPrimaryKeypairRef");
            }
            if ($.key == null) {
                throw new MissingRequiredPropertyException("LocalHexRepositoryArgs", "key");
            }
            return $;
        }
    }
