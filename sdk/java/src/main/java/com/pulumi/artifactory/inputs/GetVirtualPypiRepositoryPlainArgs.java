...
public final class GetVirtualPypiRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualPypiRepositoryPlainArgs Empty = new GetVirtualPypiRepositoryPlainArgs();
    ...
    private GetVirtualPypiRepositoryPlainArgs() {}

    private GetVirtualPypiRepositoryPlainArgs(GetVirtualPypiRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualPypiRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualPypiRepositoryPlainArgs();
        }

        public Builder(GetVirtualPypiRepositoryPlainArgs defaults) {
            $ = new GetVirtualPypiRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualPypiRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualPypiRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
