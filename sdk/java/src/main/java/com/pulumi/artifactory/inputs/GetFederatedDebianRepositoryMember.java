...
public final class GetFederatedDebianRepositoryMember extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetFederatedDebianRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedDebianRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedDebianRepositoryMember", "url");
            }
            return $;
        }
    }
