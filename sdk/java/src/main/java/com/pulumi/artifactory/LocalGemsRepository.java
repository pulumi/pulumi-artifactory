...
public class LocalGemsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalGemsRepository(String name) {
     ...
     */
    public LocalGemsRepository(String name, LocalGemsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalGemsRepository(String name, LocalGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGemsRepository:LocalGemsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LocalGemsRepository(String name, Output<String> id, @Nullable LocalGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGemsRepository:LocalGemsRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalGemsRepository get(String name, Output<String> id, @Nullable LocalGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
