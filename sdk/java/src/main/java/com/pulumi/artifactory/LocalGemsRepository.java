...
import com.pulumi.artifactory.inputs.LocalGemsRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localGemsRepository:LocalGemsRepository")
public class LocalGemsRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalGemsRepository(java.lang.String name) {
        this(name, LocalGemsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalGemsRepository(java.lang.String name, LocalGemsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalGemsRepository(java.lang.String name, LocalGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGemsRepository:LocalGemsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalGemsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGemsRepository:LocalGemsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalGemsRepositoryArgs makeArgs(LocalGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalGemsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalGemsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalGemsRepository(name, id, state, options);
    }
}
