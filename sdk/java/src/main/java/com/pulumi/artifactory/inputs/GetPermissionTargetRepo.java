...
import com.pulumi.artifactory.inputs.GetPermissionTargetRepoActions;
...
public final class GetPermissionTargetRepo extends com.pulumi.resources.InvokeArgs {

    public static final GetPermissionTargetRepo Empty = new GetPermissionTargetRepo();

    @Import(name="actions")
    private @Nullable GetPermissionTargetRepoActions actions;

    public Optional<GetPermissionTargetRepoActions> actions() {
    ...
    private GetPermissionTargetRepo() {}

    private GetPermissionTargetRepo(GetPermissionTargetRepo $) {
    ...
    public static Builder builder(GetPermissionTargetRepo defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPermissionTargetRepo();
        }

        public Builder(GetPermissionTargetRepo defaults) {
            $ = new GetPermissionTargetRepo(Objects.requireNonNull(defaults));
        }

        public Builder actions(@Nullable GetPermissionTargetRepoActions actions) {
            $.actions = actions;
            return this;
        }
        ...
        public GetPermissionTargetRepo build() {
            if ($.repositories == null) {
                throw new MissingRequiredPropertyException("GetPermissionTargetRepo", "repositories");
            }
            return $;
        }
    }
