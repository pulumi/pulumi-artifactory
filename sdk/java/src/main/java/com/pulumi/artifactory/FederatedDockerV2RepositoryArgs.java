...
public final class FederatedDockerV2RepositoryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FederatedDockerV2RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("FederatedDockerV2RepositoryArgs", "key");
            }
            if ($.members == null) {
                throw new MissingRequiredPropertyException("FederatedDockerV2RepositoryArgs", "members");
            }
            return $;
        }
    }
