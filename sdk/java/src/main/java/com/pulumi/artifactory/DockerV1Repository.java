...
public class DockerV1Repository extends com.pulumi.resources.CustomResource {
     ...
     */
    public DockerV1Repository(java.lang.String name) {
     ...
     */
    public DockerV1Repository(java.lang.String name, DockerV1RepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DockerV1Repository(java.lang.String name, DockerV1RepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/dockerV1Repository:DockerV1Repository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DockerV1Repository(java.lang.String name, Output<java.lang.String> id, @Nullable DockerV1RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/dockerV1Repository:DockerV1Repository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DockerV1Repository get(java.lang.String name, Output<java.lang.String> id, @Nullable DockerV1RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
