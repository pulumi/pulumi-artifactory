...
public class FederatedCocoapodsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedCocoapodsRepository(String name) {
     ...
     */
    public FederatedCocoapodsRepository(String name, FederatedCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private FederatedCocoapodsRepository(String name, Output<String> id, @Nullable FederatedCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static FederatedCocoapodsRepository get(String name, Output<String> id, @Nullable FederatedCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
