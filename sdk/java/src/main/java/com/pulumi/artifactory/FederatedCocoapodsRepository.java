...
import com.pulumi.artifactory.inputs.FederatedCocoapodsRepositoryState;
import com.pulumi.artifactory.outputs.FederatedCocoapodsRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository")
public class FederatedCocoapodsRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedCocoapodsRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedCocoapodsRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedCocoapodsRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedCocoapodsRepository(java.lang.String name) {
        this(name, FederatedCocoapodsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedCocoapodsRepository(java.lang.String name, FederatedCocoapodsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedCocoapodsRepository(java.lang.String name, FederatedCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedCocoapodsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedCocoapodsRepositoryArgs makeArgs(FederatedCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedCocoapodsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedCocoapodsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
