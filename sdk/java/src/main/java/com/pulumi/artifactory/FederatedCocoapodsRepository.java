...
public class FederatedCocoapodsRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedCocoapodsRepositoryMember.class})
    ...
    public FederatedCocoapodsRepository(String name, FederatedCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCocoapodsRepository:FederatedCocoapodsRepository", name, args == null ? FederatedCocoapodsRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
