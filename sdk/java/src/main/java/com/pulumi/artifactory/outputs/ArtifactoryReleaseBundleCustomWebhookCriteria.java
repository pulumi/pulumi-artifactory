...
@CustomType
public final class ArtifactoryReleaseBundleCustomWebhookCriteria {
    /**
    ...
    public static Builder builder(ArtifactoryReleaseBundleCustomWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        public Builder anyReleaseBundle(Boolean anyReleaseBundle) {
            if (anyReleaseBundle == null) {
              throw new MissingRequiredPropertyException("ArtifactoryReleaseBundleCustomWebhookCriteria", "anyReleaseBundle");
            }
        ...
        public ArtifactoryReleaseBundleCustomWebhookCriteria build() {
            final var _resultValue = new ArtifactoryReleaseBundleCustomWebhookCriteria();
