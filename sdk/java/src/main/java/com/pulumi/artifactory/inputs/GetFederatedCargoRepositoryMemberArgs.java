...
public final class GetFederatedCargoRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedCargoRepositoryMemberArgs Empty = new GetFederatedCargoRepositoryMemberArgs();
    ...
    private GetFederatedCargoRepositoryMemberArgs() {}

    private GetFederatedCargoRepositoryMemberArgs(GetFederatedCargoRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedCargoRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedCargoRepositoryMemberArgs();
        }

        public Builder(GetFederatedCargoRepositoryMemberArgs defaults) {
            $ = new GetFederatedCargoRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedCargoRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedCargoRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedCargoRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
