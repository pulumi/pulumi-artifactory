...
import com.pulumi.artifactory.inputs.LocalNixRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localNixRepository:LocalNixRepository")
public class LocalNixRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalNixRepository(java.lang.String name) {
        this(name, LocalNixRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalNixRepository(java.lang.String name, LocalNixRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalNixRepository(java.lang.String name, LocalNixRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNixRepository:LocalNixRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalNixRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalNixRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNixRepository:LocalNixRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalNixRepositoryArgs makeArgs(LocalNixRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalNixRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalNixRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalNixRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalNixRepository(name, id, state, options);
    }
}
