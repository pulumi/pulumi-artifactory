...
public class LocalNpmRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalNpmRepository(String name) {
     ...
     */
    public LocalNpmRepository(String name, LocalNpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalNpmRepository(String name, LocalNpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNpmRepository:LocalNpmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LocalNpmRepository(String name, Output<String> id, @Nullable LocalNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNpmRepository:LocalNpmRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalNpmRepository get(String name, Output<String> id, @Nullable LocalNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
