...
import com.pulumi.artifactory.inputs.LocalNpmRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localNpmRepository:LocalNpmRepository")
public class LocalNpmRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalNpmRepository(java.lang.String name) {
        this(name, LocalNpmRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalNpmRepository(java.lang.String name, LocalNpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalNpmRepository(java.lang.String name, LocalNpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNpmRepository:LocalNpmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalNpmRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localNpmRepository:LocalNpmRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalNpmRepositoryArgs makeArgs(LocalNpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalNpmRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalNpmRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalNpmRepository(name, id, state, options);
    }
}
