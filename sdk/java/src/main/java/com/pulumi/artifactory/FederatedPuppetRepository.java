...
import com.pulumi.artifactory.inputs.FederatedPuppetRepositoryState;
import com.pulumi.artifactory.outputs.FederatedPuppetRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedPuppetRepository:FederatedPuppetRepository")
public class FederatedPuppetRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedPuppetRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedPuppetRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedPuppetRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedPuppetRepository(java.lang.String name) {
        this(name, FederatedPuppetRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedPuppetRepository(java.lang.String name, FederatedPuppetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedPuppetRepository(java.lang.String name, FederatedPuppetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedPuppetRepository:FederatedPuppetRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedPuppetRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedPuppetRepository:FederatedPuppetRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedPuppetRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
