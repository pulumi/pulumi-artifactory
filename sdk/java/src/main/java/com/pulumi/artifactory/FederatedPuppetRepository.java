...
public class FederatedPuppetRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedPuppetRepositoryMember.class})
     ...
     */
    public FederatedPuppetRepository(String name) {
     ...
     */
    public FederatedPuppetRepository(String name, FederatedPuppetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedPuppetRepository get(String name, Output<String> id, @Nullable FederatedPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
