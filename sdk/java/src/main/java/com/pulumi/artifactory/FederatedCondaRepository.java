...
public class FederatedCondaRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedCondaRepository(java.lang.String name) {
     ...
     */
    public FederatedCondaRepository(java.lang.String name, FederatedCondaRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedCondaRepository(java.lang.String name, FederatedCondaRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCondaRepository:FederatedCondaRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedCondaRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCondaRepository:FederatedCondaRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedCondaRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
