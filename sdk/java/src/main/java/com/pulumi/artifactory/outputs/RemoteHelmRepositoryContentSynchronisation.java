...
@CustomType
public final class RemoteHelmRepositoryContentSynchronisation {
    ...
    private RemoteHelmRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteHelmRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteHelmRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteHelmRepositoryContentSynchronisation build() {
            return new RemoteHelmRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
