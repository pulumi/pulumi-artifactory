...
import com.pulumi.artifactory.inputs.VirtualDockerRepositoryState;
...
public class VirtualDockerRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="resolveDockerTagsByTimestamp", refs={Boolean.class}, tree="[0]")
    ...
    public Output<Optional<Boolean>> resolveDockerTagsByTimestamp() {
        return Codegen.optional(this.resolveDockerTagsByTimestamp);
    }
     ...
     */
    public VirtualDockerRepository(java.lang.String name) {
        this(name, VirtualDockerRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VirtualDockerRepository(java.lang.String name, VirtualDockerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualDockerRepository(java.lang.String name, VirtualDockerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualDockerRepository:VirtualDockerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualDockerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualDockerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualDockerRepository:VirtualDockerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VirtualDockerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualDockerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
