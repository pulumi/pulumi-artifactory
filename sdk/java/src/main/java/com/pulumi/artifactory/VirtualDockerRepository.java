 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.index_virtualDockerRepository.VirtualDockerRepository;
 * import com.pulumi.artifactory.index_virtualDockerRepository.VirtualDockerRepositoryArgs;
 * import java.util.List;
...
public class VirtualDockerRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualDockerRepository(String name) {
     ...
     */
    public VirtualDockerRepository(String name, VirtualDockerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static VirtualDockerRepository get(String name, Output<String> id, @Nullable VirtualDockerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
