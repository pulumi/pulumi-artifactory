...
import com.pulumi.artifactory.inputs.LocalSwiftRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localSwiftRepository:LocalSwiftRepository")
public class LocalSwiftRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalSwiftRepository(java.lang.String name) {
        this(name, LocalSwiftRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalSwiftRepository(java.lang.String name, LocalSwiftRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalSwiftRepository(java.lang.String name, LocalSwiftRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localSwiftRepository:LocalSwiftRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalSwiftRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalSwiftRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localSwiftRepository:LocalSwiftRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalSwiftRepositoryArgs makeArgs(LocalSwiftRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalSwiftRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalSwiftRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalSwiftRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalSwiftRepository(name, id, state, options);
    }
}
