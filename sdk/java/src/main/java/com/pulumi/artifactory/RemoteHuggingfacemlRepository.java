...
public class RemoteHuggingfacemlRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteHuggingfacemlRepositoryContentSynchronisation.class, parameters={})
     ...
     */
    public RemoteHuggingfacemlRepository(String name) {
     ...
     */
    public RemoteHuggingfacemlRepository(String name, RemoteHuggingfacemlRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteHuggingfacemlRepository get(String name, Output<String> id, @Nullable RemoteHuggingfacemlRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
