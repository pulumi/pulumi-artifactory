...
import com.pulumi.artifactory.inputs.RemoteHuggingfacemlRepositoryState;
import com.pulumi.artifactory.outputs.RemoteHuggingfacemlRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteHuggingfacemlRepository:RemoteHuggingfacemlRepository")
public class RemoteHuggingfacemlRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    public Output<Optional<RemoteHuggingfacemlRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    /**
     * @return Enable token (Bearer) based authentication. Unlike most remote package types (default `false`), Hugging Face remotes default to `true`.
     * 
     */
     ...
     */
    public RemoteHuggingfacemlRepository(java.lang.String name) {
        this(name, RemoteHuggingfacemlRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteHuggingfacemlRepository(java.lang.String name, RemoteHuggingfacemlRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteHuggingfacemlRepository(java.lang.String name, RemoteHuggingfacemlRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteHuggingfacemlRepository:RemoteHuggingfacemlRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteHuggingfacemlRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteHuggingfacemlRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteHuggingfacemlRepository:RemoteHuggingfacemlRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteHuggingfacemlRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteHuggingfacemlRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
