...
public class DockerCustomWebhook extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="criteria", type=DockerCustomWebhookCriteria.class, parameters={})
     ...
     * 
     */
    @Export(name="handlers", type=List.class, parameters={DockerCustomWebhookHandler.class})
