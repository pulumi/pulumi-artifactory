...
public final class GetRemoteChefRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteChefRepositoryContentSynchronisationArgs Empty = new GetRemoteChefRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteChefRepositoryContentSynchronisationArgs() {}

    private GetRemoteChefRepositoryContentSynchronisationArgs(GetRemoteChefRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteChefRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteChefRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteChefRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteChefRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteChefRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
