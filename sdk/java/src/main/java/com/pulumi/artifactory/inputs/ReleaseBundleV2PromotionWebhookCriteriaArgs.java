...
public final class ReleaseBundleV2PromotionWebhookCriteriaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ReleaseBundleV2PromotionWebhookCriteriaArgs() {}

    private ReleaseBundleV2PromotionWebhookCriteriaArgs(ReleaseBundleV2PromotionWebhookCriteriaArgs $) {
    ...
    public static Builder builder(ReleaseBundleV2PromotionWebhookCriteriaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseBundleV2PromotionWebhookCriteriaArgs();
        }

        public Builder(ReleaseBundleV2PromotionWebhookCriteriaArgs defaults) {
        ...
        public ReleaseBundleV2PromotionWebhookCriteriaArgs build() {
            if ($.selectedEnvironments == null) {
                throw new MissingRequiredPropertyException("ReleaseBundleV2PromotionWebhookCriteriaArgs", "selectedEnvironments");
            }
            return $;
        }
    }
