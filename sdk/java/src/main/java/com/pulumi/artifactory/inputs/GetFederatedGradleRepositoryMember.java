...
public final class GetFederatedGradleRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedGradleRepositoryMember Empty = new GetFederatedGradleRepositoryMember();
    ...
    private GetFederatedGradleRepositoryMember() {}

    private GetFederatedGradleRepositoryMember(GetFederatedGradleRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedGradleRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedGradleRepositoryMember();
        }

        public Builder(GetFederatedGradleRepositoryMember defaults) {
            $ = new GetFederatedGradleRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedGradleRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedGradleRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedGradleRepositoryMember", "url");
            }
            return $;
        }
    }
