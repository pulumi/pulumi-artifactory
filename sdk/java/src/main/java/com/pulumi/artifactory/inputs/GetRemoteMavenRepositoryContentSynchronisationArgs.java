...
public final class GetRemoteMavenRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteMavenRepositoryContentSynchronisationArgs Empty = new GetRemoteMavenRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteMavenRepositoryContentSynchronisationArgs() {}

    private GetRemoteMavenRepositoryContentSynchronisationArgs(GetRemoteMavenRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteMavenRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteMavenRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteMavenRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteMavenRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteMavenRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
