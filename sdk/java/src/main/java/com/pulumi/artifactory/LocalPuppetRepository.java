...
import com.pulumi.artifactory.inputs.LocalPuppetRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localPuppetRepository:LocalPuppetRepository")
public class LocalPuppetRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalPuppetRepository(java.lang.String name) {
        this(name, LocalPuppetRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalPuppetRepository(java.lang.String name, LocalPuppetRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalPuppetRepository(java.lang.String name, LocalPuppetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localPuppetRepository:LocalPuppetRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalPuppetRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localPuppetRepository:LocalPuppetRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalPuppetRepositoryArgs makeArgs(LocalPuppetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalPuppetRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalPuppetRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalPuppetRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalPuppetRepository(name, id, state, options);
    }
}
