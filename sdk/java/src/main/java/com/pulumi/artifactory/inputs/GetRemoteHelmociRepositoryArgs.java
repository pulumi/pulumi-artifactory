...
import com.pulumi.artifactory.inputs.GetRemoteHelmociRepositoryContentSynchronisationArgs;
...
public final class GetRemoteHelmociRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteHelmociRepositoryArgs Empty = new GetRemoteHelmociRepositoryArgs();
    ...
    private @Nullable Output<GetRemoteHelmociRepositoryContentSynchronisationArgs> contentSynchronisation;

    public Optional<Output<GetRemoteHelmociRepositoryContentSynchronisationArgs>> contentSynchronisation() {
    ...
    private GetRemoteHelmociRepositoryArgs() {}

    private GetRemoteHelmociRepositoryArgs(GetRemoteHelmociRepositoryArgs $) {
    ...
    public static Builder builder(GetRemoteHelmociRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteHelmociRepositoryArgs();
        }

        public Builder(GetRemoteHelmociRepositoryArgs defaults) {
            $ = new GetRemoteHelmociRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable Output<GetRemoteHelmociRepositoryContentSynchronisationArgs> contentSynchronisation) {
            $.contentSynchronisation = contentSynchronisation;
            return this;
        }

        public Builder contentSynchronisation(GetRemoteHelmociRepositoryContentSynchronisationArgs contentSynchronisation) {
        ...
        /**
         * @param externalDependenciesPatterns (Optional) Optional include patterns to match external URLs. Ant-style path expressions are supported (*, **, ?). For example, specifying `**{@literal /}github.com/**` will only allow downloading foreign layers from github.com host. Due to SDKv2 limitations, we can&#39;t set the default value for the list. This value `[**]` must be assigned to the attribute manually, if user don&#39;t specify any other non-default values. We don&#39;t want to make this attribute required, but it must be set to avoid the state drift on update. Note: Artifactory assigns `[**]` on update if HCL doesn&#39;t have the attribute set or the list is empty.
         * 
         * @return builder
         * 
         */
        ...
        public GetRemoteHelmociRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetRemoteHelmociRepositoryArgs", "key");
            }
            return $;
        }
    }
