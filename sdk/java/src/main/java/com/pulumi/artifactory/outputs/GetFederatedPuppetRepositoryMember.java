...
@CustomType
public final class GetFederatedPuppetRepositoryMember {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetFederatedPuppetRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetFederatedPuppetRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
        public GetFederatedPuppetRepositoryMember build() {
            final var _resultValue = new GetFederatedPuppetRepositoryMember();
