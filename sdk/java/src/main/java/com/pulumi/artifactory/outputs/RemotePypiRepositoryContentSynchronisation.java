...
@CustomType
public final class RemotePypiRepositoryContentSynchronisation {
    ...
    private RemotePypiRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemotePypiRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemotePypiRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemotePypiRepositoryContentSynchronisation build() {
            return new RemotePypiRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
