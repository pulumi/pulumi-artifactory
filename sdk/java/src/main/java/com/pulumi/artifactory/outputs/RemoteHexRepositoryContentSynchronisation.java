...
@CustomType
public final class RemoteHexRepositoryContentSynchronisation {
    /**
    ...
    private RemoteHexRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteHexRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteHexRepositoryContentSynchronisation defaults) {
        ...
        public RemoteHexRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteHexRepositoryContentSynchronisation();
