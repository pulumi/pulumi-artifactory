...
import com.pulumi.artifactory.inputs.RemoteCranRepositoryState;
import com.pulumi.artifactory.outputs.RemoteCranRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteCranRepository:RemoteCranRepository")
public class RemoteCranRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteCranRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteCranRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteCranRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteCranRepository(java.lang.String name) {
        this(name, RemoteCranRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteCranRepository(java.lang.String name, RemoteCranRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteCranRepository(java.lang.String name, RemoteCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCranRepository:RemoteCranRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteCranRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCranRepository:RemoteCranRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteCranRepositoryArgs makeArgs(RemoteCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteCranRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteCranRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteCranRepository(name, id, state, options);
    }
}
