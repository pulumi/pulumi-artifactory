...
import com.pulumi.artifactory.inputs.RemoteConanRepositoryState;
import com.pulumi.artifactory.outputs.RemoteConanRepositoryContentSynchronisation;
...
public class RemoteConanRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteConanRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteConanRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteConanRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteConanRepository(java.lang.String name) {
        this(name, RemoteConanRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteConanRepository(java.lang.String name, RemoteConanRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteConanRepository(java.lang.String name, RemoteConanRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteConanRepository:RemoteConanRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteConanRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteConanRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteConanRepository:RemoteConanRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteConanRepositoryArgs makeArgs(RemoteConanRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteConanRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteConanRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteConanRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
