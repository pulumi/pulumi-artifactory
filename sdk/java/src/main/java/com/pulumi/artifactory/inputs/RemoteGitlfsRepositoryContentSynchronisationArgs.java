...
public final class RemoteGitlfsRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteGitlfsRepositoryContentSynchronisationArgs Empty = new RemoteGitlfsRepositoryContentSynchronisationArgs();
    ...
    private RemoteGitlfsRepositoryContentSynchronisationArgs() {}

    private RemoteGitlfsRepositoryContentSynchronisationArgs(RemoteGitlfsRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteGitlfsRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGitlfsRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteGitlfsRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteGitlfsRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
