...
@CustomType
public final class RemoteNugetRepositoryContentSynchronisation {
    ...
    private RemoteNugetRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteNugetRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteNugetRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteNugetRepositoryContentSynchronisation build() {
            return new RemoteNugetRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
