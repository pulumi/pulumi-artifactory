...
public final class GetVirtualGenericRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualGenericRepositoryArgs Empty = new GetVirtualGenericRepositoryArgs();
    ...
    private GetVirtualGenericRepositoryArgs() {}

    private GetVirtualGenericRepositoryArgs(GetVirtualGenericRepositoryArgs $) {
    ...
    public static Builder builder(GetVirtualGenericRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualGenericRepositoryArgs();
        }

        public Builder(GetVirtualGenericRepositoryArgs defaults) {
            $ = new GetVirtualGenericRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualGenericRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualGenericRepositoryArgs", "key");
            }
            return $;
        }
    }
