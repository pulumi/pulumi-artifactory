...
public final class GetVirtualTerraformRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualTerraformRepositoryArgs Empty = new GetVirtualTerraformRepositoryArgs();
    ...
    private GetVirtualTerraformRepositoryArgs() {}

    private GetVirtualTerraformRepositoryArgs(GetVirtualTerraformRepositoryArgs $) {
    ...
    public static Builder builder(GetVirtualTerraformRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualTerraformRepositoryArgs();
        }

        public Builder(GetVirtualTerraformRepositoryArgs defaults) {
            $ = new GetVirtualTerraformRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualTerraformRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualTerraformRepositoryArgs", "key");
            }
            return $;
        }
    }
