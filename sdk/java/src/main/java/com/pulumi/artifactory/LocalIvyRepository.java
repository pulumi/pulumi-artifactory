...
public class LocalIvyRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalIvyRepository(java.lang.String name) {
     ...
     */
    public LocalIvyRepository(java.lang.String name, LocalIvyRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalIvyRepository(java.lang.String name, LocalIvyRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localIvyRepository:LocalIvyRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalIvyRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalIvyRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localIvyRepository:LocalIvyRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalIvyRepositoryArgs makeArgs(LocalIvyRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalIvyRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalIvyRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalIvyRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
