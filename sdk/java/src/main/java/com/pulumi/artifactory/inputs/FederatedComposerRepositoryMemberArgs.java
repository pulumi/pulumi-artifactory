...
public final class FederatedComposerRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedComposerRepositoryMemberArgs Empty = new FederatedComposerRepositoryMemberArgs();
    ...
    private FederatedComposerRepositoryMemberArgs() {}

    private FederatedComposerRepositoryMemberArgs(FederatedComposerRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedComposerRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedComposerRepositoryMemberArgs();
        }

        public Builder(FederatedComposerRepositoryMemberArgs defaults) {
            $ = new FederatedComposerRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedComposerRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedComposerRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedComposerRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
