...
public final class VirtualP2RepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualP2RepositoryArgs Empty = new VirtualP2RepositoryArgs();
    ...
    private VirtualP2RepositoryArgs() {}

    private VirtualP2RepositoryArgs(VirtualP2RepositoryArgs $) {
    ...
    public static Builder builder(VirtualP2RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualP2RepositoryArgs();
        }

        public Builder(VirtualP2RepositoryArgs defaults) {
            $ = new VirtualP2RepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualP2RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("VirtualP2RepositoryArgs", "key");
            }
            return $;
        }
    }
