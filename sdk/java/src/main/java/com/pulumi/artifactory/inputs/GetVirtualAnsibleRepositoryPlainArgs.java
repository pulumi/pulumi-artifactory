...
public final class GetVirtualAnsibleRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualAnsibleRepositoryPlainArgs Empty = new GetVirtualAnsibleRepositoryPlainArgs();
    ...
    private GetVirtualAnsibleRepositoryPlainArgs() {}

    private GetVirtualAnsibleRepositoryPlainArgs(GetVirtualAnsibleRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualAnsibleRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualAnsibleRepositoryPlainArgs();
        }

        public Builder(GetVirtualAnsibleRepositoryPlainArgs defaults) {
            $ = new GetVirtualAnsibleRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualAnsibleRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualAnsibleRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
