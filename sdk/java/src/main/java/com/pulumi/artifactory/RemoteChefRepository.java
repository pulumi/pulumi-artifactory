...
import com.pulumi.artifactory.inputs.RemoteChefRepositoryState;
import com.pulumi.artifactory.outputs.RemoteChefRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteChefRepository:RemoteChefRepository")
public class RemoteChefRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteChefRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteChefRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteChefRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteChefRepository(java.lang.String name) {
        this(name, RemoteChefRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteChefRepository(java.lang.String name, RemoteChefRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteChefRepository(java.lang.String name, RemoteChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteChefRepository:RemoteChefRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteChefRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteChefRepository:RemoteChefRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteChefRepositoryArgs makeArgs(RemoteChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteChefRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteChefRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteChefRepository(name, id, state, options);
    }
}
