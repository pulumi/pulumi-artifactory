...
@CustomType
public final class RemoteAlpineRepositoryContentSynchronisation {
    ...
    public static Builder builder(RemoteAlpineRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteAlpineRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteAlpineRepositoryContentSynchronisation build() {
            return new RemoteAlpineRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
