...
public class RemotePubRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemotePubRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemotePubRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemotePubRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemotePubRepository(java.lang.String name) {
     ...
     */
    public RemotePubRepository(java.lang.String name, RemotePubRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemotePubRepository(java.lang.String name, RemotePubRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remotePubRepository:RemotePubRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemotePubRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemotePubRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remotePubRepository:RemotePubRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemotePubRepositoryArgs makeArgs(RemotePubRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemotePubRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemotePubRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemotePubRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
