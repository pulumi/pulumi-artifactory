...
@CustomType
public final class ReleaseBundleV2PromotionCustomWebhookCriteria {
    ...
    public static Builder builder(ReleaseBundleV2PromotionCustomWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> selectedEnvironments;
        public Builder() {}
        public Builder(ReleaseBundleV2PromotionCustomWebhookCriteria defaults) {
        ...
        public Builder selectedEnvironments(List<String> selectedEnvironments) {
            if (selectedEnvironments == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleV2PromotionCustomWebhookCriteria", "selectedEnvironments");
            }
        ...
        public ReleaseBundleV2PromotionCustomWebhookCriteria build() {
            final var _resultValue = new ReleaseBundleV2PromotionCustomWebhookCriteria();
