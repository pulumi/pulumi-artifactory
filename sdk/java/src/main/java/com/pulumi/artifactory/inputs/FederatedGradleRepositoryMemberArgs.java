...
public final class FederatedGradleRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedGradleRepositoryMemberArgs Empty = new FederatedGradleRepositoryMemberArgs();
    ...
    private FederatedGradleRepositoryMemberArgs() {}

    private FederatedGradleRepositoryMemberArgs(FederatedGradleRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedGradleRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedGradleRepositoryMemberArgs();
        }

        public Builder(FederatedGradleRepositoryMemberArgs defaults) {
            $ = new FederatedGradleRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedGradleRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedGradleRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedGradleRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
