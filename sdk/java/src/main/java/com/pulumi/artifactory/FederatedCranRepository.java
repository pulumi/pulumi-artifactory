...
public class FederatedCranRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedCranRepository(java.lang.String name) {
     ...
     */
    public FederatedCranRepository(java.lang.String name, FederatedCranRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedCranRepository(java.lang.String name, FederatedCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCranRepository:FederatedCranRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedCranRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedCranRepository:FederatedCranRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedCranRepositoryArgs makeArgs(FederatedCranRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedCranRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedCranRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedCranRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
