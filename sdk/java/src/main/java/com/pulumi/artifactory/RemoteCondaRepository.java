...
import com.pulumi.artifactory.inputs.RemoteCondaRepositoryState;
import com.pulumi.artifactory.outputs.RemoteCondaRepositoryContentSynchronisation;
...
public class RemoteCondaRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteCondaRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteCondaRepositoryContentSynchronisation> contentSynchronisation;
     ...
     */
    public RemoteCondaRepository(java.lang.String name) {
        this(name, RemoteCondaRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteCondaRepository(java.lang.String name, RemoteCondaRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteCondaRepository(java.lang.String name, RemoteCondaRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCondaRepository:RemoteCondaRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteCondaRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCondaRepository:RemoteCondaRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteCondaRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteCondaRepository(name, id, state, options);
    }
}
