...
public class RemoteCondaRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteCondaRepositoryContentSynchronisation.class, parameters={})
     ...
     */
    public RemoteCondaRepository(String name) {
     ...
     */
    public RemoteCondaRepository(String name, RemoteCondaRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteCondaRepository get(String name, Output<String> id, @Nullable RemoteCondaRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
