...
public final class GetFederatedOciRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedOciRepositoryMemberArgs Empty = new GetFederatedOciRepositoryMemberArgs();
    ...
    private GetFederatedOciRepositoryMemberArgs() {}

    private GetFederatedOciRepositoryMemberArgs(GetFederatedOciRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedOciRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedOciRepositoryMemberArgs();
        }

        public Builder(GetFederatedOciRepositoryMemberArgs defaults) {
            $ = new GetFederatedOciRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedOciRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedOciRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedOciRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
