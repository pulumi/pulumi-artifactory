...
public final class GetFederatedChefRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedChefRepositoryMemberArgs Empty = new GetFederatedChefRepositoryMemberArgs();
    ...
    private GetFederatedChefRepositoryMemberArgs() {}

    private GetFederatedChefRepositoryMemberArgs(GetFederatedChefRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedChefRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedChefRepositoryMemberArgs();
        }

        public Builder(GetFederatedChefRepositoryMemberArgs defaults) {
            $ = new GetFederatedChefRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedChefRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedChefRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedChefRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
