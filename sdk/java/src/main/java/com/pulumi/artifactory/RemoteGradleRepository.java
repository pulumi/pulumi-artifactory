...
public class RemoteGradleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteGradleRepository(String name) {
     ...
     */
    public static RemoteGradleRepository get(String name, Output<String> id, @Nullable RemoteGradleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
