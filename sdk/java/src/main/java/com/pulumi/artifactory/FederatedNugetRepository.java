...
import com.pulumi.artifactory.inputs.FederatedNugetRepositoryState;
import com.pulumi.artifactory.outputs.FederatedNugetRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedNugetRepository:FederatedNugetRepository")
public class FederatedNugetRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedNugetRepositoryMember.class})
    private Output<List<FederatedNugetRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedNugetRepositoryMember>> members() {
        return this.members;
    }
    /**
    ...
    public FederatedNugetRepository(String name, FederatedNugetRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedNugetRepository:FederatedNugetRepository", name, args == null ? FederatedNugetRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
