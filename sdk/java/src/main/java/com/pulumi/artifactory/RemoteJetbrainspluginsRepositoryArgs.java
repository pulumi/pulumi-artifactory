...
import com.pulumi.artifactory.inputs.RemoteJetbrainspluginsRepositoryContentSynchronisationArgs;
...
public final class RemoteJetbrainspluginsRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteJetbrainspluginsRepositoryArgs Empty = new RemoteJetbrainspluginsRepositoryArgs();
    ...
    private @Nullable Output<RemoteJetbrainspluginsRepositoryContentSynchronisationArgs> contentSynchronisation;

    public Optional<Output<RemoteJetbrainspluginsRepositoryContentSynchronisationArgs>> contentSynchronisation() {
    ...
    private RemoteJetbrainspluginsRepositoryArgs() {}

    private RemoteJetbrainspluginsRepositoryArgs(RemoteJetbrainspluginsRepositoryArgs $) {
    ...
    public static Builder builder(RemoteJetbrainspluginsRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteJetbrainspluginsRepositoryArgs();
        }

        public Builder(RemoteJetbrainspluginsRepositoryArgs defaults) {
            $ = new RemoteJetbrainspluginsRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable Output<RemoteJetbrainspluginsRepositoryContentSynchronisationArgs> contentSynchronisation) {
            $.contentSynchronisation = contentSynchronisation;
            return this;
        }

        public Builder contentSynchronisation(RemoteJetbrainspluginsRepositoryContentSynchronisationArgs contentSynchronisation) {
        ...
        /**
         * @param notes `repoLayoutRef` defaults to `simple-default`.
         * 
         * There are no JetBrains Plugins specific attributes: the package type contributes only `url` to the
         * repository contract, so everything else comes from the common remote repository arguments.
         * 
        ...
        /**
         * @param url The remote repo URL. Use `https://plugins.jetbrains.com` for the JetBrains Marketplace.
         * Artifactory applies no default URL over the REST API and rejects the request with
         * `No URL defined for remote repository` if it is omitted.
         * 
         * @return builder
        ...
        public RemoteJetbrainspluginsRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("RemoteJetbrainspluginsRepositoryArgs", "key");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("RemoteJetbrainspluginsRepositoryArgs", "url");
            }
            return $;
        }
    }
