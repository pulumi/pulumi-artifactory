...
@CustomType
public final class GetFederatedHelmRepositoryMember {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetFederatedHelmRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetFederatedHelmRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
