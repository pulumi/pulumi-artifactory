...
public class LocalMavenRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalMavenRepository(java.lang.String name) {
     ...
     */
    public LocalMavenRepository(java.lang.String name, LocalMavenRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalMavenRepository(java.lang.String name, LocalMavenRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localMavenRepository:LocalMavenRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalMavenRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalMavenRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localMavenRepository:LocalMavenRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalMavenRepositoryArgs makeArgs(LocalMavenRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalMavenRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalMavenRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalMavenRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
