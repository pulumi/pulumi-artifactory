...
@CustomType
public final class RemoteBowerRepositoryContentSynchronisation {
    ...
    private RemoteBowerRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteBowerRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteBowerRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteBowerRepositoryContentSynchronisation build() {
            return new RemoteBowerRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
