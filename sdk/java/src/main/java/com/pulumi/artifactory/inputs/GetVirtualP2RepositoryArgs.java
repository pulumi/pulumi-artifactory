...
public final class GetVirtualP2RepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualP2RepositoryArgs Empty = new GetVirtualP2RepositoryArgs();
    ...
    private GetVirtualP2RepositoryArgs() {}

    private GetVirtualP2RepositoryArgs(GetVirtualP2RepositoryArgs $) {
    ...
    public static Builder builder(GetVirtualP2RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualP2RepositoryArgs();
        }

        public Builder(GetVirtualP2RepositoryArgs defaults) {
            $ = new GetVirtualP2RepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualP2RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualP2RepositoryArgs", "key");
            }
            return $;
        }
    }
