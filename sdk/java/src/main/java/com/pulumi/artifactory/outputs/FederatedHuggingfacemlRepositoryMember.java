...
public final class FederatedHuggingfacemlRepositoryMember {
    ...
    public static Builder builder(FederatedHuggingfacemlRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(FederatedHuggingfacemlRepositoryMember defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedHuggingfacemlRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedHuggingfacemlRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
        public FederatedHuggingfacemlRepositoryMember build() {
            final var _resultValue = new FederatedHuggingfacemlRepositoryMember();
