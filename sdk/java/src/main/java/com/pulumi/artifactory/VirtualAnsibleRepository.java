...
public class VirtualAnsibleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualAnsibleRepository(String name) {
     ...
     */
    public VirtualAnsibleRepository(String name, VirtualAnsibleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static VirtualAnsibleRepository get(String name, Output<String> id, @Nullable VirtualAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
