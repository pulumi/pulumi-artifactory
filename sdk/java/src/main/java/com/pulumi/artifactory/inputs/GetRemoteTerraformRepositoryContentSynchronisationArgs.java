...
public final class GetRemoteTerraformRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteTerraformRepositoryContentSynchronisationArgs Empty = new GetRemoteTerraformRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteTerraformRepositoryContentSynchronisationArgs() {}

    private GetRemoteTerraformRepositoryContentSynchronisationArgs(GetRemoteTerraformRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteTerraformRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteTerraformRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteTerraformRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteTerraformRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteTerraformRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
