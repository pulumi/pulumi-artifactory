...
public final class GetVirtualAlpineRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualAlpineRepositoryPlainArgs Empty = new GetVirtualAlpineRepositoryPlainArgs();
    ...
    private GetVirtualAlpineRepositoryPlainArgs() {}

    private GetVirtualAlpineRepositoryPlainArgs(GetVirtualAlpineRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualAlpineRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualAlpineRepositoryPlainArgs();
        }

        public Builder(GetVirtualAlpineRepositoryPlainArgs defaults) {
            $ = new GetVirtualAlpineRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualAlpineRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualAlpineRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
