...
@CustomType
public final class GetFederatedTerraformProviderRepositoryMember {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetFederatedTerraformProviderRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetFederatedTerraformProviderRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
