...
public final class FederatedDockerV2RepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final FederatedDockerV2RepositoryState Empty = new FederatedDockerV2RepositoryState();
     ...
     */
    @Import(name="members")
    private @Nullable Output<List<FederatedDockerV2RepositoryMemberArgs>> members;
     ...
     * 
     */
    public Optional<Output<List<FederatedDockerV2RepositoryMemberArgs>>> members() {
    ...
    private FederatedDockerV2RepositoryState() {}

    private FederatedDockerV2RepositoryState(FederatedDockerV2RepositoryState $) {
    ...
    public static Builder builder(FederatedDockerV2RepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedDockerV2RepositoryState();
        }

        public Builder(FederatedDockerV2RepositoryState defaults) {
            $ = new FederatedDockerV2RepositoryState(Objects.requireNonNull(defaults));
        }

        /**
         * @param apiVersion The Docker API version to use. This cannot be set
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder members(@Nullable Output<List<FederatedDockerV2RepositoryMemberArgs>> members) {
            $.members = members;
            return this;
        }
        ...
        public FederatedDockerV2RepositoryState build() {
            return $;
        }
    }
