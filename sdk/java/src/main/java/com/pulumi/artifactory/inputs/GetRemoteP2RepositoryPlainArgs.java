...
public final class GetRemoteP2RepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteP2RepositoryPlainArgs Empty = new GetRemoteP2RepositoryPlainArgs();
    ...
    private @Nullable GetRemoteP2RepositoryContentSynchronisation contentSynchronisation;

    public Optional<GetRemoteP2RepositoryContentSynchronisation> contentSynchronisation() {
    ...
    private GetRemoteP2RepositoryPlainArgs() {}
    ...
    public static Builder builder(GetRemoteP2RepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteP2RepositoryPlainArgs();
        }

        public Builder(GetRemoteP2RepositoryPlainArgs defaults) {
            $ = new GetRemoteP2RepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable GetRemoteP2RepositoryContentSynchronisation contentSynchronisation) {
