...
import com.pulumi.artifactory.inputs.RemoteHexRepositoryContentSynchronisationArgs;
...
public final class RemoteHexRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteHexRepositoryArgs Empty = new RemoteHexRepositoryArgs();
    ...
    private @Nullable Output<RemoteHexRepositoryContentSynchronisationArgs> contentSynchronisation;

    public Optional<Output<RemoteHexRepositoryContentSynchronisationArgs>> contentSynchronisation() {
     ...
     * 
     */
    @Import(name="hexPrimaryKeypairRef", required=true)
    ...
    private RemoteHexRepositoryArgs() {}

    private RemoteHexRepositoryArgs(RemoteHexRepositoryArgs $) {
    ...
    public static Builder builder(RemoteHexRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteHexRepositoryArgs();
        }

        public Builder(RemoteHexRepositoryArgs defaults) {
            $ = new RemoteHexRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable Output<RemoteHexRepositoryContentSynchronisationArgs> contentSynchronisation) {
            $.contentSynchronisation = contentSynchronisation;
            return this;
        }

        public Builder contentSynchronisation(RemoteHexRepositoryContentSynchronisationArgs contentSynchronisation) {
        ...
        /**
         * @param enableTokenAuthentication Enable token (Bearer) based authentication. When set, use an access token as `password` (username may be empty) so Artifactory authenticates to the remote with a Bearer token instead of Basic auth. Default is `false` for most package types; OCI, Helm OCI, and Hugging Face remotes default to `true`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param hexPrimaryKeypairRef Select the RSA key pair to sign and encrypt content for secure communication between Artifactory and the Mix client.
         * 
         * @return builder
         * 
         */
        public Builder hexPrimaryKeypairRef(Output<String> hexPrimaryKeypairRef) {
        ...
        public Builder hexPrimaryKeypairRef(String hexPrimaryKeypairRef) {
            return hexPrimaryKeypairRef(Output.of(hexPrimaryKeypairRef));
        }
        ...
        /**
         * @param publicKey Contains the public key used when downloading packages from the Hex remote registry (public, private, or self-hosted Hex server).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param url The remote repo URL. For the official Hex registry, use `https://repo.hex.pm`.
         * 
         * @return builder
         * 
         */
        ...
        public RemoteHexRepositoryArgs build() {
            if ($.hexPrimaryKeypairRef == null) {
                throw new MissingRequiredPropertyException("RemoteHexRepositoryArgs", "hexPrimaryKeypairRef");
            }
            if ($.key == null) {
                throw new MissingRequiredPropertyException("RemoteHexRepositoryArgs", "key");
            }
            if ($.publicKey == null) {
                throw new MissingRequiredPropertyException("RemoteHexRepositoryArgs", "publicKey");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("RemoteHexRepositoryArgs", "url");
            }
            return $;
        }
    }
