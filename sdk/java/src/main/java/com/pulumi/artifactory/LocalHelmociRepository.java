...
public class LocalHelmociRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalHelmociRepository(String name) {
     ...
     */
    public LocalHelmociRepository(String name, LocalHelmociRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static LocalHelmociRepository get(String name, Output<String> id, @Nullable LocalHelmociRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
