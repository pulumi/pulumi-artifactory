...
import com.pulumi.artifactory.inputs.LocalHelmociRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localHelmociRepository:LocalHelmociRepository")
public class LocalHelmociRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalHelmociRepository(java.lang.String name) {
        this(name, LocalHelmociRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalHelmociRepository(java.lang.String name, LocalHelmociRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalHelmociRepository(java.lang.String name, LocalHelmociRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localHelmociRepository:LocalHelmociRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalHelmociRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalHelmociRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localHelmociRepository:LocalHelmociRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalHelmociRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalHelmociRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
