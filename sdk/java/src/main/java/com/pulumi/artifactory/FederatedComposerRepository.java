...
import com.pulumi.artifactory.inputs.FederatedComposerRepositoryState;
import com.pulumi.artifactory.outputs.FederatedComposerRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedComposerRepository:FederatedComposerRepository")
public class FederatedComposerRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedComposerRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedComposerRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedComposerRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedComposerRepository(java.lang.String name) {
        this(name, FederatedComposerRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedComposerRepository(java.lang.String name, FederatedComposerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedComposerRepository(java.lang.String name, FederatedComposerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedComposerRepository:FederatedComposerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedComposerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedComposerRepository:FederatedComposerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedComposerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
