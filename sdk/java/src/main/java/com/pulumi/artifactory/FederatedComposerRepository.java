...
public class FederatedComposerRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedComposerRepositoryMember.class})
     ...
     */
    public FederatedComposerRepository(String name) {
     ...
     */
    public FederatedComposerRepository(String name, FederatedComposerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedComposerRepository get(String name, Output<String> id, @Nullable FederatedComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
