...
public final class RemoteP2RepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteP2RepositoryContentSynchronisationArgs Empty = new RemoteP2RepositoryContentSynchronisationArgs();
    ...
    private RemoteP2RepositoryContentSynchronisationArgs() {}

    private RemoteP2RepositoryContentSynchronisationArgs(RemoteP2RepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteP2RepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteP2RepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteP2RepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteP2RepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
