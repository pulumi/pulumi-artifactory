...
public final class GetFederatedCondaRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedCondaRepositoryMember Empty = new GetFederatedCondaRepositoryMember();
    ...
    private GetFederatedCondaRepositoryMember() {}

    private GetFederatedCondaRepositoryMember(GetFederatedCondaRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedCondaRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedCondaRepositoryMember();
        }

        public Builder(GetFederatedCondaRepositoryMember defaults) {
            $ = new GetFederatedCondaRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedCondaRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedCondaRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedCondaRepositoryMember", "url");
            }
            return $;
        }
    }
