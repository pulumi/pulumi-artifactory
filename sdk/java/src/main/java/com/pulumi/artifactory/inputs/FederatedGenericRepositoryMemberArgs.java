...
public final class FederatedGenericRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedGenericRepositoryMemberArgs Empty = new FederatedGenericRepositoryMemberArgs();
    ...
    private FederatedGenericRepositoryMemberArgs() {}

    private FederatedGenericRepositoryMemberArgs(FederatedGenericRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedGenericRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedGenericRepositoryMemberArgs();
        }

        public Builder(FederatedGenericRepositoryMemberArgs defaults) {
            $ = new FederatedGenericRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedGenericRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedGenericRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedGenericRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
