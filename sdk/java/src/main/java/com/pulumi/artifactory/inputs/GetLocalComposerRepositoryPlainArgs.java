...
public final class GetLocalComposerRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalComposerRepositoryPlainArgs Empty = new GetLocalComposerRepositoryPlainArgs();
    ...
    private GetLocalComposerRepositoryPlainArgs() {}

    private GetLocalComposerRepositoryPlainArgs(GetLocalComposerRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalComposerRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalComposerRepositoryPlainArgs();
        }

        public Builder(GetLocalComposerRepositoryPlainArgs defaults) {
            $ = new GetLocalComposerRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalComposerRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalComposerRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
