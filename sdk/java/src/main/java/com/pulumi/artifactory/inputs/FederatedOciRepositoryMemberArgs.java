...
public final class FederatedOciRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedOciRepositoryMemberArgs Empty = new FederatedOciRepositoryMemberArgs();
    ...
    private FederatedOciRepositoryMemberArgs() {}

    private FederatedOciRepositoryMemberArgs(FederatedOciRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedOciRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedOciRepositoryMemberArgs();
        }

        public Builder(FederatedOciRepositoryMemberArgs defaults) {
            $ = new FederatedOciRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedOciRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedOciRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedOciRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
