...
@CustomType
public final class DestinationWebhookHandler {
    /**
    ...
    private DestinationWebhookHandler() {}
    /**
     * @return Custom HTTP headers you wish to use to invoke the Webhook, comprise of key/value pair.
     * 
     */
    ...
    public static Builder builder(DestinationWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSecretForSigning;
        public Builder() {}
        public Builder(DestinationWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("DestinationWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public DestinationWebhookHandler build() {
            final var _resultValue = new DestinationWebhookHandler();
