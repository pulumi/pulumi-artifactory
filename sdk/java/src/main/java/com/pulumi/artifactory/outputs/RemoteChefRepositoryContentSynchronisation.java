...
@CustomType
public final class RemoteChefRepositoryContentSynchronisation {
    ...
    private RemoteChefRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteChefRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteChefRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteChefRepositoryContentSynchronisation build() {
            return new RemoteChefRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
