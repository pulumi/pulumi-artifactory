...
public final class DockerWebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final DockerWebhookHandlerArgs Empty = new DockerWebhookHandlerArgs();
    ...
    public static Builder builder(DockerWebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DockerWebhookHandlerArgs();
        }

        public Builder(DockerWebhookHandlerArgs defaults) {
            $ = new DockerWebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DockerWebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("DockerWebhookHandlerArgs", "url");
            }
            return $;
        }
    }
