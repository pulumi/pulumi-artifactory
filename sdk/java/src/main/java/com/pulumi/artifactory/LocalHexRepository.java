...
import com.pulumi.artifactory.inputs.LocalHexRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localHexRepository:LocalHexRepository")
public class LocalHexRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalHexRepository(java.lang.String name) {
        this(name, LocalHexRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalHexRepository(java.lang.String name, LocalHexRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalHexRepository(java.lang.String name, LocalHexRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localHexRepository:LocalHexRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalHexRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalHexRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localHexRepository:LocalHexRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalHexRepositoryArgs makeArgs(LocalHexRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalHexRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalHexRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalHexRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
