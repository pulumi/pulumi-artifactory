...
public final class GetRemoteHelmRepositoryContentSynchronisation extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteHelmRepositoryContentSynchronisation Empty = new GetRemoteHelmRepositoryContentSynchronisation();
    ...
    private GetRemoteHelmRepositoryContentSynchronisation(GetRemoteHelmRepositoryContentSynchronisation $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteHelmRepositoryContentSynchronisation();
        }

        public Builder(GetRemoteHelmRepositoryContentSynchronisation defaults) {
            $ = new GetRemoteHelmRepositoryContentSynchronisation(Objects.requireNonNull(defaults));
        }
