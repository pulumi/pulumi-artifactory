...
import com.pulumi.artifactory.inputs.RemoteComposerRepositoryState;
import com.pulumi.artifactory.outputs.RemoteComposerRepositoryContentSynchronisation;
...
public class RemoteComposerRepository extends com.pulumi.resources.CustomResource {
    ...
    private Output<String> composerRegistryUrl;

    /**
     * @return Proxy remote Composer repository. Default value is `https://packagist.org`.
     * 
     */
    public Output<String> composerRegistryUrl() {
    ...
    private Output</* @Nullable */ RemoteComposerRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteComposerRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteComposerRepository(java.lang.String name) {
        this(name, RemoteComposerRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteComposerRepository(java.lang.String name, RemoteComposerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteComposerRepository(java.lang.String name, RemoteComposerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteComposerRepository:RemoteComposerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteComposerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteComposerRepository:RemoteComposerRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteComposerRepositoryArgs makeArgs(RemoteComposerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteComposerRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteComposerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteComposerRepository(name, id, state, options);
    }
}
