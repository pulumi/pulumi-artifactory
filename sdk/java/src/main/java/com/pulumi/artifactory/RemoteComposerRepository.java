...
public class RemoteComposerRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteComposerRepository(String name) {
     ...
     */
    public RemoteComposerRepository(String name, RemoteComposerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteComposerRepository(String name, RemoteComposerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteComposerRepository:RemoteComposerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private RemoteComposerRepository(String name, Output<String> id, @Nullable RemoteComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteComposerRepository:RemoteComposerRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RemoteComposerRepository get(String name, Output<String> id, @Nullable RemoteComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
