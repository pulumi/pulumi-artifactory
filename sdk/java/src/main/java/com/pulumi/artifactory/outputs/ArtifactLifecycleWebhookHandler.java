...
@CustomType
public final class ArtifactLifecycleWebhookHandler {
    /**
    ...
    private ArtifactLifecycleWebhookHandler() {}
    /**
     * @return Custom HTTP headers you wish to use to invoke the Webhook, comprise of key/value pair.
     * 
     */
    ...
    public static Builder builder(ArtifactLifecycleWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useSecretForSigning;
        public Builder() {}
        public Builder(ArtifactLifecycleWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ArtifactLifecycleWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        ...
        public ArtifactLifecycleWebhookHandler build() {
            final var _resultValue = new ArtifactLifecycleWebhookHandler();
