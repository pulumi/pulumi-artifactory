...
public class RemoteVcsRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteVcsRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteVcsRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteVcsRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteVcsRepository(java.lang.String name) {
     ...
     */
    public RemoteVcsRepository(java.lang.String name, RemoteVcsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteVcsRepository(java.lang.String name, RemoteVcsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteVcsRepository:RemoteVcsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteVcsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteVcsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteVcsRepository:RemoteVcsRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteVcsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteVcsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
