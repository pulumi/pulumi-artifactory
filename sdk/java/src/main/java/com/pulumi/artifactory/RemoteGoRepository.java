...
public class RemoteGoRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteGoRepository(String name) {
     ...
     */
    public RemoteGoRepository(String name, RemoteGoRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteGoRepository(String name, RemoteGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGoRepository:RemoteGoRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private RemoteGoRepository(String name, Output<String> id, @Nullable RemoteGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGoRepository:RemoteGoRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RemoteGoRepository get(String name, Output<String> id, @Nullable RemoteGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
