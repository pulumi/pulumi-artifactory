...
import com.pulumi.artifactory.inputs.RemoteGoRepositoryState;
import com.pulumi.artifactory.outputs.RemoteGoRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteGoRepository:RemoteGoRepository")
public class RemoteGoRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteGoRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteGoRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteGoRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    private Output<String> vcsGitProvider;

    /**
     * @return Artifactory supports proxying the following Git providers out-of-the-box: GitHub (`GITHUB`), GitHub Enterprise (`GITHUBENTERPRISE`), BitBucket Cloud (`BITBUCKET`), BitBucket Server (`STASH`), GitLab (`GITLAB`), or a remote Artifactory instance (`ARTIFACTORY`). Default value is `ARTIFACTORY`.
     * 
     */
    public Output<String> vcsGitProvider() {
     ...
     */
    public RemoteGoRepository(java.lang.String name) {
        this(name, RemoteGoRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteGoRepository(java.lang.String name, RemoteGoRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteGoRepository(java.lang.String name, RemoteGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGoRepository:RemoteGoRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteGoRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGoRepository:RemoteGoRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteGoRepositoryArgs makeArgs(RemoteGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteGoRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteGoRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteGoRepository(name, id, state, options);
    }
}
