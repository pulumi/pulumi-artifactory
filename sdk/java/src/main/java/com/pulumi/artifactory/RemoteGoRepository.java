...
public class RemoteGoRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteGoRepositoryContentSynchronisation.class, parameters={})
    ...
    public RemoteGoRepository(String name, RemoteGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGoRepository:RemoteGoRepository", name, args == null ? RemoteGoRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
