...
@CustomType
public final class ReleaseBundleCustomWebhookHandler {
    /**
    ...
    private ReleaseBundleCustomWebhookHandler() {}
    /**
     * @return HTTP headers you wish to use to invoke the Webhook, comprise key/value pair.
     * 
     */
    ...
    public static Builder builder(ReleaseBundleCustomWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(ReleaseBundleCustomWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleCustomWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
