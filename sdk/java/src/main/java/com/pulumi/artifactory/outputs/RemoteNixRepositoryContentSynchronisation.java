...
@CustomType
public final class RemoteNixRepositoryContentSynchronisation {
    /**
    ...
    private RemoteNixRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteNixRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteNixRepositoryContentSynchronisation defaults) {
        ...
        public RemoteNixRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteNixRepositoryContentSynchronisation();
