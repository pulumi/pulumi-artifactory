...
public class VirtualPubRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualPubRepository(String name) {
     ...
     */
    public VirtualPubRepository(String name, VirtualPubRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualPubRepository(String name, VirtualPubRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPubRepository:VirtualPubRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualPubRepository(String name, Output<String> id, @Nullable VirtualPubRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPubRepository:VirtualPubRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static VirtualPubRepository get(String name, Output<String> id, @Nullable VirtualPubRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
