 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.index_virtualPubRepository.VirtualPubRepository;
 * import com.pulumi.artifactory.index_virtualPubRepository.VirtualPubRepositoryArgs;
 * import java.util.List;
...
public class VirtualPubRepository extends com.pulumi.resources.CustomResource {
    ...
    public VirtualPubRepository(String name, VirtualPubRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPubRepository:VirtualPubRepository", name, args == null ? VirtualPubRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
