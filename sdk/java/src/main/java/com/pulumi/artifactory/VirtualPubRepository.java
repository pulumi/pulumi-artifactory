...
import com.pulumi.artifactory.VirtualPubRepositoryArgs;
import com.pulumi.artifactory.inputs.VirtualPubRepositoryState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.VirtualPubRepository;
 * import com.pulumi.artifactory.VirtualPubRepositoryArgs;
 ...
 * 
 */
@ResourceType(type="artifactory:index/virtualPubRepository:VirtualPubRepository")
public class VirtualPubRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public VirtualPubRepository(java.lang.String name) {
        this(name, VirtualPubRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VirtualPubRepository(java.lang.String name, VirtualPubRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualPubRepository(java.lang.String name, VirtualPubRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPubRepository:VirtualPubRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualPubRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualPubRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPubRepository:VirtualPubRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualPubRepositoryArgs makeArgs(VirtualPubRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualPubRepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualPubRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualPubRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new VirtualPubRepository(name, id, state, options);
    }
}
