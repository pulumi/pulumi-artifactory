...
public final class GetFederatedCargoRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedCargoRepositoryMember Empty = new GetFederatedCargoRepositoryMember();
    ...
    private GetFederatedCargoRepositoryMember() {}

    private GetFederatedCargoRepositoryMember(GetFederatedCargoRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedCargoRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedCargoRepositoryMember();
        }

        public Builder(GetFederatedCargoRepositoryMember defaults) {
            $ = new GetFederatedCargoRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedCargoRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedCargoRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedCargoRepositoryMember", "url");
            }
            return $;
        }
    }
