...
public final class FederatedAnsibleRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedAnsibleRepositoryMemberArgs Empty = new FederatedAnsibleRepositoryMemberArgs();
    ...
    private FederatedAnsibleRepositoryMemberArgs() {}

    private FederatedAnsibleRepositoryMemberArgs(FederatedAnsibleRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedAnsibleRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedAnsibleRepositoryMemberArgs();
        }

        public Builder(FederatedAnsibleRepositoryMemberArgs defaults) {
            $ = new FederatedAnsibleRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedAnsibleRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedAnsibleRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedAnsibleRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
