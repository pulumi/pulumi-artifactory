...
public class RemoteAlpineRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteAlpineRepositoryContentSynchronisation.class, parameters={})
    ...
    public RemoteAlpineRepository(String name, RemoteAlpineRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, args == null ? RemoteAlpineRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
