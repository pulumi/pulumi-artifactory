...
public class RemoteAlpineRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteAlpineRepository(String name) {
     ...
     */
    public RemoteAlpineRepository(String name, RemoteAlpineRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private RemoteAlpineRepository(String name, Output<String> id, @Nullable RemoteAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RemoteAlpineRepository get(String name, Output<String> id, @Nullable RemoteAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
