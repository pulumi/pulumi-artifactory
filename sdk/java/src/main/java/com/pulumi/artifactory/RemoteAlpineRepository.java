...
import com.pulumi.artifactory.inputs.RemoteAlpineRepositoryState;
import com.pulumi.artifactory.outputs.RemoteAlpineRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteAlpineRepository:RemoteAlpineRepository")
public class RemoteAlpineRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteAlpineRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteAlpineRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteAlpineRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteAlpineRepository(java.lang.String name) {
        this(name, RemoteAlpineRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteAlpineRepository(java.lang.String name, RemoteAlpineRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteAlpineRepository(java.lang.String name, RemoteAlpineRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteAlpineRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAlpineRepository:RemoteAlpineRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteAlpineRepositoryArgs makeArgs(RemoteAlpineRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteAlpineRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteAlpineRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteAlpineRepository(name, id, state, options);
    }
}
