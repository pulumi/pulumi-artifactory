...
public class VirtualChefRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualChefRepository(java.lang.String name) {
     ...
     */
    public VirtualChefRepository(java.lang.String name, VirtualChefRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualChefRepository(java.lang.String name, VirtualChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualChefRepository:VirtualChefRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualChefRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualChefRepository:VirtualChefRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualChefRepositoryArgs makeArgs(VirtualChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualChefRepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualChefRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
