...
public final class ReleaseBundleV2CustomWebhookState extends com.pulumi.resources.ResourceArgs {

    public static final ReleaseBundleV2CustomWebhookState Empty = new ReleaseBundleV2CustomWebhookState();
    ...
    private @Nullable Output<ReleaseBundleV2CustomWebhookCriteriaArgs> criteria;

    /**
     * @return Specifies where the webhook will be applied on which repositories.
     * 
     */
    public Optional<Output<ReleaseBundleV2CustomWebhookCriteriaArgs>> criteria() {
    ...
    private @Nullable Output<List<ReleaseBundleV2CustomWebhookHandlerArgs>> handlers;

    /**
     * @return At least one is required.
     * 
     */
    public Optional<Output<List<ReleaseBundleV2CustomWebhookHandlerArgs>>> handlers() {
    ...
    private ReleaseBundleV2CustomWebhookState() {}

    private ReleaseBundleV2CustomWebhookState(ReleaseBundleV2CustomWebhookState $) {
    ...
    public static Builder builder(ReleaseBundleV2CustomWebhookState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseBundleV2CustomWebhookState();
        }

        public Builder(ReleaseBundleV2CustomWebhookState defaults) {
            $ = new ReleaseBundleV2CustomWebhookState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder criteria(@Nullable Output<ReleaseBundleV2CustomWebhookCriteriaArgs> criteria) {
            $.criteria = criteria;
            return this;
        }
        ...
        /**
         * @param eventTypes List of Events in Artifactory, Distribution, Release Bundle that function as the event trigger for the Webhook. Allow values: `releaseBundleV2Started`, `releaseBundleV2Failed`, `releaseBundleV2Completed`.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder handlers(@Nullable Output<List<ReleaseBundleV2CustomWebhookHandlerArgs>> handlers) {
            $.handlers = handlers;
            return this;
        }
        ...
        public ReleaseBundleV2CustomWebhookState build() {
            return $;
        }
    }
