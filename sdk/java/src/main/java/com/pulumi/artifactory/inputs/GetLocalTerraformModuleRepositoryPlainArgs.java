...
public final class GetLocalTerraformModuleRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalTerraformModuleRepositoryPlainArgs Empty = new GetLocalTerraformModuleRepositoryPlainArgs();
    ...
    private GetLocalTerraformModuleRepositoryPlainArgs() {}

    private GetLocalTerraformModuleRepositoryPlainArgs(GetLocalTerraformModuleRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalTerraformModuleRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalTerraformModuleRepositoryPlainArgs();
        }

        public Builder(GetLocalTerraformModuleRepositoryPlainArgs defaults) {
            $ = new GetLocalTerraformModuleRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalTerraformModuleRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalTerraformModuleRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
