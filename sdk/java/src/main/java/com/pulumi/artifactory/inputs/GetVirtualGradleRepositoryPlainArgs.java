...
public final class GetVirtualGradleRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualGradleRepositoryPlainArgs Empty = new GetVirtualGradleRepositoryPlainArgs();
    ...
    private GetVirtualGradleRepositoryPlainArgs() {}

    private GetVirtualGradleRepositoryPlainArgs(GetVirtualGradleRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualGradleRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualGradleRepositoryPlainArgs();
        }

        public Builder(GetVirtualGradleRepositoryPlainArgs defaults) {
            $ = new GetVirtualGradleRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualGradleRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualGradleRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
