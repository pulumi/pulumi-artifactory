...
@CustomType
public final class RemoteGoRepositoryContentSynchronisation {
    ...
    private RemoteGoRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteGoRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGoRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteGoRepositoryContentSynchronisation build() {
            return new RemoteGoRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
