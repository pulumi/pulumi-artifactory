...
public final class UserWebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final UserWebhookHandlerArgs Empty = new UserWebhookHandlerArgs();
    ...
    private UserWebhookHandlerArgs() {}

    private UserWebhookHandlerArgs(UserWebhookHandlerArgs $) {
    ...
    public static Builder builder(UserWebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserWebhookHandlerArgs();
        }

        public Builder(UserWebhookHandlerArgs defaults) {
            $ = new UserWebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UserWebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("UserWebhookHandlerArgs", "url");
            }
            return $;
        }
    }
