...
public final class GetRemoteSbtRepositoryContentSynchronisation extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteSbtRepositoryContentSynchronisation Empty = new GetRemoteSbtRepositoryContentSynchronisation();
    ...
    private GetRemoteSbtRepositoryContentSynchronisation() {}

    private GetRemoteSbtRepositoryContentSynchronisation(GetRemoteSbtRepositoryContentSynchronisation $) {
    ...
    public static Builder builder(GetRemoteSbtRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteSbtRepositoryContentSynchronisation();
        }

        public Builder(GetRemoteSbtRepositoryContentSynchronisation defaults) {
            $ = new GetRemoteSbtRepositoryContentSynchronisation(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteSbtRepositoryContentSynchronisation build() {
            return $;
        }
    }
