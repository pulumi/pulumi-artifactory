...
public class VirtualGradleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualGradleRepository(java.lang.String name) {
     ...
     */
    public VirtualGradleRepository(java.lang.String name, VirtualGradleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualGradleRepository(java.lang.String name, VirtualGradleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGradleRepository:VirtualGradleRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualGradleRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGradleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGradleRepository:VirtualGradleRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualGradleRepositoryArgs makeArgs(VirtualGradleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualGradleRepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualGradleRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGradleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
