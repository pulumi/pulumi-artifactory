...
import com.pulumi.artifactory.inputs.RemoteAnsibleRepositoryState;
import com.pulumi.artifactory.outputs.RemoteAnsibleRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteAnsibleRepository:RemoteAnsibleRepository")
public class RemoteAnsibleRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public RemoteAnsibleRepository(java.lang.String name) {
        this(name, RemoteAnsibleRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteAnsibleRepository(java.lang.String name, RemoteAnsibleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteAnsibleRepository(java.lang.String name, RemoteAnsibleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAnsibleRepository:RemoteAnsibleRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteAnsibleRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteAnsibleRepository:RemoteAnsibleRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteAnsibleRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
