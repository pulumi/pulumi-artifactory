...
public class RemoteAnsibleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteAnsibleRepository(String name) {
     ...
     */
    public RemoteAnsibleRepository(String name, RemoteAnsibleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteAnsibleRepository get(String name, Output<String> id, @Nullable RemoteAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
