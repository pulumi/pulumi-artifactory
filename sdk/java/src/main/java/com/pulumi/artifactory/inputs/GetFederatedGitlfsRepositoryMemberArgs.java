...
public final class GetFederatedGitlfsRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedGitlfsRepositoryMemberArgs Empty = new GetFederatedGitlfsRepositoryMemberArgs();
    ...
    private GetFederatedGitlfsRepositoryMemberArgs() {}

    private GetFederatedGitlfsRepositoryMemberArgs(GetFederatedGitlfsRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedGitlfsRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedGitlfsRepositoryMemberArgs();
        }

        public Builder(GetFederatedGitlfsRepositoryMemberArgs defaults) {
            $ = new GetFederatedGitlfsRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedGitlfsRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedGitlfsRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedGitlfsRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
