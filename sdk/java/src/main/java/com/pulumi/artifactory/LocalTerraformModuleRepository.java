...
import com.pulumi.artifactory.inputs.LocalTerraformModuleRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository")
public class LocalTerraformModuleRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalTerraformModuleRepository(java.lang.String name) {
        this(name, LocalTerraformModuleRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalTerraformModuleRepository(java.lang.String name, LocalTerraformModuleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalTerraformModuleRepository(java.lang.String name, LocalTerraformModuleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalTerraformModuleRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalTerraformModuleRepositoryArgs makeArgs(LocalTerraformModuleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalTerraformModuleRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalTerraformModuleRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalTerraformModuleRepository(name, id, state, options);
    }
}
