...
public class LocalTerraformModuleRepository extends com.pulumi.resources.CustomResource {
    ...
    public LocalTerraformModuleRepository(String name, LocalTerraformModuleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository", name, args == null ? LocalTerraformModuleRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
