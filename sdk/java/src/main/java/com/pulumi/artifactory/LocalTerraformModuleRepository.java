...
public class LocalTerraformModuleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalTerraformModuleRepository(String name) {
     ...
     */
    public LocalTerraformModuleRepository(String name, LocalTerraformModuleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalTerraformModuleRepository(String name, LocalTerraformModuleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private LocalTerraformModuleRepository(String name, Output<String> id, @Nullable LocalTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localTerraformModuleRepository:LocalTerraformModuleRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static LocalTerraformModuleRepository get(String name, Output<String> id, @Nullable LocalTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
