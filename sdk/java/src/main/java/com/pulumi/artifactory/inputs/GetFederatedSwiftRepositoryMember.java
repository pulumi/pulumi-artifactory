...
public final class GetFederatedSwiftRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedSwiftRepositoryMember Empty = new GetFederatedSwiftRepositoryMember();
    ...
    private GetFederatedSwiftRepositoryMember() {}

    private GetFederatedSwiftRepositoryMember(GetFederatedSwiftRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedSwiftRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedSwiftRepositoryMember();
        }

        public Builder(GetFederatedSwiftRepositoryMember defaults) {
            $ = new GetFederatedSwiftRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedSwiftRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedSwiftRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedSwiftRepositoryMember", "url");
            }
            return $;
        }
    }
