...
import com.pulumi.artifactory.inputs.LocalBowerRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localBowerRepository:LocalBowerRepository")
public class LocalBowerRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalBowerRepository(java.lang.String name) {
        this(name, LocalBowerRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalBowerRepository(java.lang.String name, LocalBowerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalBowerRepository(java.lang.String name, LocalBowerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localBowerRepository:LocalBowerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalBowerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localBowerRepository:LocalBowerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalBowerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalBowerRepository(name, id, state, options);
    }
}
