...
public class LocalBowerRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalBowerRepository(String name) {
     ...
     */
    public LocalBowerRepository(String name, LocalBowerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static LocalBowerRepository get(String name, Output<String> id, @Nullable LocalBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
