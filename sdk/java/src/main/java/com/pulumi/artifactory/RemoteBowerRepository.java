...
import com.pulumi.artifactory.inputs.RemoteBowerRepositoryState;
import com.pulumi.artifactory.outputs.RemoteBowerRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteBowerRepository:RemoteBowerRepository")
public class RemoteBowerRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="bowerRegistryUrl", refs={String.class}, tree="[0]")
    private Output<String> bowerRegistryUrl;

    /**
     * @return Proxy remote Bower repository. Default value is `https://registry.bower.io`.
     * 
     */
    public Output<String> bowerRegistryUrl() {
    ...
    @Export(name="contentSynchronisation", refs={RemoteBowerRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteBowerRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteBowerRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteBowerRepository(java.lang.String name) {
        this(name, RemoteBowerRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteBowerRepository(java.lang.String name, RemoteBowerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteBowerRepository(java.lang.String name, RemoteBowerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteBowerRepository:RemoteBowerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteBowerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteBowerRepository:RemoteBowerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteBowerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteBowerRepository(name, id, state, options);
    }
}
