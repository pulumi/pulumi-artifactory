...
public class RemoteBowerRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="bowerRegistryUrl", type=String.class, parameters={})
    ...
    @Export(name="contentSynchronisation", type=RemoteBowerRepositoryContentSynchronisation.class, parameters={})
     ...
     */
    public RemoteBowerRepository(String name) {
     ...
     */
    public RemoteBowerRepository(String name, RemoteBowerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteBowerRepository get(String name, Output<String> id, @Nullable RemoteBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
