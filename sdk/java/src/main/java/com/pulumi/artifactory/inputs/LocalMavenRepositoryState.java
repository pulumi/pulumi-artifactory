...
public final class LocalMavenRepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final LocalMavenRepositoryState Empty = new LocalMavenRepositoryState();
    ...
    private LocalMavenRepositoryState() {}

    private LocalMavenRepositoryState(LocalMavenRepositoryState $) {
    ...
    public static Builder builder(LocalMavenRepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalMavenRepositoryState();
        }

        public Builder(LocalMavenRepositoryState defaults) {
            $ = new LocalMavenRepositoryState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param checksumPolicyType Checksum policy determines how Artifactory behaves when a client checksum for a deployed resource is missing or conflicts with the locally calculated checksum (bad checksum). The options are:
         * - `client-checksums`
         * - `server-generated-checksums`.
         *   For more details, please refer to [Checksum Policy](https://www.jfrog.com/confluence/display/JFROG/Local+Repositories#LocalRepositories-ChecksumPolicy).
         * 
        ...
        public LocalMavenRepositoryState build() {
            return $;
        }
    }
