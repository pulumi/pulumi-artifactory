...
public final class RemoteOpkgRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteOpkgRepositoryContentSynchronisationArgs Empty = new RemoteOpkgRepositoryContentSynchronisationArgs();
    ...
    private RemoteOpkgRepositoryContentSynchronisationArgs() {}

    private RemoteOpkgRepositoryContentSynchronisationArgs(RemoteOpkgRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteOpkgRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteOpkgRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteOpkgRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteOpkgRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteOpkgRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
