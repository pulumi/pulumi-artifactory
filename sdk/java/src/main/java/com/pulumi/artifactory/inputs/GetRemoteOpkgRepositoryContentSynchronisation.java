...
public final class GetRemoteOpkgRepositoryContentSynchronisation extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteOpkgRepositoryContentSynchronisation Empty = new GetRemoteOpkgRepositoryContentSynchronisation();
    ...
    private GetRemoteOpkgRepositoryContentSynchronisation() {}

    private GetRemoteOpkgRepositoryContentSynchronisation(GetRemoteOpkgRepositoryContentSynchronisation $) {
    ...
    public static Builder builder(GetRemoteOpkgRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteOpkgRepositoryContentSynchronisation();
        }

        public Builder(GetRemoteOpkgRepositoryContentSynchronisation defaults) {
            $ = new GetRemoteOpkgRepositoryContentSynchronisation(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteOpkgRepositoryContentSynchronisation build() {
            return $;
        }
    }
