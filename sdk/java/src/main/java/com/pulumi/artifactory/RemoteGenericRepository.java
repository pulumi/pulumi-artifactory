 ...
 * 
 *     public static void stack(Context ctx) {
 *         var token_auth = new RemoteGenericRepository("token-auth", RemoteGenericRepositoryArgs.builder()
...
public class RemoteGenericRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteGenericRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteGenericRepositoryContentSynchronisation> contentSynchronisation;
