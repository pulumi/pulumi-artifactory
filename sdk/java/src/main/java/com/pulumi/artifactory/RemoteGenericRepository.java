...
public class RemoteGenericRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteGenericRepositoryContentSynchronisation.class, parameters={})
    private Output<RemoteGenericRepositoryContentSynchronisation> contentSynchronisation;

    public Output<RemoteGenericRepositoryContentSynchronisation> contentSynchronisation() {
