...
public final class ReleaseBundleV2CustomWebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReleaseBundleV2CustomWebhookHandlerArgs Empty = new ReleaseBundleV2CustomWebhookHandlerArgs();
    ...
    private ReleaseBundleV2CustomWebhookHandlerArgs() {}

    private ReleaseBundleV2CustomWebhookHandlerArgs(ReleaseBundleV2CustomWebhookHandlerArgs $) {
    ...
    public static Builder builder(ReleaseBundleV2CustomWebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseBundleV2CustomWebhookHandlerArgs();
        }

        public Builder(ReleaseBundleV2CustomWebhookHandlerArgs defaults) {
            $ = new ReleaseBundleV2CustomWebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReleaseBundleV2CustomWebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ReleaseBundleV2CustomWebhookHandlerArgs", "url");
            }
            return $;
        }
    }
