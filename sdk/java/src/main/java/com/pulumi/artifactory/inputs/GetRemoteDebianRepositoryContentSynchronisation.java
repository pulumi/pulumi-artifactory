...
public final class GetRemoteDebianRepositoryContentSynchronisation extends com.pulumi.resources.InvokeArgs {

    public static final GetRemoteDebianRepositoryContentSynchronisation Empty = new GetRemoteDebianRepositoryContentSynchronisation();
    ...
    private GetRemoteDebianRepositoryContentSynchronisation() {}

    private GetRemoteDebianRepositoryContentSynchronisation(GetRemoteDebianRepositoryContentSynchronisation $) {
    ...
    public static Builder builder(GetRemoteDebianRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteDebianRepositoryContentSynchronisation();
        }

        public Builder(GetRemoteDebianRepositoryContentSynchronisation defaults) {
            $ = new GetRemoteDebianRepositoryContentSynchronisation(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteDebianRepositoryContentSynchronisation build() {
            return $;
        }
    }
