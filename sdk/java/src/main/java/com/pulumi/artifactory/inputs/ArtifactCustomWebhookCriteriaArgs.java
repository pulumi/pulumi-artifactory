...
public final class ArtifactCustomWebhookCriteriaArgs extends com.pulumi.resources.ResourceArgs {

    public static final ArtifactCustomWebhookCriteriaArgs Empty = new ArtifactCustomWebhookCriteriaArgs();
    ...
    private ArtifactCustomWebhookCriteriaArgs() {}

    private ArtifactCustomWebhookCriteriaArgs(ArtifactCustomWebhookCriteriaArgs $) {
    ...
    public static Builder builder(ArtifactCustomWebhookCriteriaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ArtifactCustomWebhookCriteriaArgs();
        }

        public Builder(ArtifactCustomWebhookCriteriaArgs defaults) {
            $ = new ArtifactCustomWebhookCriteriaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ArtifactCustomWebhookCriteriaArgs build() {
            if ($.anyFederated == null) {
                throw new MissingRequiredPropertyException("ArtifactCustomWebhookCriteriaArgs", "anyFederated");
            }
            if ($.anyLocal == null) {
                throw new MissingRequiredPropertyException("ArtifactCustomWebhookCriteriaArgs", "anyLocal");
            }
            if ($.anyRemote == null) {
                throw new MissingRequiredPropertyException("ArtifactCustomWebhookCriteriaArgs", "anyRemote");
            }
            if ($.repoKeys == null) {
                throw new MissingRequiredPropertyException("ArtifactCustomWebhookCriteriaArgs", "repoKeys");
            }
            return $;
        }
    }
