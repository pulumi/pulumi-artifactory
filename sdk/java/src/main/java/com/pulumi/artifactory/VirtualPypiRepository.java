...
public class VirtualPypiRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualPypiRepository(java.lang.String name) {
     ...
     */
    public VirtualPypiRepository(java.lang.String name, VirtualPypiRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualPypiRepository(java.lang.String name, VirtualPypiRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPypiRepository:VirtualPypiRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualPypiRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualPypiRepository:VirtualPypiRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VirtualPypiRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
