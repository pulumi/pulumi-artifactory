...
public class FederatedChefRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedChefRepositoryMember.class})
    ...
    public FederatedChefRepository(String name, FederatedChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedChefRepository:FederatedChefRepository", name, args == null ? FederatedChefRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
