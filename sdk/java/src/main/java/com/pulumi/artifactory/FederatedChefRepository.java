...
public class FederatedChefRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedChefRepository(String name) {
     ...
     */
    public FederatedChefRepository(String name, FederatedChefRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedChefRepository(String name, FederatedChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedChefRepository:FederatedChefRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private FederatedChefRepository(String name, Output<String> id, @Nullable FederatedChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedChefRepository:FederatedChefRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static FederatedChefRepository get(String name, Output<String> id, @Nullable FederatedChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
