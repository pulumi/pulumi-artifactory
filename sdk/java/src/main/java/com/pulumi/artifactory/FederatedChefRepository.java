...
import com.pulumi.artifactory.inputs.FederatedChefRepositoryState;
import com.pulumi.artifactory.outputs.FederatedChefRepositoryMember;
...
public class FederatedChefRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedChefRepositoryMember.class}, tree="[0,1]")
     ...
     * 
     */
    public Output<List<FederatedChefRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedChefRepository(java.lang.String name) {
        this(name, FederatedChefRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedChefRepository(java.lang.String name, FederatedChefRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedChefRepository(java.lang.String name, FederatedChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedChefRepository:FederatedChefRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedChefRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedChefRepository:FederatedChefRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedChefRepositoryArgs makeArgs(FederatedChefRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedChefRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedChefRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedChefRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
