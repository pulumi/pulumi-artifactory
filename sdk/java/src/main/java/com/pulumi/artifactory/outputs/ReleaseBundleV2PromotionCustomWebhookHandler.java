...
@CustomType
public final class ReleaseBundleV2PromotionCustomWebhookHandler {
    /**
    ...
    private ReleaseBundleV2PromotionCustomWebhookHandler() {}
    /**
     * @return HTTP headers you wish to use to invoke the Webhook, comprise key/value pair.
     * 
     */
    ...
    public static Builder builder(ReleaseBundleV2PromotionCustomWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(ReleaseBundleV2PromotionCustomWebhookHandler defaults) {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ReleaseBundleV2PromotionCustomWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        public ReleaseBundleV2PromotionCustomWebhookHandler build() {
            final var _resultValue = new ReleaseBundleV2PromotionCustomWebhookHandler();
