...
public final class LocalGenericRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalGenericRepositoryArgs Empty = new LocalGenericRepositoryArgs();
    ...
    private LocalGenericRepositoryArgs() {}

    private LocalGenericRepositoryArgs(LocalGenericRepositoryArgs $) {
    ...
    public static Builder builder(LocalGenericRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalGenericRepositoryArgs();
        }

        public Builder(LocalGenericRepositoryArgs defaults) {
            $ = new LocalGenericRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param key A mandatory identifier for the repository that must be unique.
         * It cannot begin with a number or contain spaces or special characters.
         * 
         * @return builder
         * 
        ...
        public LocalGenericRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("LocalGenericRepositoryArgs", "key");
            }
            return $;
        }
    }
