...
public final class DockerV1RepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final DockerV1RepositoryState Empty = new DockerV1RepositoryState();
    ...
    private DockerV1RepositoryState() {}

    private DockerV1RepositoryState(DockerV1RepositoryState $) {
    ...
    public static Builder builder(DockerV1RepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DockerV1RepositoryState();
        }

        public Builder(DockerV1RepositoryState defaults) {
            $ = new DockerV1RepositoryState(Objects.requireNonNull(defaults));
        }
        ...
        public DockerV1RepositoryState build() {
            return $;
        }
    }
