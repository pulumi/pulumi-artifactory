...
public class FederatedGoRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedGoRepository(java.lang.String name) {
     ...
     */
    public FederatedGoRepository(java.lang.String name, FederatedGoRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedGoRepository(java.lang.String name, FederatedGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGoRepository:FederatedGoRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedGoRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGoRepository:FederatedGoRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedGoRepositoryArgs makeArgs(FederatedGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedGoRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedGoRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
