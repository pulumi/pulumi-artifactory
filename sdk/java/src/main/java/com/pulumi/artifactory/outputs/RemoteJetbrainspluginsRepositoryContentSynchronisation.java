...
@CustomType
public final class RemoteJetbrainspluginsRepositoryContentSynchronisation {
    /**
    ...
    private RemoteJetbrainspluginsRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteJetbrainspluginsRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteJetbrainspluginsRepositoryContentSynchronisation defaults) {
        ...
        public RemoteJetbrainspluginsRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteJetbrainspluginsRepositoryContentSynchronisation();
