...
public final class GetRemoteGitlfsRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetRemoteGitlfsRepositoryContentSynchronisationArgs Empty = new GetRemoteGitlfsRepositoryContentSynchronisationArgs();
    ...
    private GetRemoteGitlfsRepositoryContentSynchronisationArgs() {}

    private GetRemoteGitlfsRepositoryContentSynchronisationArgs(GetRemoteGitlfsRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(GetRemoteGitlfsRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemoteGitlfsRepositoryContentSynchronisationArgs();
        }

        public Builder(GetRemoteGitlfsRepositoryContentSynchronisationArgs defaults) {
            $ = new GetRemoteGitlfsRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetRemoteGitlfsRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
