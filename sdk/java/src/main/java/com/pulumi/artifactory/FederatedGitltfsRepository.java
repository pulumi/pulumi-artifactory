...
import com.pulumi.artifactory.inputs.FederatedGitltfsRepositoryState;
import com.pulumi.artifactory.outputs.FederatedGitltfsRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedGitltfsRepository:FederatedGitltfsRepository")
public class FederatedGitltfsRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedGitltfsRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedGitltfsRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedGitltfsRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedGitltfsRepository(java.lang.String name) {
        this(name, FederatedGitltfsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedGitltfsRepository(java.lang.String name, FederatedGitltfsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedGitltfsRepository(java.lang.String name, FederatedGitltfsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGitltfsRepository:FederatedGitltfsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedGitltfsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGitltfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGitltfsRepository:FederatedGitltfsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedGitltfsRepositoryArgs makeArgs(FederatedGitltfsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedGitltfsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedGitltfsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedGitltfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
