...
public class FederatedGitltfsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedGitltfsRepository(String name) {
     ...
     */
    public FederatedGitltfsRepository(String name, FederatedGitltfsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedGitltfsRepository(String name, FederatedGitltfsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGitltfsRepository:FederatedGitltfsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private FederatedGitltfsRepository(String name, Output<String> id, @Nullable FederatedGitltfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGitltfsRepository:FederatedGitltfsRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static FederatedGitltfsRepository get(String name, Output<String> id, @Nullable FederatedGitltfsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
