...
public class FederatedGitltfsRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedGitltfsRepositoryMember.class})
    ...
    public FederatedGitltfsRepository(String name, FederatedGitltfsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedGitltfsRepository:FederatedGitltfsRepository", name, args == null ? FederatedGitltfsRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
