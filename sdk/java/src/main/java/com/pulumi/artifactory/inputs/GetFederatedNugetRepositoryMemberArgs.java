...
public final class GetFederatedNugetRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedNugetRepositoryMemberArgs Empty = new GetFederatedNugetRepositoryMemberArgs();
    ...
    private GetFederatedNugetRepositoryMemberArgs() {}

    private GetFederatedNugetRepositoryMemberArgs(GetFederatedNugetRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedNugetRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedNugetRepositoryMemberArgs();
        }

        public Builder(GetFederatedNugetRepositoryMemberArgs defaults) {
            $ = new GetFederatedNugetRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedNugetRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedNugetRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedNugetRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
