...
public final class GetFederatedMavenRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedMavenRepositoryMemberArgs Empty = new GetFederatedMavenRepositoryMemberArgs();
    ...
    private GetFederatedMavenRepositoryMemberArgs() {}

    private GetFederatedMavenRepositoryMemberArgs(GetFederatedMavenRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedMavenRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedMavenRepositoryMemberArgs();
        }

        public Builder(GetFederatedMavenRepositoryMemberArgs defaults) {
            $ = new GetFederatedMavenRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedMavenRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedMavenRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedMavenRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
