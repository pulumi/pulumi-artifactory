...
public final class FederatedChefRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedChefRepositoryMemberArgs Empty = new FederatedChefRepositoryMemberArgs();
    ...
    private FederatedChefRepositoryMemberArgs() {}

    private FederatedChefRepositoryMemberArgs(FederatedChefRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedChefRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedChefRepositoryMemberArgs();
        }

        public Builder(FederatedChefRepositoryMemberArgs defaults) {
            $ = new FederatedChefRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedChefRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedChefRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedChefRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
