...
@CustomType
public final class RemoteAieditorextensionsRepositoryContentSynchronisation {
    /**
    ...
    private RemoteAieditorextensionsRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteAieditorextensionsRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteAieditorextensionsRepositoryContentSynchronisation defaults) {
        ...
        public RemoteAieditorextensionsRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteAieditorextensionsRepositoryContentSynchronisation();
