...
public final class GetFederatedVagrantRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedVagrantRepositoryMember Empty = new GetFederatedVagrantRepositoryMember();
    ...
    private GetFederatedVagrantRepositoryMember() {}

    private GetFederatedVagrantRepositoryMember(GetFederatedVagrantRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedVagrantRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedVagrantRepositoryMember();
        }

        public Builder(GetFederatedVagrantRepositoryMember defaults) {
            $ = new GetFederatedVagrantRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedVagrantRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedVagrantRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedVagrantRepositoryMember", "url");
            }
            return $;
        }
    }
