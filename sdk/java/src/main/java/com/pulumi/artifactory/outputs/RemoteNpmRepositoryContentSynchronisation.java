...
@CustomType
public final class RemoteNpmRepositoryContentSynchronisation {
    ...
    public static Builder builder(RemoteNpmRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteNpmRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteNpmRepositoryContentSynchronisation build() {
            return new RemoteNpmRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
