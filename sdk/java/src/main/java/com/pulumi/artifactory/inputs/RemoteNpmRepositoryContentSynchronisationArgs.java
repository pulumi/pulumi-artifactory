...
public final class RemoteNpmRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteNpmRepositoryContentSynchronisationArgs Empty = new RemoteNpmRepositoryContentSynchronisationArgs();
    ...
    private RemoteNpmRepositoryContentSynchronisationArgs() {}

    private RemoteNpmRepositoryContentSynchronisationArgs(RemoteNpmRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteNpmRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteNpmRepositoryContentSynchronisationArgs();
        }

        public Builder(RemoteNpmRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteNpmRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteNpmRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
