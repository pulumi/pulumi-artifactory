...
public final class FederatedReleasebundlesRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedReleasebundlesRepositoryArgs Empty = new FederatedReleasebundlesRepositoryArgs();
    ...
    private Output<List<FederatedReleasebundlesRepositoryMemberArgs>> members;
     ...
     * 
     */
    public Output<List<FederatedReleasebundlesRepositoryMemberArgs>> members() {
        return this.members;
    }
    ...
    private FederatedReleasebundlesRepositoryArgs() {}

    private FederatedReleasebundlesRepositoryArgs(FederatedReleasebundlesRepositoryArgs $) {
    ...
    public static Builder builder(FederatedReleasebundlesRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedReleasebundlesRepositoryArgs();
        }

        public Builder(FederatedReleasebundlesRepositoryArgs defaults) {
            $ = new FederatedReleasebundlesRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param key the identity key of the repo. Repository name for this package type myst chave following format: `&lt;project_name&gt;-release-bundles-v2`. Project myst exist before the repository was created.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder members(Output<List<FederatedReleasebundlesRepositoryMemberArgs>> members) {
            $.members = members;
            return this;
        }
         ...
         * 
         */
        public Builder members(List<FederatedReleasebundlesRepositoryMemberArgs> members) {
         ...
         * 
         */
        public Builder members(FederatedReleasebundlesRepositoryMemberArgs... members) {
        ...
        /**
         * @param projectKey Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash. Even thought we don&#39;t recommend using this attribute to assign all other repository types to the project, in the scope of this specific package type, it is necessary to have theis attribute.
         * 
         * @return builder
         * 
         */
        ...
        public FederatedReleasebundlesRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("FederatedReleasebundlesRepositoryArgs", "key");
            }
            if ($.members == null) {
                throw new MissingRequiredPropertyException("FederatedReleasebundlesRepositoryArgs", "members");
            }
            return $;
        }
    }
