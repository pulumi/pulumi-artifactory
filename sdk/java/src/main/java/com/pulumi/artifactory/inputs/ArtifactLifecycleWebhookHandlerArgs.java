...
public final class ArtifactLifecycleWebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ArtifactLifecycleWebhookHandlerArgs Empty = new ArtifactLifecycleWebhookHandlerArgs();
    ...
    private ArtifactLifecycleWebhookHandlerArgs() {}

    private ArtifactLifecycleWebhookHandlerArgs(ArtifactLifecycleWebhookHandlerArgs $) {
    ...
    public static Builder builder(ArtifactLifecycleWebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ArtifactLifecycleWebhookHandlerArgs();
        }

        public Builder(ArtifactLifecycleWebhookHandlerArgs defaults) {
            $ = new ArtifactLifecycleWebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ArtifactLifecycleWebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ArtifactLifecycleWebhookHandlerArgs", "url");
            }
            return $;
        }
    }
