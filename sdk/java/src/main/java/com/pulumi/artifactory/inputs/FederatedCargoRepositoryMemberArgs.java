...
public final class FederatedCargoRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedCargoRepositoryMemberArgs Empty = new FederatedCargoRepositoryMemberArgs();
    ...
    private FederatedCargoRepositoryMemberArgs() {}

    private FederatedCargoRepositoryMemberArgs(FederatedCargoRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedCargoRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedCargoRepositoryMemberArgs();
        }

        public Builder(FederatedCargoRepositoryMemberArgs defaults) {
            $ = new FederatedCargoRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedCargoRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedCargoRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedCargoRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
