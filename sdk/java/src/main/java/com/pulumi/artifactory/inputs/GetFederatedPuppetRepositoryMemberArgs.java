...
public final class GetFederatedPuppetRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedPuppetRepositoryMemberArgs Empty = new GetFederatedPuppetRepositoryMemberArgs();
    ...
    private GetFederatedPuppetRepositoryMemberArgs() {}

    private GetFederatedPuppetRepositoryMemberArgs(GetFederatedPuppetRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedPuppetRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedPuppetRepositoryMemberArgs();
        }

        public Builder(GetFederatedPuppetRepositoryMemberArgs defaults) {
            $ = new GetFederatedPuppetRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedPuppetRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedPuppetRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedPuppetRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
