...
@CustomType
public final class RemoteRpmRepositoryContentSynchronisation {
    ...
    private RemoteRpmRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteRpmRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteRpmRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteRpmRepositoryContentSynchronisation build() {
            return new RemoteRpmRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
