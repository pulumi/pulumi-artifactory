...
public class RemoteCargoRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteCargoRepositoryContentSynchronisation.class, parameters={})
    private Output<RemoteCargoRepositoryContentSynchronisation> contentSynchronisation;

    public Output<RemoteCargoRepositoryContentSynchronisation> contentSynchronisation() {
    ...
    public RemoteCargoRepository(String name, RemoteCargoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCargoRepository:RemoteCargoRepository", name, args == null ? RemoteCargoRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
