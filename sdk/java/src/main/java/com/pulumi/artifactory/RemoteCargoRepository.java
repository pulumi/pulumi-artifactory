...
import com.pulumi.artifactory.inputs.RemoteCargoRepositoryState;
import com.pulumi.artifactory.outputs.RemoteCargoRepositoryContentSynchronisation;
...
public class RemoteCargoRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteCargoRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteCargoRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteCargoRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    private Output<Boolean> enableSparseIndex;
     ...
     * 
     */
    public Output<Boolean> enableSparseIndex() {
        return this.enableSparseIndex;
    }
    /**
