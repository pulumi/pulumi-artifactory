...
public class FederatedOciRepository extends com.pulumi.resources.CustomResource {
    ...
    public FederatedOciRepository(String name, FederatedOciRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedOciRepository:FederatedOciRepository", name, args == null ? FederatedOciRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
