...
public final class FederatedHuggingfacemlRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedHuggingfacemlRepositoryMemberArgs Empty = new FederatedHuggingfacemlRepositoryMemberArgs();
    ...
    private FederatedHuggingfacemlRepositoryMemberArgs() {}

    private FederatedHuggingfacemlRepositoryMemberArgs(FederatedHuggingfacemlRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedHuggingfacemlRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedHuggingfacemlRepositoryMemberArgs();
        }

        public Builder(FederatedHuggingfacemlRepositoryMemberArgs defaults) {
            $ = new FederatedHuggingfacemlRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedHuggingfacemlRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedHuggingfacemlRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedHuggingfacemlRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
