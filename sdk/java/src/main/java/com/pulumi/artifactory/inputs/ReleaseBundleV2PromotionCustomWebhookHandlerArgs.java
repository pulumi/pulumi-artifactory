...
public final class ReleaseBundleV2PromotionCustomWebhookHandlerArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReleaseBundleV2PromotionCustomWebhookHandlerArgs Empty = new ReleaseBundleV2PromotionCustomWebhookHandlerArgs();
    ...
    private ReleaseBundleV2PromotionCustomWebhookHandlerArgs() {}

    private ReleaseBundleV2PromotionCustomWebhookHandlerArgs(ReleaseBundleV2PromotionCustomWebhookHandlerArgs $) {
    ...
    public static Builder builder(ReleaseBundleV2PromotionCustomWebhookHandlerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReleaseBundleV2PromotionCustomWebhookHandlerArgs();
        }

        public Builder(ReleaseBundleV2PromotionCustomWebhookHandlerArgs defaults) {
            $ = new ReleaseBundleV2PromotionCustomWebhookHandlerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReleaseBundleV2PromotionCustomWebhookHandlerArgs build() {
            if ($.url == null) {
                throw new MissingRequiredPropertyException("ReleaseBundleV2PromotionCustomWebhookHandlerArgs", "url");
            }
            return $;
        }
    }
