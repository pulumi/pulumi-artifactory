...
import com.pulumi.artifactory.inputs.RemoteRpmRepositoryState;
import com.pulumi.artifactory.outputs.RemoteRpmRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteRpmRepository:RemoteRpmRepository")
public class RemoteRpmRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteRpmRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteRpmRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteRpmRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteRpmRepository(java.lang.String name) {
        this(name, RemoteRpmRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteRpmRepository(java.lang.String name, RemoteRpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteRpmRepository(java.lang.String name, RemoteRpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteRpmRepository:RemoteRpmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteRpmRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteRpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteRpmRepository:RemoteRpmRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteRpmRepositoryArgs makeArgs(RemoteRpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteRpmRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteRpmRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteRpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteRpmRepository(name, id, state, options);
    }
}
