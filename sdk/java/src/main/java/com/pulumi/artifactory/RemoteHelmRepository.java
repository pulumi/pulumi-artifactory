...
public class RemoteHelmRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteHelmRepository(String name) {
     ...
     */
    public RemoteHelmRepository(String name, RemoteHelmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteHelmRepository get(String name, Output<String> id, @Nullable RemoteHelmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
