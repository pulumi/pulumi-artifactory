...
import com.pulumi.artifactory.inputs.RemoteHelmRepositoryState;
import com.pulumi.artifactory.outputs.RemoteHelmRepositoryContentSynchronisation;
...
public class RemoteHelmRepository extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ RemoteHelmRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteHelmRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    private Output<String> helmChartsBaseUrl;
     ...
     * 
     */
    public Output<String> helmChartsBaseUrl() {
        return this.helmChartsBaseUrl;
    }
    /**
     ...
     */
    public RemoteHelmRepository(java.lang.String name) {
        this(name, RemoteHelmRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteHelmRepository(java.lang.String name, RemoteHelmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteHelmRepository(java.lang.String name, RemoteHelmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteHelmRepository:RemoteHelmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteHelmRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteHelmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteHelmRepository:RemoteHelmRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteHelmRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteHelmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
