...
import com.pulumi.artifactory.inputs.RemoteP2RepositoryContentSynchronisationArgs;
...
public final class RemoteP2RepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteP2RepositoryArgs Empty = new RemoteP2RepositoryArgs();
    ...
    private @Nullable Output<RemoteP2RepositoryContentSynchronisationArgs> contentSynchronisation;

    public Optional<Output<RemoteP2RepositoryContentSynchronisationArgs>> contentSynchronisation() {
    ...
    private RemoteP2RepositoryArgs() {}

    private RemoteP2RepositoryArgs(RemoteP2RepositoryArgs $) {
    ...
    public static Builder builder(RemoteP2RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RemoteP2RepositoryArgs();
        }

        public Builder(RemoteP2RepositoryArgs defaults) {
            $ = new RemoteP2RepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder contentSynchronisation(@Nullable Output<RemoteP2RepositoryContentSynchronisationArgs> contentSynchronisation) {
            $.contentSynchronisation = contentSynchronisation;
            return this;
        }

        public Builder contentSynchronisation(RemoteP2RepositoryContentSynchronisationArgs contentSynchronisation) {
        ...
        public RemoteP2RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("RemoteP2RepositoryArgs", "key");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("RemoteP2RepositoryArgs", "url");
            }
            return $;
        }
    }
