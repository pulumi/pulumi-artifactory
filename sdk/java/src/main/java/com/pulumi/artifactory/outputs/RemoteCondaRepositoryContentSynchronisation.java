...
@CustomType
public final class RemoteCondaRepositoryContentSynchronisation {
    ...
    private RemoteCondaRepositoryContentSynchronisation(
    ...
    public static Builder builder(RemoteCondaRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteCondaRepositoryContentSynchronisation defaults) {
        ...
        public Builder statisticsEnabled(@Nullable Boolean statisticsEnabled) {
            this.statisticsEnabled = statisticsEnabled;
            return this;
        }        public RemoteCondaRepositoryContentSynchronisation build() {
            return new RemoteCondaRepositoryContentSynchronisation(enabled, propertiesEnabled, sourceOriginAbsenceDetection, statisticsEnabled);
        }
    }
}
