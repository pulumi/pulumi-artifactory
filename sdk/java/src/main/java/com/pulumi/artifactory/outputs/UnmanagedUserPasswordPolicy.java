...
@CustomType
public final class UnmanagedUserPasswordPolicy {
    /**
    ...
    public static Builder builder(UnmanagedUserPasswordPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer uppercase;
        public Builder() {}
        public Builder(UnmanagedUserPasswordPolicy defaults) {
        ...
        public UnmanagedUserPasswordPolicy build() {
            final var _resultValue = new UnmanagedUserPasswordPolicy();
