...
public class FederatedPypiRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedPypiRepositoryMember.class}, tree="[0,1]")
     ...
     */
    public FederatedPypiRepository(java.lang.String name) {
     ...
     */
    public FederatedPypiRepository(java.lang.String name, FederatedPypiRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedPypiRepository(java.lang.String name, FederatedPypiRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedPypiRepository:FederatedPypiRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedPypiRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedPypiRepository:FederatedPypiRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedPypiRepositoryArgs makeArgs(FederatedPypiRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedPypiRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedPypiRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedPypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
