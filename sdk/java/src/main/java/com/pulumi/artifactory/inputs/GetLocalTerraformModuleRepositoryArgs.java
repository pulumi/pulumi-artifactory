...
public final class GetLocalTerraformModuleRepositoryArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalTerraformModuleRepositoryArgs Empty = new GetLocalTerraformModuleRepositoryArgs();
    ...
    private GetLocalTerraformModuleRepositoryArgs() {}

    private GetLocalTerraformModuleRepositoryArgs(GetLocalTerraformModuleRepositoryArgs $) {
    ...
    public static Builder builder(GetLocalTerraformModuleRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalTerraformModuleRepositoryArgs();
        }

        public Builder(GetLocalTerraformModuleRepositoryArgs defaults) {
            $ = new GetLocalTerraformModuleRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalTerraformModuleRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalTerraformModuleRepositoryArgs", "key");
            }
            return $;
        }
    }
