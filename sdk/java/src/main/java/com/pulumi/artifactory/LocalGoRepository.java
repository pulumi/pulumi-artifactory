...
import com.pulumi.artifactory.inputs.LocalGoRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localGoRepository:LocalGoRepository")
public class LocalGoRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalGoRepository(java.lang.String name) {
        this(name, LocalGoRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalGoRepository(java.lang.String name, LocalGoRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalGoRepository(java.lang.String name, LocalGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGoRepository:LocalGoRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalGoRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localGoRepository:LocalGoRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalGoRepositoryArgs makeArgs(LocalGoRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalGoRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalGoRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGoRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
