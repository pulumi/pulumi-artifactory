...
public final class GetPermissionTargetReleaseBundleActionsGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetPermissionTargetReleaseBundleActionsGroupArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPermissionTargetReleaseBundleActionsGroupArgs", "name");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("GetPermissionTargetReleaseBundleActionsGroupArgs", "permissions");
            }
            return $;
        }
    }
