...
@CustomType
public final class DestinationCustomWebhookCriteria {
    /**
    ...
    private DestinationCustomWebhookCriteria() {}
    /**
     * @return Trigger on any release bundle
     * 
     */
    ...
    public static Builder builder(DestinationCustomWebhookCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> registeredReleaseBundleNames;
        public Builder() {}
        public Builder(DestinationCustomWebhookCriteria defaults) {
        ...
        public Builder anyReleaseBundle(Boolean anyReleaseBundle) {
            if (anyReleaseBundle == null) {
              throw new MissingRequiredPropertyException("DestinationCustomWebhookCriteria", "anyReleaseBundle");
            }
        ...
        public Builder registeredReleaseBundleNames(List<String> registeredReleaseBundleNames) {
            if (registeredReleaseBundleNames == null) {
              throw new MissingRequiredPropertyException("DestinationCustomWebhookCriteria", "registeredReleaseBundleNames");
            }
        ...
        public DestinationCustomWebhookCriteria build() {
            final var _resultValue = new DestinationCustomWebhookCriteria();
