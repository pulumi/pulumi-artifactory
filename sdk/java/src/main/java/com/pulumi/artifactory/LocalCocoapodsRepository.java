...
import com.pulumi.artifactory.inputs.LocalCocoapodsRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localCocoapodsRepository:LocalCocoapodsRepository")
public class LocalCocoapodsRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalCocoapodsRepository(java.lang.String name) {
        this(name, LocalCocoapodsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalCocoapodsRepository(java.lang.String name, LocalCocoapodsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalCocoapodsRepository(java.lang.String name, LocalCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localCocoapodsRepository:LocalCocoapodsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalCocoapodsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localCocoapodsRepository:LocalCocoapodsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalCocoapodsRepositoryArgs makeArgs(LocalCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalCocoapodsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalCocoapodsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalCocoapodsRepository(name, id, state, options);
    }
}
