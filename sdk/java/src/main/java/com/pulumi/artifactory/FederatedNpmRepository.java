...
public class FederatedNpmRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedNpmRepositoryMember.class})
     ...
     */
    public FederatedNpmRepository(String name) {
     ...
     */
    public FederatedNpmRepository(String name, FederatedNpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedNpmRepository get(String name, Output<String> id, @Nullable FederatedNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
