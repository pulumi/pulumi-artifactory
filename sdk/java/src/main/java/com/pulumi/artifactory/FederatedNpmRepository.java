...
import com.pulumi.artifactory.inputs.FederatedNpmRepositoryState;
import com.pulumi.artifactory.outputs.FederatedNpmRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedNpmRepository:FederatedNpmRepository")
public class FederatedNpmRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedNpmRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedNpmRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedNpmRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedNpmRepository(java.lang.String name) {
        this(name, FederatedNpmRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedNpmRepository(java.lang.String name, FederatedNpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedNpmRepository(java.lang.String name, FederatedNpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedNpmRepository:FederatedNpmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedNpmRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedNpmRepository:FederatedNpmRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedNpmRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedNpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
