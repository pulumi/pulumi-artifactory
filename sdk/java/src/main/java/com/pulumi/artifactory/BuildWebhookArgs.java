...
public final class BuildWebhookArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BuildWebhookArgs() {}

    private BuildWebhookArgs(BuildWebhookArgs $) {
    ...
    public static Builder builder(BuildWebhookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BuildWebhookArgs();
        }

        public Builder(BuildWebhookArgs defaults) {
            $ = new BuildWebhookArgs(Objects.requireNonNull(defaults));
        }
