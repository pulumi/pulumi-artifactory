...
@CustomType
public final class GetLocalDockerV1RepositoryResult {
    /**
     * @return The Docker API version in use.
     * 
     */
    ...
    /**
     * @return When set, Artifactory will block the pushing of Docker images with manifest v2 schema 1 to
     * this repository.
     * 
     */
    ...
    /**
     * @return If greater than 1, overwritten tags will be saved by their digest, up to the set up number. This
    ...
    public static Builder builder(GetLocalDockerV1RepositoryResult defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean xrayIndex;
        public Builder() {}
        public Builder(GetLocalDockerV1RepositoryResult defaults) {
        ...
        public Builder apiVersion(String apiVersion) {
            if (apiVersion == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "apiVersion");
            }
        ...
        public Builder blockPushingSchema1(Boolean blockPushingSchema1) {
            if (blockPushingSchema1 == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "blockPushingSchema1");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder maxUniqueTags(Integer maxUniqueTags) {
            if (maxUniqueTags == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "maxUniqueTags");
            }
        ...
        public Builder packageType(String packageType) {
            if (packageType == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "packageType");
            }
        ...
        public Builder projectEnvironments(List<String> projectEnvironments) {
            if (projectEnvironments == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "projectEnvironments");
            }
        ...
        public Builder tagRetention(Integer tagRetention) {
            if (tagRetention == null) {
              throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryResult", "tagRetention");
            }
        ...
        public GetLocalDockerV1RepositoryResult build() {
            final var _resultValue = new GetLocalDockerV1RepositoryResult();
