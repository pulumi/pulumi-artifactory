...
public final class FederatedOpkgRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedOpkgRepositoryMemberArgs Empty = new FederatedOpkgRepositoryMemberArgs();
    ...
    private FederatedOpkgRepositoryMemberArgs() {}

    private FederatedOpkgRepositoryMemberArgs(FederatedOpkgRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedOpkgRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedOpkgRepositoryMemberArgs();
        }

        public Builder(FederatedOpkgRepositoryMemberArgs defaults) {
            $ = new FederatedOpkgRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedOpkgRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedOpkgRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedOpkgRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
