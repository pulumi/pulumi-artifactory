 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.index_virtualAlpineRepository.VirtualAlpineRepository;
 * import com.pulumi.artifactory.index_virtualAlpineRepository.VirtualAlpineRepositoryArgs;
 * import java.util.List;
...
public class VirtualAlpineRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualAlpineRepository(String name) {
     ...
     */
    public static VirtualAlpineRepository get(String name, Output<String> id, @Nullable VirtualAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
