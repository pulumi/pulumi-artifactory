...
import com.pulumi.artifactory.inputs.VirtualAlpineRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/virtualAlpineRepository:VirtualAlpineRepository")
public class VirtualAlpineRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public VirtualAlpineRepository(java.lang.String name) {
        this(name, VirtualAlpineRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VirtualAlpineRepository(java.lang.String name, VirtualAlpineRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualAlpineRepository(java.lang.String name, VirtualAlpineRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualAlpineRepository:VirtualAlpineRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualAlpineRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualAlpineRepository:VirtualAlpineRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VirtualAlpineRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualAlpineRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
