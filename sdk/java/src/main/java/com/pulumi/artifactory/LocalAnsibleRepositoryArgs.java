...
public final class LocalAnsibleRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalAnsibleRepositoryArgs Empty = new LocalAnsibleRepositoryArgs();
    ...
    private LocalAnsibleRepositoryArgs() {}
    ...
    public static Builder builder(LocalAnsibleRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalAnsibleRepositoryArgs();
        }

        public Builder(LocalAnsibleRepositoryArgs defaults) {
            $ = new LocalAnsibleRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LocalAnsibleRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("LocalAnsibleRepositoryArgs", "key");
            }
            return $;
        }
    }
