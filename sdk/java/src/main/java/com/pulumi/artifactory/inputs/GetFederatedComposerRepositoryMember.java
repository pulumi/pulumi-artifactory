...
public final class GetFederatedComposerRepositoryMember extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetFederatedComposerRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedComposerRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedComposerRepositoryMember", "url");
            }
            return $;
        }
    }
