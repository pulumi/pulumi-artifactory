...
@CustomType
public final class RemoteHelmociRepositoryContentSynchronisation {
    /**
    ...
    private RemoteHelmociRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteHelmociRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteHelmociRepositoryContentSynchronisation defaults) {
        ...
        public RemoteHelmociRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteHelmociRepositoryContentSynchronisation();
