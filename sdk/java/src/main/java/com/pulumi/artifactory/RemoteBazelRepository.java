...
import com.pulumi.artifactory.RemoteBazelRepositoryArgs;
import com.pulumi.artifactory.Utilities;
import com.pulumi.artifactory.inputs.RemoteBazelRepositoryState;
import com.pulumi.artifactory.outputs.RemoteBazelRepositoryContentSynchronisation;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.RemoteBazelRepository;
 * import com.pulumi.artifactory.RemoteBazelRepositoryArgs;
 ...
 *         var my_remote_bazelmodules = new RemoteBazelRepository("my-remote-bazelmodules", RemoteBazelRepositoryArgs.builder()
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteBazelRepository:RemoteBazelRepository")
public class RemoteBazelRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteBazelRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteBazelRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteBazelRepositoryContentSynchronisation>> contentSynchronisation() {
    ...
    /**
     * @return The remote repo URL. For the Bazel Central Registry, use `https://bcr.bazel.build/`.
     * 
     */
     ...
     */
    public RemoteBazelRepository(java.lang.String name) {
        this(name, RemoteBazelRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteBazelRepository(java.lang.String name, RemoteBazelRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteBazelRepository(java.lang.String name, RemoteBazelRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteBazelRepository:RemoteBazelRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteBazelRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteBazelRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteBazelRepository:RemoteBazelRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteBazelRepositoryArgs makeArgs(RemoteBazelRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteBazelRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteBazelRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteBazelRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteBazelRepository(name, id, state, options);
    }
}
