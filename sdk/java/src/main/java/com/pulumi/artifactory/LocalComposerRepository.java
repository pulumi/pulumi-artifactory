...
public class LocalComposerRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalComposerRepository(String name) {
     ...
     */
    public static LocalComposerRepository get(String name, Output<String> id, @Nullable LocalComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
