...
import com.pulumi.artifactory.inputs.LocalComposerRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localComposerRepository:LocalComposerRepository")
public class LocalComposerRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalComposerRepository(java.lang.String name) {
        this(name, LocalComposerRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalComposerRepository(java.lang.String name, LocalComposerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalComposerRepository(java.lang.String name, LocalComposerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localComposerRepository:LocalComposerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalComposerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localComposerRepository:LocalComposerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalComposerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalComposerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
