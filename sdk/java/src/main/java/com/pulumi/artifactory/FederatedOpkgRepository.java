...
import com.pulumi.artifactory.inputs.FederatedOpkgRepositoryState;
import com.pulumi.artifactory.outputs.FederatedOpkgRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedOpkgRepository:FederatedOpkgRepository")
public class FederatedOpkgRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedOpkgRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedOpkgRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedOpkgRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedOpkgRepository(java.lang.String name) {
        this(name, FederatedOpkgRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedOpkgRepository(java.lang.String name, FederatedOpkgRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedOpkgRepository(java.lang.String name, FederatedOpkgRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedOpkgRepository:FederatedOpkgRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedOpkgRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedOpkgRepository:FederatedOpkgRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedOpkgRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
