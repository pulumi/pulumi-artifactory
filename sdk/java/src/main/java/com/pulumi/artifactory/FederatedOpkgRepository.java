...
public class FederatedOpkgRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedOpkgRepositoryMember.class})
     ...
     */
    public FederatedOpkgRepository(String name) {
     ...
     */
    public FederatedOpkgRepository(String name, FederatedOpkgRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedOpkgRepository get(String name, Output<String> id, @Nullable FederatedOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
