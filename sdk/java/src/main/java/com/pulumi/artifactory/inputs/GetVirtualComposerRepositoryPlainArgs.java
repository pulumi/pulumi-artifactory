...
public final class GetVirtualComposerRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetVirtualComposerRepositoryPlainArgs Empty = new GetVirtualComposerRepositoryPlainArgs();
    ...
    private GetVirtualComposerRepositoryPlainArgs() {}

    private GetVirtualComposerRepositoryPlainArgs(GetVirtualComposerRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetVirtualComposerRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVirtualComposerRepositoryPlainArgs();
        }

        public Builder(GetVirtualComposerRepositoryPlainArgs defaults) {
            $ = new GetVirtualComposerRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVirtualComposerRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetVirtualComposerRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
