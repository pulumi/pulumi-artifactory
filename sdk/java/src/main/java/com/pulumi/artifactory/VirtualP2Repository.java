...
import com.pulumi.artifactory.VirtualP2RepositoryArgs;
import com.pulumi.artifactory.inputs.VirtualP2RepositoryState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.VirtualP2Repository;
 * import com.pulumi.artifactory.VirtualP2RepositoryArgs;
 ...
 * 
 */
@ResourceType(type="artifactory:index/virtualP2Repository:VirtualP2Repository")
public class VirtualP2Repository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public VirtualP2Repository(java.lang.String name) {
        this(name, VirtualP2RepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VirtualP2Repository(java.lang.String name, VirtualP2RepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualP2Repository(java.lang.String name, VirtualP2RepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualP2Repository:VirtualP2Repository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualP2Repository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualP2RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualP2Repository:VirtualP2Repository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualP2RepositoryArgs makeArgs(VirtualP2RepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualP2RepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualP2Repository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualP2RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new VirtualP2Repository(name, id, state, options);
    }
}
