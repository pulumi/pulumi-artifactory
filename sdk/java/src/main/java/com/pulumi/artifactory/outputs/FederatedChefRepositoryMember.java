...
@CustomType
public final class FederatedChefRepositoryMember {
    /**
    ...
    private FederatedChefRepositoryMember() {}
    /**
     * @return Admin access token for this member Artifactory instance. Used in conjunction with `cleanupOnDelete` attribute when Access Federation for access tokens is not enabled.
     * 
     */
    ...
    public static Builder builder(FederatedChefRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(FederatedChefRepositoryMember defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedChefRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedChefRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
