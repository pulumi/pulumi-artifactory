...
import com.pulumi.artifactory.inputs.LocalAnsibleRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localAnsibleRepository:LocalAnsibleRepository")
public class LocalAnsibleRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalAnsibleRepository(java.lang.String name) {
        this(name, LocalAnsibleRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalAnsibleRepository(java.lang.String name, LocalAnsibleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalAnsibleRepository(java.lang.String name, LocalAnsibleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localAnsibleRepository:LocalAnsibleRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalAnsibleRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localAnsibleRepository:LocalAnsibleRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LocalAnsibleRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
