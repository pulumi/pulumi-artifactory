...
public class LocalAnsibleRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public LocalAnsibleRepository(String name) {
     ...
     */
    public LocalAnsibleRepository(String name, LocalAnsibleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static LocalAnsibleRepository get(String name, Output<String> id, @Nullable LocalAnsibleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
