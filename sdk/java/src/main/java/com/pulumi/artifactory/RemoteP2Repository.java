...
import com.pulumi.artifactory.inputs.RemoteP2RepositoryState;
import com.pulumi.artifactory.outputs.RemoteP2RepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remoteP2Repository:RemoteP2Repository")
public class RemoteP2Repository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemoteP2RepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteP2RepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteP2RepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteP2Repository(java.lang.String name) {
        this(name, RemoteP2RepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteP2Repository(java.lang.String name, RemoteP2RepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteP2Repository(java.lang.String name, RemoteP2RepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteP2Repository:RemoteP2Repository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteP2Repository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteP2RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteP2Repository:RemoteP2Repository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteP2Repository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteP2RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
