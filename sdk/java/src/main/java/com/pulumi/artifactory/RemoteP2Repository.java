...
public class RemoteP2Repository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteP2RepositoryContentSynchronisation.class, parameters={})
     ...
     */
    public RemoteP2Repository(String name) {
     ...
     */
    public static RemoteP2Repository get(String name, Output<String> id, @Nullable RemoteP2RepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
