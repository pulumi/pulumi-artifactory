...
@CustomType
public final class FederatedVagrantRepositoryMember {
    /**
    ...
    private FederatedVagrantRepositoryMember() {}
    /**
     * @return Admin access token for this member Artifactory instance. Used in conjunction with `cleanupOnDelete` attribute when Access Federation for access tokens is not enabled.
     * 
     */
    ...
    public static Builder builder(FederatedVagrantRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        private String url;
        public Builder() {}
        public Builder(FederatedVagrantRepositoryMember defaults) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("FederatedVagrantRepositoryMember", "enabled");
            }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("FederatedVagrantRepositoryMember", "url");
            }
            this.url = url;
            return this;
        }
