...
public final class GetFederatedAnsibleRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedAnsibleRepositoryMember Empty = new GetFederatedAnsibleRepositoryMember();
    ...
    private GetFederatedAnsibleRepositoryMember() {}

    private GetFederatedAnsibleRepositoryMember(GetFederatedAnsibleRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedAnsibleRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedAnsibleRepositoryMember();
        }

        public Builder(GetFederatedAnsibleRepositoryMember defaults) {
            $ = new GetFederatedAnsibleRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedAnsibleRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedAnsibleRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedAnsibleRepositoryMember", "url");
            }
            return $;
        }
    }
