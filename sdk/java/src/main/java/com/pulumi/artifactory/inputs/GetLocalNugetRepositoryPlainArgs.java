...
public final class GetLocalNugetRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalNugetRepositoryPlainArgs Empty = new GetLocalNugetRepositoryPlainArgs();
    ...
    private GetLocalNugetRepositoryPlainArgs() {}

    private GetLocalNugetRepositoryPlainArgs(GetLocalNugetRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalNugetRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalNugetRepositoryPlainArgs();
        }

        public Builder(GetLocalNugetRepositoryPlainArgs defaults) {
            $ = new GetLocalNugetRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalNugetRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalNugetRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
