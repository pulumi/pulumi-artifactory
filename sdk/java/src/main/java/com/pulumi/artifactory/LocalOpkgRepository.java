...
import com.pulumi.artifactory.inputs.LocalOpkgRepositoryState;
 ...
 * 
 */
@ResourceType(type="artifactory:index/localOpkgRepository:LocalOpkgRepository")
public class LocalOpkgRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalOpkgRepository(java.lang.String name) {
        this(name, LocalOpkgRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalOpkgRepository(java.lang.String name, LocalOpkgRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalOpkgRepository(java.lang.String name, LocalOpkgRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localOpkgRepository:LocalOpkgRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalOpkgRepository(java.lang.String name, Output<java.lang.String> id, @Nullable LocalOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localOpkgRepository:LocalOpkgRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalOpkgRepositoryArgs makeArgs(LocalOpkgRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalOpkgRepositoryArgs.Empty : args;
    }
     ...
     */
    public static LocalOpkgRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalOpkgRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LocalOpkgRepository(name, id, state, options);
    }
}
