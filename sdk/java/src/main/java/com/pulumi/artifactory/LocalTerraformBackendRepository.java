...
public class LocalTerraformBackendRepository extends com.pulumi.resources.CustomResource {
    ...
    public LocalTerraformBackendRepository(String name, LocalTerraformBackendRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/localTerraformBackendRepository:LocalTerraformBackendRepository", name, args == null ? LocalTerraformBackendRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
