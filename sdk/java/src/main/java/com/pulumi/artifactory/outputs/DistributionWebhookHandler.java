...
@CustomType
public final class DistributionWebhookHandler {
    /**
    ...
    public static Builder builder(DistributionWebhookHandler defaults) {
    ...
    public static final class Builder {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("DistributionWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
