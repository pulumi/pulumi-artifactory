...
public final class PermissionTargetBuildActionsGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PermissionTargetBuildActionsGroupArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PermissionTargetBuildActionsGroupArgs", "name");
            }
            if ($.permissions == null) {
                throw new MissingRequiredPropertyException("PermissionTargetBuildActionsGroupArgs", "permissions");
            }
            return $;
        }
    }
