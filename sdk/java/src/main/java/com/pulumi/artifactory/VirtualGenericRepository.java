 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.index_virtualGenericRepository.VirtualGenericRepository;
 * import com.pulumi.artifactory.index_virtualGenericRepository.VirtualGenericRepositoryArgs;
 * import java.util.List;
...
public class VirtualGenericRepository extends com.pulumi.resources.CustomResource {
    ...
    public VirtualGenericRepository(String name, VirtualGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGenericRepository:VirtualGenericRepository", name, args == null ? VirtualGenericRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
