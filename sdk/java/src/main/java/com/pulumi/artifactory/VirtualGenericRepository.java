...
public class VirtualGenericRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualGenericRepository(String name) {
     ...
     */
    public VirtualGenericRepository(String name, VirtualGenericRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualGenericRepository(String name, VirtualGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGenericRepository:VirtualGenericRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private VirtualGenericRepository(String name, Output<String> id, @Nullable VirtualGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGenericRepository:VirtualGenericRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static VirtualGenericRepository get(String name, Output<String> id, @Nullable VirtualGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
