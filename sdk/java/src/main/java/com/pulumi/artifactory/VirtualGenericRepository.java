...
import com.pulumi.artifactory.VirtualGenericRepositoryArgs;
import com.pulumi.artifactory.inputs.VirtualGenericRepositoryState;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.artifactory.VirtualGenericRepository;
 * import com.pulumi.artifactory.VirtualGenericRepositoryArgs;
 ...
 * 
 */
@ResourceType(type="artifactory:index/virtualGenericRepository:VirtualGenericRepository")
public class VirtualGenericRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public VirtualGenericRepository(java.lang.String name) {
        this(name, VirtualGenericRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VirtualGenericRepository(java.lang.String name, VirtualGenericRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualGenericRepository(java.lang.String name, VirtualGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGenericRepository:VirtualGenericRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualGenericRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualGenericRepository:VirtualGenericRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static VirtualGenericRepositoryArgs makeArgs(VirtualGenericRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VirtualGenericRepositoryArgs.Empty : args;
    }
     ...
     */
    public static VirtualGenericRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualGenericRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new VirtualGenericRepository(name, id, state, options);
    }
}
