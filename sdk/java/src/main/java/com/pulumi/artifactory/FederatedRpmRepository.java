...
public class FederatedRpmRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public FederatedRpmRepository(java.lang.String name) {
     ...
     */
    public FederatedRpmRepository(java.lang.String name, FederatedRpmRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedRpmRepository(java.lang.String name, FederatedRpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedRpmRepository:FederatedRpmRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedRpmRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedRpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedRpmRepository:FederatedRpmRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static FederatedRpmRepositoryArgs makeArgs(FederatedRpmRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? FederatedRpmRepositoryArgs.Empty : args;
    }
     ...
     */
    public static FederatedRpmRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedRpmRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
