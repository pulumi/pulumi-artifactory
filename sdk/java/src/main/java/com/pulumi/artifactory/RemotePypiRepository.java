...
public class RemotePypiRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemotePypiRepository(String name) {
     ...
     */
    public RemotePypiRepository(String name, RemotePypiRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemotePypiRepository get(String name, Output<String> id, @Nullable RemotePypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
