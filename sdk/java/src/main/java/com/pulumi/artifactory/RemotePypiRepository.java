...
public class RemotePypiRepository extends com.pulumi.resources.CustomResource {
    ...
    private Output<RemotePypiRepositoryContentSynchronisation> contentSynchronisation;

    public Output<RemotePypiRepositoryContentSynchronisation> contentSynchronisation() {
    ...
    public Output<Optional<String>> pypiRepositorySuffix() {
        return Codegen.optional(this.pypiRepositorySuffix);
    }
    /**
