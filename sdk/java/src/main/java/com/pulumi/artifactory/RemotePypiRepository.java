...
import com.pulumi.artifactory.inputs.RemotePypiRepositoryState;
import com.pulumi.artifactory.outputs.RemotePypiRepositoryContentSynchronisation;
 ...
 * 
 */
@ResourceType(type="artifactory:index/remotePypiRepository:RemotePypiRepository")
public class RemotePypiRepository extends com.pulumi.resources.CustomResource {
    /**
    ...
    @Export(name="contentSynchronisation", refs={RemotePypiRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemotePypiRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemotePypiRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     * 
     */
    @Export(name="pypiRegistryUrl", refs={String.class}, tree="[0]")
    private Output<String> pypiRegistryUrl;
     ...
     * 
     */
    public Output<String> pypiRegistryUrl() {
     ...
     * 
     */
    @Export(name="pypiRepositorySuffix", refs={String.class}, tree="[0]")
    private Output<String> pypiRepositorySuffix;
     ...
     * 
     */
    public Output<String> pypiRepositorySuffix() {
        return this.pypiRepositorySuffix;
    }
    /**
     ...
     */
    public RemotePypiRepository(java.lang.String name) {
        this(name, RemotePypiRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemotePypiRepository(java.lang.String name, RemotePypiRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemotePypiRepository(java.lang.String name, RemotePypiRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remotePypiRepository:RemotePypiRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemotePypiRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemotePypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remotePypiRepository:RemotePypiRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemotePypiRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemotePypiRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
