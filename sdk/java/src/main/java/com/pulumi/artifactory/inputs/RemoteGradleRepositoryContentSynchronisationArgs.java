...
public final class RemoteGradleRepositoryContentSynchronisationArgs extends com.pulumi.resources.ResourceArgs {

    public static final RemoteGradleRepositoryContentSynchronisationArgs Empty = new RemoteGradleRepositoryContentSynchronisationArgs();
    ...
    private RemoteGradleRepositoryContentSynchronisationArgs() {}

    private RemoteGradleRepositoryContentSynchronisationArgs(RemoteGradleRepositoryContentSynchronisationArgs $) {
    ...
    public static Builder builder(RemoteGradleRepositoryContentSynchronisationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RemoteGradleRepositoryContentSynchronisationArgs defaults) {
            $ = new RemoteGradleRepositoryContentSynchronisationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RemoteGradleRepositoryContentSynchronisationArgs build() {
            return $;
        }
    }
