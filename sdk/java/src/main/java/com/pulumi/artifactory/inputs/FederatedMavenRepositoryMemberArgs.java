...
public final class FederatedMavenRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedMavenRepositoryMemberArgs Empty = new FederatedMavenRepositoryMemberArgs();
    ...
    private FederatedMavenRepositoryMemberArgs() {}

    private FederatedMavenRepositoryMemberArgs(FederatedMavenRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedMavenRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedMavenRepositoryMemberArgs();
        }

        public Builder(FederatedMavenRepositoryMemberArgs defaults) {
            $ = new FederatedMavenRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedMavenRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedMavenRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedMavenRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
