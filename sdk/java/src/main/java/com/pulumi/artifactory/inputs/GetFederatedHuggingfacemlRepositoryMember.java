...
public final class GetFederatedHuggingfacemlRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedHuggingfacemlRepositoryMember Empty = new GetFederatedHuggingfacemlRepositoryMember();
    ...
    private GetFederatedHuggingfacemlRepositoryMember() {}

    private GetFederatedHuggingfacemlRepositoryMember(GetFederatedHuggingfacemlRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedHuggingfacemlRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedHuggingfacemlRepositoryMember();
        }

        public Builder(GetFederatedHuggingfacemlRepositoryMember defaults) {
            $ = new GetFederatedHuggingfacemlRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedHuggingfacemlRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedHuggingfacemlRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedHuggingfacemlRepositoryMember", "url");
            }
            return $;
        }
    }
