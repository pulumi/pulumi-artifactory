...
public final class DestinationWebhookCriteriaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DestinationWebhookCriteriaArgs Empty = new DestinationWebhookCriteriaArgs();
    ...
    private DestinationWebhookCriteriaArgs() {}

    private DestinationWebhookCriteriaArgs(DestinationWebhookCriteriaArgs $) {
    ...
    public static Builder builder(DestinationWebhookCriteriaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DestinationWebhookCriteriaArgs();
        }

        public Builder(DestinationWebhookCriteriaArgs defaults) {
            $ = new DestinationWebhookCriteriaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DestinationWebhookCriteriaArgs build() {
            if ($.anyReleaseBundle == null) {
                throw new MissingRequiredPropertyException("DestinationWebhookCriteriaArgs", "anyReleaseBundle");
            }
            if ($.registeredReleaseBundleNames == null) {
                throw new MissingRequiredPropertyException("DestinationWebhookCriteriaArgs", "registeredReleaseBundleNames");
            }
            return $;
        }
    }
