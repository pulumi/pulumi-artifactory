...
@CustomType
public final class RemoteOciRepositoryContentSynchronisation {
    /**
    ...
    private RemoteOciRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteOciRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteOciRepositoryContentSynchronisation defaults) {
        ...
        public RemoteOciRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteOciRepositoryContentSynchronisation();
