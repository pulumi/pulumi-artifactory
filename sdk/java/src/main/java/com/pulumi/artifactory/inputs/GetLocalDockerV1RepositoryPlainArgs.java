...
public final class GetLocalDockerV1RepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLocalDockerV1RepositoryPlainArgs Empty = new GetLocalDockerV1RepositoryPlainArgs();
    ...
    private GetLocalDockerV1RepositoryPlainArgs() {}

    private GetLocalDockerV1RepositoryPlainArgs(GetLocalDockerV1RepositoryPlainArgs $) {
    ...
    public static Builder builder(GetLocalDockerV1RepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLocalDockerV1RepositoryPlainArgs();
        }

        public Builder(GetLocalDockerV1RepositoryPlainArgs defaults) {
            $ = new GetLocalDockerV1RepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLocalDockerV1RepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetLocalDockerV1RepositoryPlainArgs", "key");
            }
            return $;
        }
    }
