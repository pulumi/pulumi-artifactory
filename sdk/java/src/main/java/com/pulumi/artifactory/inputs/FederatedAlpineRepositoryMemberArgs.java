...
public final class FederatedAlpineRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final FederatedAlpineRepositoryMemberArgs Empty = new FederatedAlpineRepositoryMemberArgs();
    ...
    private FederatedAlpineRepositoryMemberArgs() {}

    private FederatedAlpineRepositoryMemberArgs(FederatedAlpineRepositoryMemberArgs $) {
    ...
    public static Builder builder(FederatedAlpineRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FederatedAlpineRepositoryMemberArgs();
        }

        public Builder(FederatedAlpineRepositoryMemberArgs defaults) {
            $ = new FederatedAlpineRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FederatedAlpineRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("FederatedAlpineRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("FederatedAlpineRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
