...
@CustomType
public final class RemoteBazelRepositoryContentSynchronisation {
    /**
    ...
    private RemoteBazelRepositoryContentSynchronisation() {}
    /**
     * @return If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is &#39;false&#39;.
     * 
     */
    ...
    public static Builder builder(RemoteBazelRepositoryContentSynchronisation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean statisticsEnabled;
        public Builder() {}
        public Builder(RemoteBazelRepositoryContentSynchronisation defaults) {
        ...
        public RemoteBazelRepositoryContentSynchronisation build() {
            final var _resultValue = new RemoteBazelRepositoryContentSynchronisation();
