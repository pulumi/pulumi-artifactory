...
public final class GoRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final GoRepositoryArgs Empty = new GoRepositoryArgs();
    ...
    private GoRepositoryArgs() {}

    private GoRepositoryArgs(GoRepositoryArgs $) {
    ...
    public static Builder builder(GoRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GoRepositoryArgs();
        }

        public Builder(GoRepositoryArgs defaults) {
            $ = new GoRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GoRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GoRepositoryArgs", "key");
            }
            return $;
        }
    }
