...
public final class VirtualNugetRepositoryState extends com.pulumi.resources.ResourceArgs {

    public static final VirtualNugetRepositoryState Empty = new VirtualNugetRepositoryState();
    ...
    public static Builder builder(VirtualNugetRepositoryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNugetRepositoryState();
        }

        public Builder(VirtualNugetRepositoryState defaults) {
            $ = new VirtualNugetRepositoryState(Objects.requireNonNull(defaults));
        }
