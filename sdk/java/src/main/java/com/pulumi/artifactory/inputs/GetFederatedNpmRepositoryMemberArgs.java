...
public final class GetFederatedNpmRepositoryMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetFederatedNpmRepositoryMemberArgs Empty = new GetFederatedNpmRepositoryMemberArgs();
    ...
    private GetFederatedNpmRepositoryMemberArgs() {}

    private GetFederatedNpmRepositoryMemberArgs(GetFederatedNpmRepositoryMemberArgs $) {
    ...
    public static Builder builder(GetFederatedNpmRepositoryMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedNpmRepositoryMemberArgs();
        }

        public Builder(GetFederatedNpmRepositoryMemberArgs defaults) {
            $ = new GetFederatedNpmRepositoryMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedNpmRepositoryMemberArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedNpmRepositoryMemberArgs", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedNpmRepositoryMemberArgs", "url");
            }
            return $;
        }
    }
