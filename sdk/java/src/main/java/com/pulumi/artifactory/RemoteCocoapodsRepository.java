...
import com.pulumi.artifactory.inputs.RemoteCocoapodsRepositoryState;
import com.pulumi.artifactory.outputs.RemoteCocoapodsRepositoryContentSynchronisation;
...
public class RemoteCocoapodsRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteCocoapodsRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteCocoapodsRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteCocoapodsRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     * 
     */
    @Export(name="podsSpecsRepoUrl", refs={String.class}, tree="[0]")
    private Output<String> podsSpecsRepoUrl;

    /**
     * @return Proxy remote CocoaPods Specs repositories. Default value is `https://github.com/CocoaPods/Specs`.
     * 
     */
    public Output<String> podsSpecsRepoUrl() {
     ...
     */
    public RemoteCocoapodsRepository(java.lang.String name) {
        this(name, RemoteCocoapodsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteCocoapodsRepository(java.lang.String name, RemoteCocoapodsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteCocoapodsRepository(java.lang.String name, RemoteCocoapodsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCocoapodsRepository:RemoteCocoapodsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteCocoapodsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteCocoapodsRepository:RemoteCocoapodsRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemoteCocoapodsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteCocoapodsRepository(name, id, state, options);
    }
}
