...
public class RemoteCocoapodsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteCocoapodsRepository(String name) {
     ...
     */
    public RemoteCocoapodsRepository(String name, RemoteCocoapodsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static RemoteCocoapodsRepository get(String name, Output<String> id, @Nullable RemoteCocoapodsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
