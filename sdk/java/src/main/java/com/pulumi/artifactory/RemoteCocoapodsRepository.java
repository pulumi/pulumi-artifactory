...
public class RemoteCocoapodsRepository extends com.pulumi.resources.CustomResource {
    ...
    private Output<RemoteCocoapodsRepositoryContentSynchronisation> contentSynchronisation;

    public Output<RemoteCocoapodsRepositoryContentSynchronisation> contentSynchronisation() {
    ...
    public Output<Optional<String>> podsSpecsRepoUrl() {
        return Codegen.optional(this.podsSpecsRepoUrl);
    }
    /**
