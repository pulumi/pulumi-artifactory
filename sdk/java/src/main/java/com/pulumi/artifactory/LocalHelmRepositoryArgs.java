...
public final class LocalHelmRepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LocalHelmRepositoryArgs Empty = new LocalHelmRepositoryArgs();
    ...
    private LocalHelmRepositoryArgs() {}

    private LocalHelmRepositoryArgs(LocalHelmRepositoryArgs $) {
    ...
    public static Builder builder(LocalHelmRepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalHelmRepositoryArgs();
        }

        public Builder(LocalHelmRepositoryArgs defaults) {
            $ = new LocalHelmRepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LocalHelmRepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("LocalHelmRepositoryArgs", "key");
            }
            return $;
        }
    }
