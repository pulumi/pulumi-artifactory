...
import com.pulumi.artifactory.outputs.PermissionTargetsBuildActions;
...
@CustomType
public final class PermissionTargetsBuild {
    /**
     * @return -
     * 
     */
    private final @Nullable PermissionTargetsBuildActions actions;
    /**
    ...
    private PermissionTargetsBuild(
        @CustomType.Parameter("actions") @Nullable PermissionTargetsBuildActions actions,
     ...
     * 
     */
    public Optional<PermissionTargetsBuildActions> actions() {
    ...
    public static Builder builder(PermissionTargetsBuild defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable PermissionTargetsBuildActions actions;
        ...
        public Builder(PermissionTargetsBuild defaults) {
        ...
        public Builder actions(@Nullable PermissionTargetsBuildActions actions) {
            this.actions = actions;
            return this;
        }
        ...
        }        public PermissionTargetsBuild build() {
            return new PermissionTargetsBuild(actions, excludesPatterns, includesPatterns, repositories);
        }
    }
}
