...
public class FederatedTerraformModuleRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", type=List.class, parameters={FederatedTerraformModuleRepositoryMember.class})
     ...
     */
    public FederatedTerraformModuleRepository(String name) {
     ...
     */
    public FederatedTerraformModuleRepository(String name, FederatedTerraformModuleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static FederatedTerraformModuleRepository get(String name, Output<String> id, @Nullable FederatedTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
