...
import com.pulumi.artifactory.inputs.FederatedTerraformModuleRepositoryState;
import com.pulumi.artifactory.outputs.FederatedTerraformModuleRepositoryMember;
 ...
 * 
 */
@ResourceType(type="artifactory:index/federatedTerraformModuleRepository:FederatedTerraformModuleRepository")
public class FederatedTerraformModuleRepository extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedTerraformModuleRepositoryMember.class}, tree="[0,1]")
    private Output<List<FederatedTerraformModuleRepositoryMember>> members;
     ...
     * 
     */
    public Output<List<FederatedTerraformModuleRepositoryMember>> members() {
        return this.members;
    }
    /**
     ...
     */
    public FederatedTerraformModuleRepository(java.lang.String name) {
        this(name, FederatedTerraformModuleRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public FederatedTerraformModuleRepository(java.lang.String name, FederatedTerraformModuleRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedTerraformModuleRepository(java.lang.String name, FederatedTerraformModuleRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedTerraformModuleRepository:FederatedTerraformModuleRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedTerraformModuleRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedTerraformModuleRepository:FederatedTerraformModuleRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedTerraformModuleRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedTerraformModuleRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
