...
public final class GetFederatedHelmociRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedHelmociRepositoryMember Empty = new GetFederatedHelmociRepositoryMember();
    ...
    private GetFederatedHelmociRepositoryMember() {}

    private GetFederatedHelmociRepositoryMember(GetFederatedHelmociRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedHelmociRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedHelmociRepositoryMember();
        }

        public Builder(GetFederatedHelmociRepositoryMember defaults) {
            $ = new GetFederatedHelmociRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedHelmociRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedHelmociRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedHelmociRepositoryMember", "url");
            }
            return $;
        }
    }
