...
public final class DockerV1RepositoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final DockerV1RepositoryArgs Empty = new DockerV1RepositoryArgs();
    ...
    private DockerV1RepositoryArgs() {}
    ...
    public static Builder builder(DockerV1RepositoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DockerV1RepositoryArgs();
        }

        public Builder(DockerV1RepositoryArgs defaults) {
            $ = new DockerV1RepositoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DockerV1RepositoryArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("DockerV1RepositoryArgs", "key");
            }
            return $;
        }
    }
