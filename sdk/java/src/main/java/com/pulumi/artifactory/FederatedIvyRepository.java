...
public class FederatedIvyRepository extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="members", refs={List.class,FederatedIvyRepositoryMember.class}, tree="[0,1]")
     ...
     */
    public FederatedIvyRepository(java.lang.String name) {
     ...
     */
    public FederatedIvyRepository(java.lang.String name, FederatedIvyRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FederatedIvyRepository(java.lang.String name, FederatedIvyRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedIvyRepository:FederatedIvyRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FederatedIvyRepository(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedIvyRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/federatedIvyRepository:FederatedIvyRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FederatedIvyRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable FederatedIvyRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
