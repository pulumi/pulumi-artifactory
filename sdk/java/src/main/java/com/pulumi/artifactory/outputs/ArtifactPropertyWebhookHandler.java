...
@CustomType
public final class ArtifactPropertyWebhookHandler {
    /**
    ...
    public static final class Builder {
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("ArtifactPropertyWebhookHandler", "url");
            }
            this.url = url;
            return this;
        }
        public ArtifactPropertyWebhookHandler build() {
            final var _resultValue = new ArtifactPropertyWebhookHandler();
