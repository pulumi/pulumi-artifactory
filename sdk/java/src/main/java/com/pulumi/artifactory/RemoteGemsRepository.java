...
public class RemoteGemsRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemoteGemsRepository(String name) {
     ...
     */
    public RemoteGemsRepository(String name, RemoteGemsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteGemsRepository(String name, RemoteGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGemsRepository:RemoteGemsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private RemoteGemsRepository(String name, Output<String> id, @Nullable RemoteGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGemsRepository:RemoteGemsRepository", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RemoteGemsRepository get(String name, Output<String> id, @Nullable RemoteGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
