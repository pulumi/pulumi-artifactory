...
import com.pulumi.artifactory.inputs.RemoteGemsRepositoryState;
import com.pulumi.artifactory.outputs.RemoteGemsRepositoryContentSynchronisation;
...
public class RemoteGemsRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", refs={RemoteGemsRepositoryContentSynchronisation.class}, tree="[0]")
    private Output</* @Nullable */ RemoteGemsRepositoryContentSynchronisation> contentSynchronisation;

    public Output<Optional<RemoteGemsRepositoryContentSynchronisation>> contentSynchronisation() {
     ...
     */
    public RemoteGemsRepository(java.lang.String name) {
        this(name, RemoteGemsRepositoryArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RemoteGemsRepository(java.lang.String name, RemoteGemsRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemoteGemsRepository(java.lang.String name, RemoteGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGemsRepository:RemoteGemsRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemoteGemsRepository(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGemsRepository:RemoteGemsRepository", name, state, makeResourceOptions(options, id), false);
    }

    private static RemoteGemsRepositoryArgs makeArgs(RemoteGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RemoteGemsRepositoryArgs.Empty : args;
    }
     ...
     */
    public static RemoteGemsRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable RemoteGemsRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new RemoteGemsRepository(name, id, state, options);
    }
}
