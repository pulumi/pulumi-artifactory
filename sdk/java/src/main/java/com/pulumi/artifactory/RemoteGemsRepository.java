...
public class RemoteGemsRepository extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="contentSynchronisation", type=RemoteGemsRepositoryContentSynchronisation.class, parameters={})
    ...
    public RemoteGemsRepository(String name, RemoteGemsRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/remoteGemsRepository:RemoteGemsRepository", name, args == null ? RemoteGemsRepositoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
