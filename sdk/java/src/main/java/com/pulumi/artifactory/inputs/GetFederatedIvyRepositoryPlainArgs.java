...
import com.pulumi.artifactory.inputs.GetFederatedIvyRepositoryMember;
...
public final class GetFederatedIvyRepositoryPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedIvyRepositoryPlainArgs Empty = new GetFederatedIvyRepositoryPlainArgs();
    ...
    private GetFederatedIvyRepositoryPlainArgs() {}

    private GetFederatedIvyRepositoryPlainArgs(GetFederatedIvyRepositoryPlainArgs $) {
    ...
    public static Builder builder(GetFederatedIvyRepositoryPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedIvyRepositoryPlainArgs();
        }

        public Builder(GetFederatedIvyRepositoryPlainArgs defaults) {
            $ = new GetFederatedIvyRepositoryPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedIvyRepositoryPlainArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetFederatedIvyRepositoryPlainArgs", "key");
            }
            return $;
        }
    }
