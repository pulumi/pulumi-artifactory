...
public final class GetFederatedGenericRepositoryMember extends com.pulumi.resources.InvokeArgs {

    public static final GetFederatedGenericRepositoryMember Empty = new GetFederatedGenericRepositoryMember();
    ...
    private GetFederatedGenericRepositoryMember() {}

    private GetFederatedGenericRepositoryMember(GetFederatedGenericRepositoryMember $) {
    ...
    public static Builder builder(GetFederatedGenericRepositoryMember defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFederatedGenericRepositoryMember();
        }

        public Builder(GetFederatedGenericRepositoryMember defaults) {
            $ = new GetFederatedGenericRepositoryMember(Objects.requireNonNull(defaults));
        }
        ...
        public GetFederatedGenericRepositoryMember build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("GetFederatedGenericRepositoryMember", "enabled");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("GetFederatedGenericRepositoryMember", "url");
            }
            return $;
        }
    }
