...
public class VirtualBowerRepository extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualBowerRepository(java.lang.String name) {
     ...
     */
    public VirtualBowerRepository(java.lang.String name, VirtualBowerRepositoryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VirtualBowerRepository(java.lang.String name, VirtualBowerRepositoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualBowerRepository:VirtualBowerRepository", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VirtualBowerRepository(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("artifactory:index/virtualBowerRepository:VirtualBowerRepository", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VirtualBowerRepository get(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualBowerRepositoryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
